...
struct FWorldContext {
	char pad_0[0x18]; // 0x00(0x18)
	struct UGameViewportClient* GameViewport; // 0x18(0x08)
	char pad_20[0x10]; // 0x20(0x10)
	struct U*8ea0475d8b* *8ea0475d8b; // 0x30(0x08)
	char pad_38[0x8]; // 0x38(0x08)
	struct TArray<struct U*7c448e30ae*> *55d92776e4; // 0x40(0x10)
	char pad_50[0x8]; // 0x50(0x08)
	struct TArray<struct F*9dcd338c5a> PackagesToFullyLoad; // 0x58(0x10)
	char pad_68[0xe0]; // 0x68(0xe0)
	struct TArray<struct F*248f357491> *959985156a; // 0x148(0x10)
	char pad_158[0x8]; // 0x158(0x08)
	struct FURL *e2dd2c7e65; // 0x160(0x70)
	char pad_1D0[0x20]; // 0x1d0(0x20)
	struct TArray<struct F*f189697845> *22f89144d6; // 0x1f0(0x10)
	char pad_200[0x8]; // 0x200(0x08)
	struct FURL *83f990b9f5; // 0x208(0x70)
	struct TArray<struct ULevel*> *fdfac597be; // 0x278(0x10)
	struct UGameInstance* *55c38de05e; // 0x288(0x08)
