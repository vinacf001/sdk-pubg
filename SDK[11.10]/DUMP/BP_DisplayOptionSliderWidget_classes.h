...
struct UBP_DisplayOptionSliderWidget_C : U*09cb64dd50 {
	...
	float Tick(); // Function BP_DisplayOptionSliderWidget.BP_DisplayOptionSliderWidget_C.Tick // BlueprintCosmetic|Event|Public|BlueprintEvent // @ game+0x273e04
	float ExecuteUbergraph_BP_DisplayOptionSliderWidget(); // Function BP_DisplayOptionSliderWidget.BP_DisplayOptionSliderWidget_C.ExecuteUbergraph_BP_DisplayOptionSliderWidget // HasDefaults // @ game+0x273e04
};
