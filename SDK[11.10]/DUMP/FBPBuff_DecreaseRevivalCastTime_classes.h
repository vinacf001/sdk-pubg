...
struct AFBPBuff_DecreaseRevivalCastTime_C : ATslFBRBuff {
	...
	void UserConstructionScript(); // Function FBPBuff_DecreaseRevivalCastTime.FBPBuff_DecreaseRevivalCastTime_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x273e04
};
