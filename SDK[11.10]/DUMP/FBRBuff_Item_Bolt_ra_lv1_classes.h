...
struct AFBRBuff_Item_Bolt_ra_lv1_C : ATslFBRItemBuff {
	...
	void UserConstructionScript(); // Function FBRBuff_Item_Bolt_ra_lv1.FBRBuff_Item_Bolt_ra_lv1_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x273e04
};
