...
struct ABP_SelectBoxActor_C : AActor {
	...
	void UserConstructionScript(); // Function BP_SelectBoxActor.BP_SelectBoxActor_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x273e04
};
