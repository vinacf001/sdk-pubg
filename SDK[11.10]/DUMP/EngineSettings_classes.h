...
struct UConsoleSettings : UObject {
	...
	struct TArray<struct F*d52791d8ba> ManualAutoCompleteList; // 0x38(0x10)
...
struct UGameMapsSettings : UObject {
	...
	enum class *5cfaeea139 ThreePlayerSplitscreenLayout; // 0x62(0x01)
	...
	struct TArray<struct F*c8a73dc119> GameModeMapPrefixes; // 0xb8(0x10)
	struct TArray<struct F*c8a73dc119> GameModeClassAliases; // 0xc8(0x10)
};
