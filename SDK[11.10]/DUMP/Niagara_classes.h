...
struct ANiagaraActor : AActor {
	struct UNiagaraComponent* NiagaraComponent; // 0x400(0x08)
};
...
struct UNiagaraComponent : UPrimitiveComponent {
	...
	struct FVector *19576e91ee(); // Function Niagara.NiagaraComponent.*19576e91ee // Final|Native|Public|HasDefaults|BlueprintCallable // @ game+0x620dbfc
	void *d0b8a0f598(); // Function Niagara.NiagaraComponent.*d0b8a0f598 // Final|Native|Public|BlueprintCallable // @ game+0x620d56c
	struct AActor* *72e447b430(); // Function Niagara.NiagaraComponent.*72e447b430 // Final|Native|Public|BlueprintCallable // @ game+0x620d70c
	bool *c15b4db1a0(); // Function Niagara.NiagaraComponent.*c15b4db1a0 // Final|Native|Public|BlueprintCallable // @ game+0x620d828
	bool *7e0a5c9c69(); // Function Niagara.NiagaraComponent.*7e0a5c9c69 // Final|Native|Public|BlueprintCallable // @ game+0x620de88
	void *f351277176(); // Function Niagara.NiagaraComponent.*f351277176 // Final|Native|Public|BlueprintCallable // @ game+0x620d5ac
	struct FVector2D *db2ecc8b0f(); // Function Niagara.NiagaraComponent.*db2ecc8b0f // Final|Native|Public|HasDefaults|BlueprintCallable // @ game+0x620da9c
	float *7b6fe82f05(); // Function Niagara.NiagaraComponent.*7b6fe82f05 // Final|Native|Public|BlueprintCallable // @ game+0x620d97c
	struct FVector4 *7b565e9d05(); // Function Niagara.NiagaraComponent.*7b565e9d05 // Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable // @ game+0x620dd54
	float *bf4466f9f5(); // Function Niagara.NiagaraComponent.*bf4466f9f5 // Final|Native|Public|BlueprintCallable // @ game+0x620d5ec
};
...
struct U*b07648ef36 : UBlueprintFunctionLibrary {
	...
	struct UNiagaraComponent* SpawnEffectAttached(); // Function Niagara.*b07648ef36.SpawnEffectAttached // Final|Native|Static|Public|HasDefaults|BlueprintCallable // @ game+0x620e0e0
	struct UNiagaraComponent* *6da170feb8(); // Function Niagara.*b07648ef36.*6da170feb8 // Final|Native|Static|Public|HasDefaults|BlueprintCallable // @ game+0x620df18
};
