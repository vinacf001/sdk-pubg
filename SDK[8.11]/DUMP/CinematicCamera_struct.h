...
// ScriptStruct CinematicCamera.*69a8d4adc4
...
struct FCameraFocusSettings {
	...
	struct F*5286c055c0 TrackingFocusSettings; // 0x08(0x18)
	char bDrawDebugFocusPlane : 1; // 0x20(0x01)
	char pad_20_1 : 7; // 0x20(0x01)
	char pad_21[0x3]; // 0x21(0x03)
	struct FColor *bd3080ffad; // 0x24(0x04)
...
// ScriptStruct CinematicCamera.*5286c055c0
...
// ScriptStruct CinematicCamera.*5f97372596
...
// ScriptStruct CinematicCamera.*7cf7ea4908
