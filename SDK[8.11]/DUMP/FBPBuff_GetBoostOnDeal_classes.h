...
struct AFBPBuff_GetBoostOnDeal_C : ATslFBRBuff {
	...
	void UserConstructionScript(); // Function FBPBuff_GetBoostOnDeal.FBPBuff_GetBoostOnDeal_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x293938
};
