...
struct UW_RecoilDebugMenu_C : U*93b4e6955c {
	...
	void AddDebugShotPoint(); // Function W_RecoilDebugMenu.W_RecoilDebugMenu_C.AddDebugShotPoint // Public|BlueprintCallable|BlueprintEvent // @ game+0x293938
	void ClearStats(); // Function W_RecoilDebugMenu.W_RecoilDebugMenu_C.ClearStats // Public|HasDefaults|BlueprintCallable|BlueprintEvent // @ game+0x293938
	float UpdateStats(struct FVector2D CallFunc_MakeVector2D_ReturnValue6, struct FVector2D CallFunc_MakeVector2D_ReturnValue8, float CallFunc_BreakVector2D_Y, float CallFunc_BreakVector2D_Y2, struct FText CallFunc__8ede4714d5_ReturnValue7, struct FText CallFunc__8ede4714d5_ReturnValue9, float CallFunc_BreakVector2D_Y5, float CallFunc_BreakVector2D_Y6, struct FText CallFunc__8ede4714d5_ReturnValue15, struct FText CallFunc__8ede4714d5_ReturnValue17, float CallFunc__23a8e3a7f4_ReturnValue2, bool CallFunc__a59f4817f1_ReturnValue, struct FVector2D CallFunc_MakeVector2D_ReturnValue10, float CallFunc_BreakVector2D_Y11, float CallFunc_BreakVector2D_X12, float CallFunc_FMin_ReturnValue3, float CallFunc_FMin_ReturnValue5, struct FVector2D CallFunc_MakeVector2D_ReturnValue13, struct FVector2D CallFunc_MakeVector2D_ReturnValue14, float CallFunc_BreakVector2D_X15); // Function W_RecoilDebugMenu.W_RecoilDebugMenu_C.UpdateStats // Public|HasDefaults|BlueprintCallable|BlueprintEvent // @ game+0x293938
	void ClearAll(); // Function W_RecoilDebugMenu.W_RecoilDebugMenu_C.ClearAll // Public|BlueprintCallable|BlueprintEvent // @ game+0x293938
	void ClearTarget(); // Function W_RecoilDebugMenu.W_RecoilDebugMenu_C.ClearTarget // Public|BlueprintCallable|BlueprintEvent // @ game+0x293938
	void ClearList(); // Function W_RecoilDebugMenu.W_RecoilDebugMenu_C.ClearList // Public|BlueprintCallable|BlueprintEvent // @ game+0x293938
	...
	struct FGeometry Tick(); // Function W_RecoilDebugMenu.W_RecoilDebugMenu_C.Tick // BlueprintCosmetic|Event|Public|BlueprintEvent // @ game+0x293938
	void BndEvt__Button_399_K2Node_ComponentBoundEvent_15_OnButtonClickedEvent__DelegateSignature(); // Function W_RecoilDebugMenu.W_RecoilDebugMenu_C.BndEvt__Button_399_K2Node_ComponentBoundEvent_15_OnButtonClickedEvent__DelegateSignature // BlueprintEvent // @ game+0x293938
	void BndEvt__Button_498_K2Node_ComponentBoundEvent_19_OnButtonClickedEvent__DelegateSignature(); // Function W_RecoilDebugMenu.W_RecoilDebugMenu_C.BndEvt__Button_498_K2Node_ComponentBoundEvent_19_OnButtonClickedEvent__DelegateSignature // BlueprintEvent // @ game+0x293938
	void BndEvt__ButtonClear_K2Node_ComponentBoundEvent_109_OnButtonClickedEvent__DelegateSignature(); // Function W_RecoilDebugMenu.W_RecoilDebugMenu_C.BndEvt__ButtonClear_K2Node_ComponentBoundEvent_109_OnButtonClickedEvent__DelegateSignature // BlueprintEvent // @ game+0x293938
	struct FText ExecuteUbergraph_W_RecoilDebugMenu(bool CallFunc_IsValid_ReturnValue2, bool CallFunc__63b36ff994_ReturnValue, struct FString CallFunc__3cb7b87e18_ReturnValue, struct ATslCharacter* CallFunc__36cf5fd6b9_ReturnValue2); // Function W_RecoilDebugMenu.W_RecoilDebugMenu_C.ExecuteUbergraph_W_RecoilDebugMenu // HasDefaults // @ game+0x293938
};
