...
struct AFBPBuff_AddJump_C : ATslFBRBuff {
	...
	void UserConstructionScript(); // Function FBPBuff_AddJump.FBPBuff_AddJump_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x293938
};
