...
struct ABP_PP_OutlineCustomDepthOcclusion_Inst_C : ATslPostProcessEffect {
	...
	void UserConstructionScript(); // Function BP_PP_OutlineCustomDepthOcclusion_Inst.BP_PP_OutlineCustomDepthOcclusion_Inst_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x293938
};
