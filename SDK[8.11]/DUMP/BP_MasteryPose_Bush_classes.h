...
struct ABP_MasteryPose_Bush_C : ABP_MasteryPose_C {
	...
	void UserConstructionScript(); // Function BP_MasteryPose_Bush.BP_MasteryPose_Bush_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x293938
};
