...
struct ABP_TslSLBDizzinessResistanceBuff_C : ATslResistanceBuff {
	...
	void UserConstructionScript(); // Function BP_TslSLBDizzinessResistanceBuff.BP_TslSLBDizzinessResistanceBuff_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x293938
};
