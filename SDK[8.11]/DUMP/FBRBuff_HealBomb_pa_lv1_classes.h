...
struct AFBRBuff_HealBomb_pa_lv1_C : ATslFBRItemBuff {
	...
	void UserConstructionScript(); // Function FBRBuff_HealBomb_pa_lv1.FBRBuff_HealBomb_pa_lv1_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x293938
};
