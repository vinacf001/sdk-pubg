...
struct APrefabActor : AActor {
	...
	struct U*f720ae3ffb* BuildingHLOD; // 0x418(0x08)

	struct UPrefabAsset* *fae53a886c(); // Function PrefabAsset.PrefabActor.*fae53a886c // Final|Native|Public|BlueprintCallable // @ game+0x6aa4e28
	bool *dcdd606e61(); // Function PrefabAsset.PrefabActor.*dcdd606e61 // Final|Native|Public|BlueprintCallable // @ game+0x5ae8688
	bool *5a4e9de26a(); // Function PrefabAsset.PrefabActor.*5a4e9de26a // Final|Native|Public|BlueprintCallable // @ game+0x6aa4edc
	enum class EComponentMobility *9dc3ed0312(); // Function PrefabAsset.PrefabActor.*9dc3ed0312 // Final|Native|Public|BlueprintCallable // @ game+0x6aa4e48
};
...
struct APrefabLODHolder : APrefabActorHolder {
	struct U*f720ae3ffb* HLODParentComponent; // 0x3f0(0x08)
