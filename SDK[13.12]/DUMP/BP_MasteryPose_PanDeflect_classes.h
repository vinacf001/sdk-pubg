...
struct ABP_MasteryPose_PanDeflect_C : ABP_MasteryPose_C {
	...
	struct U*43d0c6adcf* Pan; // 0x468(0x08)
	...
	void UserConstructionScript(); // Function BP_MasteryPose_PanDeflect.BP_MasteryPose_PanDeflect_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x20a5d0
	void ReceiveBeginPlay(); // Function BP_MasteryPose_PanDeflect.BP_MasteryPose_PanDeflect_C.ReceiveBeginPlay // Event|Protected|BlueprintEvent // @ game+0x20a5d0
	int32 ExecuteUbergraph_BP_MasteryPose_PanDeflect(); // Function BP_MasteryPose_PanDeflect.BP_MasteryPose_PanDeflect_C.ExecuteUbergraph_BP_MasteryPose_PanDeflect //  // @ game+0x20a5d0
};
