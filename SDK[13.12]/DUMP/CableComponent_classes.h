...
struct UCableComponent : UMeshComponent {
	...
	void *964e40b0d6(struct USceneComponent* ReturnValue); // Function CableComponent.CableComponent.*964e40b0d6 // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x6bc8b38
	void *18d715e2a2(struct TArray<struct FVector> Locations); // Function CableComponent.CableComponent.*18d715e2a2 // Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const // @ game+0x6bc8b70
	void *56bed28938(); // Function CableComponent.CableComponent.*56bed28938 // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x6bc8b20
	void *b78de2535f(); // Function CableComponent.CableComponent.*b78de2535f // Final|Native|Public|BlueprintCallable // @ game+0x6bc8c38
};
