...
struct U*6bc7d6794d : U*9d605b393c {
	...
	void *7a752b6a05(); // Function AudioMixer.*6bc7d6794d.*7a752b6a05 // Final|Native|Public|HasOutParms|BlueprintCallable // @ game+0x696146c
};
...
struct U*27ef2e7df2 : U*9d605b393c {
	...
	void *b9de5b5f7f(); // Function AudioMixer.*27ef2e7df2.*b9de5b5f7f // Final|Native|Public|BlueprintCallable // @ game+0x6961794
	void *7a752b6a05(); // Function AudioMixer.*27ef2e7df2.*7a752b6a05 // Final|Native|Public|HasOutParms|BlueprintCallable // @ game+0x6961568
};
...
struct U*57545eb14f : U*9d605b393c {
	...
	void *7a752b6a05(); // Function AudioMixer.*57545eb14f.*7a752b6a05 // Final|Native|Public|HasOutParms|BlueprintCallable // @ game+0x6961674
};
...
struct U*f4c0684a9a : USceneComponent {
	...
	void IsPlaying(); // Function AudioMixer.*f4c0684a9a.IsPlaying // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x6961084
	void *017d6601d2(); // Function AudioMixer.*f4c0684a9a.*017d6601d2 // Final|Native|Public|BlueprintCallable // @ game+0x6961874
	void Stop(); // Function AudioMixer.*f4c0684a9a.Stop // Final|Native|Public|BlueprintCallable // @ game+0x6961974
	void Start(); // Function AudioMixer.*f4c0684a9a.Start // Final|Native|Public|BlueprintCallable // @ game+0x6961960
};
