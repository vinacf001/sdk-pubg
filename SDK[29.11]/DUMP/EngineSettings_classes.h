...
struct UConsoleSettings : UObject {
	...
	struct TArray<struct F*edd2c28b19> ManualAutoCompleteList; // 0x38(0x10)
...
struct UGameMapsSettings : UObject {
	...
	enum class *bdd6c0976d ThreePlayerSplitscreenLayout; // 0x62(0x01)
	...
	struct TArray<struct F*8518dffd3a> GameModeMapPrefixes; // 0xb8(0x10)
	struct TArray<struct F*8518dffd3a> GameModeClassAliases; // 0xc8(0x10)
};
...
// Class EngineSettings.*f3fd77bcb7
// Size: 0x30 (Inherited: 0x30)
struct U*f3fd77bcb7 : UObject {
};
