...
struct AFBRBuff_Medikit_pa_lv4_C : ATslFBRItemBuff {
	...
	void UserConstructionScript(); // Function FBRBuff_Medikit_pa_lv4.FBRBuff_Medikit_pa_lv4_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x1dcd78
};
