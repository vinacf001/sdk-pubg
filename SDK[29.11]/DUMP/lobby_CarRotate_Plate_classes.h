...
struct Alobby_CarRotate_Plate_C : AActor {
	...
	void UserConstructionScript(); // Function lobby_CarRotate_Plate.lobby_CarRotate_Plate_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x1dcd78
};
