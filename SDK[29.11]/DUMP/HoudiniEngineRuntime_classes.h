...
// Size: 0x1280 (Inherited: 0x9b0)
struct UHoudiniAssetComponent : UPrimitiveComponent {
	char *dc67542aa7 : 1; // 0x9b0(0x01)
	char pad_9B0_1 : 7; // 0x9b0(0x01)
	char pad_9B1[0x7]; // 0x9b1(0x07)
	struct UPhysicalMaterial* *1ab2e12a57; // 0x9b8(0x08)
	struct FBodyInstance *43c30a9fd5; // 0x9c0(0x230)
	enum class ECollisionTraceFlag *2b737a2b6a; // 0xbf0(0x01)
	char pad_BF1[0x3]; // 0xbf1(0x03)
	int32 *32f561112a; // 0xbf4(0x04)
	float GeneratedLpvBiasMultiplier; // 0xbf8(0x04)
	float *f1bdc8c46c; // 0xbfc(0x04)
	struct F*630cf25516 *3cafead770; // 0xc00(0x10)
	int32 *9e75667e0a; // 0xc10(0x04)
	char *0a2ac72b64 : 1; // 0xc14(0x01)
	char pad_C14_1 : 7; // 0xc14(0x01)
	char pad_C15[0x3]; // 0xc15(0x03)
	float *0df7e49436; // 0xc18(0x04)
	char pad_C1C[0x4]; // 0xc1c(0x04)
	struct UFoliageType_InstancedStaticMesh* *1f2158f21e; // 0xc20(0x08)
	struct TArray<struct UAssetUserData*> *dab70d92a6; // 0xc28(0x10)
	char pad_C38[0x478]; // 0xc38(0x478)
	struct FText BakeFolder; // 0x10b0(0x18)
	struct FText *ccde7a89c6; // 0x10c8(0x18)
	char pad_10E0[0x1a0]; // 0x10e0(0x1a0)

	int32 *ed8599e9a3(); // Function HoudiniEngineRuntime.HoudiniAssetComponent.*ed8599e9a3 // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x68ccd68
};
...
struct U*1575bf57f2 : USceneComponent {
	...
	enum class EHoudiniHandleType *cd861743bd; // 0x528(0x01)
...
struct U*73468efbc3 : USceneComponent {
	struct UObject* *c07cfa4782; // 0x478(0x08)
