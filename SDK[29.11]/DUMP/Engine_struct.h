...
struct F*5cde951495 {
	...
	float PostProcessBlendWeight; // 0x2c(0x04)
...
struct FWorldContext {
	...
	struct FURL *67a79206d3; // 0x68(0x70)
	struct TArray<struct U*f633e75a6f*> *4b8fad4d6c; // 0xd8(0x10)
	char pad_E8[0xc0]; // 0xe8(0xc0)
	struct TArray<struct F*270e8b5d12> PackagesToFullyLoad; // 0x1a8(0x10)
	struct FURL *b5cfa248f4; // 0x1b8(0x70)
	char pad_228[0x10]; // 0x228(0x10)
	struct UGameViewportClient* GameViewport; // 0x238(0x08)
	char pad_240[0x18]; // 0x240(0x18)
	struct TArray<struct F*748cdb5bcc> *f91257b2df; // 0x258(0x10)
	char pad_268[0x8]; // 0x268(0x08)
	struct UGameInstance* *1d311e10e5; // 0x270(0x08)
	struct U*ecaf7d9876* *ecaf7d9876; // 0x278(0x08)
	struct TArray<struct F*055697d8f7> *6b4a4246de; // 0x280(0x10)
