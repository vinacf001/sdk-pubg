...
struct U*b09f37ac16 : UObject {
	...
	void PlayReverse(); // Function MovieScene.*b09f37ac16.PlayReverse // Final|Native|Public|BlueprintCallable // @ game+0x5def0ec
	void Stop(); // Function MovieScene.*b09f37ac16.Stop // Final|Native|Public|BlueprintCallable // @ game+0x5def328
	float *4018e53717(); // Function MovieScene.*b09f37ac16.*4018e53717 // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x5def088
	float SetPlayRate(); // Function MovieScene.*b09f37ac16.SetPlayRate // Final|Native|Public|BlueprintCallable // @ game+0x5def108
	void Pause(); // Function MovieScene.*b09f37ac16.Pause // Final|Native|Public|BlueprintCallable // @ game+0x5def0bc
	float *08afa86053(); // Function MovieScene.*b09f37ac16.*08afa86053 // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x5def070
	float GetPlayRate(); // Function MovieScene.*b09f37ac16.GetPlayRate // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x5def040
	float *44267931b6(); // Function MovieScene.*b09f37ac16.*44267931b6 // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x5def058
	float SetPlaybackPosition(); // Function MovieScene.*b09f37ac16.SetPlaybackPosition // Final|Native|Public|BlueprintCallable // @ game+0x5def1a0
	float *9393821099(); // Function MovieScene.*b09f37ac16.*9393821099 // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x5def01c
	void Play(); // Function MovieScene.*b09f37ac16.Play // Final|Native|Public|BlueprintCallable // @ game+0x5def0d0
	float *a1ff349d19(); // Function MovieScene.*b09f37ac16.*a1ff349d19 // Final|Native|Public|BlueprintCallable // @ game+0x5def238
	void *76ad3d2497(); // Function MovieScene.*b09f37ac16.*76ad3d2497 // Final|Native|Public|BlueprintCallable // @ game+0x5deeecc
	struct TArray<struct UObject*> *f601f1620b(); // Function MovieScene.*b09f37ac16.*f601f1620b // Final|Native|Public|BlueprintCallable // @ game+0x5deeef8
	bool IsPlaying(); // Function MovieScene.*b09f37ac16.IsPlaying // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x5def0a0
	void *697f6ffc90(); // Function MovieScene.*b09f37ac16.*697f6ffc90 // Final|Native|Public|BlueprintCallable // @ game+0x5def314
	int32 *f16b0b2e9e(); // Function MovieScene.*b09f37ac16.*f16b0b2e9e // Final|Native|Public|BlueprintCallable // @ game+0xcb854c
};
