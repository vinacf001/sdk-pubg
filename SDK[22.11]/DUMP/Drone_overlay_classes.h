...
struct UDrone_overlay_C : U*a879ad53dc {
	struct F*a3d8ff36c0 UberGraphFrame; // 0x2e0(0x08)
	...
	void ExecuteUbergraph_Drone_overlay(); // Function Drone_overlay.Drone_overlay_C.ExecuteUbergraph_Drone_overlay //  // @ game+0x32e590
};
