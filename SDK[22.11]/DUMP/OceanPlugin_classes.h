...
struct AOceanManager : AActor {
	...
	float *bc13c1bc75(float V); // Function OceanPlugin.OceanManager.*bc13c1bc75 // Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const // @ game+0x6780120
	void *2f9df9694e(); // Function OceanPlugin.OceanManager.*2f9df9694e // Final|Native|Public|BlueprintCallable // @ game+0x6780544
	bool *cca8ca0c1f(); // Function OceanPlugin.OceanManager.*cca8ca0c1f // Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable // @ game+0x4e4914
};
...
struct U*3514da26a1 : USceneComponent {
	...
	void *d50f5ebbe9(); // Function OceanPlugin.*3514da26a1.*d50f5ebbe9 // Final|Native|Public|HasDefaults|BlueprintCallable // @ game+0x677fd80
	void *9f85407194(); // Function OceanPlugin.*3514da26a1.*9f85407194 // Final|Native|Public|BlueprintCallable // @ game+0x678023c
	struct F*582d4c55f8 *96aabe154c(struct F*582d4c55f8 L, struct FVector InArrow); // Function OceanPlugin.*3514da26a1.*96aabe154c // Final|Native|Public|HasDefaults|BlueprintCallable // @ game+0x6780d0c
	void *5dfdd4ca90(struct FVector SlamForce); // Function OceanPlugin.*3514da26a1.*5dfdd4ca90 // Final|Native|Public|HasDefaults|BlueprintCallable // @ game+0x677fb88
	struct FVector TriangleArea(); // Function OceanPlugin.*3514da26a1.TriangleArea // Final|Native|Public|HasDefaults|BlueprintCallable // @ game+0x6780f68
	void *aed982231b(bool bJustGetHeightAtLocation); // Function OceanPlugin.*3514da26a1.*aed982231b // Final|Native|Public|HasDefaults|BlueprintCallable // @ game+0x6780250
	void *828aa4acbe(); // Function OceanPlugin.*3514da26a1.*828aa4acbe // Final|Native|Public|BlueprintCallable // @ game+0x677fa98
	float *a2a1952f4f(); // Function OceanPlugin.*3514da26a1.*a2a1952f4f // Final|Native|Public|BlueprintCallable // @ game+0x6780c10
};
...
struct ACustomVehicleController : APlayerController {
	...
	void *cc9c61c338(); // Function OceanPlugin.CustomVehicleController.*cc9c61c338 // Native|Public|BlueprintCallable|BlueprintPure // @ game+0x6780214
	void *e88e2e3b2d(); // Function OceanPlugin.CustomVehicleController.*e88e2e3b2d // Native|Public|BlueprintCallable // @ game+0x677ff08
	void *7dbe8d7d9f(); // Function OceanPlugin.CustomVehicleController.*7dbe8d7d9f // Native|Public|BlueprintCallable // @ game+0x677fe74
	void DrawBuoyancyPoints(); // Function OceanPlugin.CustomVehicleController.DrawBuoyancyPoints // Exec|Native|Public // @ game+0x677fd68
	void EnableBuoyancy(); // Function OceanPlugin.CustomVehicleController.EnableBuoyancy // Exec|Native|Public // @ game+0x677fe5c
};
...
struct AFlockFish : APawn {
	...
	struct UPrimitiveComponent* OnEndOverlap(struct AActor* Param1); // Function OceanPlugin.FlockFish.OnEndOverlap // Final|Native|Protected // @ game+0x6780824
	bool OnBeginOverlap(struct AActor* Param1); // Function OceanPlugin.FlockFish.OnBeginOverlap // Final|Native|Protected|HasOutParms // @ game+0x67805d4
};
...
struct UOceanMeshComponent : UPrimitiveComponent {
	...
	void *6ace248513(float InLODTransitionStart); // Function OceanPlugin.OceanMeshComponent.*6ace248513 // Final|Native|Public|BlueprintCallable // @ game+0x6780b34
	void *7453946f33(); // Function OceanPlugin.OceanMeshComponent.*7453946f33 // Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable // @ game+0x67809a0
};
...
struct ATimeManager : AActor {
	...
	void GetDayOfYear(); // Function OceanPlugin.TimeManager.GetDayOfYear // Final|Native|Public|BlueprintCallable // @ game+0x677ff20
	void *662d401aa9(); // Function OceanPlugin.TimeManager.*662d401aa9 // Final|Native|Public|BlueprintCallable // @ game+0x6780100
	void *f48e922afd(); // Function OceanPlugin.TimeManager.*f48e922afd // Final|Native|Public|HasDefaults|BlueprintCallable // @ game+0x677fd34
	void *a59c0b00be(); // Function OceanPlugin.TimeManager.*a59c0b00be // Final|Native|Public|BlueprintCallable|BlueprintPure // @ game+0x678034c
	void *923b519da4(); // Function OceanPlugin.TimeManager.*923b519da4 // Final|Native|Public|HasDefaults|BlueprintCallable // @ game+0x677fc90
	void *dc4646d597(); // Function OceanPlugin.TimeManager.*dc4646d597 // Final|Native|Public|BlueprintCallable|BlueprintPure // @ game+0x677fff4
	int32 IsLeapYear(); // Function OceanPlugin.TimeManager.IsLeapYear // Final|Native|Public|BlueprintCallable // @ game+0x67804b8
	void *c1eaf299ba(); // Function OceanPlugin.TimeManager.*c1eaf299ba // Final|Native|Public|BlueprintCallable // @ game+0x678040c
	void *28dce5f162(); // Function OceanPlugin.TimeManager.*28dce5f162 // Final|Native|Public|BlueprintCallable // @ game+0x677fcc4
	void *68b7d984ac(); // Function OceanPlugin.TimeManager.*68b7d984ac // Final|Native|Public|BlueprintCallable // @ game+0x6780374
	void *da07f331f7(); // Function OceanPlugin.TimeManager.*da07f331f7 // Final|Native|Public|BlueprintCallable // @ game+0x6780a9c
	int32 *fdd15d99a3(int32 Month); // Function OceanPlugin.TimeManager.*fdd15d99a3 // Final|Native|Public|BlueprintCallable // @ game+0x678002c
	void *fe8603affc(); // Function OceanPlugin.TimeManager.*fe8603affc // Final|Native|Public|BlueprintCallable // @ game+0x650ca4c
};
