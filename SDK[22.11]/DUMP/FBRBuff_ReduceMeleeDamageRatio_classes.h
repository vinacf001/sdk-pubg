...
struct AFBRBuff_ReduceMeleeDamageRatio_C : ATslFBRBuff {
	...
	void UserConstructionScript(); // Function FBRBuff_ReduceMeleeDamageRatio.FBRBuff_ReduceMeleeDamageRatio_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x32e590
};
