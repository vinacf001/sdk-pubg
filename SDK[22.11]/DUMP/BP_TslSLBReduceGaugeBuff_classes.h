...
struct ABP_TslSLBReduceGaugeBuff_C : ATslFBRBuff {
	...
	void UserConstructionScript(); // Function BP_TslSLBReduceGaugeBuff.BP_TslSLBReduceGaugeBuff_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x32e590
};
