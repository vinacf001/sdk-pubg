...
struct UNiagaraComponent : UPrimitiveComponent {
	...
	struct FString *c295b4c44d(); // Function Niagara.NiagaraComponent.*c295b4c44d // Final|Native|Public|HasDefaults|BlueprintCallable // @ game+0x605adf8
	void *82a41ea059(); // Function Niagara.NiagaraComponent.*82a41ea059 // Final|Native|Public|HasDefaults|BlueprintCallable // @ game+0x605ac98
	void *4887bfdca5(); // Function Niagara.NiagaraComponent.*4887bfdca5 // Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable // @ game+0x605af50
	void *c27fd77e4a(); // Function Niagara.NiagaraComponent.*c27fd77e4a // Final|Native|Public|BlueprintCallable // @ game+0x605a7a8
	struct FString *1ba7b99f0e(); // Function Niagara.NiagaraComponent.*1ba7b99f0e // Final|Native|Public|BlueprintCallable // @ game+0x605a7e8
	void *bb159d3df5(); // Function Niagara.NiagaraComponent.*bb159d3df5 // Final|Native|Public|BlueprintCallable // @ game+0x605b084
	void *3a2c3cec9a(); // Function Niagara.NiagaraComponent.*3a2c3cec9a // Final|Native|Public|BlueprintCallable // @ game+0x605a768
	struct FString *0bf5489262(); // Function Niagara.NiagaraComponent.*0bf5489262 // Final|Native|Public|BlueprintCallable // @ game+0x605ab78
	struct FString *5e10cdf5fb(); // Function Niagara.NiagaraComponent.*5e10cdf5fb // Final|Native|Public|BlueprintCallable // @ game+0x605aa24
	void *0ee27878ae(struct FString InVariableName); // Function Niagara.NiagaraComponent.*0ee27878ae // Final|Native|Public|BlueprintCallable // @ game+0x605a908
};
...
struct U*b3665cbb22 : UBlueprintFunctionLibrary {
	...
	struct FName SpawnEffectAttached(struct FVector Location, enum class EAttachLocation LocationType); // Function Niagara.*b3665cbb22.SpawnEffectAttached // Final|Native|Static|Public|HasDefaults|BlueprintCallable // @ game+0x605b2dc
	bool *f921c9dbbb(); // Function Niagara.*b3665cbb22.*f921c9dbbb // Final|Native|Static|Public|HasDefaults|BlueprintCallable // @ game+0x605b114
};
