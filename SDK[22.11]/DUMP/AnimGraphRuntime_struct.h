...
// Enum AnimGraphRuntime.*c877f84b4e
enum class *c877f84b4e : uint8 {
	*0bf8b4706c,
	*9a7c781a46,
	*e66bf39841,
	*c877f84b4e_MAX,
...
struct FAnimNode_CurveSource : FAnimNode_Base {
	...
	TScriptInterface<struct U*6d1afc3bce> CurveSource; // 0x58(0x10)
};
...
struct FAnimNode_LayeredBoneBlend : FAnimNode_Base {
	...
	enum class *25bebd741c CurveBlendOption; // 0x90(0x01)
...
// ScriptStruct AnimGraphRuntime.*e85bb60d9c
// Size: 0x88 (Inherited: 0x10)
struct F*e85bb60d9c : F*e9b36f0d25 {
	float ScaleFactor; // 0x10(0x04)
	bool *7788bb2cd1; // 0x14(0x01)
	char pad_15[0x3]; // 0x15(0x03)
	struct FRichCurve CustomCurve; // 0x18(0x70)
};

// ScriptStruct AnimGraphRuntime.*e9b36f0d25
// Size: 0x10 (Inherited: 0x00)
struct F*e9b36f0d25 {
...
struct FAnimNode_RefPose : FAnimNode_Base {
	enum class *c877f84b4e RefPoseType; // 0x30(0x01)
	char pad_31[0x7]; // 0x31(0x07)
};
...
// ScriptStruct AnimGraphRuntime.*3a997939ed
// Size: 0x750 (Inherited: 0x520)
struct F*3a997939ed : F*29144ded29 {
...
struct FAnimNode_CopyBone : FAnimNode_SkeletalControlBase {
	...
	enum class *4c02c9923e ControlSpace; // 0x12b(0x01)
	char pad_12C[0x4]; // 0x12c(0x04)
};
...
// ScriptStruct AnimGraphRuntime.*cadc8eafb1
// Size: 0x30 (Inherited: 0x00)
struct F*cadc8eafb1 {
	char pad_0[0x30]; // 0x00(0x30)
};

// ScriptStruct AnimGraphRuntime.*ccebd20d6b
...
struct FAnimNode_ModifyBone : FAnimNode_SkeletalControlBase {
	...
	enum class *4c02c9923e TranslationSpace; // 0x137(0x01)
	enum class *4c02c9923e RotationSpace; // 0x138(0x01)
	enum class *4c02c9923e ScaleSpace; // 0x139(0x01)
...
struct FAnimNode_ObserveBone : FAnimNode_SkeletalControlBase {
	...
	enum class *4c02c9923e DisplaySpace; // 0x110(0x01)
...
struct FAnimNode_TwoBoneIK : FAnimNode_SkeletalControlBase {
	...
	enum class *4c02c9923e EffectorLocationSpace; // 0x144(0x01)
	enum class *4c02c9923e JointTargetLocationSpace; // 0x145(0x01)
	char pad_146[0x2]; // 0x146(0x02)
