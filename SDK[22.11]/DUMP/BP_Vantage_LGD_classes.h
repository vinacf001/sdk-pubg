...
struct ABP_Vantage_LGD_C : ABP_Vantage_C {
	...
	void UserConstructionScript(); // Function BP_Vantage_LGD.BP_Vantage_LGD_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x32e590
};
