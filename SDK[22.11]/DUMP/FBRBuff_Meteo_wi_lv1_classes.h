...
struct AFBRBuff_Meteo_wi_lv1_C : ATslFBRItemBuff {
	...
	void UserConstructionScript(); // Function FBRBuff_Meteo_wi_lv1.FBRBuff_Meteo_wi_lv1_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x32e590
};
