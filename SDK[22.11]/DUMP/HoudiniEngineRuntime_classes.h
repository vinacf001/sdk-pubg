...
struct UHoudiniAssetComponent : UPrimitiveComponent {
	...
	void *ed8599e9a3(); // Function HoudiniEngineRuntime.HoudiniAssetComponent.*ed8599e9a3 // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x68cc2a8
};
