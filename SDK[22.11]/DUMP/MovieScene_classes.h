...
struct U*b09f37ac16 : UObject {
	...
	void PlayReverse(); // Function MovieScene.*b09f37ac16.PlayReverse // Final|Native|Public|BlueprintCallable // @ game+0x5df7578
	void Stop(); // Function MovieScene.*b09f37ac16.Stop // Final|Native|Public|BlueprintCallable // @ game+0x5df77b4
	void *4018e53717(); // Function MovieScene.*b09f37ac16.*4018e53717 // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x5df7514
	void SetPlayRate(); // Function MovieScene.*b09f37ac16.SetPlayRate // Final|Native|Public|BlueprintCallable // @ game+0x5df7594
	void Pause(); // Function MovieScene.*b09f37ac16.Pause // Final|Native|Public|BlueprintCallable // @ game+0x5df7548
	void *08afa86053(); // Function MovieScene.*b09f37ac16.*08afa86053 // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x5df74fc
	void GetPlayRate(); // Function MovieScene.*b09f37ac16.GetPlayRate // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x5df74cc
	void *44267931b6(); // Function MovieScene.*b09f37ac16.*44267931b6 // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x5df74e4
	void SetPlaybackPosition(); // Function MovieScene.*b09f37ac16.SetPlaybackPosition // Final|Native|Public|BlueprintCallable // @ game+0x5df762c
	void *9393821099(); // Function MovieScene.*b09f37ac16.*9393821099 // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x5df74a8
	void Play(); // Function MovieScene.*b09f37ac16.Play // Final|Native|Public|BlueprintCallable // @ game+0x5df755c
	void *a1ff349d19(); // Function MovieScene.*b09f37ac16.*a1ff349d19 // Final|Native|Public|BlueprintCallable // @ game+0x5df76c4
	void *76ad3d2497(); // Function MovieScene.*b09f37ac16.*76ad3d2497 // Final|Native|Public|BlueprintCallable // @ game+0x5df7358
	struct FMovieSceneObjectBindingID *f601f1620b(); // Function MovieScene.*b09f37ac16.*f601f1620b // Final|Native|Public|BlueprintCallable // @ game+0x5df7384
	void IsPlaying(); // Function MovieScene.*b09f37ac16.IsPlaying // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x5df752c
	void *697f6ffc90(); // Function MovieScene.*b09f37ac16.*697f6ffc90 // Final|Native|Public|BlueprintCallable // @ game+0x5df77a0
	void *f16b0b2e9e(); // Function MovieScene.*b09f37ac16.*f16b0b2e9e // Final|Native|Public|BlueprintCallable // @ game+0xbaea54
};
