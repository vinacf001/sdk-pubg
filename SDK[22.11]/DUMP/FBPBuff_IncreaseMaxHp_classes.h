...
struct AFBPBuff_IncreaseMaxHp_C : ATslIncreaseMaxHpBuff {
	...
	void UserConstructionScript(); // Function FBPBuff_IncreaseMaxHp.FBPBuff_IncreaseMaxHp_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x32e590
};
