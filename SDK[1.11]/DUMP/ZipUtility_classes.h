...
struct U*56aea4c34a : UObject {
	...
	struct FString file[0x10]; // 0x38(0x10)
	struct FString DestinationFolder[0x10]; // 0x48(0x10)
	int32 *841f38bbaf[0x04]; // 0x58(0x04)
	char pad_5C[0x4]; // 0x5c(0x04)
	struct UObject* Callback[0x08]; // 0x60(0x08)
