...
struct U*e18a9d1f3d : UObject {
	...
	struct TArray<struct FMovieSceneBindingOverrideData> *8ad4bc9095; // 0x30(0x10)
...
struct U*8c2f1dd818 : UObject {
	...
	struct TArray<struct U*8c2f1dd818*> *83203c076c; // 0x30(0x10)
	struct TArray<struct UMovieSceneTrack*> *c40940cd18; // 0x40(0x10)
	struct TArray<struct FString> *fc5a77e7f2; // 0x50(0x10)
...
struct U*14a032dbde : UObject {
	...
	float *b10075d914; // 0x3b0(0x04)
	float StartTime; // 0x3b4(0x04)
	float *0abd4a1669; // 0x3b8(0x04)
	int32 *b2d7f331a7; // 0x3bc(0x04)
	char pad_3C0[0x10]; // 0x3c0(0x10)
	struct FMovieSceneSequencePlaybackSettings *71e043bb6c; // 0x3d0(0x28)
