...
struct ABP_TslSLBMaxHpBuff_C : ATslIncreaseMaxHpBuff {
	...
	void UserConstructionScript(); // Function BP_TslSLBMaxHpBuff.BP_TslSLBMaxHpBuff_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x2cd4ac
};
