...
struct ABP_CameraMan_C : AActor {
	...
	struct UCameraComponent* Camera[0x08]; // 0x3f0(0x08)
	struct USpringArmComponent* SpringArm[0x08]; // 0x3f8(0x08)
	struct USceneComponent* DefaultSceneRoot[0x08]; // 0x400(0x08)
	struct ATslCharacter* ParentRef[0x08]; // 0x408(0x08)
	bool bInitialized; // 0x410(0x01)
	bool bIsAttached; // 0x411(0x01)
	bool bLookAtTarget; // 0x412(0x01)
	bool bAutoZoom; // 0x413(0x01)
	char pad_414[0x4]; // 0x414(0x04)
	struct UCurveFloat* DistanceZoomCurve[0x08]; // 0x418(0x08)
	float YawRotation[0x04]; // 0x420(0x04)
	float YawRotationRate[0x04]; // 0x424(0x04)
	float TargetOffsetZ[0x04]; // 0x428(0x04)
	char pad_42C[0x4]; // 0x42c(0x04)
	struct ATslWheeledVehicle* ParentRefMoto[0x08]; // 0x430(0x08)
