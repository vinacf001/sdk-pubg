...
struct UDrone_overlay_C : U*acca5b25ed {
	struct F*abc8f374e0 UberGraphFrame; // 0x2e0(0x08)
	...
	void ExecuteUbergraph_Drone_overlay(); // Function Drone_overlay.Drone_overlay_C.ExecuteUbergraph_Drone_overlay //  // @ game+0x2cd4ac
};
