...
struct APowerup_Base_C : ATslPhysicsBody {
	struct F*abc8f374e0 UberGraphFrame[0x08]; // 0x3f8(0x08)
	struct USphereComponent* SmallRadiusSphere[0x08]; // 0x400(0x08)
	struct U*43a9d0bed0* TslFPPShadowSupport[0x08]; // 0x408(0x08)
	struct USkeletalMeshComponent* SkeletalMesh[0x08]; // 0x410(0x08)
	struct UAnimSequence* Animation[0x08]; // 0x418(0x08)
	float Delay[0x04]; // 0x420(0x04)
	char pad_424[0x4]; // 0x424(0x04)
	struct F*da672abddc TimerHandle[0x08]; // 0x428(0x08)
	struct FVector LocalBaseVelocity[0x0c]; // 0x430(0x0c)
	float PlayRateScale[0x04]; // 0x43c(0x04)
