...
struct UW_AIItemMenu_C : U*bc854bc287 {
	...
	struct UVerticalBox* AIListBox[0x08]; // 0x418(0x08)
	struct UButton* Button_37[0x08]; // 0x420(0x08)
	struct UImage* DebugCrosshair[0x08]; // 0x428(0x08)
	struct UButton* UseButton_124[0x08]; // 0x430(0x08)
	struct UVerticalBox* VB_Ammo[0x08]; // 0x438(0x08)
	struct UVerticalBox* VB_Armor[0x08]; // 0x440(0x08)
	struct UVerticalBox* VB_Backpack[0x08]; // 0x448(0x08)
	struct UVerticalBox* VB_Cosmetic[0x08]; // 0x450(0x08)
	struct UVerticalBox* VB_Helm[0x08]; // 0x458(0x08)
	struct UVerticalBox* VB_Lower[0x08]; // 0x460(0x08)
	struct UVerticalBox* VB_Mag[0x08]; // 0x468(0x08)
	struct UVerticalBox* VB_Meds[0x08]; // 0x470(0x08)
	struct UVerticalBox* VB_Melee[0x08]; // 0x478(0x08)
	struct UVerticalBox* VB_Muzzle[0x08]; // 0x480(0x08)
	struct UVerticalBox* VB_Other[0x08]; // 0x488(0x08)
	struct UVerticalBox* VB_Pistols[0x08]; // 0x490(0x08)
	struct UVerticalBox* VB_Rifle[0x08]; // 0x498(0x08)
	struct UVerticalBox* VB_Scopes[0x08]; // 0x4a0(0x08)
	struct UVerticalBox* VB_Shotguns[0x08]; // 0x4a8(0x08)
	struct UVerticalBox* VB_SMG[0x08]; // 0x4b0(0x08)
	struct UVerticalBox* VB_Sniper[0x08]; // 0x4b8(0x08)
	struct UVerticalBox* VB_Stock[0x08]; // 0x4c0(0x08)
	struct UVerticalBox* VB_Thrown[0x08]; // 0x4c8(0x08)
	struct UWidgetSwitcher* WidgetSwitcher_1[0x08]; // 0x4d0(0x08)
	struct TArray<struct FName> WeapClassArray_Pistol[0x10]; // 0x4d8(0x10)
	struct TArray<struct FName> WeapClassArray_SMG[0x10]; // 0x4e8(0x10)
	struct TArray<struct FName> WeapClassArray_Shotgun[0x10]; // 0x4f8(0x10)
	struct TArray<struct FName> WeapClassArray_Rifle[0x10]; // 0x508(0x10)
	struct TArray<struct FName> WeapClassArray_Sniper[0x10]; // 0x518(0x10)
	struct TArray<struct FName> WeapClassArray_Other[0x10]; // 0x528(0x10)
	struct F*7bb05e3554 WeapButtonStyle[0x2a8]; // 0x538(0x2a8)
	struct TArray<struct FName> AttachClassArray_Scopes[0x10]; // 0x7e0(0x10)
	struct TArray<struct FName> AttachClassArray_Muzzle[0x10]; // 0x7f0(0x10)
	struct TArray<struct FName> AttachClassArray_Mag[0x10]; // 0x800(0x10)
	struct TArray<struct FName> AttachClassArray_Lower[0x10]; // 0x810(0x10)
	struct TArray<struct FName> AttachClassArray_Stock[0x10]; // 0x820(0x10)
	struct F*7bb05e3554 AttachButtonStyle[0x2a8]; // 0x830(0x2a8)
	struct TArray<struct FName> ArmorClassArray_Helm[0x10]; // 0xad8(0x10)
	struct TArray<struct FName> ArmorClassArray_Armor[0x10]; // 0xae8(0x10)
	struct TArray<struct FName> ArmorClassArray_Backpack[0x10]; // 0xaf8(0x10)
	struct F*7bb05e3554 ArmorButtonStyle[0x2a8]; // 0xb08(0x2a8)
	struct TArray<struct FName> MedsClassArray_Meds[0x10]; // 0xdb0(0x10)
	struct F*7bb05e3554 MedsButtonStyle[0x2a8]; // 0xdc0(0x2a8)
	struct TArray<struct FName> ThrownClassArray_Thrown[0x10]; // 0x1068(0x10)
	struct F*7bb05e3554 ThrownButtonStyle[0x2a8]; // 0x1078(0x2a8)
	struct TArray<struct FName> CosmeticClassArray_Cosmetic[0x10]; // 0x1320(0x10)
	struct F*7bb05e3554 CosmeticButtonStyle[0x2a8]; // 0x1330(0x2a8)
	struct APlayerPawn_v2_C* CharRef[0x08]; // 0x15d8(0x08)
	int32 ActivePresetArray[0x04]; // 0x15e0(0x04)
	char pad_15E4[0x4]; // 0x15e4(0x04)
	struct F*7bb05e3554 PresetButtonStyle[0x2a8]; // 0x15e8(0x2a8)
	struct TArray<struct FName> AmmoClassArray_Ammo[0x10]; // 0x1890(0x10)
	struct F*7bb05e3554 AmmoButtonStyle[0x2a8]; // 0x18a0(0x2a8)
	struct TArray<struct FName> MeleeClassArray[0x10]; // 0x1b48(0x10)
	struct F*7bb05e3554 MeleeButtonStyle[0x2a8]; // 0x1b58(0x2a8)
	bool bInUse; // 0x1e00(0x01)
	char pad_1E01[0x7]; // 0x1e01(0x07)
	struct UW_WeaponMenu_C* weaponMenu[0x08]; // 0x1e08(0x08)
	int32 CacheAINum[0x04]; // 0x1e10(0x04)
	char pad_1E14[0x4]; // 0x1e14(0x04)
	struct F*da672abddc AIListHandle[0x08]; // 0x1e18(0x08)
	struct TArray<struct ATslNewBotCharacter*> aiNum[0x10]; // 0x1e20(0x10)
	struct UW_AIButton_C* CacheAIBtn[0x08]; // 0x1e30(0x08)
	struct TArray<struct ATslNewBotCharacter*> AICharacters[0x10]; // 0x1e38(0x10)
