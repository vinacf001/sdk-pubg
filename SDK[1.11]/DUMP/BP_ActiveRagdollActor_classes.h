...
struct ABP_ActiveRagdollActor_C : AActor {
	...
	struct UBillboardComponent* Billboard[0x08]; // 0x3f0(0x08)
	struct UPhysicsConstraintComponent* PhysicsConstraint[0x08]; // 0x3f8(0x08)
	struct UArrowComponent* Arrow[0x08]; // 0x400(0x08)
	struct UCapsuleComponent* Capsule[0x08]; // 0x408(0x08)
	struct USceneComponent* Scene[0x08]; // 0x410(0x08)
	struct FVector ServerPosition[0x0c]; // 0x418(0x0c)
	bool ClientInitialized; // 0x424(0x01)
	char pad_425[0x3]; // 0x425(0x03)
	struct APlayerPawn_v2_C* ParentRef[0x08]; // 0x428(0x08)
