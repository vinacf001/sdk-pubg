...
struct UBP_PcSystemMenuWidget_C : U*46fedf838a {
	...
	struct U*54cc75d10f* GuideConsoleFocusList[0x08]; // 0x6f8(0x08)
	struct U*54cc75d10f* GuideConsoleNormalFocusSystemMenu[0x08]; // 0x700(0x08)
	struct U*54cc75d10f* GuideReportPopup[0x08]; // 0x708(0x08)
	struct U*54cc75d10f* VanishingAnim[0x08]; // 0x710(0x08)
	struct U*54cc75d10f* EmergingAnim[0x08]; // 0x718(0x08)
	struct UImage* BackgroundGradient[0x08]; // 0x720(0x08)
	struct UImage* BG[0x08]; // 0x728(0x08)
	struct UBackgroundBlur* Blur[0x08]; // 0x730(0x08)
	struct U*5a9e6ea43b* ButtonTos[0x08]; // 0x738(0x08)
	struct UBP_PcSystemMenuButtonWidget_C* ExitToDesktopButton[0x08]; // 0x740(0x08)
	struct UBP_PcSystemMenuButtonWidget_C* KeyGuideButton[0x08]; // 0x748(0x08)
	struct UBP_GamepadKeyIconWidget_C* KeyIconRB_Left[0x08]; // 0x750(0x08)
	struct U*290fc681a4* KeyIconRB_Left_PlatformSwitcher[0x08]; // 0x758(0x08)
	struct UBP_PcSystemMenuButtonWidget_C* LeaveMatchButton[0x08]; // 0x760(0x08)
	struct UCanvasPanel* MainCanvasPanel[0x08]; // 0x768(0x08)
	struct UBP_PcSystemMenuButtonWidget_C* MatchLogButton[0x08]; // 0x770(0x08)
	struct UImage* OutGame_PanImage[0x08]; // 0x778(0x08)
	struct UButton* RatingsButton[0x08]; // 0x780(0x08)
	struct UBP_PcSystemMenuButtonWidget_C* RestartLobbyButton[0x08]; // 0x788(0x08)
	struct UBP_PcSystemMenuButtonWidget_C* ResumeButton[0x08]; // 0x790(0x08)
	struct UBP_PcSystemMenuButtonWidget_C* SettingsButton[0x08]; // 0x798(0x08)
	struct U*290fc681a4* SwitcherKeyIconTos[0x08]; // 0x7a0(0x08)
	struct UBorder* SystemMenuBorder[0x08]; // 0x7a8(0x08)
	struct UVerticalBox* SystemMenuVerticalBox[0x08]; // 0x7b0(0x08)
	struct U*290fc681a4* TslUniversalInputVisibilitySwitcher_5[0x08]; // 0x7b8(0x08)
	struct UUI_TeamManagementAndMissionList_C* UI_TeamManagementAndMissionList[0x08]; // 0x7c0(0x08)
	struct UTextBlock* VersionInfoText[0x08]; // 0x7c8(0x08)
	struct F*da672abddc BlockKeyBindingTimer[0x08]; // 0x7d0(0x08)
