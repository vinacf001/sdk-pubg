...
struct UGeometryCache : UObject {
	...
	struct TArray<struct UMaterialInterface*> Materials[0x10]; // 0x30(0x10)
	struct TArray<struct U*332c7342e5*> Tracks[0x10]; // 0x40(0x10)
...
struct AGeometryCacheActor : AActor {
	struct UGeometryCacheComponent* GeometryCacheComponent[0x08]; // 0x3e8(0x08)
...
struct UGeometryCacheComponent : UMeshComponent {
	struct UGeometryCache* GeometryCache[0x08]; // 0xb00(0x08)
	bool bRunning; // 0xb08(0x01)
	bool bLooping; // 0xb09(0x01)
	char pad_B0A[0x2]; // 0xb0a(0x02)
	float StartTimeOffset[0x04]; // 0xb0c(0x04)
	float PlaybackSpeed[0x04]; // 0xb10(0x04)
	int32 *9e625d70ff[0x04]; // 0xb14(0x04)
	float *4a0e165ffa[0x04]; // 0xb18(0x04)
...
struct U*5fe5629c4d : U*332c7342e5 {
	uint32 *46dd47d53a[0x04]; // 0x50(0x04)
