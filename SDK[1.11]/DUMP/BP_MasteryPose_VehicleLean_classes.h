...
struct ABP_MasteryPose_VehicleLean_C : ABP_MasteryPose_C {
	...
	struct U*13053458a7* VehicleMesh[0x08]; // 0x440(0x08)
	struct U*4240fd5502* HelmMesh[0x08]; // 0x448(0x08)
	struct USpotLightComponent* SpotLightEyes[0x08]; // 0x450(0x08)
	struct USpotLightComponent* SpotLight1[0x08]; // 0x458(0x08)
	struct USpotLightComponent* SpotLight2[0x08]; // 0x460(0x08)
	struct USpotLightComponent* LobbySpotLight[0x08]; // 0x468(0x08)
	struct USpotLightComponent* spotlight[0x08]; // 0x470(0x08)
	bool bIsInLobby; // 0x478(0x01)
	char pad_479[0x7]; // 0x479(0x07)
	struct UMaterialInstanceDynamic* MotorcycleLightsMaterial[0x08]; // 0x480(0x08)
	struct UCurveFloat* BrightnessCurve[0x08]; // 0x488(0x08)
	float BrightnessTime[0x04]; // 0x490(0x04)
	float BrightnessMax[0x04]; // 0x494(0x04)
