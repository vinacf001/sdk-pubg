...
struct APowerup_KfcChicken_C : APowerup_Base_C {
	...
	void UserConstructionScript(); // Function Powerup_KfcChicken.Powerup_KfcChicken_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x2cd4ac
};
