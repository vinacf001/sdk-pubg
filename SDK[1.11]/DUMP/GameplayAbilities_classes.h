...
struct UAbilitySystemComponent : UGameplayTasksComponent {
	...
	struct TArray<struct F*f0cf8b7179> *8a1512d2b0[0x10]; // 0x270(0x10)
	struct FName AffectedAnimInstanceTag[0x08]; // 0x280(0x08)
	char pad_288[0x5c8]; // 0x288(0x5c8)
	float *e24992b890[0x04]; // 0x850(0x04)
	float *f462cbec4d[0x04]; // 0x854(0x04)
	...
	struct TArray<struct AGameplayAbilityTargetActor*> *4b41094e7e[0x10]; // 0x8e0(0x10)
	char pad_8F0[0x38]; // 0x8f0(0x38)
	struct F*d30baabecf ActivatableAbilities[0xc8]; // 0x928(0xc8)
	char pad_9F0[0x30]; // 0x9f0(0x30)
	struct TArray<struct UGameplayAbility*> *a42ca7e6e2[0x10]; // 0xa20(0x10)
	char pad_A30[0x20c]; // 0xa30(0x20c)
	bool *99108c550b; // 0xc3c(0x01)
	bool *a65b21ff95; // 0xc3d(0x01)
	char pad_C3E[0x2]; // 0xc3e(0x02)
	struct F*aed4390e2f *73a0fd3dc9[0x30]; // 0xc40(0x30)
	char pad_C70[0xa0]; // 0xc70(0xa0)
	struct F*fd3ab3cc0d *59aae4b2e8[0x4e0]; // 0xd10(0x4e0)
	struct F*d583d4ccf6 *48269715ca[0xd0]; // 0x11f0(0xd0)
	struct F*d583d4ccf6 *711668646b[0xd0]; // 0x12c0(0xd0)
	char pad_1390[0x318]; // 0x1390(0x318)
	struct TArray<struct UAttributeSet*> *ab243ac431[0x10]; // 0x16a8(0x10)
	struct TArray<struct FString> *cb30c9d802[0x10]; // 0x16b8(0x10)
	struct AActor* *282b1f70c0[0x08]; // 0x16c8(0x08)
	struct AActor* AvatarActor[0x08]; // 0x16d0(0x08)
	struct F*c838a82bb4 *814d77c69e[0x38]; // 0x16d8(0x38)
	struct TArray<bool> *9afdd0b505[0x10]; // 0x1710(0x10)
	struct F*684cb9739a *60e84b4d68[0x60]; // 0x1720(0x60)
	struct TArray<struct FString> *265ac99221[0x10]; // 0x1780(0x10)
	struct F*6fe0834992 *6fe0834992[0xc0]; // 0x1790(0xc0)
...
struct UAbilityTask : UGameplayTask {
	struct UGameplayAbility* Ability[0x08]; // 0x68(0x08)
	struct UAbilitySystemComponent* AbilitySystemComponent[0x08]; // 0x70(0x08)
...
struct U*4b98fd5b79 : UObject {
	struct TArray<struct F*a220ab4781> RelevantAttributesToCapture[0x10]; // 0x28(0x10)
};
...
struct UGameplayAbility : UObject {
	...
	struct FGameplayTagContainer *bd4922c11b[0x20]; // 0x260(0x20)
	...
	struct F*6a42616980 CurrentActivationInfo[0x20]; // 0x290(0x20)
	struct F*35341a2d42 CurrentEventData[0xb0]; // 0x2b0(0xb0)
	...
	struct UClass* *46e65f80a3[0x08]; // 0x368(0x08)
	struct TArray<struct F*e3004e6158> *2885166003[0x10]; // 0x370(0x10)
	struct UClass* *ef57e6c97b[0x08]; // 0x380(0x08)
	struct FGameplayTagContainer *6c6505f6de[0x20]; // 0x388(0x20)
	struct FGameplayTagContainer *c23ec81c5a[0x20]; // 0x3a8(0x20)
	struct FGameplayTagContainer *1b47118555[0x20]; // 0x3c8(0x20)
	struct FGameplayTagContainer *5c5342673b[0x20]; // 0x3e8(0x20)
	struct FGameplayTagContainer *153d10a88d[0x20]; // 0x408(0x20)
	struct FGameplayTagContainer *6ac2715799[0x20]; // 0x428(0x20)
	struct FGameplayTagContainer *d72262c83d[0x20]; // 0x448(0x20)
	struct FGameplayTagContainer *4e4429a049[0x20]; // 0x468(0x20)
	struct FGameplayTagContainer *2359da15e0[0x20]; // 0x488(0x20)
	char pad_4A8[0x20]; // 0x4a8(0x20)
	struct TArray<struct UGameplayTask*> *9886fae8f4[0x10]; // 0x4c8(0x10)
	char pad_4D8[0x10]; // 0x4d8(0x10)
	struct UAnimMontage* *0198870c84[0x08]; // 0x4e8(0x08)
...
struct UGameplayEffect : UObject {
	...
	struct FGameplayEffectModifierMagnitude *0e6af612db[0x200]; // 0x38(0x200)
	struct FScalableFloat Period[0x30]; // 0x238(0x30)
	...
	struct TArray<struct F*78b34c26ea> Modifiers[0x10]; // 0x270(0x10)
	struct TArray<struct FGameplayEffectExecutionDefinition> Executions[0x10]; // 0x280(0x10)
	struct FScalableFloat *8ed90c5343[0x30]; // 0x290(0x30)
	struct TArray<struct UClass*> *4baedd8ac3[0x10]; // 0x2c0(0x10)
	struct TArray<struct UClass*> TargetEffectClasses[0x10]; // 0x2d0(0x10)
	struct TArray<struct F*b23d3847b8> ConditionalGameplayEffects[0x10]; // 0x2e0(0x10)
	struct TArray<struct UClass*> OverflowEffects[0x10]; // 0x2f0(0x10)
	bool bDenyOverflowApplication; // 0x300(0x01)
	bool bClearStackOnOverflow; // 0x301(0x01)
	char pad_302[0x6]; // 0x302(0x06)
	struct TArray<struct UClass*> PrematureExpirationEffectClasses[0x10]; // 0x308(0x10)
	struct TArray<struct UClass*> RoutineExpirationEffectClasses[0x10]; // 0x318(0x10)
	bool bRequireModifierSuccessToTriggerCues; // 0x328(0x01)
	bool *0a6d1b761b; // 0x329(0x01)
	char pad_32A[0x6]; // 0x32a(0x06)
	struct TArray<struct F*cfbad48b2f> GameplayCues[0x10]; // 0x330(0x10)
	struct UGameplayEffectUIData* UIData[0x08]; // 0x340(0x08)
	struct F*bd2309b738 InheritableGameplayEffectTags[0x60]; // 0x348(0x60)
	struct F*bd2309b738 InheritableOwnedTagsContainer[0x60]; // 0x3a8(0x60)
	struct F*be289b2c60 OngoingTagRequirements[0x40]; // 0x408(0x40)
	struct F*be289b2c60 ApplicationTagRequirements[0x40]; // 0x448(0x40)
	struct F*be289b2c60 RemovalTagRequirements[0x40]; // 0x488(0x40)
	struct F*bd2309b738 RemoveGameplayEffectsWithTags[0x60]; // 0x4c8(0x60)
	struct F*be289b2c60 GrantedApplicationImmunityTags[0x40]; // 0x528(0x40)
	char pad_568[0x8]; // 0x568(0x08)
	struct F*ef0a92a7f7 GrantedApplicationImmunityQuery[0x170]; // 0x570(0x170)
	char pad_6E0[0x10]; // 0x6e0(0x10)
	struct F*ef0a92a7f7 RemoveGameplayEffectQuery[0x170]; // 0x6f0(0x170)
	char pad_860[0x1]; // 0x860(0x01)
	enum class EGameplayEffectStackingType StackingType; // 0x861(0x01)
	char pad_862[0x2]; // 0x862(0x02)
	int32 StackLimitCount[0x04]; // 0x864(0x04)
	...
	struct TArray<struct F*1ce213372d> GrantedAbilities[0x10]; // 0x870(0x10)
};
...
struct U*0bdb90d9f5 : U*e370fd54bb {
	struct FMulticastDelegate OnApplied[0x10]; // 0x30(0x10)
...
struct U*c1d8349d38 : U*e370fd54bb {
	struct FMulticastDelegate EventReceived[0x10]; // 0x30(0x10)
...
struct U*021827460f : U*137715b638 {
	struct FMulticastDelegate Added[0x10]; // 0x50(0x10)
...
struct U*3760d1977e : U*137715b638 {
	struct FMulticastDelegate Removed[0x10]; // 0x50(0x10)
...
struct UAbilitySystemGlobals : UObject {
	struct FStringClassReference AbilitySystemGlobalsClassName[0x10]; // 0x28(0x10)
	char pad_38[0x88]; // 0x38(0x88)
	struct FGameplayTag *202de4eb36[0x08]; // 0xc0(0x08)
	struct FName ActivateFailIsDeadName[0x08]; // 0xc8(0x08)
	struct FGameplayTag *a1796b6598[0x08]; // 0xd0(0x08)
	struct FName ActivateFailCooldownName[0x08]; // 0xd8(0x08)
	struct FGameplayTag *3714a05f6e[0x08]; // 0xe0(0x08)
	struct FName ActivateFailCostName[0x08]; // 0xe8(0x08)
	struct FGameplayTag *a02011fb37[0x08]; // 0xf0(0x08)
	struct FName ActivateFailTagsBlockedName[0x08]; // 0xf8(0x08)
	struct FGameplayTag *7d49383852[0x08]; // 0x100(0x08)
	struct FName ActivateFailTagsMissingName[0x08]; // 0x108(0x08)
	struct FGameplayTag *c8766081ef[0x08]; // 0x110(0x08)
	struct FName ActivateFailNetworkingName[0x08]; // 0x118(0x08)
	int32 MinimalReplicationTagCountBits[0x04]; // 0x120(0x04)
	char pad_124[0x4]; // 0x124(0x04)
	struct F*dbdd3831ef *ef9f923fda[0x10]; // 0x128(0x10)
	...
	struct FName GameplayModEvaluationChannelAliases[0x08]; // 0x140(0x50)
	struct FStringAssetReference GlobalCurveTableName[0x10]; // 0x190(0x10)
	struct UCurveTable* *71d4b58726[0x08]; // 0x1a0(0x08)
	struct FStringAssetReference GlobalAttributeMetaDataTableName[0x10]; // 0x1a8(0x10)
	struct UDataTable* *2d92a0dc92[0x08]; // 0x1b8(0x08)
	struct FStringAssetReference GlobalAttributeSetDefaultsTableName[0x10]; // 0x1c0(0x10)
	struct TArray<struct FStringAssetReference> GlobalAttributeSetDefaultsTableNames[0x10]; // 0x1d0(0x10)
	struct TArray<struct UCurveTable*> *922e093274[0x10]; // 0x1e0(0x10)
	struct FStringAssetReference GlobalGameplayCueManagerClass[0x10]; // 0x1f0(0x10)
	struct FStringAssetReference GlobalGameplayCueManagerName[0x10]; // 0x200(0x10)
	struct TArray<struct FString> GameplayCueNotifyPaths[0x10]; // 0x210(0x10)
	struct FStringAssetReference GameplayTagResponseTableName[0x10]; // 0x220(0x10)
	struct U*0e4bd35382* *40fc13c0f7[0x08]; // 0x230(0x08)
	bool PredictTargetGameplayEffects; // 0x238(0x01)
	char pad_239[0x7]; // 0x239(0x07)
	struct UGameplayCueManager* *a64fbc3828[0x08]; // 0x240(0x08)
...
struct AAbilitySystemTestPawn : ADefaultPawn {
	...
	struct UAbilitySystemComponent* AbilitySystemComponent[0x08]; // 0x488(0x08)
};

// Class GameplayAbilities.AbilityTask_ApplyRootMotion_Base
// Size: 0xb8 (Inherited: 0x80)
struct UAbilityTask_ApplyRootMotion_Base : UAbilityTask {
	struct FName *ef04733cfe[0x08]; // 0x80(0x08)
	enum class *30be4da0fa *5e99cb80d7; // 0x88(0x01)
	char pad_89[0x3]; // 0x89(0x03)
	struct FVector *214e18f7c1[0x0c]; // 0x8c(0x0c)
	float *485a1eeee8[0x04]; // 0x98(0x04)
	char pad_9C[0x4]; // 0x9c(0x04)
	struct UCharacterMovementComponent* MovementComponent[0x08]; // 0xa0(0x08)
...
struct UAbilityTask_ApplyRootMotionConstantForce : UAbilityTask_ApplyRootMotion_Base {
	struct FMulticastDelegate OnFinish[0x10]; // 0xb8(0x10)
	struct FVector WorldDirection[0x0c]; // 0xc8(0x0c)
	float Strength[0x04]; // 0xd4(0x04)
	float Duration[0x04]; // 0xd8(0x04)
	bool *5ebf5b10ed; // 0xdc(0x01)
	char pad_DD[0x3]; // 0xdd(0x03)
	struct UCurveFloat* *8fc156f86d[0x08]; // 0xe0(0x08)
...
struct UAbilityTask_ApplyRootMotionJumpForce : UAbilityTask_ApplyRootMotion_Base {
	struct FMulticastDelegate OnFinish[0x10]; // 0xb8(0x10)
	struct FMulticastDelegate OnLanded[0x10]; // 0xc8(0x10)
	struct FRotator Rotation[0x0c]; // 0xd8(0x0c)
	float Distance[0x04]; // 0xe4(0x04)
	float Height[0x04]; // 0xe8(0x04)
	float Duration[0x04]; // 0xec(0x04)
	float *1c527e8709[0x04]; // 0xf0(0x04)
	bool *ee530b9e1b; // 0xf4(0x01)
	char pad_F5[0x3]; // 0xf5(0x03)
	struct U*59a0aeaef9* *da7756b7db[0x08]; // 0xf8(0x08)
	struct UCurveFloat* *d672920056[0x08]; // 0x100(0x08)
...
struct UAbilityTask_ApplyRootMotionMoveToActorForce : UAbilityTask_ApplyRootMotion_Base {
	struct FMulticastDelegate OnFinished[0x10]; // 0xb8(0x10)
	char pad_C8[0x8]; // 0xc8(0x08)
	struct FVector StartLocation[0x0c]; // 0xd0(0x0c)
	struct FVector TargetLocation[0x0c]; // 0xdc(0x0c)
	struct AActor* TargetActor[0x08]; // 0xe8(0x08)
	struct FVector *aa08a0e944[0x0c]; // 0xf0(0x0c)
	enum class *a6b6e6317f *1cd1203018; // 0xfc(0x01)
	char pad_FD[0x3]; // 0xfd(0x03)
	float Duration[0x04]; // 0x100(0x04)
	...
	struct U*59a0aeaef9* *da7756b7db[0x08]; // 0x108(0x08)
	struct UCurveFloat* *d672920056[0x08]; // 0x110(0x08)
	struct UCurveFloat* *a56eb17ba0[0x08]; // 0x118(0x08)
	struct UCurveFloat* *be969ca714[0x08]; // 0x120(0x08)
...
struct UAbilityTask_ApplyRootMotionMoveToForce : UAbilityTask_ApplyRootMotion_Base {
	struct FMulticastDelegate OnTimedOut[0x10]; // 0xb8(0x10)
	struct FMulticastDelegate OnTimedOutAndDestinationReached[0x10]; // 0xc8(0x10)
	struct FVector StartLocation[0x0c]; // 0xd8(0x0c)
	struct FVector TargetLocation[0x0c]; // 0xe4(0x0c)
	float Duration[0x04]; // 0xf0(0x04)
...
struct UAbilityTask_ApplyRootMotionRadialForce : UAbilityTask_ApplyRootMotion_Base {
	struct FMulticastDelegate OnFinish[0x10]; // 0xb8(0x10)
	struct FVector Location[0x0c]; // 0xc8(0x0c)
	char pad_D4[0x4]; // 0xd4(0x04)
	struct AActor* *f37a2ef1e9[0x08]; // 0xd8(0x08)
	float Strength[0x04]; // 0xe0(0x04)
	float Duration[0x04]; // 0xe4(0x04)
	float Radius[0x04]; // 0xe8(0x04)
	bool *ff362984df; // 0xec(0x01)
	bool *5ebf5b10ed; // 0xed(0x01)
	bool *5549f9328f; // 0xee(0x01)
	char pad_EF[0x1]; // 0xef(0x01)
	struct UCurveFloat* *ca92445d00[0x08]; // 0xf0(0x08)
	struct UCurveFloat* *8fc156f86d[0x08]; // 0xf8(0x08)
	bool *0963b0b13a; // 0x100(0x01)
	char pad_101[0x3]; // 0x101(0x03)
	struct FRotator *426d246e6a[0x0c]; // 0x104(0x0c)
...
struct UAbilityTask_MoveToLocation : UAbilityTask {
	struct FMulticastDelegate OnTargetLocationReached[0x10]; // 0x80(0x10)
	char pad_90[0x4]; // 0x90(0x04)
	struct FVector StartLocation[0x0c]; // 0x94(0x0c)
	struct FVector TargetLocation[0x0c]; // 0xa0(0x0c)
	float *44735d9bd3[0x04]; // 0xac(0x04)
	char pad_B0[0x8]; // 0xb0(0x08)
	struct UCurveFloat* *ac01a19749[0x08]; // 0xb8(0x08)
	struct U*59a0aeaef9* *7e6ffa4995[0x08]; // 0xc0(0x08)
...
struct UAbilityTask_NetworkSyncPoint : UAbilityTask {
	struct FMulticastDelegate OnSync[0x10]; // 0x80(0x10)
...
struct UAbilityTask_PlayMontageAndWait : UAbilityTask {
	struct FMulticastDelegate OnCompleted[0x10]; // 0x80(0x10)
	struct FMulticastDelegate OnBlendOut[0x10]; // 0x90(0x10)
	struct FMulticastDelegate OnInterrupted[0x10]; // 0xa0(0x10)
	struct FMulticastDelegate OnCancelled[0x10]; // 0xb0(0x10)
	char pad_C0[0x88]; // 0xc0(0x88)
	struct UAnimMontage* *cc3fe64113[0x08]; // 0x148(0x08)
	float Rate[0x04]; // 0x150(0x04)
	char pad_154[0x4]; // 0x154(0x04)
	struct FName *25c2cf3d7f[0x08]; // 0x158(0x08)
	float *fdceab32c3[0x04]; // 0x160(0x04)
	float *db01c9c0ac[0x04]; // 0x164(0x04)
...
struct UAbilityTask_Repeat : UAbilityTask {
	struct FMulticastDelegate OnPerformAction[0x10]; // 0x80(0x10)
	struct FMulticastDelegate OnFinished[0x10]; // 0x90(0x10)
...
struct UAbilityTask_SpawnActor : UAbilityTask {
	struct FMulticastDelegate SUCCESS[0x10]; // 0x80(0x10)
	struct FMulticastDelegate DidNotSpawn[0x10]; // 0x90(0x10)
...
struct UAbilityTask_StartAbilityState : UAbilityTask {
	struct FMulticastDelegate OnStateEnded[0x10]; // 0x80(0x10)
	struct FMulticastDelegate OnStateInterrupted[0x10]; // 0x90(0x10)
	char pad_A0[0x18]; // 0xa0(0x18)
...
struct AGameplayAbilityWorldReticle : AActor {
	struct F*26ccbc5580 Parameters[0x0c]; // 0x3e8(0x0c)
	...
	struct APlayerController* MasterPC[0x08]; // 0x3f8(0x08)
	struct AActor* TargetingActor[0x08]; // 0x400(0x08)
...
struct AGameplayAbilityTargetActor : AActor {
	...
	struct F*8b87ae35f3 StartLocation[0x70]; // 0x3f0(0x70)
	char pad_460[0xe0]; // 0x460(0xe0)
	struct APlayerController* MasterPC[0x08]; // 0x540(0x08)
	struct UGameplayAbility* OwningAbility[0x08]; // 0x548(0x08)
	bool bDestroyOnConfirmation; // 0x550(0x01)
	char pad_551[0x7]; // 0x551(0x07)
	struct AActor* SourceActor[0x08]; // 0x558(0x08)
	struct F*26ccbc5580 ReticleParams[0x0c]; // 0x560(0x0c)
	char pad_56C[0x4]; // 0x56c(0x04)
	struct UClass* ReticleClass[0x08]; // 0x570(0x08)
	struct F*6616fa779a Filter[0x10]; // 0x578(0x10)
	bool bDebug; // 0x588(0x01)
	char pad_589[0x17]; // 0x589(0x17)
	struct UAbilitySystemComponent* *7cd7f473f1[0x08]; // 0x5a0(0x08)
...
struct UAbilityTask_VisualizeTargeting : UAbilityTask {
	struct FMulticastDelegate TimeElapsed[0x10]; // 0x80(0x10)
...
struct UAbilityTask_WaitAbilityActivate : UAbilityTask {
	struct FMulticastDelegate OnActivate[0x10]; // 0x80(0x10)
...
struct UAbilityTask_WaitAbilityCommit : UAbilityTask {
	struct FMulticastDelegate OnCommit[0x10]; // 0x80(0x10)
...
struct UAbilityTask_WaitAttributeChange : UAbilityTask {
	struct FMulticastDelegate OnChange[0x10]; // 0x80(0x10)
	char pad_90[0x48]; // 0x90(0x48)
	struct UAbilitySystemComponent* *1211f01e6b[0x08]; // 0xd8(0x08)
...
struct UAbilityTask_WaitAttributeChangeRatioThreshold : UAbilityTask {
	...
	struct UAbilitySystemComponent* *1211f01e6b[0x08]; // 0x108(0x08)
...
struct UAbilityTask_WaitAttributeChangeThreshold : UAbilityTask {
	...
	struct UAbilitySystemComponent* *1211f01e6b[0x08]; // 0xd0(0x08)
...
struct UAbilityTask_WaitCancel : UAbilityTask {
	struct FMulticastDelegate OnCancel[0x10]; // 0x80(0x10)
	char pad_90[0x8]; // 0x90(0x08)
...
struct UAbilityTask_WaitConfirm : UAbilityTask {
	struct FMulticastDelegate OnConfirm[0x10]; // 0x80(0x10)
...
struct UAbilityTask_WaitConfirmCancel : UAbilityTask {
	struct FMulticastDelegate OnConfirm[0x10]; // 0x80(0x10)
	struct FMulticastDelegate OnCancel[0x10]; // 0x90(0x10)
...
struct UAbilityTask_WaitDelay : UAbilityTask {
	struct FMulticastDelegate OnFinish[0x10]; // 0x80(0x10)
	char pad_90[0x8]; // 0x90(0x08)
...
struct UAbilityTask_WaitGameplayEffectApplied : UAbilityTask {
	...
	struct UAbilitySystemComponent* *1211f01e6b[0x08]; // 0x1a8(0x08)
...
struct UAbilityTask_WaitGameplayEffectApplied_Self : UAbilityTask_WaitGameplayEffectApplied {
	struct FMulticastDelegate OnApplied[0x10]; // 0x1b8(0x10)
...
struct UAbilityTask_WaitGameplayEffectBlockedImmunity : UAbilityTask {
	struct FMulticastDelegate bLocked[0x10]; // 0x80(0x10)
	char pad_90[0x88]; // 0x90(0x88)
	struct UAbilitySystemComponent* *1211f01e6b[0x08]; // 0x118(0x08)
...
struct UAbilityTask_WaitGameplayEffectRemoved : UAbilityTask {
	struct FMulticastDelegate OnRemoved[0x10]; // 0x80(0x10)
	struct FMulticastDelegate InvalidHandle[0x10]; // 0x90(0x10)
...
struct UAbilityTask_WaitGameplayEvent : UAbilityTask {
	struct FMulticastDelegate EventReceived[0x10]; // 0x80(0x10)
	char pad_90[0x8]; // 0x90(0x08)
	struct UAbilitySystemComponent* *1c4fabdd56[0x08]; // 0x98(0x08)
...
struct UAbilityTask_WaitGameplayTag : UAbilityTask {
	...
	struct UAbilitySystemComponent* *1c4fabdd56[0x08]; // 0x90(0x08)
...
struct UAbilityTask_WaitGameplayTagAdded : UAbilityTask_WaitGameplayTag {
	struct FMulticastDelegate Added[0x10]; // 0xa8(0x10)
...
struct UAbilityTask_WaitGameplayTagRemoved : UAbilityTask_WaitGameplayTag {
	struct FMulticastDelegate Removed[0x10]; // 0xa8(0x10)
...
struct UAbilityTask_WaitInputPress : UAbilityTask {
	struct FMulticastDelegate OnPress[0x10]; // 0x80(0x10)
	char pad_90[0x10]; // 0x90(0x10)
...
struct UAbilityTask_WaitInputRelease : UAbilityTask {
	struct FMulticastDelegate OnRelease[0x10]; // 0x80(0x10)
	char pad_90[0x10]; // 0x90(0x10)
...
struct UAbilityTask_WaitOverlap : UAbilityTask {
	struct FMulticastDelegate OnOverlap[0x10]; // 0x80(0x10)
...
struct UAbilityTask_WaitTargetData : UAbilityTask {
	struct FMulticastDelegate ValidData[0x10]; // 0x80(0x10)
	struct FMulticastDelegate Cancelled[0x10]; // 0x90(0x10)
	struct UClass* TargetClass[0x08]; // 0xa0(0x08)
	struct AGameplayAbilityTargetActor* TargetActor[0x08]; // 0xa8(0x08)
...
struct UAbilityTask_WaitVelocityChange : UAbilityTask {
	struct FMulticastDelegate OnVelocityChage[0x10]; // 0x80(0x10)
	struct UMovementComponent* *95a3ade266[0x08]; // 0x90(0x08)
	char pad_98[0x10]; // 0x98(0x10)
...
struct U*f1a7cdc4a5 : UAttributeSet {
	float MaxHealth[0x04]; // 0x30(0x04)
	float Health[0x04]; // 0x34(0x04)
	float Mana[0x04]; // 0x38(0x04)
	float MaxMana[0x04]; // 0x3c(0x04)
	float Damage[0x04]; // 0x40(0x04)
	float SpellDamage[0x04]; // 0x44(0x04)
	float PhysicalDamage[0x04]; // 0x48(0x04)
	float CritChance[0x04]; // 0x4c(0x04)
	float CritMultiplier[0x04]; // 0x50(0x04)
	float ArmorDamageReduction[0x04]; // 0x54(0x04)
	float DodgeChance[0x04]; // 0x58(0x04)
	float LifeSteal[0x04]; // 0x5c(0x04)
	float Strength[0x04]; // 0x60(0x04)
	float StackingAttribute1[0x04]; // 0x64(0x04)
	float StackingAttribute2[0x04]; // 0x68(0x04)
	float NoStackAttribute[0x04]; // 0x6c(0x04)
};
...
struct U*476845cb3d : UGameplayAbility {
	struct UAnimMontage* *cc3fe64113[0x08]; // 0x570(0x08)
	float PlayRate[0x04]; // 0x578(0x04)
	char pad_57C[0x4]; // 0x57c(0x04)
	struct FName SectionName[0x08]; // 0x580(0x08)
	struct TArray<struct UClass*> *e0327af2ec[0x10]; // 0x588(0x10)
	struct TArray<struct UGameplayEffect*> *ec740b56c0[0x10]; // 0x598(0x10)
	char pad_5A8[0x8]; // 0x5a8(0x08)
};
...
struct AGameplayAbilityTargetActor_GroundTrace : AGameplayAbilityTargetActor_Trace {
	float CollisionRadius[0x04]; // 0x5c8(0x04)
	float CollisionHeight[0x04]; // 0x5cc(0x04)
...
struct AGameplayAbilityTargetActor_ActorPlacement : AGameplayAbilityTargetActor_GroundTrace {
	struct UClass* PlacedActorClass[0x08]; // 0x5e8(0x08)
	struct UMaterialInterface* PlacedActorMaterial[0x08]; // 0x5f0(0x08)
};
...
struct AGameplayAbilityWorldReticle_ActorVisualization : AGameplayAbilityWorldReticle {
	struct UCapsuleComponent* CollisionComponent[0x08]; // 0x408(0x08)
	struct TArray<struct UActorComponent*> *cb5b01ed61[0x10]; // 0x410(0x10)
};
...
struct UGameplayCueManager : UDataAsset {
	...
	struct F*a1b25a3259 *fac1076964[0xb0]; // 0xa0(0xb0)
	struct F*a1b25a3259 *649fa6453a[0xb0]; // 0x150(0xb0)
	char pad_200[0x1a0]; // 0x200(0x1a0)
	struct TArray<struct UClass*> *d53caaed62[0x10]; // 0x3a0(0x10)
	struct TArray<struct UClass*> *a37198c1b8[0x10]; // 0x3b0(0x10)
	struct TArray<struct F*eae0ebff14> *49b79b92de[0x10]; // 0x3c0(0x10)
	int32 *3186a4df45[0x04]; // 0x3d0(0x04)
	char pad_3D4[0x4]; // 0x3d4(0x04)
	struct TArray<struct F*ae73b4ceaa> *4d1a656c9e[0x10]; // 0x3d8(0x10)
...
struct AGameplayCueNotify_Actor : AActor {
	...
	float *a9940553da[0x04]; // 0x3ec(0x04)
	bool *6b238b0ded; // 0x3f0(0x01)
	bool *9281ed79b7; // 0x3f1(0x01)
	char pad_3F2[0x6]; // 0x3f2(0x06)
	struct FGameplayTag GameplayCueTag[0x08]; // 0x3f8(0x08)
	struct FName GameplayCueName[0x08]; // 0x400(0x08)
	...
	int32 *16b408a30f[0x04]; // 0x410(0x04)
...
struct UGameplayCueNotify_Static : UObject {
	struct FGameplayTag GameplayCueTag[0x08]; // 0x28(0x08)
	struct FName GameplayCueName[0x08]; // 0x30(0x08)
...
struct U*9548613553 : UGameplayCueNotify_Static {
	struct USoundBase* Sound[0x08]; // 0x40(0x08)
	struct UParticleSystem* ParticleSystem[0x08]; // 0x48(0x08)
};

// Class GameplayAbilities.*936c76ae6d
// Size: 0x90 (Inherited: 0x30)
struct U*936c76ae6d : UDataAsset {
	struct TArray<struct F*731ab2bf2c> *712cfcffae[0x10]; // 0x30(0x10)
...
struct U*0e4bd35382 : UDataAsset {
	struct TArray<struct F*c97d215778> Entries[0x10]; // 0x30(0x10)
