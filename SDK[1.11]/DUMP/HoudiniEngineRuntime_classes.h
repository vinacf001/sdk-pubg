...
struct UHoudiniAsset : UObject {
	struct FString *446fdcf446[0x10]; // 0x28(0x10)
	struct U*f0a07311c5* *f0a07311c5[0x08]; // 0x38(0x08)
...
struct AHoudiniAssetActor : AActor {
	struct UHoudiniAssetComponent* HoudiniAssetComponent[0x08]; // 0x3e8(0x08)
...
struct UHoudiniRuntimeSettings : UObject {
	...
	struct FString ServerHost[0x10]; // 0x30(0x10)
	int32 ServerPort[0x04]; // 0x40(0x04)
	char pad_44[0x4]; // 0x44(0x04)
	struct FString ServerPipeName[0x10]; // 0x48(0x10)
	bool bStartAutomaticServer; // 0x58(0x01)
	char pad_59[0x3]; // 0x59(0x03)
	float AutomaticServerTimeout[0x04]; // 0x5c(0x04)
	...
	struct FText TemporaryCookFolder[0x18]; // 0x68(0x18)
	bool bTreatRampParametersAsMultiparms; // 0x80(0x01)
	char pad_81[0x7]; // 0x81(0x07)
	struct FString CollisionGroupNamePrefix[0x10]; // 0x88(0x10)
	struct FString RenderedCollisionGroupNamePrefix[0x10]; // 0x98(0x10)
	struct FString UCXCollisionGroupNamePrefix[0x10]; // 0xa8(0x10)
	struct FString UCXRenderedCollisionGroupNamePrefix[0x10]; // 0xb8(0x10)
	struct FString SimpleCollisionGroupNamePrefix[0x10]; // 0xc8(0x10)
	struct FString SimpleRenderedCollisionGroupNamePrefix[0x10]; // 0xd8(0x10)
	struct FString MarshallingAttributeMaterial[0x10]; // 0xe8(0x10)
	struct FString MarshallingAttributeMaterialHole[0x10]; // 0xf8(0x10)
	struct FString MarshallingAttributeInstanceOverride[0x10]; // 0x108(0x10)
	struct FString MarshallingAttributeFaceSmoothingMask[0x10]; // 0x118(0x10)
	struct FString MarshallingAttributeLightmapResolution[0x10]; // 0x128(0x10)
	struct FString MarshallingAttributeGeneratedMeshName[0x10]; // 0x138(0x10)
	struct FString MarshallingAttributeInputMeshName[0x10]; // 0x148(0x10)
	struct FString MarshallingAttributeInputSourceFile[0x10]; // 0x158(0x10)
	float MarshallingSplineResolution[0x04]; // 0x168(0x04)
	...
	float MarshallingLandscapesForcedMinValue[0x04]; // 0x170(0x04)
	float MarshallingLandscapesForcedMaxValue[0x04]; // 0x174(0x04)
	float GeneratedGeometryScaleFactor[0x04]; // 0x178(0x04)
	float TransformScaleFactor[0x04]; // 0x17c(0x04)
	...
	struct UPhysicalMaterial* PhysMaterial[0x08]; // 0x188(0x08)
	struct FBodyInstance *0134eb6c71[0x230]; // 0x190(0x230)
	enum class ECollisionTraceFlag CollisionTraceFlag; // 0x3c0(0x01)
	char pad_3C1[0x3]; // 0x3c1(0x03)
	int32 LightMapResolution[0x04]; // 0x3c4(0x04)
	float LpvBiasMultiplier[0x04]; // 0x3c8(0x04)
	float GeneratedDistanceFieldResolutionScale[0x04]; // 0x3cc(0x04)
	struct F*a92203063d WalkableSlopeOverride[0x10]; // 0x3d0(0x10)
	int32 LightMapCoordinateIndex[0x04]; // 0x3e0(0x04)
	char bUseMaximumStreamingTexelRatio : 1; // 0x3e4(0x01)
	char pad_3E4_1 : 7; // 0x3e4(0x01)
	char pad_3E5[0x3]; // 0x3e5(0x03)
	float StreamingDistanceMultiplier[0x04]; // 0x3e8(0x04)
	char pad_3EC[0x4]; // 0x3ec(0x04)
	struct UFoliageType_InstancedStaticMesh* *10a51c00da[0x08]; // 0x3f0(0x08)
	struct TArray<struct UAssetUserData*> AssetUserData[0x10]; // 0x3f8(0x10)
	bool bUseFullPrecisionUVs; // 0x408(0x01)
	char pad_409[0x3]; // 0x409(0x03)
	int32 SrcLightmapIndex[0x04]; // 0x40c(0x04)
	int32 DstLightmapIndex[0x04]; // 0x410(0x04)
	int32 MinLightmapResolution[0x04]; // 0x414(0x04)
	...
	struct FDirectoryPath CustomHoudiniLocation[0x10]; // 0x420(0x10)
	bool bHidePlacementModeHoudiniTools; // 0x430(0x01)
	char pad_431[0x7]; // 0x431(0x07)
	struct TArray<struct F*9f2306d7c5> CustomHoudiniToolsLocation[0x10]; // 0x438(0x10)
	int32 CookingThreadStackSize[0x04]; // 0x448(0x04)
	char pad_44C[0x4]; // 0x44c(0x04)
	struct FString HoudiniEnvironmentFiles[0x10]; // 0x450(0x10)
	struct FString OtlSearchPath[0x10]; // 0x460(0x10)
	struct FString DsoSearchPath[0x10]; // 0x470(0x10)
	struct FString ImageDsoSearchPath[0x10]; // 0x480(0x10)
	struct FString AudioDsoSearchPath[0x10]; // 0x490(0x10)
};
...
struct UHoudiniAssetComponent : UPrimitiveComponent {
	...
	struct UPhysicalMaterial* *9af61bf936[0x08]; // 0xa08(0x08)
	struct FBodyInstance *0134eb6c71[0x230]; // 0xa10(0x230)
	enum class ECollisionTraceFlag *de7f303171; // 0xc40(0x01)
	char pad_C41[0x3]; // 0xc41(0x03)
	int32 *60566caead[0x04]; // 0xc44(0x04)
	float GeneratedLpvBiasMultiplier[0x04]; // 0xc48(0x04)
	float *ea8027872d[0x04]; // 0xc4c(0x04)
	struct F*a92203063d *6e7b79d459[0x10]; // 0xc50(0x10)
	int32 *dc91edb0c1[0x04]; // 0xc60(0x04)
	char *5cfbb93b25 : 1; // 0xc64(0x01)
	char pad_C64_1 : 7; // 0xc64(0x01)
	char pad_C65[0x3]; // 0xc65(0x03)
	float *7bac08a753[0x04]; // 0xc68(0x04)
	char pad_C6C[0x4]; // 0xc6c(0x04)
	struct UFoliageType_InstancedStaticMesh* *1cac115a4b[0x08]; // 0xc70(0x08)
	struct TArray<struct UAssetUserData*> *55cc152614[0x10]; // 0xc78(0x10)
	char pad_C88[0x478]; // 0xc88(0x478)
	struct FText BakeFolder[0x18]; // 0x1100(0x18)
	struct FText *bbc1b50338[0x18]; // 0x1118(0x18)
...
struct U*a59e690045 : USceneComponent {
	struct UObject* *3ad714604d[0x08]; // 0x4d0(0x08)
	struct TArray<struct AActor*> Instances[0x10]; // 0x4d8(0x10)
...
struct U*e7f71cadcc : USceneComponent {
	struct TArray<struct UStaticMeshComponent*> Instances[0x10]; // 0x4d0(0x10)
	struct UMaterialInterface* OverrideMaterial[0x08]; // 0x4e0(0x08)
	struct UStaticMesh* InstancedMesh[0x08]; // 0x4e8(0x08)
};
