...
struct UBP_PcOptionDetailWidget_C : U*8a8464eec8 {
	struct F*abc8f374e0 UberGraphFrame; // 0x5b0(0x08)
	...
	void ExecuteUbergraph_BP_PcOptionDetailWidget(); // Function BP_PcOptionDetailWidget.BP_PcOptionDetailWidget_C.ExecuteUbergraph_BP_PcOptionDetailWidget //  // @ game+0x2cd4ac
};
