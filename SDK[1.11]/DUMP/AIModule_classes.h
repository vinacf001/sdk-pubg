...
struct UBTNode : UObject {
	...
	struct UBehaviorTree* *23b47663f5; // 0x50(0x08)
	struct UBTCompositeNode* *7241e2d970; // 0x58(0x08)
...
struct UAISense : UObject {
	...
	struct UAIPerceptionSystem* *65c690bb6c; // 0x38(0x08)
...
struct UAISenseConfig_Hearing : U*87e264aa3c {
	...
	struct F*69aff14219 DetectionByAffiliation; // 0x5c(0x04)
};
...
struct UBlackboardComponent : UActorComponent {
	struct UBrainComponent* *291d373322; // 0x1f0(0x08)
	struct UBlackboardData* BlackboardAsset; // 0x1f8(0x08)
	char pad_200[0x20]; // 0x200(0x20)
	struct TArray<struct UBlackboardKeyType*> *67afa5be9c; // 0x220(0x10)
...
struct UPathFollowingComponent : UActorComponent {
	...
	struct ANavigationData* *eac456cf29; // 0x330(0x08)
...
struct UBTDecorator_Blackboard : UBTDecorator_BlackboardBase {
	...
	struct FString *6def975b7c; // 0xb8(0x10)
...
struct UAIPerceptionComponent : UActorComponent {
	struct TArray<struct U*87e264aa3c*> *02ad26e521; // 0x1f0(0x10)
	struct UClass* *6f1de5bcb4; // 0x200(0x08)
	char pad_208[0x10]; // 0x208(0x10)
	struct AAIController* *9477fbe1d5; // 0x218(0x08)
...
struct UBTTask_MoveTo : UBTTask_BlackboardBase {
	...
	struct UClass* *b5456fcb59; // 0xb0(0x08)
	float *f5b45d93e0; // 0xb8(0x04)
...
struct UBTTask_Wait : UBTTaskNode {
	float *577765ed3c; // 0x80(0x04)
	float *e7cfc56453; // 0x84(0x04)
};
...
struct UCrowdFollowingComponent : UPathFollowingComponent {
	struct FVector *7d21e0de79; // 0x4c0(0x0c)
	char pad_4CC[0x4]; // 0x4cc(0x04)
	struct UCharacterMovementComponent* CharacterMovement; // 0x4d0(0x08)
	struct F*f2710e04b9 AvoidanceGroup; // 0x4d8(0x04)
	struct F*f2710e04b9 GroupsToAvoid; // 0x4dc(0x04)
	struct F*f2710e04b9 GroupsToIgnore; // 0x4e0(0x04)
...
struct UAIPerceptionSystem : UObject {
	...
	struct TArray<struct UAISense*> *826dc25744; // 0x80(0x10)
...
struct U*4dc916c1b7 : U*1c525798c2 {
	struct F*2f8eafb470 Event; // 0x28(0x30)
};

// Class AIModule.*a6f50ad483
// Size: 0x58 (Inherited: 0x28)
struct U*a6f50ad483 : U*1c525798c2 {
	struct F*c6e7d5afa9 Event; // 0x28(0x30)
};
...
struct UAISystem : UAISystemBase {
	...
	struct UEnvQueryManager* *392836d7b1; // 0x88(0x08)
	struct UAIPerceptionSystem* PerceptionSystem; // 0x90(0x08)
	struct TArray<struct UAIAsyncTaskBlueprintProxy*> *3cc5dfc624; // 0x98(0x10)
	struct UAIHotSpotManager* *718e6887d4; // 0xa8(0x08)
	struct U*ce0e010772* *63b8ba983f; // 0xb0(0x08)
...
struct UAITask_MoveTo : UAITask {
	...
	struct F*de7f12a472 *d137c5c17f; // 0x90(0x50)
...
struct UBrainComponent : UActorComponent {
	...
	struct AAIController* *9477fbe1d5; // 0x200(0x08)
...
struct UBehaviorTreeComponent : UBrainComponent {
	...
	struct TArray<struct UBTNode*> *874ee6642b; // 0x270(0x10)
...
struct UBTCompositeNode : UBTNode {
	struct TArray<struct F*bc8cfc90a0> Children; // 0x68(0x10)
...
struct UBehaviorTree : UObject {
	...
	struct TArray<struct UBTDecorator*> *9fc94fdf8f; // 0x38(0x10)
	struct TArray<struct F*0a3d5e26e0> *38ce266528; // 0x48(0x10)
...
struct UBehaviorTreeManager : UObject {
	...
	struct TArray<struct F*fcbe40058d> *62b3bea7fa; // 0x30(0x10)
	struct TArray<struct UBehaviorTreeComponent*> *3f51b8977e; // 0x40(0x10)
};
...
struct UBlackboardKeyType_Class : UBlackboardKeyType {
	struct UClass* *0d626c6c45; // 0x30(0x08)
};
...
struct U*9d927a6f0a : UBTDecorator_BlackboardBase {
	float *e9d5f57f54; // 0xa0(0x04)
	char pad_A4[0x4]; // 0xa4(0x04)
	struct FAIDataProviderFloatValue *4d5e1d1245; // 0xa8(0x30)
...
struct U*269f3e079b : UBTDecorator_BlackboardBase {
	struct UClass* *bdd1f79260; // 0xa0(0x08)
};

// Class AIModule.BTDecorator_BlueprintBase
// Size: 0xb0 (Inherited: 0x78)
struct UBTDecorator_BlueprintBase : UBTDecorator {
	struct AAIController* *9477fbe1d5; // 0x78(0x08)
	struct AActor* *73e497a1ad; // 0x80(0x08)
	struct TArray<struct FName> *29763f2980; // 0x88(0x10)
...
struct UBTDecorator_ConeCheck : UBTDecorator {
	float *2a1ee2b6eb; // 0x78(0x04)
	char pad_7C[0x4]; // 0x7c(0x04)
	struct FBlackboardKeySelector *af3fa2eef0; // 0x80(0x28)
	struct FBlackboardKeySelector *675d196ff2; // 0xa8(0x28)
	struct FBlackboardKeySelector *eaa5757a7a; // 0xd0(0x28)
...
struct UBTDecorator_DoesPathExist : UBTDecorator {
	struct FBlackboardKeySelector *0c3b20c2cf; // 0x78(0x28)
	struct FBlackboardKeySelector *f4dbb55888; // 0xa0(0x28)
	char *75e8f046ef : 1; // 0xc8(0x01)
	char pad_C8_1 : 7; // 0xc8(0x01)
	char pad_C9[0x3]; // 0xc9(0x03)
	enum class EPathExistanceQueryType *c9f7ee7df2; // 0xcc(0x01)
	char pad_CD[0x3]; // 0xcd(0x03)
	struct UClass* *b5456fcb59; // 0xd0(0x08)
};
...
struct UBTDecorator_KeepInCone : UBTDecorator {
	...
	char pad_7C[0x4]; // 0x7c(0x04)
	struct FBlackboardKeySelector *af3fa2eef0; // 0x80(0x28)
	struct FBlackboardKeySelector *eaa5757a7a; // 0xa8(0x28)
...
struct UBTDecorator_Loop : UBTDecorator {
	int32 *97ddf9fa54; // 0x78(0x04)
	bool bInfiniteLoop; // 0x7c(0x01)
	char pad_7D[0x3]; // 0x7d(0x03)
	float *caeeb46594; // 0x80(0x04)
...
struct U*a65de6ab75 : UBTDecorator {
	struct FGameplayTag *6bb7513bdd; // 0x78(0x08)
	float *f3d7337c25; // 0x80(0x04)
...
struct U*71d15c7b4c : UBTService_BlackboardBase {
	struct F*a44cd53957 *52ef090d74; // 0xa8(0x48)
...
struct UBTTask_RunEQSQuery : UBTTask_BlackboardBase {
	struct UEnvQuery* *c9c902c1bb; // 0xa8(0x08)
	struct TArray<struct FEnvNamedValue> *c1c14617b5; // 0xb0(0x10)
	struct TArray<struct F*adbe44f542> *3e5e5c24de; // 0xc0(0x10)
	enum class EEnvQueryRunMode *6759275bad; // 0xd0(0x01)
	char pad_D1[0x7]; // 0xd1(0x07)
	struct FBlackboardKeySelector *65e8432f43; // 0xd8(0x28)
	bool bUseBBKey; // 0x100(0x01)
	char pad_101[0x7]; // 0x101(0x07)
	struct F*a44cd53957 *52ef090d74; // 0x108(0x48)
...
struct U*e3c207468d : U*e084f28481 {
	struct U*25f78a9188* Action; // 0x80(0x08)
};

// Class AIModule.*645b456865
// Size: 0x100 (Inherited: 0x80)
struct U*645b456865 : UBTTaskNode {
	struct UAnimationAsset* *75d470c155; // 0x80(0x08)
	char bLooping : 1; // 0x88(0x01)
	char *7fc7c3f7ef : 1; // 0x88(0x01)
	char pad_88_2 : 6; // 0x88(0x01)
	char pad_89[0x7]; // 0x89(0x07)
	struct UBehaviorTreeComponent* *508fb9e143; // 0x90(0x08)
	struct USkeletalMeshComponent* *fa5baba31b; // 0x98(0x08)
...
struct UBTTask_PlaySound : UBTTaskNode {
	struct USoundCue* *bbd3278733; // 0x80(0x08)
};
...
struct U*828c0df4b9 : UBTTaskNode {
	struct FGameplayTag *97a089001c; // 0x80(0x08)
	struct UBehaviorTree* *57ff9c91fd; // 0x88(0x08)
...
struct UCrowdManager : UObject {
	struct ANavigationData* *eac456cf29; // 0x28(0x08)
	struct TArray<struct F*7dbe801015> AvoidanceConfig; // 0x30(0x10)
	struct TArray<struct F*2735eb2cdf> SamplingPatterns; // 0x40(0x10)
...
struct UEnvQuery : UDataAsset {
	struct FName *f4e91bb58c; // 0x30(0x08)
...
struct UEnvQueryManager : UObject {
	...
	struct TArray<struct F*7c630400ed> *e2d840aa9e; // 0xa0(0x10)
	struct TArray<struct UEnvQueryContext*> *12595f6df4; // 0xb0(0x10)
	struct TArray<struct U*d8b052ce38*> *e9d64f352a; // 0xc0(0x10)
...
struct UEnvQueryGenerator : U*157e6de374 {
	...
	struct UClass* *505b924fe4; // 0x40(0x08)
...
struct U*3191b2cb7c : UEnvQueryGenerator {
	struct UClass* *542e4b7f11; // 0x50(0x08)
	struct FAIDataProviderBoolValue *8cb9da09e8; // 0x58(0x30)
	struct FAIDataProviderFloatValue SearchRadius; // 0x88(0x30)
	struct UClass* *ab86b5d69f; // 0xb8(0x08)
};

// Class AIModule.*292d9d5109
// Size: 0x80 (Inherited: 0x50)
struct U*292d9d5109 : UEnvQueryGenerator {
	struct FText *ad2f45badc; // 0x50(0x18)
	struct UClass* Context; // 0x68(0x08)
	struct UClass* *0fa36b6d7b; // 0x70(0x08)
...
struct U*c5d74297a7 : UEnvQueryGenerator {
	struct UClass* *b0e61d7a47; // 0x50(0x08)
};

// Class AIModule.EnvQueryGenerator_ProjectedPoints
// Size: 0x80 (Inherited: 0x50)
struct UEnvQueryGenerator_ProjectedPoints : UEnvQueryGenerator {
	struct FEnvTraceData *54275f9c11; // 0x50(0x30)
};

// Class AIModule.*a4c79bb320
// Size: 0x150 (Inherited: 0x80)
struct U*a4c79bb320 : UEnvQueryGenerator_ProjectedPoints {
	struct FAIDataProviderFloatValue *0888e93ea5; // 0x80(0x30)
	struct FAIDataProviderFloatValue *00619c8dcf; // 0xb0(0x30)
	struct FAIDataProviderFloatValue *079ea16e2a; // 0xe0(0x30)
	struct FAIDataProviderFloatValue Range; // 0x110(0x30)
	struct UClass* *5a9073ead9; // 0x140(0x08)
...
struct U*e164f5e7b4 : UEnvQueryGenerator_ProjectedPoints {
	...
	struct FAIDataProviderIntValue *ef21aaf75e; // 0xe0(0x30)
	struct FAIDataProviderIntValue *d6c8f7821f; // 0x110(0x30)
	struct FEnvDirection ArcDirection; // 0x140(0x20)
	struct FAIDataProviderFloatValue *da0c349b4b; // 0x160(0x30)
...
struct UEnvQueryGenerator_OnCircle : UEnvQueryGenerator_ProjectedPoints {
	struct FAIDataProviderFloatValue *fa0e7b41ec; // 0x80(0x30)
	struct FAIDataProviderFloatValue *5dccd4b679; // 0xb0(0x30)
	...
	struct FAIDataProviderFloatValue *da0c349b4b; // 0x138(0x30)
	float *f2c8bb4001; // 0x168(0x04)
	char pad_16C[0x4]; // 0x16c(0x04)
	struct UClass* *935973d898; // 0x170(0x08)
	bool *6bc7b1581c; // 0x178(0x01)
	char pad_179[0x7]; // 0x179(0x07)
	struct FAIDataProviderFloatValue *3496f15891; // 0x180(0x30)
...
struct UEnvQueryTest : U*157e6de374 {
	...
	struct FAIDataProviderBoolValue *3e13fd76d8; // 0x50(0x30)
	struct FAIDataProviderFloatValue *b692249611; // 0x80(0x30)
	struct FAIDataProviderFloatValue *84779bab27; // 0xb0(0x30)
	...
	struct FAIDataProviderFloatValue *6a6614ff2c; // 0xe8(0x30)
	struct FAIDataProviderFloatValue *fc234cb0ef; // 0x118(0x30)
	struct FAIDataProviderFloatValue *f327f6ae3f; // 0x148(0x30)
...
struct UEnvQueryTest_Dot : UEnvQueryTest {
	struct FEnvDirection *a18274f722; // 0x1c0(0x20)
	struct FEnvDirection *11403e5e5a; // 0x1e0(0x20)
...
struct U*7b1157a24c : UEnvQueryTest {
	struct FGameplayTagQuery *a910d2fee0; // 0x1c0(0x48)
...
struct U*e9d2629490 : UEnvQueryTest {
	struct F*43315c3d9f *9b8eda705b; // 0x1c0(0x20)
};
...
struct UEnvQueryTest_Pathfinding : UEnvQueryTest {
	...
	struct FAIDataProviderBoolValue *80c5411538; // 0x1d0(0x30)
	struct FAIDataProviderBoolValue *d820beb4de; // 0x200(0x30)
	struct UClass* *b5456fcb59; // 0x230(0x08)
};

// Class AIModule.*ef265485c8
// Size: 0x268 (Inherited: 0x238)
struct U*ef265485c8 : UEnvQueryTest_Pathfinding {
	struct FAIDataProviderFloatValue *172a4e4da8; // 0x238(0x30)
};

// Class AIModule.*c5407dc7df
// Size: 0x1f0 (Inherited: 0x1c0)
struct U*c5407dc7df : UEnvQueryTest {
	struct FEnvTraceData *54275f9c11; // 0x1c0(0x30)
};
...
struct UEnvQueryTest_Trace : UEnvQueryTest {
	...
	struct FAIDataProviderBoolValue *3153f3b147; // 0x1f0(0x30)
	struct FAIDataProviderFloatValue *f78008679a; // 0x220(0x30)
	struct FAIDataProviderFloatValue *7a5e71d083; // 0x250(0x30)
...
struct U*b5a882f41d : UPathFollowingComponent {
	struct U*ce0e010772* *cfeec1b73c; // 0x4b8(0x08)
...
struct U*25f78a9188 : UObject {
	struct U*25f78a9188* *fd59edafdb; // 0x28(0x08)
	struct U*25f78a9188* *846f2c47b1; // 0x30(0x08)
	struct U*abba2dbb00* *139e630113; // 0x38(0x08)
	struct UObject* Instigator; // 0x40(0x08)
	struct UBrainComponent* *291d373322; // 0x48(0x08)
...
struct U*abba2dbb00 : UActorComponent {
	...
	struct TArray<struct F*e6d6914bb8> *14459bc9f9; // 0x1f8(0x10)
	struct TArray<struct F*9b44471641> *66f66b6f92; // 0x208(0x10)
	struct U*25f78a9188* *59ac9c4cb4; // 0x218(0x08)
