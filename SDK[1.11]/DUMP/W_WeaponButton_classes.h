...
struct UW_WeaponButton_C : UUserWidget {
	...
	struct UButton* ButtonGive[0x08]; // 0x258(0x08)
	struct UTextBlock* Text_Name[0x08]; // 0x260(0x08)
	struct FName ItemID[0x08]; // 0x268(0x08)
	struct F*1b4ab4ebac ClassVar[0x08]; // 0x270(0x08)
	struct F*7bb05e3554 ButtonStyle[0x2a8]; // 0x278(0x2a8)
	struct UW_WeaponMenu_C* MenuRef[0x08]; // 0x520(0x08)
