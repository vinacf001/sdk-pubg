...
struct ABP_MasteryPose_Bush_C : ABP_MasteryPose_C {
	struct UAsyncStaticMeshComponent* GrassMesh[0x08]; // 0x438(0x08)
	struct UAsyncStaticMeshComponent* BushMesh[0x08]; // 0x440(0x08)
	struct USpotLightComponent* spotlight[0x08]; // 0x448(0x08)
