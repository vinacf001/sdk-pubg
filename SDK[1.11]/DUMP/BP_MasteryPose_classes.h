...
struct ABP_MasteryPose_C : AMasteryPose {
	...
	struct UPostProcessComponent* PostProcess[0x08]; // 0x400(0x08)
	struct USceneComponent* PlayerCardScene[0x08]; // 0x408(0x08)
	struct USceneComponent* LobbyScene[0x08]; // 0x410(0x08)
	struct USkeletalMeshComponent* SkeletalMesh[0x08]; // 0x418(0x08)
	struct USceneComponent* DefaultSceneRoot[0x08]; // 0x420(0x08)
	struct TArray<struct FPoseCharacterAttachments> CharacterAttachedObjects[0x10]; // 0x428(0x10)
