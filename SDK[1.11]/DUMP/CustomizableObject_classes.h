...
struct UCustomizableSkeletalComponent : USceneComponent {
	...
	float *9bc184e8b2[0x04]; // 0x4d4(0x04)
	struct UCustomizableObjectInstance* CustomizableObjectInstance[0x08]; // 0x4d8(0x08)
	char pad_4E0[0x40]; // 0x4e0(0x40)
	struct USkeletalMesh* *d6439dd092[0x08]; // 0x520(0x08)
...
struct UCustomizableObjectInstance : UObject {
	struct UCustomizableObject* CustomizableObject[0x08]; // 0x28(0x08)
	struct USkeletalMesh* SkeletalMesh[0x08]; // 0x30(0x08)
	struct TArray<struct F*50337b7e4f> *7e9a6feeb6[0x10]; // 0x38(0x10)
	struct TArray<struct F*e82b45fc9c> *3107593f55[0x10]; // 0x48(0x10)
	struct TArray<struct F*9c105b932b> *ca8a4280c7[0x10]; // 0x58(0x10)
	struct TArray<struct F*b63a11dea5> *beb946aeb4[0x10]; // 0x68(0x10)
	struct TArray<struct F*48c3c84a0f> *f5b6331d28[0x10]; // 0x78(0x10)
	struct TArray<struct F*e357ce8580> *80f62bf23f[0x10]; // 0x88(0x10)
	bool bBuildParameterDecorations; // 0x98(0x01)
	char pad_99[0x7]; // 0x99(0x07)
	struct FMulticastDelegate UpdatedDelegate[0x10]; // 0xa0(0x10)
	char pad_B0[0x90]; // 0xb0(0x90)
	struct FString *8e5beb3aa2[0x10]; // 0x140(0x10)
	char pad_150[0x80]; // 0x150(0x80)
	struct FGuid *cdf3952819[0x10]; // 0x1d0(0x10)
	char pad_1E0[0x8]; // 0x1e0(0x08)
	struct U*11a6a5ae08* *d68132b5ae[0x08]; // 0x1e8(0x08)
...
struct U*11a6a5ae08 : UObject {
	...
	struct TArray<struct F*f0d78aa66b> *29c140dbdd[0x10]; // 0x30(0x10)
	struct TArray<struct F*36eb595a74> *2bcaf82a00[0x10]; // 0x40(0x10)
	struct TArray<struct F*89b0dafd96> *6f74314334[0x10]; // 0x50(0x10)
	char pad_60[0x88]; // 0x60(0x88)
	struct TArray<struct F*bfd4aa08bb> *bfd4aa08bb[0x10]; // 0xe8(0x10)
	char pad_F8[0x10]; // 0xf8(0x10)
	struct TMap<struct FString, struct UTexture2D*> *389a8b58dc[0x50]; // 0x108(0x50)
	char pad_158[0x1c8]; // 0x158(0x1c8)
	struct TArray<struct UMaterialInterface*> *c402c0157d[0x10]; // 0x320(0x10)
	char pad_330[0xa0]; // 0x330(0xa0)
	struct TArray<struct UPhysicsAsset*> *a9d4008402[0x10]; // 0x3d0(0x10)
...
struct U*fb0c0e7a50 : UObject {
	struct TMap<struct FString, struct FString> Materials[0x50]; // 0x28(0x50)
	struct TMap<struct FString, struct F*5be47f90d9> Textures[0x50]; // 0x78(0x50)
};

// Class CustomizableObject.CustomizableObject
// Size: 0x2c8 (Inherited: 0x28)
struct UCustomizableObject : UObject {
	struct USkeletalMesh* ReferenceSkeletalMesh[0x08]; // 0x28(0x08)
	struct UStaticMesh* *943637aa87[0x08]; // 0x30(0x08)
	enum class ECustomizableObjectRelevancy Relevancy; // 0x38(0x01)
	bool *fce324a45b; // 0x39(0x01)
	char pad_3A[0x6]; // 0x3a(0x06)
	struct TArray<struct UMaterialInterface*> *c402c0157d[0x10]; // 0x40(0x10)
	struct TArray<struct F*c8168d8edd> *2663421129[0x10]; // 0x50(0x10)
	struct TMap<struct FString, struct F*54424d3e0d> *203a78e0c1[0x50]; // 0x60(0x50)
	struct TArray<struct UMorphTarget*> *9b9598d76e[0x10]; // 0xb0(0x10)
	struct TArray<struct F*294c46bd80> *851c012943[0x10]; // 0xc0(0x10)
	struct FGuid *6f4e7b2cbc[0x10]; // 0xd0(0x10)
	struct TArray<struct F*8eb896974a> *d102e1d6ca[0x10]; // 0xe0(0x10)
	char pad_F0[0xa8]; // 0xf0(0xa8)
	struct TMap<struct FString, struct F*c4331059b1> *73353cace8[0x50]; // 0x198(0x50)
	struct TMap<struct FString, struct F*c4331059b1> *e202617813[0x50]; // 0x1e8(0x50)
	struct TMap<struct FString, struct UPhysicsAsset*> *ee45d4ffe9[0x50]; // 0x238(0x50)
	struct U*fb0c0e7a50* MaskOutCache[0x20]; // 0x288(0x20)
	bool *63258cfff0; // 0x2a8(0x01)
	char pad_2A9[0x7]; // 0x2a9(0x07)
	struct U*fb0c0e7a50* *f178728775[0x08]; // 0x2b0(0x08)
...
struct U*3fec10b2c7 : U*b6803fd32c {
	struct TArray<struct UTexture2D*> Textures[0x10]; // 0x28(0x10)
...
struct U*90cdf05591 : UObject {
	struct TArray<struct F*2cc416b752> PendingReleaseSkeletalMesh[0x10]; // 0x28(0x10)
	struct U*3fec10b2c7* *b82f75eb51[0x08]; // 0x38(0x08)
	char pad_40[0xd8]; // 0x40(0xd8)
	struct TArray<struct UTexture2D*> *0aadeaee50[0x10]; // 0x118(0x10)
	char pad_128[0x10]; // 0x128(0x10)
	struct U*031b455e26* *626090d7f2[0x08]; // 0x138(0x08)
	struct U*031b455e26* *7892b7154f[0x08]; // 0x140(0x08)
...
struct ACustomizableSkeletalMeshActor : ASkeletalMeshActor {
	struct UCustomizableSkeletalComponent* CustomizableSkeletalComponent[0x08]; // 0x470(0x08)
};
