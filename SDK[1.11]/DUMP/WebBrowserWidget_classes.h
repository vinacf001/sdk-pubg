...
struct UWebBrowser : UWidget {
	struct FMulticastDelegate OnUrlChanged[0x10]; // 0x128(0x10)
	struct FMulticastDelegate OnBeforePopup[0x10]; // 0x138(0x10)
	struct FMulticastDelegate OnTitleChanged[0x10]; // 0x148(0x10)
	char pad_158[0x78]; // 0x158(0x78)
	struct FMulticastDelegate OnMessageReceived[0x10]; // 0x1d0(0x10)
	struct FMulticastDelegate OnQRCodeRecognized[0x10]; // 0x1e0(0x10)
	struct FString *eac2bc5046[0x10]; // 0x1f0(0x10)
	...
	struct FBox2D *f0cd8810b5[0x14]; // 0x214(0x14)
	bool *fdf9a26995; // 0x228(0x01)
	char pad_229[0x7]; // 0x229(0x07)
	struct USoundClass* SoundClass[0x08]; // 0x230(0x08)
	struct USoundAttenuation* AttenuationSettings[0x08]; // 0x238(0x08)
