...
struct ACrossActor : AStaticMeshActor {
	struct FString *239deb22ac[0x10]; // 0x3f8(0x10)
	struct TArray<struct F*da3fc6fcb8> *8de59d22d8[0x10]; // 0x408(0x10)
	struct TArray<struct F*4c7ad277d8> *c25964cb6a[0x10]; // 0x418(0x10)
...
struct ARoadActor : AActor {
	...
	struct FVector LocalOffset[0x0c]; // 0x3ec(0x0c)
	struct FString *239deb22ac[0x10]; // 0x3f8(0x10)
	struct USplineComponent* Spline[0x08]; // 0x408(0x08)
	int32 *ca1df9feca[0x04]; // 0x410(0x04)
	int32 *862dc237ba[0x04]; // 0x414(0x04)
	struct UStaticMesh* *7e69c4a8ca[0x08]; // 0x418(0x08)
	struct TArray<struct USplineMeshComponent*> *22c75f55a4[0x10]; // 0x420(0x10)
	struct TArray<struct F*6332d153d5> *8de59d22d8[0x10]; // 0x430(0x10)
	struct TArray<struct F*fc659451b0> *c25964cb6a[0x10]; // 0x440(0x10)
	struct TArray<struct F*bad823b6c7> *a45e083a01[0x10]; // 0x450(0x10)
};
