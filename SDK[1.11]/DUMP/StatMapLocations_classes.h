...
struct AStatMapLocations_C : AActor {
	...
	int32 CurrentLocationNumber[0x04]; // 0x3f8(0x04)
	char pad_3FC[0x4]; // 0x3fc(0x04)
	struct FTransform CurrentTransform[0x30]; // 0x400(0x30)
	float DelayBeforeStatCheck[0x04]; // 0x430(0x04)
	char pad_434[0x4]; // 0x434(0x04)
	struct TArray<struct FString> BeginConsoleCommands[0x10]; // 0x438(0x10)
	struct TArray<struct FString> StatGroups[0x10]; // 0x448(0x10)
	float DelayTimeAfterTeleport[0x04]; // 0x458(0x04)
	char pad_45C[0x4]; // 0x45c(0x04)
	struct TArray<struct FString> StatCounterNames[0x10]; // 0x460(0x10)
	struct TArray<struct FString> StatCycleNames[0x10]; // 0x470(0x10)
	struct UStatLocationsWidget_C* StatsWidget[0x08]; // 0x480(0x08)
	struct TArray<struct FString> StatsOutputArray[0x10]; // 0x488(0x10)
	struct TArray<struct FTransform> MapLocations[0x10]; // 0x498(0x10)
	float StartupDelay[0x04]; // 0x4a8(0x04)
