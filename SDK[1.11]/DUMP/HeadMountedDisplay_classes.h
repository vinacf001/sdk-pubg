...
struct U*81cee62a85 : UPrimitiveComponent {
	int32 PlayerIndex[0x04]; // 0x9f8(0x04)
...
struct U*a9e78bafed : UActorComponent {
	struct FMulticastDelegate HMDTrackingInitializingAndNeedsHMDToBeTrackedDelegate[0x10]; // 0x1f0(0x10)
	struct FMulticastDelegate HMDTrackingInitializedDelegate[0x10]; // 0x200(0x10)
	struct FMulticastDelegate HMDRecenteredDelegate[0x10]; // 0x210(0x10)
	struct FMulticastDelegate HMDLostDelegate[0x10]; // 0x220(0x10)
	struct FMulticastDelegate HMDReconnectedDelegate[0x10]; // 0x230(0x10)
	struct FMulticastDelegate HMDConnectCanceledDelegate[0x10]; // 0x240(0x10)
	struct FMulticastDelegate HMDPutOnHeadDelegate[0x10]; // 0x250(0x10)
	struct FMulticastDelegate HMDRemovedFromHeadDelegate[0x10]; // 0x260(0x10)
