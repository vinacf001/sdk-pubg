...
struct UW_RecoilDebug_ShotGroup_C : UUserWidget {
	...
	struct UButton* Button_Absolute[0x08]; // 0x260(0x08)
	struct UButton* Button_Relative[0x08]; // 0x268(0x08)
	struct UButton* Button_RenderBox[0x08]; // 0x270(0x08)
	struct UButton* Button_RenderPoint[0x08]; // 0x278(0x08)
	struct UButton* Button_ZoomIn[0x08]; // 0x280(0x08)
	struct UButton* Button_ZoomOut[0x08]; // 0x288(0x08)
	struct UCanvasPanel* CP_GridList[0x08]; // 0x290(0x08)
	struct UCanvasPanel* CP_PointList[0x08]; // 0x298(0x08)
	struct UImage* Image_2[0x08]; // 0x2a0(0x08)
	struct UImage* Image_3[0x08]; // 0x2a8(0x08)
	struct UImage* Image_6[0x08]; // 0x2b0(0x08)
	struct UImage* Image_7[0x08]; // 0x2b8(0x08)
	struct UImage* Img_PointDrawType[0x08]; // 0x2c0(0x08)
	struct URetainerBox* Retainer_GridPanel[0x08]; // 0x2c8(0x08)
	struct USlider* Slider_50[0x08]; // 0x2d0(0x08)
	struct UImage* SliderBG[0x08]; // 0x2d8(0x08)
	struct UTextBlock* T_PointDrawType[0x08]; // 0x2e0(0x08)
	struct UTextBlock* T_SliderValue[0x08]; // 0x2e8(0x08)
	struct UW_RecoilDebug_Target_GridMarkH_C* W_RecoilDebug_Target_GridMarkH_313[0x08]; // 0x2f0(0x08)
	float PositionScale[0x04]; // 0x2f8(0x04)
	int32 ZoomLevel[0x04]; // 0x2fc(0x04)
	int32 DebugValueType[0x04]; // 0x300(0x04)
	float StepScale[0x04]; // 0x304(0x04)
	int32 DebugRenderType[0x04]; // 0x308(0x04)
	float BoxSizeScale[0x04]; // 0x30c(0x04)
	float VerticalVariationScalar[0x04]; // 0x310(0x04)
	float MaxRangeLimit[0x04]; // 0x314(0x04)
	int32 PointDrawType[0x04]; // 0x318(0x04)
	bool bIsFirstShot; // 0x31c(0x01)
	char pad_31D[0x3]; // 0x31d(0x03)
	struct FVector FirstShotPoint[0x0c]; // 0x320(0x0c)
	int32 ShotGroupDrawIndex[0x04]; // 0x32c(0x04)
