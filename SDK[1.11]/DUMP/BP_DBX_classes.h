...
struct ABP_DBX_C : AVehicleBase_C {
	...
	struct U*9644c8969d* PassengerBRSeat; // 0xff0(0x08)
	struct USphereComponent* Sphere2; // 0xff8(0x08)
	struct U*9644c8969d* PassengerBLSeat; // 0x1000(0x08)
	struct USphereComponent* Sphere1; // 0x1008(0x08)
	struct U*9644c8969d* PassengerFRSeat; // 0x1010(0x08)
	struct USphereComponent* Sphere; // 0x1018(0x08)
	struct U*9644c8969d* DriverSeat; // 0x1020(0x08)

	void UserConstructionScript(); // Function BP_DBX.BP_DBX_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x2cd4ac
};
