...
struct UStatLocationsWidget_C : UUserWidget {
	struct UVerticalBox* VerticalAvgBox[0x08]; // 0x250(0x08)
	struct UVerticalBox* VerticalCallBox[0x08]; // 0x258(0x08)
	struct UVerticalBox* VerticalMaxBox[0x08]; // 0x260(0x08)
	struct UVerticalBox* VerticalStatbox[0x08]; // 0x268(0x08)
	struct FText Stats[0x18]; // 0x270(0x18)
