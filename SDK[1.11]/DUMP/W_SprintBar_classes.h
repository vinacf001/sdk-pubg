...
struct UW_SprintBar_C : UUserWidget {
	...
	struct U*54cc75d10f* SprintIcon_OFF[0x08]; // 0x258(0x08)
	struct U*54cc75d10f* SprintIcon_ON[0x08]; // 0x260(0x08)
	struct U*54cc75d10f* SprintBar_Hide[0x08]; // 0x268(0x08)
	struct U*54cc75d10f* SprintBar_Show[0x08]; // 0x270(0x08)
	struct UCanvasPanel* SprintBar_BG[0x08]; // 0x278(0x08)
	struct UImage* SprintBar_Icon[0x08]; // 0x280(0x08)
	struct UImage* SprintBar_Value[0x08]; // 0x288(0x08)
	float SprintValue[0x04]; // 0x290(0x04)
	float SprintBarWidth[0x04]; // 0x294(0x04)
