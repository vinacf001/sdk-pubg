...
struct AReplayList_BP_C : AActor {
	...
	struct UTslGameInstance* TslGameInstance[0x08]; // 0x3f8(0x08)
	struct UUiReplayList_C* UiReplayList[0x08]; // 0x400(0x08)
	struct FString IsLive[0x10]; // 0x408(0x10)
	struct FText NewVar_1[0x18]; // 0x418(0x18)
	struct FString RegionOrLocal[0x10]; // 0x430(0x10)
	int32 PageSize[0x04]; // 0x440(0x04)
	int32 pageCount[0x04]; // 0x444(0x04)
	float prev_Percent[0x04]; // 0x448(0x04)
	char pad_44C[0x4]; // 0x44c(0x04)
	struct UWidget* CurrentItemWidget[0x08]; // 0x450(0x08)
