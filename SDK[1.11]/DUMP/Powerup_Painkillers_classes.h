...
struct APowerup_Painkillers_C : APowerup_Base_C {
	...
	void CustomEvent_1(); // Function Powerup_Painkillers.Powerup_Painkillers_C.CustomEvent_1 // BlueprintCallable|BlueprintEvent // @ game+0x2cd4ac
	void ReceiveDestroyed(); // Function Powerup_Painkillers.Powerup_Painkillers_C.ReceiveDestroyed // Event|Public|BlueprintEvent // @ game+0x2cd4ac
	struct FName ExecuteUbergraph_Powerup_Painkillers(); // Function Powerup_Painkillers.Powerup_Painkillers_C.ExecuteUbergraph_Powerup_Painkillers // HasDefaults // @ game+0x2cd4ac
};
