...
struct APrefabActor : AActor {
	struct UPrefabComponent* PrefabComponent[0x08]; // 0x3e8(0x08)
	struct FText BackupPrefabCopyData[0x18]; // 0x3f0(0x18)
	bool bKeepMaterialOverrides; // 0x408(0x01)
	bool bKeepTslOverrides; // 0x409(0x01)
	char pad_40A[0x6]; // 0x40a(0x06)
	struct U*7593155b31* BuildingHLOD[0x08]; // 0x410(0x08)
...
struct APrefabLODHolder : APrefabActorHolder {
	struct U*7593155b31* HLODParentComponent[0x08]; // 0x3e8(0x08)
	struct UStaticMesh* LevelLODMesh[0x08]; // 0x3f0(0x08)
};

// Class PrefabAsset.PrefabAsset
// Size: 0x130 (Inherited: 0x28)
struct UPrefabAsset : UObject {
	struct FGuid *ab9c3f9f59[0x10]; // 0x28(0x10)
	struct FText PrefabContent[0x18]; // 0x38(0x18)
	struct FVector PrefabPivot[0x0c]; // 0x50(0x0c)
	char pad_5C[0x4]; // 0x5c(0x04)
	struct FString *78e152a1f9[0x10]; // 0x60(0x10)
	struct TMap<struct FString, struct FStringAssetReference> AssetReferences[0x50]; // 0x70(0x50)
	int32 NumActors[0x04]; // 0xc0(0x04)
	char pad_C4[0x4]; // 0xc4(0x04)
	struct FStringAssetReference *ec36852f13[0x10]; // 0xc8(0x10)
	struct TMap<struct FString, struct F*d0c99cb1dc> *d98e3606eb[0x50]; // 0xd8(0x50)
...
struct APrefabBuildingCreator : AActor {
	...
	struct TArray<struct UPrefabAsset*> PrefabAssetList[0x10]; // 0x3f8(0x10)
	struct TArray<struct UPrefabAsset*> PrefabOverrides[0x10]; // 0x408(0x10)
	bool bUseRoofPrefab; // 0x418(0x01)
	char pad_419[0x7]; // 0x419(0x07)
	struct UPrefabAsset* RoofPrefab[0x08]; // 0x420(0x08)
	struct AActor* SpawnedRoofPrefab[0x08]; // 0x428(0x08)
	struct TArray<struct AActor*> SpawnedPrefabActors[0x10]; // 0x430(0x10)
	float FloorHeight[0x04]; // 0x440(0x04)
	float BaseOffset[0x04]; // 0x444(0x04)
	int32 NumberOfFloors[0x04]; // 0x448(0x04)
...
struct UPrefabComponent : UPrimitiveComponent {
	...
	struct TMap<struct FString, struct F*d0c99cb1dc> ComponentPrefabOverrideMap[0x50]; // 0xa00(0x50)
	struct FVector *dce59dcc87[0x0c]; // 0xa50(0x0c)
	struct FVector *44b0c7b72d[0x0c]; // 0xa5c(0x0c)
	char *b6633313e8 : 1; // 0xa68(0x01)
	char pad_A68_4 : 4; // 0xa68(0x01)
	char pad_A69[0x7]; // 0xa69(0x07)
	struct UBlueprint* GeneratedBlueprint[0x08]; // 0xa70(0x08)
	struct UPrefabAsset* Prefab[0x08]; // 0xa78(0x08)
	struct TMap<struct FName, struct AActor*> PrefabInstancesMap[0x50]; // 0xa80(0x50)
	...
	uint32 HouseID[0x04]; // 0xad8(0x04)
...
struct UPrefabToolSettings : UObject {
	...
	struct FColor PrefabViewVisualizerColor[0x04]; // 0x3c(0x04)
	struct FColor PrefabViewVisualizerColorBaseBuilding[0x04]; // 0x40(0x04)
	struct FColor PrefabViewVisualizerColorDesignItems[0x04]; // 0x44(0x04)
	struct FColor TargetActorColor[0x04]; // 0x48(0x04)
	struct FColor UnLockedConnectedColor[0x04]; // 0x4c(0x04)
	struct FColor LockedConnectedColor[0x04]; // 0x50(0x04)
	struct FColor UnLockedDisConnectedColor[0x04]; // 0x54(0x04)
	struct FColor LockedDisConnectedColor[0x04]; // 0x58(0x04)
	struct FColor UnLockedNoPrefabAssignedColor[0x04]; // 0x5c(0x04)
	struct FColor LockedNoPrefabAssignedColor[0x04]; // 0x60(0x04)
	char pad_64[0x4]; // 0x64(0x04)
	struct FStringAssetReference PrefabMaterialPath[0x10]; // 0x68(0x10)
	struct UMaterial* PrefabMaterial[0x08]; // 0x78(0x08)
