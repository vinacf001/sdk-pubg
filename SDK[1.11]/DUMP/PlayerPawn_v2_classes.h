...
struct APlayerPawn_v2_C : ATslCharacter {
	struct F*abc8f374e0 UberGraphFrame[0x08]; // 0x2d80(0x08)
	struct UPawnNoiseEmitterComponent* PawnNoiseEmitter[0x08]; // 0x2d88(0x08)
	struct UCapsuleComponent* Hit_Prone[0x08]; // 0x2d90(0x08)
	struct UCapsuleComponent* Hit_Stand[0x08]; // 0x2d98(0x08)
	struct F*da672abddc TestInspectHandle[0x08]; // 0x2da0(0x08)
	struct UAnimInstance* BaseAnimInstance[0x08]; // 0x2da8(0x08)
	bool AudioListenerIsSet; // 0x2db0(0x01)
	char pad_2DB1[0x3]; // 0x2db1(0x03)
	float MinVCut[0x04]; // 0x2db4(0x04)
	float MinZVCut[0x04]; // 0x2db8(0x04)
	float DmgFactor[0x04]; // 0x2dbc(0x04)
	float VDampingZ[0x04]; // 0x2dc0(0x04)
	char pad_2DC4[0x4]; // 0x2dc4(0x04)
	struct F*1b4ab4ebac TestWeaponItemClass[0x08]; // 0x2dc8(0x08)
	struct F*1b4ab4ebac TestAmmoItemClass[0x08]; // 0x2dd0(0x08)
	float MaxJumpZVelocity[0x04]; // 0x2dd8(0x04)
	float MovementAfterJumpCounter[0x04]; // 0x2ddc(0x04)
	float MinJumpZVelocity[0x04]; // 0x2de0(0x04)
	float MovementAfterJumpCounterDecrease[0x04]; // 0x2de4(0x04)
	float MaxMovementAfterJumpCounter[0x04]; // 0x2de8(0x04)
	char pad_2DEC[0x4]; // 0x2dec(0x04)
	struct U*59a0aeaef9* Curve_TPP2FPP[0x08]; // 0x2df0(0x08)
	struct U*59a0aeaef9* Curve_FPP2TPP[0x08]; // 0x2df8(0x08)
	struct U*59a0aeaef9* Curve_TPP2FPP_Pitch[0x08]; // 0x2e00(0x08)
	struct U*59a0aeaef9* Curve_FPP2TPP_Pitch[0x08]; // 0x2e08(0x08)
	bool bIsWeaponShoulderAttached; // 0x2e10(0x01)
	char pad_2E11[0x3]; // 0x2e11(0x03)
	float ADS_ReadyAngle[0x04]; // 0x2e14(0x04)
	float SocketOffset_YZ[0x04]; // 0x2e18(0x04)
	char pad_2E1C[0x4]; // 0x2e1c(0x04)
	struct ATslWeapon_Gun* ActiveGunRef[0x08]; // 0x2e20(0x08)
	bool bCameraUnderWater; // 0x2e28(0x01)
	char pad_2E29[0x7]; // 0x2e29(0x07)
	struct ABP_CameraMan_C* CameraManRef[0x08]; // 0x2e30(0x08)
	float YawTarget[0x04]; // 0x2e38(0x04)
	float YawStep[0x04]; // 0x2e3c(0x04)
	float GameTime[0x04]; // 0x2e40(0x04)
	char pad_2E44[0x4]; // 0x2e44(0x04)
	struct U*50a4472fea* Shake[0x08]; // 0x2e48(0x08)
	float WeaponCollisionAlpha[0x04]; // 0x2e50(0x04)
	char pad_2E54[0x4]; // 0x2e54(0x04)
	struct UW_SprintBar_C* SprintBarWidget[0x08]; // 0x2e58(0x08)
	struct UStaticMeshComponent* ImpactMeshRef[0x08]; // 0x2e60(0x08)
	bool HeavyFallStarted; // 0x2e68(0x01)
	bool PhysicalAnimationInitialized; // 0x2e69(0x01)
	char pad_2E6A[0x6]; // 0x2e6a(0x06)
	struct AAudioTestActor_C* AudioActorRef[0x08]; // 0x2e70(0x08)
	struct UCurveFloat* Curve_EjectDamage[0x08]; // 0x2e78(0x08)
	struct ABP_BulletCamActor_C* WeaponBulletCamRef[0x08]; // 0x2e80(0x08)
	struct UW_WeaponMenu_C* WeapMenuRef[0x08]; // 0x2e88(0x08)
	struct ABP_ActiveRagdollActor_C* RagdollActorRef[0x08]; // 0x2e90(0x08)
	struct FVector RagdollActorPos[0x0c]; // 0x2e98(0x0c)
	char pad_2EA4[0x4]; // 0x2ea4(0x04)
	struct UW_RecoilDebugMenu_C* RecoilMenuRef[0x08]; // 0x2ea8(0x08)
	struct TArray<struct FName> DistributedLoadout[0x10]; // 0x2eb0(0x10)
	struct F*dbf31c1c98 AudioTestClassString[0x10]; // 0x2ec0(0x10)
	struct UW_AIItemMenu_C* aiWeapMenu[0x08]; // 0x2ed0(0x08)
