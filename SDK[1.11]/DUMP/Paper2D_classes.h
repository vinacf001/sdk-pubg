...
struct U*5d3297a495 : U*54c410c5a3 {
	...
	int32 *2dd9ac5ff0[0x04]; // 0x20c(0x04)
	struct FText *134e992bed[0x18]; // 0x210(0x18)
};

// Class Paper2D.PaperCharacter
// Size: 0x870 (Inherited: 0x860)
struct APaperCharacter : ACharacter {
	struct UPaperFlipbookComponent* Sprite[0x08]; // 0x860(0x08)
...
struct UPaperFlipbook : UObject {
	float FramesPerSecond[0x04]; // 0x28(0x04)
	char pad_2C[0x4]; // 0x2c(0x04)
	struct TArray<struct F*489eb0edd9> KeyFrames[0x10]; // 0x30(0x10)
	struct UMaterialInterface* DefaultMaterial[0x08]; // 0x40(0x08)
...
struct APaperFlipbookActor : AActor {
	struct UPaperFlipbookComponent* RenderComponent[0x08]; // 0x3e8(0x08)
};

// Class Paper2D.PaperFlipbookComponent
// Size: 0xb50 (Inherited: 0xb00)
struct UPaperFlipbookComponent : UMeshComponent {
	struct UPaperFlipbook* *07f2507db0[0x08]; // 0xb00(0x08)
	struct UMaterialInterface* Material[0x08]; // 0xb08(0x08)
	float PlayRate[0x04]; // 0xb10(0x04)
	...
	float *96b530bb58[0x04]; // 0xb18(0x04)
	int32 *7278c3ed3c[0x04]; // 0xb1c(0x04)
	struct FLinearColor SpriteColor[0x10]; // 0xb20(0x10)
	struct UBodySetup* *d652a4445b[0x08]; // 0xb30(0x08)
	struct FMulticastDelegate OnFinishedPlaying[0x10]; // 0xb38(0x10)
...
struct APaperGroupedSpriteActor : AActor {
	struct U*11b81ab22f* RenderComponent[0x08]; // 0x3e8(0x08)
};

// Class Paper2D.*11b81ab22f
// Size: 0xb30 (Inherited: 0xb00)
struct U*11b81ab22f : UMeshComponent {
	struct TArray<struct UMaterialInterface*> *5f6de5d74a[0x10]; // 0xb00(0x10)
	struct TArray<struct F*8d05613588> *5ac63db397[0x10]; // 0xb10(0x10)
...
struct UPaperSprite : UObject {
	...
	struct FVector2D SourceUV[0x08]; // 0x38(0x08)
	struct FVector2D SourceDimension[0x08]; // 0x40(0x08)
	struct UTexture2D* SourceTexture[0x08]; // 0x48(0x08)
	struct TArray<struct UTexture*> *7d2f934b1e[0x10]; // 0x50(0x10)
	struct FVector2D *cf48dd68e8[0x08]; // 0x60(0x08)
	struct FVector2D *daea98e6b5[0x08]; // 0x68(0x08)
	struct UTexture2D* *7e80aabd2a[0x08]; // 0x70(0x08)
	struct UMaterialInterface* DefaultMaterial[0x08]; // 0x78(0x08)
	struct UMaterialInterface* AlternateMaterial[0x08]; // 0x80(0x08)
	struct TArray<struct F*c0f76242e4> Sockets[0x10]; // 0x88(0x10)
	enum class ESpriteCollisionMode *a3fcfa90e3; // 0x98(0x01)
	char pad_99[0x3]; // 0x99(0x03)
	float *72d61e87a7[0x04]; // 0x9c(0x04)
	struct UBodySetup* BodySetup[0x08]; // 0xa0(0x08)
	int32 *ed657c59be[0x04]; // 0xa8(0x04)
	char pad_AC[0x4]; // 0xac(0x04)
	struct TArray<struct FVector4> *96e12e6874[0x10]; // 0xb0(0x10)
};

// Class Paper2D.PaperSpriteActor
// Size: 0x3f0 (Inherited: 0x3e8)
struct APaperSpriteActor : AActor {
	struct UPaperSpriteComponent* RenderComponent[0x08]; // 0x3e8(0x08)
};
...
struct UPaperSpriteComponent : UMeshComponent {
	struct UPaperSprite* SourceSprite[0x08]; // 0xb00(0x08)
	struct UMaterialInterface* MaterialOverride[0x08]; // 0xb08(0x08)
	struct FLinearColor SpriteColor[0x10]; // 0xb10(0x10)
...
struct APaperTerrainActor : AActor {
	struct USceneComponent* *22ecb5cdbf[0x08]; // 0x3e8(0x08)
	struct U*caa1187fc5* SplineComponent[0x08]; // 0x3f0(0x08)
	struct UPaperTerrainComponent* RenderComponent[0x08]; // 0x3f8(0x08)
};

// Class Paper2D.PaperTerrainComponent
// Size: 0xa50 (Inherited: 0xa00)
struct UPaperTerrainComponent : UPrimitiveComponent {
	struct UPaperTerrainMaterial* TerrainMaterial[0x08]; // 0x9f8(0x08)
	bool bClosedSpline; // 0xa00(0x01)
	bool bFilledSpline; // 0xa01(0x01)
	struct U*caa1187fc5* *8825e4ec83[0x08]; // 0xa08(0x08)
	int32 RandomSeed[0x04]; // 0xa10(0x04)
	float *20bff1d4f7[0x04]; // 0xa14(0x04)
	struct FLinearColor TerrainColor[0x10]; // 0xa18(0x10)
	int32 *b2fc378f11[0x04]; // 0xa28(0x04)
	enum class ESpriteCollisionMode *a3fcfa90e3; // 0xa2c(0x01)
	char pad_A2F[0x1]; // 0xa2f(0x01)
	float *0874902f89[0x04]; // 0xa30(0x04)
	char pad_A34[0x4]; // 0xa34(0x04)
	struct UBodySetup* *d652a4445b[0x08]; // 0xa38(0x08)
...
struct UPaperTerrainMaterial : UDataAsset {
	struct TArray<struct F*60281822b6> Rules[0x10]; // 0x30(0x10)
	struct UPaperSprite* *7e9a84ad9e[0x08]; // 0x40(0x08)
};
...
struct U*292d744149 : UObject {
	struct FText LayerName[0x18]; // 0x28(0x18)
	int32 LayerWidth[0x04]; // 0x40(0x04)
	int32 LayerHeight[0x04]; // 0x44(0x04)
	...
	float CollisionThicknessOverride[0x04]; // 0x4c(0x04)
	float CollisionOffsetOverride[0x04]; // 0x50(0x04)
	struct FLinearColor LayerColor[0x10]; // 0x54(0x10)
	int32 *12405fcf05[0x04]; // 0x64(0x04)
	int32 *5749e18c65[0x04]; // 0x68(0x04)
	char pad_6C[0x4]; // 0x6c(0x04)
	struct TArray<struct F*fda10ad7e1> *e92e172c9d[0x10]; // 0x70(0x10)
	struct UPaperTileSet* TileSet[0x08]; // 0x80(0x08)
	struct TArray<int32> AllocatedGrid[0x10]; // 0x88(0x10)
};

// Class Paper2D.PaperTileMap
// Size: 0xa0 (Inherited: 0x28)
struct UPaperTileMap : UObject {
	int32 MapWidth[0x04]; // 0x28(0x04)
	int32 MapHeight[0x04]; // 0x2c(0x04)
	int32 TileWidth[0x04]; // 0x30(0x04)
	int32 TileHeight[0x04]; // 0x34(0x04)
	float *72d61e87a7[0x04]; // 0x38(0x04)
	float *e7f0cd6653[0x04]; // 0x3c(0x04)
	float *85f3fc7b98[0x04]; // 0x40(0x04)
	float SeparationPerLayer[0x04]; // 0x44(0x04)
	struct UPaperTileSet* *2f6aac0b16[0x20]; // 0x48(0x20)
	struct UMaterialInterface* Material[0x08]; // 0x68(0x08)
	struct TArray<struct U*292d744149*> TileLayers[0x10]; // 0x70(0x10)
	float CollisionThickness[0x04]; // 0x80(0x04)
	...
	int32 HexSideLength[0x04]; // 0x88(0x04)
	char pad_8C[0x4]; // 0x8c(0x04)
	struct UBodySetup* BodySetup[0x08]; // 0x90(0x08)
	int32 *9f12062bf3[0x04]; // 0x98(0x04)
...
struct APaperTileMapActor : AActor {
	struct UPaperTileMapComponent* RenderComponent[0x08]; // 0x3e8(0x08)
};

// Class Paper2D.PaperTileMapComponent
// Size: 0xb50 (Inherited: 0xb00)
struct UPaperTileMapComponent : UMeshComponent {
	int32 MapWidth[0x04]; // 0xb00(0x04)
	int32 MapHeight[0x04]; // 0xb04(0x04)
	int32 TileWidth[0x04]; // 0xb08(0x04)
	int32 TileHeight[0x04]; // 0xb0c(0x04)
	struct UPaperTileSet* DefaultLayerTileSet[0x08]; // 0xb10(0x08)
	struct UMaterialInterface* Material[0x08]; // 0xb18(0x08)
	struct TArray<struct U*292d744149*> TileLayers[0x10]; // 0xb20(0x10)
	struct FLinearColor *2c9b92e666[0x10]; // 0xb30(0x10)
	int32 *03f2e8513b[0x04]; // 0xb40(0x04)
	bool *d4c212717f; // 0xb44(0x01)
	char pad_B45[0x3]; // 0xb45(0x03)
	struct UPaperTileMap* TileMap[0x08]; // 0xb48(0x08)
...
struct UPaperTileSet : UObject {
	struct FIntPoint TileSize[0x08]; // 0x28(0x08)
	struct UTexture2D* TileSheet[0x08]; // 0x30(0x08)
	struct F*3aa79f8329 BorderMargin[0x10]; // 0x38(0x10)
	struct FIntPoint PerTileSpacing[0x08]; // 0x48(0x08)
	struct FIntPoint DrawingOffset[0x08]; // 0x50(0x08)
	int32 *9078fc69de[0x04]; // 0x58(0x04)
	int32 *f3a0a0b0b3[0x04]; // 0x5c(0x04)
	int32 *12405fcf05[0x04]; // 0x60(0x04)
	int32 *5749e18c65[0x04]; // 0x64(0x04)
	struct TArray<struct F*f278ae409e> PerTileData[0x10]; // 0x68(0x10)
	struct TArray<struct F*0483626ec2> Terrains[0x10]; // 0x78(0x10)
	int32 TileWidth[0x04]; // 0x88(0x04)
	int32 TileHeight[0x04]; // 0x8c(0x04)
	int32 Margin[0x04]; // 0x90(0x04)
	int32 Spacing[0x04]; // 0x94(0x04)
};
