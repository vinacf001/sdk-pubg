...
struct U*6681f0e447 : UObject {
	struct FString UserDescription[0x10]; // 0x28(0x10)
	char pad_38[0x10]; // 0x38(0x10)
	struct U*114cd936f5* *3207a609f9[0x08]; // 0x48(0x08)
	struct FGameplayTagQuery TagQueryExportText_Helper[0x48]; // 0x50(0x48)
};
...
struct U*3d7aa209b7 : U*114cd936f5 {
	struct FGameplayTagContainer Tags[0x20]; // 0x28(0x20)
};
...
struct U*dcc514c310 : U*114cd936f5 {
	struct TArray<struct U*114cd936f5*> Expressions[0x10]; // 0x28(0x10)
};
...
struct U*a090700d19 : UObject {
	...
	struct TArray<struct F*1fd0190e0b> *077e44d442[0x10]; // 0xa8(0x10)
	char pad_B8[0x68]; // 0xb8(0x68)
	struct TArray<struct UDataTable*> *5a224f78f6[0x10]; // 0x120(0x10)
...
struct UGameplayTagsList : UObject {
	struct FString *70a127b1c0[0x10]; // 0x28(0x10)
	struct TArray<struct F*06a658789a> GameplayTagList[0x10]; // 0x38(0x10)
};
...
struct UGameplayTagsSettings : UGameplayTagsList {
	...
	struct TArray<struct F*d96f513953> CategoryRemapping[0x10]; // 0x50(0x10)
	bool FastReplication; // 0x60(0x01)
	char pad_61[0x7]; // 0x61(0x07)
	struct TArray<struct FStringAssetReference> GameplayTagTableList[0x10]; // 0x68(0x10)
	struct TArray<struct F*3a30957ba5> GameplayTagRedirects[0x10]; // 0x78(0x10)
	struct TArray<struct FName> CommonlyReplicatedTags[0x10]; // 0x88(0x10)
	int32 NumBitsForContainerSize[0x04]; // 0x98(0x04)
	int32 NetIndexFirstBitSegment[0x04]; // 0x9c(0x04)
};

// Class GameplayTags.GameplayTagsDeveloperSettings
// Size: 0x38 (Inherited: 0x28)
struct UGameplayTagsDeveloperSettings : UObject {
	struct FString DeveloperConfigName[0x10]; // 0x28(0x10)
};
