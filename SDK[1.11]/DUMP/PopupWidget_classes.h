...
struct UPopupWidget_C : U*a00fdddd1f {
	struct F*abc8f374e0 UberGraphFrame; // 0x528(0x08)
	struct U*54cc75d10f* PopupEmerging; // 0x530(0x08)
	struct UHorizontalBox* GamepadButtonCancel; // 0x538(0x08)
	struct UHorizontalBox* GamepadButtonOK; // 0x540(0x08)
	struct U*290fc681a4* TslUniversalInputVisibilitySwitcher_1; // 0x548(0x08)
