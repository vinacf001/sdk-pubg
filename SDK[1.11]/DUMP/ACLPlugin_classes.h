...
struct U*ecaa10e490 : U*83905c7eb2 {
	...
	float *9598ff5361; // 0x4c(0x04)
	float *52dfab0903; // 0x50(0x04)
	float *99d1f717d9; // 0x54(0x04)
	float *c0c7a3d0d0; // 0x58(0x04)
...
struct U*7b003d30ca : U*83905c7eb2 {
	float *9598ff5361; // 0x48(0x04)
	float *52dfab0903; // 0x4c(0x04)
	...
	float *c0c7a3d0d0; // 0x54(0x04)
	float *63786ce313; // 0x58(0x04)
	float *5b131163be; // 0x5c(0x04)
	float *f029f92952; // 0x60(0x04)
	...
	uint16 *104b796b26; // 0x68(0x02)
	uint16 *ea6396fd3e; // 0x6a(0x02)
