...
struct U*2312e04442 : UHierarchicalInstancedStaticMeshComponent {
	struct FMulticastDelegate OnInstanceTakePointDamage[0x10]; // 0xda8(0x10)
	struct FMulticastDelegate OnInstanceTakeRadialDamage[0x10]; // 0xdb8(0x10)
};
...
struct UFoliageType : UObject {
	struct FGuid *0c361bc6a3[0x10]; // 0x28(0x10)
	float Density[0x04]; // 0x38(0x04)
	float *1badf58b71[0x04]; // 0x3c(0x04)
	float Radius[0x04]; // 0x40(0x04)
	enum class EFoliageScaling Scaling; // 0x44(0x01)
	char pad_45[0x3]; // 0x45(0x03)
	struct FFloatInterval ScaleX[0x08]; // 0x48(0x08)
	struct FFloatInterval ScaleY[0x08]; // 0x50(0x08)
	struct FFloatInterval ScaleZ[0x08]; // 0x58(0x08)
	struct F*8088cd7e9b *25f5d4a4d8[0x0c]; // 0x60(0x30)
	enum class FoliageVertexColorMask VertexColorMask; // 0x90(0x01)
	char pad_91[0x3]; // 0x91(0x03)
	float VertexColorMaskThreshold[0x04]; // 0x94(0x04)
	char VertexColorMaskInvert : 1; // 0x98(0x01)
	char pad_98_1 : 7; // 0x98(0x01)
	char pad_99[0x3]; // 0x99(0x03)
	struct FFloatInterval *1e009b5180[0x08]; // 0x9c(0x08)
	char AlignToNormal : 1; // 0xa4(0x01)
	char pad_A4_1 : 7; // 0xa4(0x01)
	char pad_A5[0x3]; // 0xa5(0x03)
	float *3205f2e2a3[0x04]; // 0xa8(0x04)
	char *f8bdd84665 : 1; // 0xac(0x01)
	char pad_AC_1 : 7; // 0xac(0x01)
	char pad_AD[0x3]; // 0xad(0x03)
	float *459a588fca[0x04]; // 0xb0(0x04)
	struct FFloatInterval *200ac50c38[0x08]; // 0xb4(0x08)
	struct FFloatInterval Height[0x08]; // 0xbc(0x08)
	char pad_C4[0x4]; // 0xc4(0x04)
	struct TArray<struct FName> LandscapeLayers[0x10]; // 0xc8(0x10)
	struct FName LandscapeLayer[0x08]; // 0xd8(0x08)
	char CollisionWithWorld : 1; // 0xe0(0x01)
	char pad_E0_1 : 7; // 0xe0(0x01)
	char pad_E1[0x3]; // 0xe1(0x03)
	struct FVector *b17cccdb80[0x0c]; // 0xe4(0x0c)
	float *ed6a819e24[0x04]; // 0xf0(0x04)
	struct FBoxSphereBounds *6aa6417be5[0x1c]; // 0xf4(0x1c)
	struct FVector *63fa54fa87[0x0c]; // 0x110(0x0c)
	enum class EComponentMobility Mobility; // 0x11c(0x01)
	char pad_11D[0x3]; // 0x11d(0x03)
	struct FInt32Interval CullDistance[0x08]; // 0x120(0x08)
	...
	int32 OverriddenLightMapRes[0x04]; // 0x12c(0x04)
	...
	int32 CustomDepthStencilValue[0x04]; // 0x134(0x04)
	...
	struct FLightingChannels LightingChannels[0x03]; // 0x13e(0x03)
	char pad_141[0xf]; // 0x141(0x0f)
	struct FBodyInstance BodyInstance[0x230]; // 0x150(0x230)
	float *8dbb45714e[0x04]; // 0x380(0x04)
	float *ce73f4073f[0x04]; // 0x384(0x04)
	int32 *1051228a6b[0x04]; // 0x388(0x04)
	float *2f6886a4c3[0x04]; // 0x38c(0x04)
	float *1201615545[0x04]; // 0x390(0x04)
	float *601e407a76[0x04]; // 0x394(0x04)
	int32 *535cf7aca7[0x04]; // 0x398(0x04)
	int32 *e58643ee94[0x04]; // 0x39c(0x04)
	float *b8f4941a24[0x04]; // 0x3a0(0x04)
	bool bCanGrowInShade; // 0x3a4(0x01)
	bool bSpawnsInShade; // 0x3a5(0x01)
	char pad_3A6[0x2]; // 0x3a6(0x02)
	float MaxInitialAge[0x04]; // 0x3a8(0x04)
	float MaxAge[0x04]; // 0x3ac(0x04)
	float *e5755ec720[0x04]; // 0x3b0(0x04)
	struct FFloatInterval *8fbc5e6696[0x08]; // 0x3b4(0x08)
	char pad_3BC[0x4]; // 0x3bc(0x04)
	struct FRuntimeFloatCurve *0ee2e9841f[0x78]; // 0x3c0(0x78)
	int32 *c16ed9db17[0x04]; // 0x438(0x04)
...
struct UFoliageType_InstancedStaticMesh : UFoliageType {
	struct UStaticMesh* Mesh[0x08]; // 0x440(0x08)
	struct TArray<struct UMaterialInterface*> OverrideMaterials[0x10]; // 0x448(0x10)
	struct UClass* ComponentClass[0x08]; // 0x458(0x08)
};
...
struct AInteractiveFoliageActor : AStaticMeshActor {
	...
	struct FVector *fe59ef3398[0x0c]; // 0x400(0x0c)
	struct FVector *dbcabce038[0x0c]; // 0x40c(0x0c)
	struct FVector *f543c89244[0x0c]; // 0x418(0x0c)
	struct FVector *939f237751[0x0c]; // 0x424(0x0c)
	float FoliageDamageImpulseScale[0x04]; // 0x430(0x04)
	float FoliageTouchImpulseScale[0x04]; // 0x434(0x04)
	float FoliageStiffness[0x04]; // 0x438(0x04)
	float FoliageStiffnessQuadratic[0x04]; // 0x43c(0x04)
	float FoliageDamping[0x04]; // 0x440(0x04)
	float MaxDamageImpulse[0x04]; // 0x444(0x04)
	float MaxTouchImpulse[0x04]; // 0x448(0x04)
	float MaxForce[0x04]; // 0x44c(0x04)
	float Mass[0x04]; // 0x450(0x04)
...
struct AProceduralFoliageBlockingVolume : AVolume {
	struct AProceduralFoliageVolume* ProceduralFoliageVolume[0x08]; // 0x420(0x08)
};

// Class Foliage.ProceduralFoliageComponent
// Size: 0x220 (Inherited: 0x1f0)
struct UProceduralFoliageComponent : UActorComponent {
	struct UProceduralFoliageSpawner* FoliageSpawner[0x08]; // 0x1f0(0x08)
	float TileOverlap[0x04]; // 0x1f8(0x04)
	char pad_1FC[0x4]; // 0x1fc(0x04)
	struct AVolume* SpawningVolume[0x08]; // 0x200(0x08)
	struct FGuid *c6948e5923[0x10]; // 0x208(0x10)
...
struct UProceduralFoliageSpawner : UObject {
	int32 RandomSeed[0x04]; // 0x28(0x04)
	float TileSize[0x04]; // 0x2c(0x04)
	int32 NumUniqueTiles[0x04]; // 0x30(0x04)
	float MinimumQuadTreeSize[0x04]; // 0x34(0x04)
	char pad_38[0x8]; // 0x38(0x08)
	struct TArray<struct FFoliageTypeObject> FoliageTypes[0x10]; // 0x40(0x10)
...
struct U*7dbd3e3567 : UObject {
	struct UProceduralFoliageSpawner* FoliageSpawner[0x08]; // 0x28(0x08)
	char pad_30[0xa0]; // 0x30(0xa0)
	struct TArray<struct F*25271daf79> *bb3fbf778b[0x10]; // 0xd0(0x10)
...
struct AProceduralFoliageVolume : AVolume {
	struct UProceduralFoliageComponent* ProceduralComponent[0x08]; // 0x420(0x08)
};
