...
struct U*f1b96e3e95 : U*059f6ca67c {
	...
	struct F*a8e749b2bc Settings[0x28]; // 0x90(0x28)
...
struct U*90f5ea8fea : U*059f6ca67c {
	...
	struct F*6bc1291df3 Settings[0x30]; // 0x98(0x30)
...
struct U*076c606631 : U*059f6ca67c {
	...
	struct F*68bb90b557 Settings[0x10]; // 0x78(0x10)
...
struct U*5fbd5ae5d1 : USceneComponent {
	...
	struct USoundAttenuation* AttenuationSettings[0x08]; // 0x4d8(0x08)
	struct FSoundAttenuationSettings AttenuationOverrides[0x130]; // 0x4e0(0x130)
	struct USoundConcurrency* ConcurrencySettings[0x08]; // 0x610(0x08)
	struct USoundClass* SoundClass[0x08]; // 0x618(0x08)
	struct U*065aab1e6f* SourceEffectChain[0x08]; // 0x620(0x08)
	float DefaultMasterReverbSendAmount[0x04]; // 0x628(0x04)
	char pad_62C[0x4]; // 0x62c(0x04)
	struct USoundSubmix* SoundSubmix[0x08]; // 0x630(0x08)
	struct TArray<struct F*dbabf904cf> SoundSubmixSends[0x10]; // 0x638(0x10)
	char pad_648[0x8]; // 0x648(0x08)
	struct U*4a082db300* Synth[0x08]; // 0x650(0x08)
	struct UAudioComponent* AudioComponent[0x08]; // 0x658(0x08)
