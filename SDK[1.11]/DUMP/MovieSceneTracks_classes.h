...
struct U*655652a152 : UMovieSceneSection {
	struct FGuid *80e1c02e1a[0x10]; // 0xd0(0x10)
};

// Class MovieSceneTracks.*63609a2c0e
// Size: 0x100 (Inherited: 0xe0)
struct U*63609a2c0e : U*655652a152 {
	struct FName *d373ab65c0[0x08]; // 0xe0(0x08)
	struct FName *1a9619f01d[0x08]; // 0xe8(0x08)
...
struct U*d4bc644f51 : U*655652a152 {
	struct FRichCurve *ef9296323d[0x70]; // 0xe0(0x70)
...
struct UMovieScene3DConstraintTrack : UMovieSceneTrack {
	struct TArray<struct UMovieSceneSection*> *82c5729088[0x10]; // 0xb8(0x10)
};
...
struct UMovieScene3DTransformSection : UMovieSceneSection {
	...
	struct FRichCurve Translation[0x70]; // 0xd8(0x150)
	struct FRichCurve Rotation[0x70]; // 0x228(0x150)
	struct FRichCurve Scale[0x70]; // 0x378(0x150)
...
struct U*539faa5c1a : UMovieSceneSection {
	char pad_D0[0x8]; // 0xd0(0x08)
	struct F*a422f9d4ff *90771a3ffe[0x70]; // 0xd8(0x70)
	char pad_148[0x10]; // 0x148(0x10)
	struct TArray<struct FString> *7ad6383a5a[0x10]; // 0x158(0x10)
...
struct UMovieSceneAudioSection : UMovieSceneSection {
	struct USoundBase* Sound[0x08]; // 0xd0(0x08)
	float StartOffset[0x04]; // 0xd8(0x04)
	float AudioStartTime[0x04]; // 0xdc(0x04)
	float AudioDilationFactor[0x04]; // 0xe0(0x04)
	float AudioVolume[0x04]; // 0xe4(0x04)
	struct FRichCurve *66201586d9[0x70]; // 0xe8(0x70)
	struct FRichCurve *a785000e4c[0x70]; // 0x158(0x70)
	bool *ef89b4e1fa; // 0x1c8(0x01)
	char pad_1C9[0x7]; // 0x1c9(0x07)
	DelegateProperty *2b3f413ec8[0x10]; // 0x1d0(0x10)
	struct FMulticastDelegate *319260c8a8[0x10]; // 0x1e0(0x10)
	struct FMulticastDelegate *ad534c7196[0x10]; // 0x1f0(0x10)
};

// Class MovieSceneTracks.MovieSceneAudioTrack
// Size: 0xd0 (Inherited: 0xc0)
struct UMovieSceneAudioTrack : UMovieSceneNameableTrack {
	struct TArray<struct UMovieSceneSection*> *c29301c4d4[0x10]; // 0xb8(0x10)
};
...
struct UMovieSceneBoolSection : UMovieSceneSection {
	...
	struct F*a422f9d4ff *e769e648e6[0x70]; // 0xe0(0x70)
};
...
struct UMovieSceneByteSection : UMovieSceneSection {
	char pad_D0[0x8]; // 0xd0(0x08)
	struct F*a422f9d4ff *1c59b21309[0x70]; // 0xd8(0x70)
...
struct U*e84d3815fa : UMovieSceneSection {
	struct F*8d8f974b0b *16df726153[0x20]; // 0xd0(0x20)
	struct UCameraAnim* CameraAnim[0x08]; // 0xf0(0x08)
	float PlayRate[0x04]; // 0xf8(0x04)
	float PlayScale[0x04]; // 0xfc(0x04)
	float BlendInTime[0x04]; // 0x100(0x04)
	float BlendOutTime[0x04]; // 0x104(0x04)
...
struct UMovieSceneCameraAnimTrack : UMovieSceneNameableTrack {
	struct TArray<struct UMovieSceneSection*> *b1a8a95e0f[0x10]; // 0xb8(0x10)
};

// Class MovieSceneTracks.MovieSceneCameraCutSection
// Size: 0xe0 (Inherited: 0xd0)
struct UMovieSceneCameraCutSection : UMovieSceneSection {
	struct FGuid *a2333c5817[0x10]; // 0xd0(0x10)
};
...
struct U*1552c9999f : UMovieSceneSection {
	struct F*99422fccd2 *4928b8dcbb[0x20]; // 0xd0(0x20)
	struct UClass* ShakeClass[0x08]; // 0xf0(0x08)
	float PlayScale[0x04]; // 0xf8(0x04)
	enum class ECameraAnimPlaySpace PlaySpace; // 0xfc(0x01)
	char pad_FD[0x3]; // 0xfd(0x03)
	struct FRotator UserDefinedPlaySpace[0x0c]; // 0x100(0x0c)
...
struct UMovieSceneCameraShakeTrack : UMovieSceneNameableTrack {
	struct TArray<struct UMovieSceneSection*> *37e30fde27[0x10]; // 0xb8(0x10)
};
...
struct UMovieSceneColorSection : UMovieSceneSection {
	char pad_D0[0x8]; // 0xd0(0x08)
	struct FRichCurve *ce07ec0a99[0x70]; // 0xd8(0x70)
	struct FRichCurve *ecb940efc5[0x70]; // 0x148(0x70)
	struct FRichCurve *48d16680d2[0x70]; // 0x1b8(0x70)
	struct FRichCurve *7b49fabe25[0x70]; // 0x228(0x70)
...
struct U*4f79b7d540 : UMovieSceneSection {
	char pad_D0[0x8]; // 0xd0(0x08)
	struct F*a422f9d4ff *0df0f3f9db[0x70]; // 0xd8(0x70)
	char pad_148[0x8]; // 0x148(0x08)
};
...
struct U*f4d5ee3c4c : UMovieSceneSection {
	struct F*3bbfdcfb3f Events[0x68]; // 0xd0(0x68)
	struct F*127da3598a EventData[0x20]; // 0x138(0x20)
...
struct UMovieSceneSpawnTrack : UMovieSceneTrack {
	struct TArray<struct UMovieSceneSection*> Sections[0x10]; // 0xb8(0x10)
	struct FGuid *bdbe008281[0x10]; // 0xc8(0x10)
};
...
struct UMovieSceneEventTrack : UMovieSceneNameableTrack {
	...
	struct TArray<struct FMovieSceneObjectBindingID> EventReceivers[0x10]; // 0xc0(0x10)
	struct TArray<struct UMovieSceneSection*> Sections[0x10]; // 0xd0(0x10)
};
...
struct UMovieSceneFloatSection : UMovieSceneSection {
	char pad_D0[0x8]; // 0xd0(0x08)
	struct FRichCurve *e7fc2b8ab7[0x70]; // 0xd8(0x70)
	char pad_148[0x8]; // 0x148(0x08)
};
...
struct U*5b6b7d83ec : UMovieSceneFloatSection {
	struct FLinearColor *59ad6910df[0x10]; // 0x148(0x10)
...
struct U*a420432707 : UMovieSceneSection {
	char pad_D0[0x8]; // 0xd0(0x08)
	struct F*a422f9d4ff *03937a0b98[0x70]; // 0xd8(0x70)
	char pad_148[0x8]; // 0x148(0x08)
};
...
struct U*9688205de6 : UMovieSceneSection {
	...
	struct TArray<struct FName> *33f67d2b24[0x10]; // 0xd8(0x10)
...
struct UMovieScenePropertyTrack : UMovieSceneNameableTrack {
	struct FName PropertyName[0x08]; // 0xb8(0x08)
	struct FString PropertyPath[0x10]; // 0xc0(0x10)
	struct TArray<struct UMovieSceneSection*> Sections[0x10]; // 0xd0(0x10)
};
...
struct UMovieSceneParameterSection : UMovieSceneSection {
	struct TArray<struct F*298ca1f497> *fb84226b65[0x10]; // 0xd0(0x10)
	struct TArray<struct F*21fbc1ac13> *2b4145058d[0x10]; // 0xe0(0x10)
	struct TArray<struct F*df788b5612> *cf54cc898d[0x10]; // 0xf0(0x10)
};
...
struct U*71b5fb040b : U*771ec893c5 {
	int32 MaterialIndex[0x04]; // 0xc8(0x04)
};

// Class MovieSceneTracks.MovieSceneMaterialParameterCollectionTrack
// Size: 0xd0 (Inherited: 0xd0)
struct UMovieSceneMaterialParameterCollectionTrack : U*771ec893c5 {
	struct UMaterialParameterCollection* MPC[0x08]; // 0xc8(0x08)
};
...
struct UMovieSceneParticleSection : UMovieSceneSection {
	struct F*a422f9d4ff *e0ead3eac1[0x70]; // 0xd0(0x70)
};

// Class MovieSceneTracks.MovieSceneParticleTrack
// Size: 0xd0 (Inherited: 0xc0)
struct UMovieSceneParticleTrack : UMovieSceneNameableTrack {
	struct TArray<struct UMovieSceneSection*> *7e7d3ed6bd[0x10]; // 0xb8(0x10)
};
...
struct UMovieSceneByteTrack : UMovieScenePropertyTrack {
	struct UEnum* Enum[0x08]; // 0xe0(0x08)
	char pad_E8[0x8]; // 0xe8(0x08)
};
...
struct UMovieSceneVectorTrack : UMovieScenePropertyTrack {
	int32 *57fdae08aa[0x04]; // 0xe0(0x04)
...
struct UMovieSceneSkeletalAnimationSection : UMovieSceneSection {
	struct F*8ed3cfc9a1 Params[0x90]; // 0xd0(0x90)
	struct UAnimSequence* AnimSequence[0x08]; // 0x160(0x08)
	struct UAnimSequenceBase* Animation[0x08]; // 0x168(0x08)
	float StartOffset[0x04]; // 0x170(0x04)
	float EndOffset[0x04]; // 0x174(0x04)
	float PlayRate[0x04]; // 0x178(0x04)
	char bReverse : 1; // 0x17c(0x01)
	char pad_17C_1 : 7; // 0x17c(0x01)
	char pad_17D[0x3]; // 0x17d(0x03)
	struct FName SlotName[0x08]; // 0x180(0x08)
...
struct UMovieSceneSkeletalAnimationTrack : UMovieSceneNameableTrack {
	struct TArray<struct UMovieSceneSection*> *1a0bbe09b9[0x10]; // 0xb8(0x10)
};
...
struct U*c11069c536 : UMovieSceneSection {
	char pad_D0[0x8]; // 0xd0(0x08)
	struct F*754bde3481 *754bde3481[0x78]; // 0xd8(0x78)
};

// Class MovieSceneTracks.*8125bd491e
// Size: 0x140 (Inherited: 0xd0)
struct U*8125bd491e : UMovieSceneSection {
	struct F*2c37a623a9 Parameters[0x14]; // 0xd0(0x14)
	float StartOffset[0x04]; // 0xe4(0x04)
	float TimeScale[0x04]; // 0xe8(0x04)
	float PrerollTime[0x04]; // 0xec(0x04)
	struct UMovieSceneSequence* *1642d070d3[0x08]; // 0xf0(0x08)
	struct AActor* *bcd80804ce[0x1c]; // 0xf8(0x1c)
	char pad_114[0x4]; // 0x114(0x04)
	struct FString *c9f07539cd[0x10]; // 0x118(0x10)
	struct FDirectoryPath *7f737f65d6[0x10]; // 0x128(0x10)
...
struct U*4f7a717dba : U*8125bd491e {
	struct FText DisplayName[0x18]; // 0x138(0x18)
};
...
struct UMovieSceneVectorSection : UMovieSceneSection {
	char pad_D0[0x8]; // 0xd0(0x08)
	struct FRichCurve Curves[0x70]; // 0xd8(0x1c0)
	int32 *30caac472e[0x04]; // 0x298(0x04)
