...
struct ABP_TslBaseLobbySceneTravel_CameraMove_Fast_C : ATslLobbySceneTravel_CameraMove {
	...
	void UserConstructionScript(); // Function BP_TslBaseLobbySceneTravel_CameraMove_Fast.BP_TslBaseLobbySceneTravel_CameraMove_Fast_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x1b829c
};
