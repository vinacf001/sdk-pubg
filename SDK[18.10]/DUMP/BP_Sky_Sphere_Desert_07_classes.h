...
struct ABP_Sky_Sphere_Desert_07_C : AActor {
	...
	struct U*594e4d7ca9* Horizon color curve; // 0x478(0x08)
	struct U*594e4d7ca9* Zenith color curve; // 0x480(0x08)
	struct U*594e4d7ca9* Cloud color curve; // 0x488(0x08)

	struct FLinearColor UpdateSunDirection(); // Function BP_Sky_Sphere_Desert_07.BP_Sky_Sphere_Desert_07_C.UpdateSunDirection // Public|BlueprintCallable|BlueprintEvent // @ game+0x1b829c
	struct FLinearColor UserConstructionScript(); // Function BP_Sky_Sphere_Desert_07.BP_Sky_Sphere_Desert_07_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x1b829c
};
