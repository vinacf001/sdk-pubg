...
struct F*8d8f974b0b {
	...
	float *434e9f9344; // 0x0c(0x04)
	float *4d6467dc71; // 0x10(0x04)
	float *19f3e239cb; // 0x14(0x04)
...
struct F*99422fccd2 {
	...
	float *434e9f9344; // 0x08(0x04)
	enum class ECameraAnimPlaySpace *364bfed6d3; // 0x0c(0x01)
	char pad_D[0x3]; // 0x0d(0x03)
	struct FRotator *63d6d36023; // 0x10(0x0c)
...
// Size: 0x20 (Inherited: 0x00)
struct F*127da3598a {
	struct TArray<float> *c7f2aa9c25; // 0x00(0x10)
	struct TArray<struct FEventPayload> *de049ba847; // 0x10(0x10)
};
...
struct F*df788b5612 {
	...
	struct FRichCurve *ce07ec0a99; // 0x10(0x70)
	struct FRichCurve *ecb940efc5; // 0x80(0x70)
	struct FRichCurve *48d16680d2; // 0xf0(0x70)
	struct FRichCurve *7b49fabe25; // 0x160(0x70)
};
...
struct F*21fbc1ac13 {
	...
	int32 Index; // 0x08(0x04)
	char pad_C[0x4]; // 0x0c(0x04)
	struct FRichCurve *adee3e5a3c; // 0x10(0x70)
	struct FRichCurve *a930f64d80; // 0x80(0x70)
	struct FRichCurve *bd9fb28530; // 0xf0(0x70)
};
...
struct F*298ca1f497 {
	...
	int32 Index; // 0x08(0x04)
	char pad_C[0x4]; // 0x0c(0x04)
	struct FRichCurve *0652bd3d88; // 0x10(0x70)
};
...
struct F*521c9d3efb : F*bb608aaa2f {
	struct TArray<struct F*298ca1f497> *f7717d625f; // 0x18(0x10)
	struct TArray<struct F*21fbc1ac13> Vectors; // 0x28(0x10)
	struct TArray<struct F*df788b5612> Colors; // 0x38(0x10)
};

// ScriptStruct MovieSceneTracks.*59513ec0b1
// Size: 0x88 (Inherited: 0x18)
struct F*59513ec0b1 : F*bb608aaa2f {
	struct F*a422f9d4ff Curve; // 0x18(0x70)
};

// ScriptStruct MovieSceneTracks.*c8714d5657
// Size: 0x38 (Inherited: 0x18)
struct F*c8714d5657 : F*bb608aaa2f {
	struct FGuid *89f093a1a4; // 0x18(0x10)
	struct FName *d373ab65c0; // 0x28(0x08)
	struct FName *1a9619f01d; // 0x30(0x08)
};

// ScriptStruct MovieSceneTracks.*5132e289db
// Size: 0xa0 (Inherited: 0x18)
struct F*5132e289db : F*bb608aaa2f {
	struct FGuid *4413adcf76; // 0x18(0x10)
	struct FRichCurve *ef9296323d; // 0x28(0x70)
...
struct F*51ef9cce13 : F*bb608aaa2f {
	struct FRichCurve *1960b1af8c[0x03]; // 0x18(0x150)
	struct FRichCurve *6eb9b2fb15[0x03]; // 0x168(0x150)
	struct FRichCurve *0ee2e9841f[0x03]; // 0x2b8(0x150)
};
...
struct F*8bc9b8a066 : F*bb608aaa2f {
	...
	struct F*a422f9d4ff *90771a3ffe; // 0x40(0x70)
	struct TArray<struct FGuid> *a309d80663; // 0xb0(0x10)
};

// ScriptStruct MovieSceneTracks.*9aa9e99537
// Size: 0x150 (Inherited: 0x18)
struct F*9aa9e99537 : F*bb608aaa2f {
	struct F*8a563567b1 *c9b45e0812; // 0x18(0x138)
};
...
struct F*8a563567b1 {
	...
	float *a117829d7c; // 0x08(0x04)
	struct FFloatRange *3f07221c79; // 0x0c(0x10)
	char pad_1C[0x4]; // 0x1c(0x04)
	struct FRichCurve *dcfa131bbe; // 0x20(0x70)
	struct FRichCurve *b1d40a50ff; // 0x90(0x70)
	int32 *3a3a453816; // 0x100(0x04)
	char pad_104[0x4]; // 0x104(0x04)
	DelegateProperty *2b3f413ec8; // 0x108(0x10)
	struct FMulticastDelegate *319260c8a8; // 0x118(0x10)
	struct FMulticastDelegate *ad534c7196; // 0x128(0x10)
};
...
struct F*e3b4abc97a : F*c449b0474a {
	struct F*99422fccd2 *a88ca1f9f2; // 0x18(0x20)
	float *890330df50; // 0x38(0x04)
...
struct F*7e8c1b4c65 : F*c449b0474a {
	struct F*8d8f974b0b *a88ca1f9f2; // 0x18(0x20)
	float *890330df50; // 0x38(0x04)
	char pad_3C[0x4]; // 0x3c(0x04)
};
...
struct F*74abdaa0d9 : F*bb608aaa2f {
	struct FGuid *a2333c5817; // 0x18(0x10)
	char pad_28[0x8]; // 0x28(0x08)
	struct FTransform *25f38a7101; // 0x30(0x30)
...
struct F*fdb8ee4e82 : F*bb608aaa2f {
	struct F*127da3598a EventData; // 0x18(0x20)
...
struct F*caf602f762 : F*bb608aaa2f {
	struct FRichCurve *da4e08eaf1; // 0x18(0x70)
	struct FLinearColor *59ad6910df; // 0x88(0x10)
...
struct F*b4eea82670 : F*bb608aaa2f {
	...
	char pad_19[0x7]; // 0x19(0x07)
	struct TArray<struct FName> *33f67d2b24; // 0x20(0x10)
};
...
struct F*3dfea610bb : F*bb608aaa2f {
	struct F*a422f9d4ff *e0ead3eac1; // 0x18(0x70)
};
...
struct F*52e9e32bad : F*bb608aaa2f {
	struct F*a1e412f2f3 *f1a0f3f2df; // 0x18(0x28)
	struct FRichCurve *1960b1af8c[0x03]; // 0x40(0x150)
	struct FRichCurve *6eb9b2fb15[0x03]; // 0x190(0x150)
	struct FRichCurve *0ee2e9841f[0x03]; // 0x2e0(0x150)
};
...
struct F*6e7cc1c305 : F*bb608aaa2f {
	struct F*a1e412f2f3 *f1a0f3f2df; // 0x18(0x28)
	struct FRichCurve *5fb73c8460[0x04]; // 0x40(0x1c0)
	int32 *57fdae08aa; // 0x200(0x04)
...
struct F*997b40d6d7 : F*bb608aaa2f {
	struct F*a1e412f2f3 *f1a0f3f2df; // 0x18(0x28)
	struct F*754bde3481 *754bde3481; // 0x40(0x78)
};
...
struct F*501aacac08 : F*bb608aaa2f {
	struct F*a1e412f2f3 *f1a0f3f2df; // 0x18(0x28)
	struct F*a422f9d4ff *03937a0b98; // 0x40(0x70)
};
...
struct F*98fec65754 : F*bb608aaa2f {
	struct F*a1e412f2f3 *f1a0f3f2df; // 0x18(0x28)
	struct F*a422f9d4ff *0df0f3f9db; // 0x40(0x70)
};
...
struct F*2d52b07c95 : F*bb608aaa2f {
	struct F*a1e412f2f3 *f1a0f3f2df; // 0x18(0x28)
	struct F*a422f9d4ff *1c59b21309; // 0x40(0x70)
};
...
struct F*e7392487cd : F*bb608aaa2f {
	struct F*a1e412f2f3 *f1a0f3f2df; // 0x18(0x28)
	struct FRichCurve *e7fc2b8ab7; // 0x40(0x70)
};
...
struct F*42eb5934cd : F*bb608aaa2f {
	struct F*a1e412f2f3 *f1a0f3f2df; // 0x18(0x28)
	struct F*a422f9d4ff *e769e648e6; // 0x40(0x70)
};
