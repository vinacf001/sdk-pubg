...
struct UNiagaraComponent : UPrimitiveComponent {
	...
	struct TArray<struct F*831ef3e2b5> *b8298c32aa; // 0xa10(0x10)
	struct TArray<struct F*f4f6cf12de> *b9dde05f74; // 0xa20(0x10)
	struct TArray<struct U*ffb587be47*> *90746846b5; // 0xa30(0x10)
	bool *1fa345edaa; // 0xa40(0x01)
	char pad_A41[0xf]; // 0xa41(0x0f)

	struct FVector *19576e91ee(); // Function Niagara.NiagaraComponent.*19576e91ee // Final|Native|Public|HasDefaults|BlueprintCallable // @ game+0x5f574a0
	void *d0b8a0f598(); // Function Niagara.NiagaraComponent.*d0b8a0f598 // Final|Native|Public|BlueprintCallable // @ game+0x5f56e10
	struct AActor* *72e447b430(); // Function Niagara.NiagaraComponent.*72e447b430 // Final|Native|Public|BlueprintCallable // @ game+0x5f56fb0
	bool *c15b4db1a0(); // Function Niagara.NiagaraComponent.*c15b4db1a0 // Final|Native|Public|BlueprintCallable // @ game+0x5f570cc
	bool *7e0a5c9c69(); // Function Niagara.NiagaraComponent.*7e0a5c9c69 // Final|Native|Public|BlueprintCallable // @ game+0x5f5772c
	void *f351277176(); // Function Niagara.NiagaraComponent.*f351277176 // Final|Native|Public|BlueprintCallable // @ game+0x5f56e50
	struct FVector2D *db2ecc8b0f(); // Function Niagara.NiagaraComponent.*db2ecc8b0f // Final|Native|Public|HasDefaults|BlueprintCallable // @ game+0x5f57340
	float *7b6fe82f05(); // Function Niagara.NiagaraComponent.*7b6fe82f05 // Final|Native|Public|BlueprintCallable // @ game+0x5f57220
	struct FVector4 *7b565e9d05(); // Function Niagara.NiagaraComponent.*7b565e9d05 // Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable // @ game+0x5f575f8
	float *bf4466f9f5(); // Function Niagara.NiagaraComponent.*bf4466f9f5 // Final|Native|Public|BlueprintCallable // @ game+0x5f56e90
};
...
struct U*b07648ef36 : UBlueprintFunctionLibrary {
	...
	struct UNiagaraComponent* SpawnEffectAttached(); // Function Niagara.*b07648ef36.SpawnEffectAttached // Final|Native|Static|Public|HasDefaults|BlueprintCallable // @ game+0x5f57984
	struct UNiagaraComponent* *6da170feb8(); // Function Niagara.*b07648ef36.*6da170feb8 // Final|Native|Static|Public|HasDefaults|BlueprintCallable // @ game+0x5f577bc
};
