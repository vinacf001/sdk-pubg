...
struct ACineCameraActor : ACameraActor {
	...
	struct UCineCameraComponent* *0bc3971ae9(); // Function CinematicCamera.CineCameraActor.*0bc3971ae9 // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x5db0208
};
...
struct UCineCameraComponent : UCameraComponent {
	...
	float *435939b600(); // Function CinematicCamera.CineCameraComponent.*435939b600 // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x5db0248
	float *5faf310e1d(); // Function CinematicCamera.CineCameraComponent.*5faf310e1d // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x5db0220
};
