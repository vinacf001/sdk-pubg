...
struct UCableComponent : UMeshComponent {
	...
	struct F*e6c2ea7bad *5322c3e86e; // 0xb08(0x18)
	struct FName *3167e96d80; // 0xb20(0x08)
	struct FName *30da14ab82; // 0xb28(0x08)
	...
	struct TArray<struct F*74dda64bfe> CustomSocketList; // 0xb68(0x10)
	...
	struct AActor* *b9efb1a0e4(); // Function CableComponent.CableComponent.*b9efb1a0e4 // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x66f3a28
	struct FName *2a029da51f(); // Function CableComponent.CableComponent.*2a029da51f // Final|Native|Public|BlueprintCallable // @ game+0x66f3b40
	struct USceneComponent* *8b674a10cf(); // Function CableComponent.CableComponent.*8b674a10cf // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x66f3a40
	struct TArray<struct FVector> *931cab8e25(); // Function CableComponent.CableComponent.*931cab8e25 // Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const // @ game+0x66f3a78
};
