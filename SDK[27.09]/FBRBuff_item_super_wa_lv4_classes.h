...
struct AFBRBuff_item_super_wa_lv4_C : ATslFBRItemBuff {
	...
	void UserConstructionScript(); // Function FBRBuff_item_super_wa_lv4.FBRBuff_item_super_wa_lv4_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x22ddc4
};
