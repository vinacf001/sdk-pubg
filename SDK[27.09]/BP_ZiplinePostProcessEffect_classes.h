...
struct ABP_ZiplinePostProcessEffect_C : ATslPostProcessEffect {
	...
	void UserConstructionScript(); // Function BP_ZiplinePostProcessEffect.BP_ZiplinePostProcessEffect_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x22ddc4
};
