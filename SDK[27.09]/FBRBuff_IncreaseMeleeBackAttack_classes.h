...
struct AFBRBuff_IncreaseMeleeBackAttack_C : ATslFBRBuff {
	...
	void UserConstructionScript(); // Function FBRBuff_IncreaseMeleeBackAttack.FBRBuff_IncreaseMeleeBackAttack_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x22ddc4
};
