...
struct UBP_ReportPlayerWidget_C : U*3ac124ec5e {
	...
	enum class *d4829cd412 ButtonEvent__DelegateSignature(); // Function BP_ReportPlayerWidget.BP_ReportPlayerWidget_C.ButtonEvent__DelegateSignature // Public|Delegate|BlueprintCallable|BlueprintEvent // @ game+0x22ddc4
};
