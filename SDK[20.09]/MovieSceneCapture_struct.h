// Enum MovieSceneCapture.*13d2c77a5e
enum class *13d2c77a5e : uint8 {
	*fd73dd112a,
	*51b7f2ad2b,
	*15a1169786,
	*d62a232419,
...
// ScriptStruct MovieSceneCapture.*6bdcdf26ea
...
struct F*6bdcdf26ea {
	...
	int32 HandleFrames; // 0x34(0x04)
	bool ZeroPadFrameNumbers; // 0x38(0x01)
	char pad_39[0x3]; // 0x39(0x03)
	int32 FrameRate; // 0x3c(0x04)
...
struct FCaptureResolution {
	uint32 ResX; // 0x00(0x04)
	uint32 ResY; // 0x04(0x04)
};
