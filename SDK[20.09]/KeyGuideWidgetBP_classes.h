...
struct UKeyGuideWidgetBP_C : U*596c132f4b {
	struct F*73a77c28fa UberGraphFrame; // 0x590(0x08)
	struct UBackgroundBlur* BackgroundBlur_1; // 0x598(0x08)
	struct U*cceb91eeec* ButtonBack; // 0x5a0(0x08)
	...
	void Construct(); // Function KeyGuideWidgetBP.KeyGuideWidgetBP_C.Construct // BlueprintCosmetic|Event|Public|BlueprintEvent // @ game+0x1e037c
	void EscapeEvent(); // Function KeyGuideWidgetBP.KeyGuideWidgetBP_C.EscapeEvent // BlueprintCallable|BlueprintEvent // @ game+0x1e037c
	void BndEvt__TslCommonButton_0_K2Node_ComponentBoundEvent_20_OnButtonClickedEvent__DelegateSignature(); // Function KeyGuideWidgetBP.KeyGuideWidgetBP_C.BndEvt__TslCommonButton_0_K2Node_ComponentBoundEvent_20_OnButtonClickedEvent__DelegateSignature // BlueprintEvent // @ game+0x1e037c
	void BndEvt__TslCommonButton_0_K2Node_ComponentBoundEvent_37_OnButtonHoverEvent__DelegateSignature(); // Function KeyGuideWidgetBP.KeyGuideWidgetBP_C.BndEvt__TslCommonButton_0_K2Node_ComponentBoundEvent_37_OnButtonHoverEvent__DelegateSignature // BlueprintEvent // @ game+0x1e037c
	bool ExecuteUbergraph_KeyGuideWidgetBP(int32 EntryPoint); // Function KeyGuideWidgetBP.KeyGuideWidgetBP_C.ExecuteUbergraph_KeyGuideWidgetBP //  // @ game+0x1e037c
};
