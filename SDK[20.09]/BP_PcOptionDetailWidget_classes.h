...
struct UBP_PcOptionDetailWidget_C : U*07a8e72141 {
	struct F*73a77c28fa UberGraphFrame; // 0x5b0(0x08)
	...
	void ExecuteUbergraph_BP_PcOptionDetailWidget(); // Function BP_PcOptionDetailWidget.BP_PcOptionDetailWidget_C.ExecuteUbergraph_BP_PcOptionDetailWidget //  // @ game+0x1e037c
};
