// Enum PowerIKRuntime.*e156199dbb
enum class *e156199dbb : uint8 {
	*88e8d183c9,
	*4c5e895874,
	*f31334191c,
	*3e8fe1b75e,
...
// Enum PowerIKRuntime.*9b5cdd45fc
enum class *9b5cdd45fc : uint8 {
	*51dbe1435e,
	*0e08dbb2e9,
	*942bf04b2a,
	*f2ee855c51,
...
// ScriptStruct PowerIKRuntime.*4cc8b4a175
// Size: 0xa8 (Inherited: 0x00)
struct F*4cc8b4a175 {
	char pad_0[0xa8]; // 0x00(0xa8)
};

// ScriptStruct PowerIKRuntime.*29dd17d35c
// Size: 0x28 (Inherited: 0x00)
struct F*29dd17d35c {
	char pad_0[0x28]; // 0x00(0x28)
};

// ScriptStruct PowerIKRuntime.*ebd7f3328e
// Size: 0x68 (Inherited: 0x00)
struct F*ebd7f3328e {
	char pad_0[0x68]; // 0x00(0x68)
};

// ScriptStruct PowerIKRuntime.*0843d179e8
...
struct FPowerIKEffector {
	...
	enum class *e156199dbb PositionSpace; // 0x14(0x01)
	char pad_15[0x3]; // 0x15(0x03)
	struct FRotator Rotation; // 0x18(0x0c)
	enum class *e156199dbb RotationSpace; // 0x24(0x01)
...
struct FPowerIKPoleVector {
	enum class *9b5cdd45fc Mode; // 0x00(0x01)
...
// ScriptStruct PowerIKRuntime.*54b3de3a63
// Size: 0x10 (Inherited: 0x00)
struct F*54b3de3a63 {
