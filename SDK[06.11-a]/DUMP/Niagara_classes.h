...
struct UNiagaraComponent : UPrimitiveComponent {
	...
	struct FString *206caa6c6a(struct FVector4 InValue); // Function Niagara.NiagaraComponent.*206caa6c6a // Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable // @ game+0x66f93e8
	void *904c9f6561(struct FString InEmitterName, float InValue); // Function Niagara.NiagaraComponent.*904c9f6561 // Final|Native|Public|BlueprintCallable // @ game+0x66f8c80
	void *1a9370ca29(); // Function Niagara.NiagaraComponent.*1a9370ca29 // Final|Native|Public|HasDefaults|BlueprintCallable // @ game+0x66f9290
	void *3958968000(); // Function Niagara.NiagaraComponent.*3958968000 // Final|Native|Public|BlueprintCallable // @ game+0x66f8c00
	void *94ee81e316(bool bInRenderingEnabled); // Function Niagara.NiagaraComponent.*94ee81e316 // Final|Native|Public|BlueprintCallable // @ game+0x66f951c
	void *6583fd4268(struct FString InVariableName); // Function Niagara.NiagaraComponent.*6583fd4268 // Final|Native|Public|BlueprintCallable // @ game+0x66f8ebc
	void *561f9f0fe5(); // Function Niagara.NiagaraComponent.*561f9f0fe5 // Final|Native|Public|BlueprintCallable // @ game+0x66f8da0
	void *d9236539a6(); // Function Niagara.NiagaraComponent.*d9236539a6 // Final|Native|Public|BlueprintCallable // @ game+0x66f8c40
	void *5b77053795(struct FString InVariableName, float InValue); // Function Niagara.NiagaraComponent.*5b77053795 // Final|Native|Public|BlueprintCallable // @ game+0x66f9010
	void *7226b31442(); // Function Niagara.NiagaraComponent.*7226b31442 // Final|Native|Public|HasDefaults|BlueprintCallable // @ game+0x66f9130
};
