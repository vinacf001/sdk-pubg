...
struct F*067063007d {
	struct FVector Location; // 0x00(0x0c)
	float AspectRatio; // 0x0c(0x04)
	float OrthoWidth; // 0x10(0x04)
	char pad_14[0xc]; // 0x14(0x0c)
	struct FPostProcessSettings PostProcessSettings; // 0x20(0x570)
	float OrthoFarClipPlane; // 0x590(0x04)
	float OrthoNearClipPlane; // 0x594(0x04)
	enum class ECameraProjectionMode ProjectionMode; // 0x598(0x01)
	char pad_599[0x3]; // 0x599(0x03)
	float FOV; // 0x59c(0x04)
	struct FRotator Rotation; // 0x5a0(0x0c)
	struct FVector2D OffCenterProjectionOffset; // 0x5ac(0x08)
	float PostProcessBlendWeight; // 0x5b4(0x04)
	char bConstrainAspectRatio : 1; // 0x5b8(0x01)
	char bUseFieldOfViewForLOD : 1; // 0x5b8(0x01)
...
struct FWorldContext {
	...
	struct FURL *cbdb4b9722; // 0x30(0x70)
	struct TArray<struct F*81839ef2e0> *b22fe64d39; // 0xa0(0x10)
	char pad_B0[0x18]; // 0xb0(0x18)
	struct UGameInstance* *d9161cd8f3; // 0xc8(0x08)
	struct UGameViewportClient* GameViewport; // 0xd0(0x08)
	char pad_D8[0x8]; // 0xd8(0x08)
	struct TArray<struct ULevel*> *d78af1966d; // 0xe0(0x10)
	struct FURL *dfec1c00f1; // 0xf0(0x70)
	char pad_160[0x8]; // 0x160(0x08)
	struct TArray<struct U*b0f24f93f7*> *c0f8e6db4a; // 0x168(0x10)
	char pad_178[0x8]; // 0x178(0x08)
	struct TArray<struct F*52c76088ce> PackagesToFullyLoad; // 0x180(0x10)
	char pad_190[0x110]; // 0x190(0x110)
	struct U*3189c6f422* *3189c6f422; // 0x2a0(0x08)
