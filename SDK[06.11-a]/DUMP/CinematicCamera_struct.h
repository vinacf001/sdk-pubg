...
// ScriptStruct CinematicCamera.*de1e88281a
...
struct FCameraFocusSettings {
	...
	struct F*eeba71d1e6 TrackingFocusSettings; // 0x08(0x18)
	char bDrawDebugFocusPlane : 1; // 0x20(0x01)
	char pad_20_1 : 7; // 0x20(0x01)
	char pad_21[0x3]; // 0x21(0x03)
	struct FColor *fdb50a45f9; // 0x24(0x04)
...
// ScriptStruct CinematicCamera.*eeba71d1e6
...
// ScriptStruct CinematicCamera.*62421bcfd0
...
// ScriptStruct CinematicCamera.*4881a7d8ef
