...
struct UBP_GamepadKeyIconWidget_C : U*400a0fbc3d {
	...
	void *ffc521df9b(); // Function TslGame.*400a0fbc3d.*ffc521df9b // Final|Native|Private // @ game+0x5ec46f0
	void HandleGameUserSettingApplied(); // Function TslGame.*400a0fbc3d.HandleGameUserSettingApplied // Final|Native|Private // @ game+0x5eb1d40
	void *4bd46feaf8(); // Function TslGame.*400a0fbc3d.*4bd46feaf8 // Final|Native|Private // @ game+0x5ec4664
};
