...
struct UNiagaraComponent : UPrimitiveComponent {
	struct UNiagaraEffect* Asset; // 0x9e8(0x08)
	char pad_9F8[0x8]; // 0x9f8(0x08)
	struct TArray<struct F*283e4b918c> *f7de8b6e51; // 0xa00(0x10)
	struct TArray<struct F*a0a24b0a2b> *84d6204bda; // 0xa10(0x10)
	struct TArray<struct U*acbc21e3b6*> *a5ce9ba5db; // 0xa20(0x10)
	bool *c84daaa889; // 0xa30(0x01)
	char pad_A31[0xf]; // 0xa31(0x0f)

	struct FString *801f14164b(); // Function Niagara.NiagaraComponent.*801f14164b // None // @ game+0x5efa2a8
	void *48024fe786(); // Function Niagara.NiagaraComponent.*48024fe786 // None // @ game+0x5efa680
	void *8cb34fc953(); // Function Niagara.NiagaraComponent.*8cb34fc953 // None // @ game+0x5ef9f18
	struct FString *300541e520(); // Function Niagara.NiagaraComponent.*300541e520 // None // @ game+0x5efa154
	void *091f7acc93(struct FString InVariableName); // Function Niagara.NiagaraComponent.*091f7acc93 // None // @ game+0x5efa3c8
	void *6af65a2eaf(); // Function Niagara.NiagaraComponent.*6af65a2eaf // None // @ game+0x5efa038
	void *974726f6dd(); // Function Niagara.NiagaraComponent.*974726f6dd // None // @ game+0x5ef9ed8
	void *4f97337528(); // Function Niagara.NiagaraComponent.*4f97337528 // None // @ game+0x5efa7b4
	void *82cd34aa7f(); // Function Niagara.NiagaraComponent.*82cd34aa7f // None // @ game+0x5ef9e98
	void *40ffea2fd5(struct FString InVariableName); // Function Niagara.NiagaraComponent.*40ffea2fd5 // None // @ game+0x5efa528
};
