...
struct UBP_PcOptionItemButtonWidget_C : U*f834ecb527 {
	...
	void ShowPopupDialogEx(); // Function TslGame.*f834ecb527.ShowPopupDialogEx // None // @ game+0x56eadbc
	void OnPopupButtonPressedEvent(); // Function TslGame.*f834ecb527.OnPopupButtonPressedEvent // None // @ game+0x56e2214
};
