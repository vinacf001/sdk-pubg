...
struct AVehicleBase_C : ATslWheeledVehicle {
	struct F*73a77c28fa UberGraphFrame; // 0xf60(0x08)
	struct UCameraComponent* ThirdPersonCameraInVehicle; // 0xf68(0x08)
	struct U*83f5889ba2* ThirdPersonSpringArmInVehicle; // 0xf70(0x08)
	struct UCameraComponent* FirstPersonCameraInVehicle; // 0xf78(0x08)
	struct U*83f5889ba2* FirstPersonSpringArmInVehicle; // 0xf80(0x08)
	...
	void SetScalarParameters(); // Function VehicleBase.VehicleBase_C.SetScalarParameters // None // @ game+0x26a108
	void UserConstructionScript(); // Function VehicleBase.VehicleBase_C.UserConstructionScript // None // @ game+0x26a108
	void ReceiveBeginPlay(); // Function VehicleBase.VehicleBase_C.ReceiveBeginPlay // None // @ game+0x26a108
	void ExecuteUbergraph_VehicleBase(); // Function VehicleBase.VehicleBase_C.ExecuteUbergraph_VehicleBase // None // @ game+0x26a108
};
