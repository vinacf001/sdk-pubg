...
struct UBP_GamepadKeyIconWidget_C : U*f50ba61dee {
	...
	void *c39e69150d(); // Function TslGame.*f50ba61dee.*c39e69150d // None // @ game+0x56eb094
	void *9c98421d97(); // Function TslGame.*f50ba61dee.*9c98421d97 // None // @ game+0x56eb244
	void HandleGameUserSettingApplied(); // Function TslGame.*f50ba61dee.HandleGameUserSettingApplied // None // @ game+0x56d97dc
};
