...
struct APrefabActor : AActor {
	...
	struct U*65fe268759* BuildingHLOD; // 0x420(0x08)

	void *5175f529f5(struct UPrefabAsset* NewPrefab); // Function PrefabAsset.PrefabActor.*5175f529f5 // None // @ game+0x656a14c
	void *2440bfc1b6(); // Function PrefabAsset.PrefabActor.*2440bfc1b6 // None // @ game+0x560b07c
	void *be7b0d0791(); // Function PrefabAsset.PrefabActor.*be7b0d0791 // None // @ game+0x656a0b8
	void *974d2a98c1(); // Function PrefabAsset.PrefabActor.*974d2a98c1 // None // @ game+0x656a098
};
...
struct APrefabLODHolder : APrefabActorHolder {
	struct U*65fe268759* HLODParentComponent; // 0x3f8(0x08)
...
struct UPrefabAsset : UObject {
	struct FGuid *b9c34774dc; // 0x28(0x10)
	struct FText PrefabContent; // 0x38(0x18)
	struct FVector PrefabPivot; // 0x50(0x0c)
	char pad_5C[0x4]; // 0x5c(0x04)
	struct FString *327654e071; // 0x60(0x10)
	struct TMap<struct FString, struct FStringAssetReference> AssetReferences; // 0x70(0x50)
	int32 NumActors; // 0xc0(0x04)
	char pad_C4[0x4]; // 0xc4(0x04)
	struct FStringAssetReference *ccf006fe3e; // 0xc8(0x10)
	struct TMap<struct FString, struct F*f3ec451ec7> *865b64f290; // 0xd8(0x50)
	bool *20b23df91d; // 0x128(0x01)
	bool *c7dcf22c82; // 0x129(0x01)
	bool *06e2de619c; // 0x12a(0x01)
...
// Size: 0xad0 (Inherited: 0x9f0)
struct UPrefabComponent : UPrimitiveComponent {
	char *48780ee637 : 1; // 0x9e8(0x01)
	char *0180783a2f : 1; // 0x9e8(0x01)
	char *2e5aabe093 : 1; // 0x9e8(0x01)
	struct TMap<struct FString, struct F*f3ec451ec7> ComponentPrefabOverrideMap; // 0x9f0(0x50)
	struct FVector *1a50398c74; // 0xa40(0x0c)
	struct FVector *2c624734a2; // 0xa4c(0x0c)
	char *e11000b2fb : 1; // 0xa58(0x01)
	char pad_A58_4 : 4; // 0xa58(0x01)
	char pad_A59[0x7]; // 0xa59(0x07)
	struct UBlueprint* GeneratedBlueprint; // 0xa60(0x08)
	struct UPrefabAsset* Prefab; // 0xa68(0x08)
	struct TMap<struct FName, struct AActor*> PrefabInstancesMap; // 0xa70(0x50)
	char bTransient : 1; // 0xac0(0x01)
	char pad_AC0_1 : 7; // 0xac0(0x01)
	char pad_AC1[0x3]; // 0xac1(0x03)
	bool bIsBaseBuilding; // 0xac4(0x01)
	char pad_AC5[0x3]; // 0xac5(0x03)
	uint32 HouseID; // 0xac8(0x04)
	bool *c7dcf22c82; // 0xacc(0x01)
	char pad_ACD[0x1]; // 0xacd(0x01)
	bool bWasDisconnectedBeforeBake; // 0xace(0x01)
...
struct UPrefabToolSettings : UObject {
	...
	enum class *82089f54f6 PrefabComponentVisualizerType; // 0x3a(0x01)
