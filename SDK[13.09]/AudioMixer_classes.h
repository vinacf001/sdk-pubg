...
struct U*406b5d6f6d : U*8379a39c46 {
	...
	void *26ae821fd2(); // Function AudioMixer.*406b5d6f6d.*26ae821fd2 // None // @ game+0x642fe48
};
...
struct U*afb83b30f8 : U*8379a39c46 {
	...
	void *26ae821fd2(); // Function AudioMixer.*afb83b30f8.*26ae821fd2 // None // @ game+0x642ff40
	void *651dd57833(struct UReverbEffect* InReverbEffect); // Function AudioMixer.*afb83b30f8.*651dd57833 // None // @ game+0x6430168
};
...
struct U*1d2d735737 : U*8379a39c46 {
	...
	void *26ae821fd2(); // Function AudioMixer.*1d2d735737.*26ae821fd2 // None // @ game+0x6430048
};
...
// Size: 0x690 (Inherited: 0x4c0)
struct U*9aa8179e28 : USceneComponent {
	char *2e8753955a : 1; // 0x4c0(0x01)
	char *d6fc981176 : 1; // 0x4c0(0x01)
	char bAllowSpatialization : 1; // 0x4c0(0x01)
	char bOverrideAttenuation : 1; // 0x4c0(0x01)
	char pad_4C0_4 : 4; // 0x4c0(0x01)
	char pad_4C1[0x7]; // 0x4c1(0x07)
	struct USoundAttenuation* AttenuationSettings; // 0x4c8(0x08)
	struct FSoundAttenuationSettings AttenuationOverrides; // 0x4d0(0x130)
	struct USoundConcurrency* ConcurrencySettings; // 0x600(0x08)
	struct USoundClass* SoundClass; // 0x608(0x08)
	struct U*844cf37c90* SourceEffectChain; // 0x610(0x08)
	float DefaultMasterReverbSendAmount; // 0x618(0x04)
	char pad_61C[0x4]; // 0x61c(0x04)
	struct USoundSubmix* SoundSubmix; // 0x620(0x08)
	struct TArray<struct F*3da6da8223> SoundSubmixSends; // 0x628(0x10)
	char pad_638[0x8]; // 0x638(0x08)
	struct U*ac88a7c271* Synth; // 0x640(0x08)
	struct UAudioComponent* AudioComponent; // 0x648(0x08)
	char pad_650[0x40]; // 0x650(0x40)

	void Stop(); // Function AudioMixer.*9aa8179e28.Stop // None // @ game+0x6430348
	void *172bd6cd1a(struct USoundSubmix* Submix); // Function AudioMixer.*9aa8179e28.*172bd6cd1a // None // @ game+0x6430248
	void Start(); // Function AudioMixer.*9aa8179e28.Start // None // @ game+0x6430334
	void IsPlaying(); // Function AudioMixer.*9aa8179e28.IsPlaying // None // @ game+0x642fa60
};
