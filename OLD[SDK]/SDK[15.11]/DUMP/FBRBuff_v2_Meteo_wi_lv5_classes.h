...
struct AFBRBuff_v2_Meteo_wi_lv5_C : ATslFBRItemBuff {
	...
	void UserConstructionScript(); // Function FBRBuff_v2_Meteo_wi_lv5.FBRBuff_v2_Meteo_wi_lv5_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x21d2c4
};
