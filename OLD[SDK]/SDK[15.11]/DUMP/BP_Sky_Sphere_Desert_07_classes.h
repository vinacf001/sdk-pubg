...
struct ABP_Sky_Sphere_Desert_07_C : AActor {
	...
	struct U*e9d5a49b26* Horizon color curve; // 0x480(0x08)
	struct U*e9d5a49b26* Zenith color curve; // 0x488(0x08)
	struct U*e9d5a49b26* Cloud color curve; // 0x490(0x08)

	void UpdateSunDirection(); // Function BP_Sky_Sphere_Desert_07.BP_Sky_Sphere_Desert_07_C.UpdateSunDirection // Public|BlueprintCallable|BlueprintEvent // @ game+0x21d2c4
	void UserConstructionScript(); // Function BP_Sky_Sphere_Desert_07.BP_Sky_Sphere_Desert_07_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x21d2c4
};
