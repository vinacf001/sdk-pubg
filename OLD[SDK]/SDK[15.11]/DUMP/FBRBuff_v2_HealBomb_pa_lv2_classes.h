...
struct AFBRBuff_v2_HealBomb_pa_lv2_C : ATslFBRItemBuff {
	...
	void UserConstructionScript(); // Function FBRBuff_v2_HealBomb_pa_lv2.FBRBuff_v2_HealBomb_pa_lv2_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x21d2c4
};
