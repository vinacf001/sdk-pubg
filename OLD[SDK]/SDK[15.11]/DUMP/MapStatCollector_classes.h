...
struct UMapStatCollectorSettings : UObject {
	...
	struct TArray<struct F*2fd8311450> CustomMinimapList; // 0x80(0x10)
	...
	struct TArray<struct F*0c8baf364c> CustomStatEntries; // 0xb8(0x10)
	...
	struct TArray<struct F*f632a24688> GeneratorSettings; // 0x110(0x10)
};
