...
struct ACineCameraActor : ACameraActor {
	...
	struct UCineCameraComponent* *800600a97c(); // Function CinematicCamera.CineCameraActor.*800600a97c // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x6540698
};
...
struct UCineCameraComponent : UCameraComponent {
	...
	float *2e48f4d56f(); // Function CinematicCamera.CineCameraComponent.*2e48f4d56f // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x65406d8
	float *3ef1f01f05(); // Function CinematicCamera.CineCameraComponent.*3ef1f01f05 // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x65406b0
};
