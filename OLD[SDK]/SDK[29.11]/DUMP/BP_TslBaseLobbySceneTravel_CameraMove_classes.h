...
struct ABP_TslBaseLobbySceneTravel_CameraMove_C : ATslLobbySceneTravel_CameraMove {
	...
	void UserConstructionScript(); // Function BP_TslBaseLobbySceneTravel_CameraMove.BP_TslBaseLobbySceneTravel_CameraMove_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x1dcd78
};
