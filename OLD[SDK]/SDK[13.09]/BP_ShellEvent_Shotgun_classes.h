...
struct UBP_ShellEvent_Shotgun_C : U*9ca7b4153a {
	...
	void *066fa08cc3(struct UObject* InObject, struct FRotator InRotation); // Function TslGame.*9ca7b4153a.*066fa08cc3 // None // @ game+0x56cbb14
};
