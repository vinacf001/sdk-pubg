...
struct UVehicleAnimInstance : UAnimInstance {
	...
	void *a95919746e(); // Function PhysXVehicles.VehicleAnimInstance.*a95919746e // None // @ game+0x676c76c
};
...
struct UVehicleWheel : UObject {
	...
	void *b2b95cf3d5(); // Function PhysXVehicles.VehicleWheel.*b2b95cf3d5 // None // @ game+0x676c6f4
	void *169e8cd187(); // Function PhysXVehicles.VehicleWheel.*169e8cd187 // None // @ game+0x676c66c
	void *622df17385(); // Function PhysXVehicles.VehicleWheel.*622df17385 // None // @ game+0x676c7b8
	void *9bdd770d31(); // Function PhysXVehicles.VehicleWheel.*9bdd770d31 // None // @ game+0x6365248
	void *8b906954bb(); // Function PhysXVehicles.VehicleWheel.*8b906954bb // None // @ game+0x676c6d0
	void *13622fd4ee(); // Function PhysXVehicles.VehicleWheel.*13622fd4ee // None // @ game+0x676c684
};
...
struct UWheeledVehicleMovementComponent : UPawnMovementComponent {
	...
	void *724cefc729(); // Function PhysXVehicles.WheeledVehicleMovementComponent.*724cefc729 // None // @ game+0x676c790
	void *84929fc112(); // Function PhysXVehicles.WheeledVehicleMovementComponent.*84929fc112 // None // @ game+0x676d298
	void *c8138f380f(); // Function PhysXVehicles.WheeledVehicleMovementComponent.*c8138f380f // None // @ game+0x676d638
	void *11603f3271(); // Function PhysXVehicles.WheeledVehicleMovementComponent.*11603f3271 // None // @ game+0x676d170
	void *6711196e50(); // Function PhysXVehicles.WheeledVehicleMovementComponent.*6711196e50 // None // @ game+0x676d334
	void *498e7f603b(); // Function PhysXVehicles.WheeledVehicleMovementComponent.*498e7f603b // None // @ game+0x676d048
	void *326fc8e4df(); // Function PhysXVehicles.WheeledVehicleMovementComponent.*326fc8e4df // None // @ game+0x676c6a8
	void *9edb794e7a(); // Function PhysXVehicles.WheeledVehicleMovementComponent.*9edb794e7a // None // @ game+0x676c620
	void *cd65943cf6(); // Function PhysXVehicles.WheeledVehicleMovementComponent.*cd65943cf6 // None // @ game+0x676d6e8
	void *2c03648be5(); // Function PhysXVehicles.WheeledVehicleMovementComponent.*2c03648be5 // None // @ game+0x676cb2c
	void *937341792a(); // Function PhysXVehicles.WheeledVehicleMovementComponent.*937341792a // None // @ game+0x676d55c
	int32 *bdd033d741(); // Function PhysXVehicles.WheeledVehicleMovementComponent.*bdd033d741 // None // @ game+0x676c8c4
	void *8381acd31f(); // Function PhysXVehicles.WheeledVehicleMovementComponent.*8381acd31f // None // @ game+0x676d0e4
	void *b32b5ec1b0(); // Function PhysXVehicles.WheeledVehicleMovementComponent.*b32b5ec1b0 // None // @ game+0x676cc14
	void *063934e150(); // Function PhysXVehicles.WheeledVehicleMovementComponent.*063934e150 // None // @ game+0x676cfac
	void *59771a8f0f(); // Function PhysXVehicles.WheeledVehicleMovementComponent.*59771a8f0f // None // @ game+0x676cd3c
	void *d227cb1c04(); // Function PhysXVehicles.WheeledVehicleMovementComponent.*d227cb1c04 // None // @ game+0x676c744
	void *86f0adc364(); // Function PhysXVehicles.WheeledVehicleMovementComponent.*86f0adc364 // None // @ game+0x676c608
	void *60ff66bd47(); // Function PhysXVehicles.WheeledVehicleMovementComponent.*60ff66bd47 // None // @ game+0x676d20c
	void *c9146df6e9(); // Function PhysXVehicles.WheeledVehicleMovementComponent.*c9146df6e9 // None // @ game+0x676c5b8
	void *9c4d7de372(); // Function PhysXVehicles.WheeledVehicleMovementComponent.*9c4d7de372 // None // @ game+0x676c5f0
	void OnRep_TirePunctured(); // Function PhysXVehicles.WheeledVehicleMovementComponent.OnRep_TirePunctured // None // @ game+0x676c7d0
	void *b7bddfd0e0(); // Function PhysXVehicles.WheeledVehicleMovementComponent.*b7bddfd0e0 // None // @ game+0x676c70c
	void *fb06094432(); // Function PhysXVehicles.WheeledVehicleMovementComponent.*fb06094432 // None // @ game+0x676cca0
	void *38ff5fe855(); // Function PhysXVehicles.WheeledVehicleMovementComponent.*38ff5fe855 // None // @ game+0x676d4ac
};
