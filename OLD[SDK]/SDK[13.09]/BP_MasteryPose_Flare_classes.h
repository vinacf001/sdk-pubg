...
struct ABP_MasteryPose_Flare_C : ABP_MasteryPose_C {
	...
	void UserConstructionScript(); // Function BP_MasteryPose_Flare.BP_MasteryPose_Flare_C.UserConstructionScript // None // @ game+0x26a108
	void AttachObjects(); // Function BP_MasteryPose_Flare.BP_MasteryPose_Flare_C.AttachObjects // None // @ game+0x26a108
	struct FPoseCharacterAttachments ExecuteUbergraph_BP_MasteryPose_Flare(); // Function BP_MasteryPose_Flare.BP_MasteryPose_Flare_C.ExecuteUbergraph_BP_MasteryPose_Flare // None // @ game+0x26a108
};
