...
struct AHoudiniAssetActor : AActor {
	struct UHoudiniAssetComponent* HoudiniAssetComponent; // 0x400(0x08)
...
// Size: 0x12e0 (Inherited: 0xa10)
struct UHoudiniAssetComponent : UPrimitiveComponent {
	char *34a6be6fef : 1; // 0xa10(0x01)
	char pad_A10_1 : 7; // 0xa10(0x01)
	char pad_A11[0x7]; // 0xa11(0x07)
	struct UPhysicalMaterial* *9af61bf936; // 0xa18(0x08)
	struct FBodyInstance *0134eb6c71; // 0xa20(0x230)
	enum class ECollisionTraceFlag *de7f303171; // 0xc50(0x01)
	char pad_C51[0x3]; // 0xc51(0x03)
	int32 *60566caead; // 0xc54(0x04)
	float GeneratedLpvBiasMultiplier; // 0xc58(0x04)
	float *ea8027872d; // 0xc5c(0x04)
	struct F*a92203063d *6e7b79d459; // 0xc60(0x10)
	int32 *dc91edb0c1; // 0xc70(0x04)
	char *5cfbb93b25 : 1; // 0xc74(0x01)
	char pad_C74_1 : 7; // 0xc74(0x01)
	char pad_C75[0x3]; // 0xc75(0x03)
	float *7bac08a753; // 0xc78(0x04)
	char pad_C7C[0x4]; // 0xc7c(0x04)
	struct UFoliageType_InstancedStaticMesh* *1cac115a4b; // 0xc80(0x08)
	struct TArray<struct UAssetUserData*> *55cc152614; // 0xc88(0x10)
	char pad_C98[0x478]; // 0xc98(0x478)
	struct FText BakeFolder; // 0x1110(0x18)
	struct FText *bbc1b50338; // 0x1128(0x18)
	char pad_1140[0x1a0]; // 0x1140(0x1a0)

	int32 *9fb740918e(); // Function HoudiniEngineRuntime.HoudiniAssetComponent.*9fb740918e // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x6a8e088
};
...
struct U*600dce9ed1 : USceneComponent {
	char pad_4E0[0xb0]; // 0x4e0(0xb0)
	enum class EHoudiniHandleType *422098b87e; // 0x590(0x01)
...
struct U*a59e690045 : USceneComponent {
	struct UObject* *3ad714604d; // 0x4e0(0x08)
	struct TArray<struct AActor*> Instances; // 0x4e8(0x10)
