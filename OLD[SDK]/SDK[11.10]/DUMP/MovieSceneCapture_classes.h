...
struct U*e4b5226582 : UObject {
	...
	float *801a3392ae(); // Function MovieSceneCapture.*e4b5226582.*801a3392ae // Final|Native|Static|Public|BlueprintCallable|BlueprintPure // @ game+0x615dd5c
	int32 *def259b86c(); // Function MovieSceneCapture.*e4b5226582.*def259b86c // Final|Native|Static|Public|BlueprintCallable|BlueprintPure // @ game+0x615dd84
};
