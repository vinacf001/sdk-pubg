...
struct AFBRBuff_v2_Flash_ra_lv5_C : ATslFBRItemBuff {
	...
	void UserConstructionScript(); // Function FBRBuff_v2_Flash_ra_lv5.FBRBuff_v2_Flash_ra_lv5_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x273e04
};
