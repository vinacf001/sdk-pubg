...
struct U*cc61dd21b2 : UBlueprintFunctionLibrary {
	...
	int32 *75ab3f0366(); // Function Foliage.*cc61dd21b2.*75ab3f0366 // Final|Native|Static|Public|HasDefaults|BlueprintCallable // @ game+0x5f625a0
	int32 *2b51d65701(); // Function Foliage.*cc61dd21b2.*2b51d65701 // Final|Native|Static|Public|HasDefaults|BlueprintCallable // @ game+0x5f626e4
};
...
struct AInteractiveFoliageActor : AStaticMeshActor {
	...
	struct FVector *fe59ef3398; // 0x418(0x0c)
	struct FVector *dbcabce038; // 0x424(0x0c)
	struct FVector *f543c89244; // 0x430(0x0c)
	struct FVector *939f237751; // 0x43c(0x0c)
	float FoliageDamageImpulseScale; // 0x448(0x04)
	float FoliageTouchImpulseScale; // 0x44c(0x04)
	float FoliageStiffness; // 0x450(0x04)
	float FoliageStiffnessQuadratic; // 0x454(0x04)
	float FoliageDamping; // 0x458(0x04)
	float MaxDamageImpulse; // 0x45c(0x04)
	float MaxTouchImpulse; // 0x460(0x04)
	float MaxForce; // 0x464(0x04)
	float Mass; // 0x468(0x04)
	char pad_46C[0x4]; // 0x46c(0x04)

	struct FHitResult CapsuleTouched(); // Function Foliage.InteractiveFoliageActor.CapsuleTouched // Final|Native|Protected|HasOutParms // @ game+0x5f62350
};
...
struct AProceduralFoliageBlockingVolume : AVolume {
	struct AProceduralFoliageVolume* ProceduralFoliageVolume; // 0x438(0x08)
};
...
struct UProceduralFoliageSpawner : UObject {
	...
	int32 Simulate(); // Function Foliage.ProceduralFoliageSpawner.Simulate // Final|Native|Public|BlueprintCallable // @ game+0x5f62860
};
...
struct AProceduralFoliageVolume : AVolume {
	struct UProceduralFoliageComponent* ProceduralComponent; // 0x438(0x08)
};
