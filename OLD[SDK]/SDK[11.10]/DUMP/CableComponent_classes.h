...
struct ACableActor : AActor {
	struct UCableComponent* CableComponent; // 0x400(0x08)
};
...
struct UCableComponent : UMeshComponent {
	...
	struct AActor* *b9efb1a0e4(); // Function CableComponent.CableComponent.*b9efb1a0e4 // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x69c30c4
	struct FName *2a029da51f(); // Function CableComponent.CableComponent.*2a029da51f // Final|Native|Public|BlueprintCallable // @ game+0x69c31dc
	struct USceneComponent* *8b674a10cf(); // Function CableComponent.CableComponent.*8b674a10cf // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x69c30dc
	struct TArray<struct FVector> *931cab8e25(); // Function CableComponent.CableComponent.*931cab8e25 // Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const // @ game+0x69c3114
};
