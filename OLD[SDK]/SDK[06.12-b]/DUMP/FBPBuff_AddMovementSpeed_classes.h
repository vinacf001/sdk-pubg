...
struct AFBPBuff_AddMovementSpeed_C : ATslFBRBuff {
	...
	void UserConstructionScript(); // Function FBPBuff_AddMovementSpeed.FBPBuff_AddMovementSpeed_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x22c9a0
};
