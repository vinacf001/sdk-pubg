...
struct ABP_QOL_Marker_C : AActor {
	...
	struct TArray<struct FParticleSysParam> UserConstructionScript(); // Function BP_QOL_Marker.BP_QOL_Marker_C.UserConstructionScript // Event|Public|HasDefaults|BlueprintCallable|BlueprintEvent // @ game+0x22c9a0
};
