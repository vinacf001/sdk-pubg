...
struct UObject {
	...
	int32 ExecuteUbergraph(); // Function CoreUObject.Object.ExecuteUbergraph // Event|Public|BlueprintEvent // @ game+0x22c9a0
};
...
// Size: 0x2c0 (Inherited: 0xe8)
struct UClass : UStruct {
	char pad_E8[0x1d8]; // 0xe8(0x1d8)
};
...
struct ULinkerPlaceholderClass : UClass {
	char pad_2C0[0x1a0]; // 0x2c0(0x1a0)
};
...
struct ULinkerPlaceholderFunction : UFunction {
	char pad_140[0x1a0]; // 0x140(0x1a0)
};
