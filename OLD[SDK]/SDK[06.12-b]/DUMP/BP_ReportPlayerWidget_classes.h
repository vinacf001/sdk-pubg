...
struct UBP_ReportPlayerWidget_C : U*55d8f761b9 {
	...
	enum class *62cdf2ca7f ButtonEvent__DelegateSignature(); // Function BP_ReportPlayerWidget.BP_ReportPlayerWidget_C.ButtonEvent__DelegateSignature // Public|Delegate|BlueprintCallable|BlueprintEvent // @ game+0x22c9a0
};
