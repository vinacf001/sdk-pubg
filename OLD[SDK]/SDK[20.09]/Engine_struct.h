...
struct F*cfcaca8725 {
	enum class ECameraProjectionMode ProjectionMode; // 0x00(0x01)
	char pad_1[0x3]; // 0x01(0x03)
	char bConstrainAspectRatio : 1; // 0x04(0x01)
	char bUseFieldOfViewForLOD : 1; // 0x04(0x01)
	char pad_4_2 : 6; // 0x04(0x01)
	char pad_5[0x3]; // 0x05(0x03)
	float PostProcessBlendWeight; // 0x08(0x04)
	float OrthoNearClipPlane; // 0x0c(0x04)
	struct FPostProcessSettings PostProcessSettings; // 0x10(0x570)
	float AspectRatio; // 0x580(0x04)
	struct FVector2D OffCenterProjectionOffset; // 0x584(0x08)
	float FOV; // 0x58c(0x04)
	float OrthoFarClipPlane; // 0x590(0x04)
	struct FVector Location; // 0x594(0x0c)
	float OrthoWidth; // 0x5a0(0x04)
	struct FRotator Rotation; // 0x5a4(0x0c)
};
...
struct F*0653442295 {
	...
	char pad_8[0x8]; // 0x08(0x08)
	struct F*cfcaca8725 POV; // 0x10(0x5b0)
...
struct F*af5ae819d5 {
	...
	struct F*cfcaca8725 *a30a1fe112; // 0x10(0x5b0)
};
...
struct FWorldContext {
	char pad_0[0x8]; // 0x00(0x08)
	struct TArray<struct F*207b02ae26> PackagesToFullyLoad; // 0x08(0x10)
	struct UGameInstance* *31e7d6ddee; // 0x18(0x08)
	struct U*c15025d53a* *c15025d53a; // 0x20(0x08)
	char pad_28[0x18]; // 0x28(0x18)
	struct TArray<struct ULevel*> *0c199fcd23; // 0x40(0x10)
	struct TArray<struct F*a504c4a12a> *d9cc5d9d66; // 0x50(0x10)
	struct TArray<struct U*d1847240ea*> *f366a5d87a; // 0x60(0x10)
	struct FURL *2689ac4446; // 0x70(0x70)
	char pad_E0[0x40]; // 0xe0(0x40)
	struct UGameViewportClient* GameViewport; // 0x120(0x08)
	struct FURL *77c52629e3; // 0x128(0x70)
	char pad_198[0x8]; // 0x198(0x08)
	struct TArray<struct F*763d6f8a36> *b6d3f72c7b; // 0x1a0(0x10)
