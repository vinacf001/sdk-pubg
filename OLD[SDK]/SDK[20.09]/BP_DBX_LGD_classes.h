...
struct ABP_DBX_LGD_C : ABP_DBX_C {
	...
	struct U*614c6d2b0f* PassengerBRSeat; // 0xff0(0x08)
	struct USphereComponent* Sphere2; // 0xff8(0x08)
	struct U*614c6d2b0f* PassengerBLSeat; // 0x1000(0x08)
	struct USphereComponent* Sphere1; // 0x1008(0x08)
	struct U*614c6d2b0f* PassengerFRSeat; // 0x1010(0x08)
	struct USphereComponent* Sphere; // 0x1018(0x08)
	struct U*614c6d2b0f* DriverSeat; // 0x1020(0x08)
};
