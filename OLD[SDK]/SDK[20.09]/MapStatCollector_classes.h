...
struct UMapStatCollectorSettings : UObject {
	...
	struct TArray<struct F*2a14cb262c> CustomMinimapList; // 0x78(0x10)
	...
	struct TArray<struct F*72cbbd73a0> CustomStatEntries; // 0xb0(0x10)
	...
	struct TArray<struct F*66f4adf62f> GeneratorSettings; // 0x108(0x10)
};
