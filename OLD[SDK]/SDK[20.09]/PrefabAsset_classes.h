...
struct APrefabActor : AActor {
	...
	struct U*65fe268759* BuildingHLOD; // 0x418(0x08)

	void *5175f529f5(struct UPrefabAsset* NewPrefab); // Function PrefabAsset.PrefabActor.*5175f529f5 // Final|Native|Public|BlueprintCallable // @ game+0x6591290
	void *2440bfc1b6(); // Function PrefabAsset.PrefabActor.*2440bfc1b6 // Final|Native|Public|BlueprintCallable // @ game+0x56131d0
	void *be7b0d0791(); // Function PrefabAsset.PrefabActor.*be7b0d0791 // Final|Native|Public|BlueprintCallable // @ game+0x65911fc
	void *974d2a98c1(); // Function PrefabAsset.PrefabActor.*974d2a98c1 // Final|Native|Public|BlueprintCallable // @ game+0x65911dc
};
...
struct APrefabLODHolder : APrefabActorHolder {
	struct U*65fe268759* HLODParentComponent; // 0x3f0(0x08)
