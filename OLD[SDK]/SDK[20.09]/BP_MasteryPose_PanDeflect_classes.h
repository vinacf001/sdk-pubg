...
struct ABP_MasteryPose_PanDeflect_C : ABP_MasteryPose_C {
	...
	struct U*a355649d99* Pan; // 0x468(0x08)
	...
	void UserConstructionScript(); // Function BP_MasteryPose_PanDeflect.BP_MasteryPose_PanDeflect_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x1e037c
	void ReceiveBeginPlay(); // Function BP_MasteryPose_PanDeflect.BP_MasteryPose_PanDeflect_C.ReceiveBeginPlay // Event|Protected|BlueprintEvent // @ game+0x1e037c
	void ExecuteUbergraph_BP_MasteryPose_PanDeflect(); // Function BP_MasteryPose_PanDeflect.BP_MasteryPose_PanDeflect_C.ExecuteUbergraph_BP_MasteryPose_PanDeflect //  // @ game+0x1e037c
};
