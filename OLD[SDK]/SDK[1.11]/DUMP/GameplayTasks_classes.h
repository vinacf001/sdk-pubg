...
struct UGameplayTasksComponent : UActorComponent {
	...
	struct TArray<struct UGameplayTask*> *22beda8612; // 0x1f8(0x10)
	struct TArray<struct UGameplayTask*> *50b7ed7bd1; // 0x208(0x10)
	char pad_218[0x10]; // 0x218(0x10)
	struct TArray<struct UGameplayTask*> *02c28b0a2b; // 0x228(0x10)
...
struct UGameplayTask_SpawnActor : UGameplayTask {
	...
	struct UClass* *3772a3fd29; // 0xa0(0x08)
