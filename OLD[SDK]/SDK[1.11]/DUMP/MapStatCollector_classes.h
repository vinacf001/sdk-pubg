...
struct UMapStatCollectorSettings : UObject {
	...
	struct TArray<struct F*45fdbbfb77> CustomMinimapList; // 0x78(0x10)
	...
	struct TArray<struct F*6b30df112f> CustomStatEntries; // 0xb0(0x10)
	...
	struct TArray<struct F*818c885fc3> GeneratorSettings; // 0x108(0x10)
};
