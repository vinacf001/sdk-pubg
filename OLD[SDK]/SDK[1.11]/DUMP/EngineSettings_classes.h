...
struct UConsoleSettings : UObject {
	...
	struct TArray<struct F*d52791d8ba> ManualAutoCompleteList; // 0x30(0x10)
...
struct UGameMapsSettings : UObject {
	...
	struct TArray<struct F*c8a73dc119> GameModeMapPrefixes; // 0xb0(0x10)
	struct TArray<struct F*c8a73dc119> GameModeClassAliases; // 0xc0(0x10)
};
