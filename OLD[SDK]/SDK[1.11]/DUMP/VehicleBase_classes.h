...
struct AVehicleBase_C : ATslWheeledVehicle {
	struct F*abc8f374e0 UberGraphFrame; // 0xf50(0x08)
	struct UCameraComponent* ThirdPersonCameraInVehicle; // 0xf58(0x08)
	struct U*41fd9c33fd* ThirdPersonSpringArmInVehicle; // 0xf60(0x08)
	struct UCameraComponent* FirstPersonCameraInVehicle; // 0xf68(0x08)
	struct U*41fd9c33fd* FirstPersonSpringArmInVehicle; // 0xf70(0x08)
