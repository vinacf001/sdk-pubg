...
struct ALevelSequenceActor : AActor {
	...
	struct U*9f9d081882* SequencePlayer; // 0x420(0x08)
	...
	struct U*e18a9d1f3d* BindingOverrides; // 0x450(0x08)
	struct ULevelSequenceBurnIn* *aadc8c2092; // 0x458(0x08)
...
struct ULevelSequenceBurnInOptions : UObject {
	...
	struct FStringClassReference *be90522cb9; // 0x30(0x10)
...
struct ULevelSequenceBurnIn : UUserWidget {
	struct F*cf8a9c6e3b FrameInformation; // 0x250(0x50)
