...
struct AOnlineBeaconClient : AOnlineBeacon {
	struct AOnlineBeaconHostObject* *465249f275; // 0x410(0x08)
	struct UNetConnection* *2bf5cf4e92; // 0x418(0x08)
...
struct U*5546920ca3 : UObject {
	...
	int32 *3b1860f842; // 0x30(0x04)
	int32 *562bae12b4; // 0x34(0x04)
	int32 *95f13abb48; // 0x38(0x04)
	int32 *ffab86cd4a; // 0x3c(0x04)
	struct FName *c1419aa873; // 0x40(0x08)
	int32 *d37f51e22b; // 0x48(0x04)
	int32 *4b2ff9e913; // 0x4c(0x04)
	struct TArray<struct F*49ed00af1b> *d020b38667; // 0x50(0x10)
...
struct AOnlineBeaconHostObject : AActor {
	struct FString *c1b83c1950; // 0x3e8(0x10)
	struct UClass* *fade146e25; // 0x3f8(0x08)
	struct TArray<struct AOnlineBeaconClient*> *91ccb01995; // 0x400(0x10)
};

// Class OnlineSubsystemUtils.PartyBeaconHost
// Size: 0x570 (Inherited: 0x410)
struct APartyBeaconHost : AOnlineBeaconHostObject {
	struct U*5546920ca3* State; // 0x410(0x08)
...
struct UOnlinePIESettings : U*6c389a598a {
	...
	struct TArray<struct F*7bf36f7666> Logins; // 0x40(0x10)
};
