...
struct U*a96cf6e730 : U*f35ca81065 {
	struct FRichCurve *adee3e5a3c; // 0x28(0x70)
	struct FRichCurve *a930f64d80; // 0x98(0x70)
	struct FRichCurve *bd9fb28530; // 0x108(0x70)
};

// Class Niagara.*414166f807
// Size: 0x1e8 (Inherited: 0x28)
struct U*414166f807 : U*f35ca81065 {
	struct FRichCurve *ce07ec0a99; // 0x28(0x70)
	struct FRichCurve *ecb940efc5; // 0x98(0x70)
	struct FRichCurve *48d16680d2; // 0x108(0x70)
	struct FRichCurve *7b49fabe25; // 0x178(0x70)
};
...
struct UNiagaraDataInterfaceStaticMesh : U*ffb587be47 {
	struct UStaticMesh* *d915a96d45; // 0x28(0x08)
	struct AActor* Source; // 0x30(0x08)
	struct F*0307a8383f *1040fe5d25; // 0x38(0x68)
...
struct UNiagaraEffect : UObject {
	struct TArray<struct F*e392b910f6> *9e77b1fa9a; // 0x28(0x10)
	struct U*10bb51f6b2* EffectScript; // 0x38(0x08)
	struct TArray<struct F*a21fec00bc> *cce9fa6fe8; // 0x40(0x10)
	struct TArray<struct F*a21fec00bc> *196798934c; // 0x50(0x10)
	struct TArray<struct F*95905ae00c> *2dc7ec5b9e; // 0x60(0x10)
};
...
struct U*c76819a6cb : U*f473aed472 {
	...
	struct FVector *aad7827b48; // 0x2c(0x0c)
};
...
struct U*10bb51f6b2 : UObject {
	struct TArray<bool> *d416a96c4c; // 0x28(0x10)
	struct F*5aeb905912 Parameters; // 0x38(0x10)
	struct F*5aeb905912 *8c18bf1a47; // 0x48(0x10)
	struct TArray<struct F*831ef3e2b5> Attributes; // 0x58(0x10)
	struct TArray<struct F*ba006c8db9> EventReceivers; // 0x68(0x10)
	struct TArray<struct F*ba006c8db9> *b365273800; // 0x78(0x10)
	struct F*4d34e704b7 *6ebe3ebafa; // 0x88(0x01)
	enum class ENiagaraScriptUsage Usage; // 0x89(0x01)
	char pad_8A[0x6]; // 0x8a(0x06)
	struct TArray<struct F*f4f6cf12de> *4bb3aa44c3; // 0x90(0x10)
	struct TArray<struct F*293bdb6ea6> *ee5a337021; // 0xa0(0x10)
	enum class ENiagaraNumericOutputTypeSelectionMode *a62f758b32; // 0xb0(0x01)
	char pad_B1[0x27]; // 0xb1(0x27)
	struct TArray<struct F*71a0132d52> *4e9054fe7f; // 0xd8(0x10)
};
...
struct U*a99086bd72 : UObject {
	...
	float *0abd4a1669; // 0x3c(0x04)
	int32 *97ddf9fa54; // 0x40(0x04)
	enum class ENiagaraCollisionMode *bee0f29f88; // 0x44(0x01)
	char pad_45[0x3]; // 0x45(0x03)
	struct U*f473aed472* *f180b26425; // 0x48(0x08)
	struct F*c2b29cb2c9 *f3dcfd2c23; // 0x50(0x28)
	struct F*c2b29cb2c9 *61c695c795; // 0x78(0x28)
	struct F*603143bda9 *161806681c; // 0xa0(0x50)
	struct TArray<struct F*b8f3e1d819> *d6fb43e5a2; // 0xf0(0x10)
