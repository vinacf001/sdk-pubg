...
struct UVehicleWheel : UObject {
	struct UStaticMesh* *a70c05f3b9; // 0x28(0x08)
	bool *bc34d8b9e9; // 0x30(0x01)
	bool *8f23d4aba4; // 0x31(0x01)
	char pad_32[0x2]; // 0x32(0x02)
	struct FVector Offset; // 0x34(0x0c)
	float *a6fad8133e; // 0x40(0x04)
	float *b5086a1f8f; // 0x44(0x04)
	float Mass; // 0x48(0x04)
	float *0cd6b72831; // 0x4c(0x04)
	float SteerAngle; // 0x50(0x04)
	bool *9d0039d379; // 0x54(0x01)
	char pad_55[0x3]; // 0x55(0x03)
	struct U*1c2e584736* *1c2e584736; // 0x58(0x08)
	struct U*4a072dac49* *4a072dac49; // 0x60(0x08)
	float *5c41d3570b; // 0x68(0x04)
	float *85b3915485; // 0x6c(0x04)
	float *954eed9daf; // 0x70(0x04)
	float *bf5266eea9; // 0x74(0x04)
	float *819bd22477; // 0x78(0x04)
	struct FVector *753d2825c3; // 0x7c(0x0c)
	struct FVector *a962ba2ca3; // 0x88(0x0c)
	float *9a93643092; // 0x94(0x04)
	float *5cca6d2acf; // 0x98(0x04)
	float *1bd2bf6fa3; // 0x9c(0x04)
	float *943de7e5fb; // 0xa0(0x04)
	float *81756536d3; // 0xa4(0x04)
	float *7ca7ad3289; // 0xa8(0x04)
	float *815c148354; // 0xac(0x04)
	struct F*8523fec421 *8523fec421; // 0xb0(0x14)
	float *d26b05c27f; // 0xc4(0x04)
	float *4b14da5fb6; // 0xc8(0x04)
	enum class ECollisionChannel *4441f491a6; // 0xcc(0x01)
	char pad_CD[0x3]; // 0xcd(0x03)
	struct UWheeledVehicleMovementComponent* VehicleSim; // 0xd0(0x08)
	int32 *c59b13a648; // 0xd8(0x04)
	float *80f951c974; // 0xdc(0x04)
	float *658b1e35d2; // 0xe0(0x04)
	float *fc25da49f0; // 0xe4(0x04)
	char pad_E8[0x4]; // 0xe8(0x04)
	float *5624989783; // 0xec(0x04)
	float *a524cac3eb; // 0xf0(0x04)
	float *1576a0580d; // 0xf4(0x04)
	struct FVector Location; // 0xf8(0x0c)
	struct FVector OldLocation; // 0x104(0x0c)
	struct FVector Velocity; // 0x110(0x0c)
	float *a788eb2b5f; // 0x11c(0x04)
...
struct UWheeledVehicleMovementComponent : UPawnMovementComponent {
	...
	struct TArray<bool> *bbc44a9454; // 0x298(0x10)
	struct TArray<struct F*4bbb30343f> *ed2151afc1; // 0x2a8(0x10)
	struct TArray<struct F*5f66ed682c> *83dd50c122; // 0x2b8(0x10)
	float Mass; // 0x2c8(0x04)
	float DragCoefficient; // 0x2cc(0x04)
	float *613c932735; // 0x2d0(0x04)
	float *b72731dcfd; // 0x2d4(0x04)
	bool *e0c71cc22f; // 0x2d8(0x01)
	char pad_2D9[0x3]; // 0x2d9(0x03)
	float *fe83aa1903; // 0x2dc(0x04)
	float *881fefe4f0; // 0x2e0(0x04)
	float *cd6f35e8dc; // 0x2e4(0x04)
	float *9b74103b03; // 0x2e8(0x04)
	struct FVector *292e1b1f1a; // 0x2ec(0x0c)
	float *f92e9c22e1; // 0x2f8(0x04)
	float *e327e8b972; // 0x2fc(0x04)
	float *dc306b8228; // 0x300(0x04)
	float *e61bd34036; // 0x304(0x04)
	float *6fec0a364a; // 0x308(0x04)
	float *5147fec91d; // 0x30c(0x04)
	...
	struct F*f2710e04b9 AvoidanceGroup; // 0x35c(0x04)
	struct F*f2710e04b9 GroupsToAvoid; // 0x360(0x04)
	struct F*f2710e04b9 GroupsToIgnore; // 0x364(0x04)
	float AvoidanceWeight; // 0x368(0x04)
	struct FVector *e29a3efc6f; // 0x36c(0x0c)
	char pad_378[0x4]; // 0x378(0x04)
	struct F*ea6b647fa8 *1b892d1067; // 0x37c(0x1c)
	char pad_398[0xf8]; // 0x398(0xf8)
	float *55a9e199e6; // 0x490(0x04)
	float *09b9af4d9f; // 0x494(0x04)
	float *30f956f0e2; // 0x498(0x04)
	...
	float *92e2c3902f; // 0x4a0(0x04)
	float *965bf1f225; // 0x4a4(0x04)
	float *76c0240d50; // 0x4a8(0x04)
	int32 *edec843a95; // 0x4ac(0x04)
	float *b486c6fc45; // 0x4b0(0x04)
	float *511051753a; // 0x4b4(0x04)
	float BrakeInput; // 0x4b8(0x04)
	float *40b41e4b8d; // 0x4bc(0x04)
	float *7cd228f39a; // 0x4c0(0x04)
	float *8fc7945ad0; // 0x4c4(0x04)
	float *60bb788f85; // 0x4c8(0x04)
	struct F*9d54d4c4f6 *7ff2d7b2c9; // 0x4cc(0x08)
	struct F*9d54d4c4f6 *9ddff5acd8; // 0x4d4(0x08)
	struct F*9d54d4c4f6 *08e3abdb0f; // 0x4dc(0x08)
	struct F*9d54d4c4f6 *57651e2f96; // 0x4e4(0x08)
...
struct UWheeledVehicleMovementComponent4W : UWheeledVehicleMovementComponent {
	struct F*59dac41ed6 EngineSetup; // 0x528(0x90)
	struct F*e57d981de0 *90c75b2078; // 0x5b8(0x1c)
	struct FVehicleTransmissionData *75ff14b76b; // 0x5d8(0x30)
	struct FRuntimeFloatCurve SteeringCurve; // 0x608(0x78)
	float *103ab4cebd; // 0x680(0x04)
...
struct U*4a072dac49 : UDataAsset {
	...
	struct TArray<struct F*42ae5cb29f> *e11ee3dc6e; // 0x38(0x10)
	char pad_48[0x8]; // 0x48(0x08)
	struct F*0b9c1223db *81ac8ba2ff; // 0x50(0x28)
	bool *ccf97c98ce; // 0x78(0x01)
	char pad_79[0x3]; // 0x79(0x03)
	float *17df7c5e1b; // 0x7c(0x04)
};
