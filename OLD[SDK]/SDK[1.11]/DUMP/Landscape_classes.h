...
struct U*36c3e95555 : UObject {
	struct TArray<struct F*4aaf79b99f> *6873070d3f; // 0x28(0x10)
...
struct ULandscapeInfo : UObject {
	...
	struct FGuid *6cb6909a1b; // 0x44(0x10)
	int32 *ae877a5ca7; // 0x54(0x04)
	int32 *7cd27fee79; // 0x58(0x04)
	int32 *e033e3f9de; // 0x5c(0x04)
	struct FVector *a21c6990fc; // 0x60(0x0c)
	char pad_6C[0x54]; // 0x6c(0x54)
	SetProperty *77641bec8d; // 0xc0(0x50)
...
struct ALandscapeMeshProxyActor : AActor {
	struct U*7f12d8f510* LandscapeMeshProxyComponent; // 0x3e8(0x08)
};
...
struct ALandscapeProxy : AActor {
	struct FGuid *6cb6909a1b; // 0x3e8(0x10)
	struct ULandscapeSplinesComponent* SplineComponent; // 0x3f8(0x08)
	int32 *ae877a5ca7; // 0x400(0x04)
	int32 *7cd27fee79; // 0x404(0x04)
	int32 *f53aeea43c; // 0x408(0x04)
	struct FIntPoint *f753b943ed; // 0x40c(0x08)
	...
	float *4fb34d5583; // 0x448(0x04)
	float *c154edc768; // 0x44c(0x04)
	struct TArray<struct ULandscapeComponent*> LandscapeComponents; // 0x450(0x10)
	struct TArray<struct ULandscapeHeightfieldCollisionComponent*> *985691eccd; // 0x460(0x10)
	struct TArray<struct UHierarchicalInstancedStaticMeshComponent*> *7d9b02b42d; // 0x470(0x10)
	...
	struct F*25888ccc71 LightmassSettings; // 0x4f0(0x18)
	int32 CollisionMipLevel; // 0x508(0x04)
	int32 *8bb396e6d2; // 0x50c(0x04)
	float *0874902f89; // 0x510(0x04)
...
struct ULandscapeSplineSegment : UObject {
	struct F*38bae448f8 Connections[0x02]; // 0x28(0x30)
	struct FInterpCurveVector *7fbc8dae1b; // 0x58(0x18)
	struct TArray<struct F*41b77fad4b> Points; // 0x70(0x10)
...
struct ULandscapeSplineControlPoint : UObject {
	...
	float *420e52b73b; // 0x44(0x04)
	float *28aa6413f3; // 0x48(0x04)
	char pad_4C[0x4]; // 0x4c(0x04)
	struct TArray<struct F*76654afa35> *8f6acb6a5b; // 0x50(0x10)
	struct TArray<struct F*41b77fad4b> Points; // 0x60(0x10)
...
struct U*57d6832fc3 : U*9cae02a0c8 {
	...
	struct FExpressionInput *4d5db406b1; // 0x108(0x38)
	struct FExpressionInput *5e5da3349b; // 0x140(0x38)
	struct TArray<struct F*bcb04eef45> Layers; // 0x178(0x10)
	uint32 *b76d4888c5; // 0x188(0x04)
	struct FGuid *8f84b5e332; // 0x18c(0x10)
...
struct U*48ace594aa : U*6a03f15cb4 {
	struct TArray<struct F*a8cc136970> *a1c78ed6e9; // 0x60(0x10)
};

// Class Landscape.MaterialExpressionLandscapeLayerBlend
// Size: 0x80 (Inherited: 0x60)
struct UMaterialExpressionLandscapeLayerBlend : UMaterialExpression {
	struct TArray<struct F*62eed615ea> Layers; // 0x60(0x10)
...
struct UMaterialExpressionLandscapeLayerCoords : UMaterialExpression {
	...
	float *5bcba46db5; // 0x64(0x04)
	float *5ae25e3928; // 0x68(0x04)
	float *5c1c259cdf; // 0x6c(0x04)
	float *8d3a894c90; // 0x70(0x04)
...
struct U*bbf9bf094f : UMaterialExpression {
	...
	float *df24f95344; // 0x68(0x04)
	struct FGuid *8f84b5e332; // 0x6c(0x10)
...
struct UMaterialExpressionLandscapeLayerSwitch : UMaterialExpression {
	struct FExpressionInput *1463af9b79; // 0x60(0x38)
	struct FExpressionInput *62103cfb7e; // 0x98(0x38)
	struct FName ParameterName; // 0xd0(0x08)
	char *a3821fd24f : 1; // 0xd8(0x01)
	char pad_D8_1 : 7; // 0xd8(0x01)
	char pad_D9[0x3]; // 0xd9(0x03)
	struct FGuid *8f84b5e332; // 0xdc(0x10)
...
struct UMaterialExpressionLandscapeLayerWeight : UMaterialExpression {
	...
	struct FName ParameterName; // 0xd0(0x08)
	float *df24f95344; // 0xd8(0x04)
	struct FVector *61c1ca53a0; // 0xdc(0x0c)
	struct FGuid *8f84b5e332; // 0xe8(0x10)
};

// Class Landscape.MaterialExpressionLandscapeVisibilityMask
// Size: 0x70 (Inherited: 0x60)
struct UMaterialExpressionLandscapeVisibilityMask : UMaterialExpression {
	struct FGuid *8f84b5e332; // 0x60(0x10)
};
