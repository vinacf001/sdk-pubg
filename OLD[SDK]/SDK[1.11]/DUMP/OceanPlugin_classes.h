...
struct AOceanManager : AActor {
	...
	struct TArray<struct F*a8ec53011e> WaveClusters; // 0x400(0x10)
	struct TArray<struct F*6f9a383ca9> WaveSetOffsetsOverride; // 0x410(0x10)
...
struct ABuoyantDestructible : AActor {
	struct U*ed33f09e51* BuoyantDestructibleComponent; // 0x3e8(0x08)
};
...
struct ATimeManager : AActor {
	struct F*de25589e23 CurrentLocalTime; // 0x3e8(0x1c)
...
struct U*5571daa0c5 : UActorComponent {
	...
	struct AOceanManager* *5f6aac570d; // 0x260(0x08)
