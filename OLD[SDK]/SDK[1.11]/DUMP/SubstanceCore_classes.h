...
struct USubstanceGraphInstance : UObject {
	...
	struct FString *ab0d670509; // 0x30(0x10)
	struct USubstanceInstanceFactory* *bdb23a5566; // 0x40(0x08)
	struct TMap<uint32, struct U*3dec47dc88*> *e5fc51ad53; // 0x48(0x50)
	struct UMaterial* *77462bba2f; // 0x98(0x08)
	struct TMap<int32, struct FGuid> *1a6f971d6a; // 0xa0(0x50)
...
struct U*3dec47dc88 : UObject {
	...
	int32 *b207f8f48e; // 0x130(0x04)
	int32 *424968a57c; // 0x134(0x04)
...
struct USubstanceInstanceFactory : UObject {
	...
	struct FString *196aaf505b; // 0x38(0x10)
	struct FString *d0de12d566; // 0x48(0x10)
	struct FString *f5a509715f; // 0x58(0x10)
...
struct U*ca364f24a9 : U*0aab017b56 {
	...
	struct USubstanceGraphInstance* *de67f705ee; // 0x1d0(0x08)
