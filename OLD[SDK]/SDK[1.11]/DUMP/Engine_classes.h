...
struct AActor : UObject {
	...
	float NetUpdateFrequency; // 0x44(0x04)
	struct FMulticastDelegate OnEndCursorOver; // 0x48(0x10)
	...
	struct FName *ab64aa9b2c; // 0x60(0x08)
	...
	struct F*f897083c18 *732a816970; // 0xb0(0x40)
	float *7974797124; // 0xf0(0x04)
	float NetCullDistanceSquared; // 0xf4(0x04)
	float NetPriority; // 0xf8(0x04)
	char pad_FC[0x4]; // 0xfc(0x04)
	struct TArray<struct FName> Layers; // 0x100(0x10)
	enum class ENetRole Role; // 0x110(0x01)
	char pad_111[0x7]; // 0x111(0x07)
	struct FMulticastDelegate OnBeginCursorOver; // 0x118(0x10)
	struct UChildActorComponent* *bcea33173e; // 0x128(0x08)
	...
	struct FMulticastDelegate OnReleased; // 0x188(0x10)
	enum class EAutoReceiveInput *1b5d625838; // 0x198(0x01)
	char pad_199[0x7]; // 0x199(0x07)
	struct FMulticastDelegate OnInputTouchBegin; // 0x1a0(0x10)
	uint64 *5b976d7486; // 0x1b0(0x08)
	struct APawn* Instigator; // 0x1b8(0x08)
	int32 *024611cfc7; // 0x1c0(0x04)
	...
	struct FMulticastDelegate OnInputTouchEnter; // 0x1c8(0x10)
	struct AActor* ParentComponentActor; // 0x1d8(0x08)
	struct FMulticastDelegate OnTakeAnyDamage; // 0x1e0(0x10)
	float CustomTimeDilation; // 0x1f0(0x04)
	char pad_1F4[0x4]; // 0x1f4(0x04)
	struct TArray<struct AMatineeActor*> *8a80c37de5; // 0x1f8(0x10)
	char pad_208[0x58]; // 0x208(0x58)
	struct TArray<struct UActorComponent*> InstanceComponents; // 0x260(0x10)
	struct FGuid DestructibleId; // 0x270(0x10)
	bool bIsDestroyedVersion; // 0x280(0x01)
	bool RemoveFromLevelLOD; // 0x281(0x01)
	char pad_282[0x6]; // 0x282(0x06)
	struct F*82957ba793 PrimaryActorTick; // 0x288(0x58)
	float MinNetUpdateFrequency; // 0x2e0(0x04)
	char pad_2E4[0x4]; // 0x2e4(0x04)
	struct TArray<struct UActorComponent*> BlueprintCreatedComponents; // 0x2e8(0x10)
	struct TArray<struct FName> Tags; // 0x2f8(0x10)
	struct FMulticastDelegate OnInputTouchEnd; // 0x308(0x10)
	struct FMulticastDelegate OnTakePointDamage; // 0x318(0x10)
	...
	struct U*4aa7f8d102* *4aa7f8d102; // 0x348(0x08)
	struct FMulticastDelegate OnClicked; // 0x350(0x10)
	int32 *16d0bb46bd; // 0x360(0x04)
	...
	struct USceneComponent* RootComponent; // 0x368(0x08)
	struct FMulticastDelegate OnInputTouchLeave; // 0x370(0x10)
	struct FMulticastDelegate OnActorBeginOverlap; // 0x380(0x10)
	float InitialLifeSpan; // 0x390(0x04)
	char pad_394[0x4]; // 0x394(0x04)
	struct TArray<struct AActor*> Children; // 0x398(0x10)
...
struct UAnimInstance : UObject {
	...
	struct USkeleton* *ed667f4877; // 0x30(0x08)
	...
	struct TArray<struct FAnimNotifyEvent> *505b5151ee; // 0x190(0x10)
...
struct UActorComponent : UObject {
	...
	struct F*0f0451e91e PrimaryComponentTick; // 0x110(0x58)
	...
	struct TArray<struct FSimpleMemberReference> *146dc34f04; // 0x1b0(0x10)
...
struct APawn : AActor {
	...
	struct AController* *ae51997ba6; // 0x408(0x08)
	struct APlayerState* PlayerState; // 0x410(0x08)
	char pad_418[0x8]; // 0x418(0x08)
	struct AController* Controller; // 0x420(0x08)
	uint16 *b10f56f1ec; // 0x428(0x02)
	char pad_42A[0x6]; // 0x42a(0x06)
	struct FVector *814ccd4912; // 0x430(0x0c)
	struct FVector *3f76097423; // 0x43c(0x0c)
...
struct UDataAsset : UObject {
	struct UClass* *10becfdadd; // 0x28(0x08)
};
...
struct USceneComponent : UActorComponent {
	...
	struct FVector *9a43cb5eb0; // 0x1f8(0x0c)
	...
	struct APhysicsVolume* PhysicsVolume; // 0x244(0x08)
	char pad_24C[0x20]; // 0x24c(0x20)
	struct FVector RelativeLocation; // 0x26c(0x0c)
	char pad_278[0x28]; // 0x278(0x28)
	enum class *8d98cbd81d DetailMode; // 0x2a0(0x01)
	char pad_2A1[0x7]; // 0x2a1(0x07)
	SetProperty *e5b54241ae; // 0x2a8(0x50)
	char pad_2F8[0x28]; // 0x2f8(0x28)
	struct TArray<struct USceneComponent*> AttachChildren; // 0x320(0x10)
	char pad_330[0x40]; // 0x330(0x40)
	struct FVector RelativeTranslation; // 0x370(0x0c)
	struct FVector RelativeScale3D; // 0x37c(0x0c)
	struct FRotator RelativeRotation; // 0x388(0x0c)
	char pad_394[0x4]; // 0x394(0x04)
	struct FName *d373ab65c0; // 0x398(0x08)
...
struct UPawnMovementComponent : UNavMovementComponent {
	struct APawn* *9376ef64fb; // 0x270(0x08)
...
struct UCharacterMovementComponent : UPawnMovementComponent {
	...
	struct ACharacter* *4938c83d2a; // 0x288(0x08)
	...
	float *dd15910807; // 0x2a4(0x04)
	float *5071bbe841; // 0x2a8(0x04)
	char pad_2AC[0x4]; // 0x2ac(0x04)
	float *1aeeb67342; // 0x2b0(0x04)
	float *d1c2ea1058; // 0x2b4(0x04)
	...
	struct USceneComponent* *e932784708; // 0x350(0x08)
	...
	struct FVector *f2cdf36f17; // 0x3a4(0x0c)
	struct FQuat *2344f9b1ba; // 0x3b0(0x10)
	struct FVector *3d5bc6c8e3; // 0x3c0(0x0c)
	float *1379983bf5; // 0x3cc(0x04)
	float *9b713bace2; // 0x3d0(0x04)
	float *32f74edb4a; // 0x3d4(0x04)
	struct FVector *53684725eb; // 0x3d8(0x0c)
	struct FVector *83c3dcb84b; // 0x3e4(0x0c)
	float *18b0dcf7ea; // 0x3f0(0x04)
	...
	float *bc7a9107d9; // 0x414(0x04)
	float *f468814d86; // 0x418(0x04)
	float *396f8361b7; // 0x41c(0x04)
	float *58c123bfd6; // 0x420(0x04)
	float *95b5d33d2f; // 0x424(0x04)
	float *1a782b9ac2; // 0x428(0x04)
	float *f5bbe755ef; // 0x42c(0x04)
	float *48231160a6; // 0x430(0x04)
	enum class ENetworkSmoothingMode NetworkSmoothingMode; // 0x434(0x01)
	char pad_435[0x3]; // 0x435(0x03)
	float *dfc538dd63; // 0x438(0x04)
	float *6a6d42d7f4; // 0x43c(0x04)
	float *afadae7855; // 0x440(0x04)
	float *33d9b4fb8b; // 0x444(0x04)
	float LedgeCheckThreshold; // 0x448(0x04)
	float JumpOutOfWaterPitch; // 0x44c(0x04)
	struct F*3718d46421 CurrentFloor; // 0x450(0x98)
	...
	struct FVector *71a3c5f6d6; // 0x51c(0x0c)
	int32 AvoidanceUID; // 0x528(0x04)
	struct F*f2710e04b9 AvoidanceGroup; // 0x52c(0x04)
	struct F*f2710e04b9 GroupsToAvoid; // 0x530(0x04)
	struct F*f2710e04b9 GroupsToIgnore; // 0x534(0x04)
	float AvoidanceWeight; // 0x538(0x04)
	struct FVector *e29a3efc6f; // 0x53c(0x0c)
	char pad_548[0xa8]; // 0x548(0xa8)
	float NavMeshProjectionInterval; // 0x5f0(0x04)
	float *7a0e85f2f7; // 0x5f4(0x04)
	...
	struct F*7d36dc8762 *f4c4231f71; // 0x6b8(0x58)
	char pad_710[0x10]; // 0x710(0x10)
	float *4df95f3c1b; // 0x720(0x04)
	char pad_724[0x4]; // 0x724(0x04)
	struct FRootMotionSourceGroup *d26ef8f08d; // 0x728(0x100)
	char pad_828[0x98]; // 0x828(0x98)
	struct F*77ba1cb021 *67f0cdfabe; // 0x8c0(0x40)
	struct FVector *45e1cf143e; // 0x900(0x0c)
...
struct AHUD : AActor {
	...
	struct TArray<struct AActor*> *5e3e96ddc9; // 0x3f8(0x10)
	...
	struct UCanvas* *4e5d7ebf6f; // 0x438(0x08)
	struct TArray<struct F*56b1f6ab8b> *71494f9592; // 0x440(0x10)
	struct UClass* *87c7d0deab; // 0x450(0x08)
	struct AActor* *a812f78775; // 0x458(0x08)
...
struct ABrush : AActor {
	...
	struct TArray<struct F*5bb08df245> *9d01312ac4; // 0x410(0x10)
};
...
struct UDataTable : UObject {
	struct UScriptStruct* *ead82841b2; // 0x28(0x08)
...
struct ACharacter : APawn {
	...
	int32 JumpCurrentCount; // 0x44c(0x04)
	float *1f829a81a5; // 0x450(0x04)
	float JumpMaxHoldTime; // 0x454(0x04)
	...
	struct UCharacterMovementComponent* CharacterMovement; // 0x470(0x08)
	float JumpKeyHoldTime; // 0x478(0x04)
	char pad_47C[0x4]; // 0x47c(0x04)
	struct F*6e7b288381 *fde57a2c96; // 0x480(0x48)
	char pad_4C8[0x8]; // 0x4c8(0x08)
	struct FQuat *e5f2932677; // 0x4d0(0x10)
	float CrouchedEyeHeight; // 0x4e0(0x04)
	char bIsCrouched : 1; // 0x4e4(0x01)
	char pad_4E4_1 : 7; // 0x4e4(0x01)
	char pad_4E5[0x3]; // 0x4e5(0x03)
	struct FVector *fa08663006; // 0x4e8(0x0c)
	char pad_4F4[0x4]; // 0x4f4(0x04)
	struct F*6e7b288381 *950fafca74; // 0x4f8(0x48)
	struct UCapsuleComponent* CapsuleComponent; // 0x540(0x08)
	int32 JumpMaxCount; // 0x548(0x04)
	char pad_54C[0x4]; // 0x54c(0x04)
	struct USkeletalMeshComponent* Mesh; // 0x550(0x08)
	...
	struct FRootMotionSourceGroup *795892ac52; // 0x598(0x100)
...
struct AController : AActor {
	...
	struct FRotator *c58941edc9; // 0x414(0x0c)
	...
	struct APlayerState* PlayerState; // 0x450(0x08)
...
struct AGameModeBase : AInfo {
	...
	struct FText *638604ca81; // 0x458(0x18)
...
struct AGameMode : AGameModeBase {
	struct FName *59acc54cb2; // 0x488(0x08)
	...
	struct UClass* *aa08ae227e; // 0x4a8(0x08)
	struct TArray<struct APlayerState*> *ea842fe704; // 0x4b0(0x10)
	float *40f6dab750; // 0x4c0(0x04)
...
struct ASkeletalMeshActor : AActor {
	...
	struct USkeletalMesh* *573ace7b5a; // 0x400(0x08)
	struct UPhysicsAsset* *12e34c7fa2; // 0x408(0x08)
	struct UMaterialInterface* *4da1d1f3fd; // 0x410(0x08)
	struct UMaterialInterface* *77466e8dca; // 0x418(0x08)
...
struct AGameStateBase : AInfo {
	...
	char pad_411[0x3]; // 0x411(0x03)
	float *b9ef543610; // 0x414(0x04)
	float *9c9ecdea9a; // 0x418(0x04)
	float *f4a4fb2240; // 0x41c(0x04)
	char pad_420[0x8]; // 0x420(0x08)
...
struct UGameInstance : UObject {
	...
	struct U*ff4b8fbd53* *ff4b8fbd53; // 0x40(0x08)
	char pad_48[0xa8]; // 0x48(0xa8)
	struct U*07115daa65* *07115daa65; // 0xf0(0x08)
...
struct ATriggerBase : AActor {
	struct U*18316965f0* CollisionComponent; // 0x3e8(0x08)
};
...
struct ANavigationObjectBase : AActor {
	...
	struct UBillboardComponent* *b6f12a9063; // 0x3f8(0x08)
	struct UBillboardComponent* *a948621fe9; // 0x400(0x08)
...
struct UCheatManager : UObject {
	struct ADebugCameraController* *d00d1e9c98; // 0x28(0x08)
...
struct UEngine : UObject {
	...
	struct UFont* *43105ceb99; // 0x60(0x08)
	...
	struct UFont* *529be18812; // 0x90(0x08)
	struct FStringAssetReference SubtitleFontName; // 0x98(0x10)
	struct TArray<struct UFont*> *df25b95969; // 0xa8(0x10)
	struct UTexture2D* *2dbaebc744; // 0xb8(0x08)
	struct UClass* *174a7c81db; // 0xc0(0x08)
	struct UMaterialInstanceDynamic* *2119402b4a; // 0xc8(0x08)
	struct UTexture2D* MiniFontTexture; // 0xd0(0x08)
	struct UMaterial* WireframeMaterial; // 0xd8(0x08)
	float MinDesiredFrameRate; // 0xe0(0x04)
	char pad_E4[0x4]; // 0xe4(0x04)
	struct FStringClassReference AIControllerClassName; // 0xe8(0x10)
	struct FString *5e1c88c287; // 0xf8(0x10)
	struct UClass* *86fb8d6a19; // 0x108(0x08)
	struct UMaterial* *dd5db1982c; // 0x110(0x08)
	struct FStringClassReference GameUserSettingsClassName; // 0x118(0x10)
	struct TArray<struct FLinearColor> HLODColorationColors; // 0x128(0x10)
	struct UTexture* DefaultDiffuseTexture; // 0x138(0x08)
	struct UClass* *6ab1c3b78a; // 0x140(0x08)
	struct FColor *30bc7575f3; // 0x148(0x04)
	struct FColor *c1f4779d2d; // 0x14c(0x04)
	struct UClass* *c79d88195f; // 0x150(0x08)
	float *25fcb3b672; // 0x158(0x04)
	float FixedFrameRate; // 0x15c(0x04)
	struct FStringAssetReference DefaultBloomKernelTextureName; // 0x160(0x10)
	struct UTexture2D* *e051d30398; // 0x170(0x08)
	struct FStringAssetReference ArrowMaterialName; // 0x178(0x10)
	struct FString ShadedLevelColorationUnlitMaterialName; // 0x188(0x10)
	struct FStringAssetReference DefaultPhysMaterialName; // 0x198(0x10)
	char bRenderLightMapDensityGrayscale : 1; // 0x1a8(0x01)
	char pad_1A8_1 : 7; // 0x1a8(0x01)
	char pad_1A9[0x7]; // 0x1a9(0x07)
	struct TArray<struct F*ce85c43b15> ActivePluginRedirects; // 0x1b0(0x10)
	struct FLinearColor LightMapDensitySelectedColor; // 0x1c0(0x10)
	char bSubtitlesForcedOff : 1; // 0x1d0(0x01)
	char pad_1D0_1 : 7; // 0x1d0(0x01)
	char pad_1D1[0x7]; // 0x1d1(0x07)
	struct UMaterialInstanceDynamic* *5459d9699e; // 0x1d8(0x08)
	struct FColor *8778089533; // 0x1e0(0x04)
	struct FFloatRange SmoothedFrameRateRange; // 0x1e4(0x10)
	struct FColor *50e4ab95e6; // 0x1f4(0x04)
	char bHardwareSurveyEnabled : 1; // 0x1f8(0x01)
	char pad_1F8_1 : 7; // 0x1f8(0x01)
	char pad_1F9[0x7]; // 0x1f9(0x07)
	struct FStringClassReference DefaultBlueprintBaseClassName; // 0x200(0x10)
	struct TArray<struct F*a72ab554af> ActiveStructRedirects; // 0x210(0x10)
	...
	struct UTexture2D* *16c3f7b8ed; // 0x240(0x08)
	struct TArray<struct FLinearColor> StreamingAccuracyColors; // 0x248(0x10)
	struct UMaterial* *1f9f176dd8; // 0x258(0x08)
	struct FColor *c944d746ad; // 0x260(0x04)
	char pad_264[0x4]; // 0x264(0x04)
	struct FStringClassReference LevelScriptActorClassName; // 0x268(0x10)
	float MaxES2PixelShaderAdditiveComplexityCount; // 0x278(0x04)
	int32 *1b556eb405; // 0x27c(0x04)
	struct FStringAssetReference RemoveSurfaceMaterialName; // 0x280(0x10)
	float RenderLightMapDensityColorScale; // 0x290(0x04)
	struct FColor *feb2694aca; // 0x294(0x04)
	struct FStringAssetReference PreIntegratedSkinBRDFTextureName; // 0x298(0x10)
	struct TArray<struct FString> *bae10a5147; // 0x2a8(0x10)
	char pad_2B8[0x18]; // 0x2b8(0x18)
	struct FStringClassReference AvoidanceManagerClassName; // 0x2d0(0x10)
	struct FString LightingTexelDensityName; // 0x2e0(0x10)
	struct FString LevelColorationUnlitMaterialName; // 0x2f0(0x10)
	struct UMaterial* LevelColorationLitMaterial; // 0x300(0x08)
	struct FStringAssetReference DefaultDiffuseTextureName; // 0x308(0x10)
	struct FStringClassReference AssetManagerClassName; // 0x318(0x10)
	float MaxOcclusionPixelsFraction; // 0x328(0x04)
	char pad_32C[0x4]; // 0x32c(0x04)
	struct FStringAssetReference HighFrequencyNoiseTextureName; // 0x330(0x10)
	struct TArray<struct FLinearColor> LightComplexityColors; // 0x340(0x10)
	struct UClass* *fe1481b5c8; // 0x350(0x08)
	struct UTexture* WeightMapPlaceholderTexture; // 0x358(0x08)
	...
	struct UTexture2D* DefaultTexture; // 0x378(0x08)
	struct FLinearColor LightingOnlyBrightness; // 0x380(0x10)
	struct FLinearColor LightingOnlySpecular; // 0x390(0x10)
	struct UMaterial* *e68fc694c0; // 0x3a0(0x08)
	struct FLinearColor LightMapDensityVertexMappedColor; // 0x3a8(0x10)
	struct UMaterial* *85c25c83f5; // 0x3b8(0x08)
	...
	struct FString VertexColorViewModeMaterialName_ColorOnly; // 0x3c8(0x10)
	struct UMaterial* VertexColorMaterial; // 0x3d8(0x08)
	struct UPhysicalMaterial* DefaultPhysMaterial; // 0x3e0(0x08)
	struct FString *89fb77e73a; // 0x3e8(0x10)
	struct TArray<struct FString> AdditionalFontNames; // 0x3f8(0x10)
	struct FStringClassReference PhysicsCollisionHandlerClassName; // 0x408(0x10)
	char bAllowMatureLanguage : 1; // 0x418(0x01)
	char pad_418_1 : 7; // 0x418(0x01)
	char pad_419[0x3]; // 0x419(0x03)
	float CameraRotationThreshold; // 0x41c(0x04)
	char pad_420[0x50]; // 0x420(0x50)
	struct TArray<struct FLinearColor> StationaryLightOverlapColors; // 0x470(0x10)
	struct TArray<struct FLinearColor> LODColorationColors; // 0x480(0x10)
	struct FColor *891c4f69de; // 0x490(0x04)
	char pad_494[0x4]; // 0x494(0x04)
	struct UMaterial* *46fcb09c9b; // 0x498(0x08)
	struct FStringAssetReference MiniFontTextureName; // 0x4a0(0x10)
	struct UMaterial* ShadedLevelColorationLitMaterial; // 0x4b0(0x08)
	struct UClass* *36300cd617; // 0x4b8(0x08)
	float IdealLightMapDensity; // 0x4c0(0x04)
	char pad_4C4[0x4]; // 0x4c4(0x04)
	struct TArray<struct F*6b88783d53> ActiveGameNameRedirects; // 0x4c8(0x10)
	struct FStringAssetReference InvalidLightmapSettingsMaterialName; // 0x4d8(0x10)
	struct TArray<struct FLinearColor> QuadComplexityColors; // 0x4e8(0x10)
	struct UMaterial* *31885943df; // 0x4f8(0x08)
	struct FStringAssetReference DefaultBSPVertexTextureName; // 0x500(0x10)
	struct FString VertexColorViewModeMaterialName_RedOnly; // 0x510(0x10)
	struct FStringAssetReference DebugMeshMaterialName; // 0x520(0x10)
	enum class *a483700a66 *3c98a1a7dd; // 0x530(0x01)
	char pad_531[0x7]; // 0x531(0x07)
	struct UTexture2D* *98f6787349; // 0x538(0x08)
	struct UClass* *2d50dcfa17; // 0x540(0x08)
	struct TArray<struct FLinearColor> ShaderComplexityColors; // 0x548(0x10)
	struct UMaterial* LevelColorationUnlitMaterial; // 0x558(0x08)
	float NetClientTicksPerSecond; // 0x560(0x04)
	int32 *a344514e05; // 0x564(0x04)
	struct FStringAssetReference DefaultTextureName; // 0x568(0x10)
	struct UGameViewportClient* GameViewport; // 0x578(0x08)
	float RenderLightMapDensityGrayscaleScale; // 0x580(0x04)
	char pad_584[0x4]; // 0x584(0x04)
	struct FStringClassReference NavigationSystemClassName; // 0x588(0x10)
	int32 *83ecc6816b; // 0x598(0x04)
	float MeshLODRange; // 0x59c(0x04)
	struct UMaterial* *ba4b02b533; // 0x5a0(0x08)
	struct FStringClassReference WorldSettingsClassName; // 0x5a8(0x10)
	struct FStringAssetReference WeightMapPlaceholderTextureName; // 0x5b8(0x10)
	struct FString WireframeMaterialName; // 0x5c8(0x10)
	struct UMaterialInstanceDynamic* *498d4ec4e1; // 0x5d8(0x08)
	struct UClass* *9cf85956b5; // 0x5e0(0x08)
	struct UMaterial* *22bea6dbb2; // 0x5e8(0x08)
	struct FStringClassReference GameViewportClientClassName; // 0x5f0(0x10)
	struct FStringAssetReference PreviewShadowsIndicatorMaterialName; // 0x600(0x10)
	struct UGameUserSettings* GameUserSettings; // 0x610(0x08)
	struct UTextureCube* *019d032e90; // 0x618(0x08)
	float CameraTranslationThreshold; // 0x620(0x04)
	char pad_624[0x4]; // 0x624(0x04)
	struct UTexture2D* *6487bfa9fa; // 0x628(0x08)
	struct FColor *c7c24b22f6; // 0x630(0x04)
	float NearClipPlane; // 0x634(0x04)
	struct TArray<struct F*73d1c21239> StatColorMappings; // 0x638(0x10)
	struct FString ShadedLevelColorationLitMaterialName; // 0x648(0x10)
	struct FStringAssetReference LightMapDensityTextureName; // 0x658(0x10)
	struct FColor *192e526923; // 0x668(0x04)
	struct FColor *7011171afe; // 0x66c(0x04)
	float MinLightMapDensity; // 0x670(0x04)
	char pad_674[0x4]; // 0x674(0x04)
	struct UMaterial* RemoveSurfaceMaterial; // 0x678(0x08)
	int32 MaxParticleResizeWarn; // 0x680(0x04)
	struct F*28687cc503 PhysicErrorCorrection; // 0x684(0x1c)
	struct UMaterial* *62fa611f80; // 0x6a0(0x08)
	float MaxLightMapDensity; // 0x6a8(0x04)
	char pad_6AC[0x4]; // 0x6ac(0x04)
	struct FStringClassReference ConsoleClassName; // 0x6b0(0x10)
	struct TArray<struct F*2f5df3d7dc> ActiveClassRedirects; // 0x6c0(0x10)
	struct UObject* *efb601c0d7; // 0x6d0(0x08)
	char pad_6D8[0x8]; // 0x6d8(0x08)
	struct FLinearColor DefaultSelectedMaterialColor; // 0x6e0(0x10)
	struct FLinearColor *71a3192718; // 0x6f0(0x10)
	struct FLinearColor *d45033e7a6; // 0x700(0x10)
	struct FLinearColor *ffccd8fd1b; // 0x710(0x10)
	struct FLinearColor *ca5c8cbcd4; // 0x720(0x10)
	...
	uint32 bEnableVisualLogRecordingOnStart; // 0x738(0x04)
	struct FBox *fa997dc2ce; // 0x73c(0x1c)
	char pad_758[0x4]; // 0x758(0x04)
	int32 *a4ea644295; // 0x75c(0x04)
	...
	struct UMaterial* *167d4506be; // 0xa50(0x08)
	struct FColor *4709a765b0; // 0xa58(0x04)
	char pad_A5C[0x4]; // 0xa5c(0x04)
	struct FString LevelColorationLitMaterialName; // 0xa60(0x10)
	struct UMaterial* *c6ef933beb; // 0xa70(0x08)
	struct FString VertexColorViewModeMaterialName_AlphaAsColor; // 0xa78(0x10)
	float PrimitiveProbablyVisibleTime; // 0xa88(0x04)
	char pad_A8C[0x4]; // 0xa8c(0x04)
	struct FString VertexColorViewModeMaterialName_BlueOnly; // 0xa90(0x10)
	struct FColor *0edfcd2d1b; // 0xaa0(0x04)
	char pad_AA4[0x1dc]; // 0xaa4(0x1dc)
	struct TArray<struct F*e13e3afa12> NetDriverDefinitions; // 0xc80(0x10)
	struct TArray<struct FString> ServerActors; // 0xc90(0x10)
	struct TArray<struct FString> *585229a891; // 0xca0(0x10)
	char *07609786a3 : 1; // 0xcb0(0x01)
	char pad_CB0_1 : 7; // 0xcb0(0x01)
	char pad_CB1[0x7]; // 0xcb1(0x07)
	struct UTexture2D* *c594b99558; // 0xcb8(0x08)
	struct TArray<struct F*7c4552fed2> *74257aa68c; // 0xcc0(0x10)
	int32 MaximumLoopIterationCount; // 0xcd0(0x04)
	char pad_CD4[0x4]; // 0xcd4(0x04)
	struct FStringAssetReference DefaultBokehTextureName; // 0xcd8(0x10)
	char bPauseOnLossOfFocus : 1; // 0xce8(0x01)
	char pad_CE8_1 : 7; // 0xce8(0x01)
	char pad_CE9[0x3]; // 0xce9(0x03)
	int32 MaxParticleResize; // 0xcec(0x04)
	float MaxPixelShaderAdditiveComplexityCount; // 0xcf0(0x04)
	char pad_CF4[0x4]; // 0xcf4(0x04)
	struct FString PlayOnConsoleSaveDir; // 0xcf8(0x10)
	struct UMaterialInstanceDynamic* *dd5dd57e60; // 0xd08(0x08)
	struct FString VertexColorViewModeMaterialName_GreenOnly; // 0xd10(0x10)
	struct FStringClassReference GameSingletonClassName; // 0xd20(0x10)
	float DisplayGamma; // 0xd30(0x04)
	char pad_D34[0x4]; // 0xd34(0x04)
	struct UMaterialInstanceDynamic* *cba3a24030; // 0xd38(0x08)
	struct UMaterialInstanceDynamic* *c546a776e0; // 0xd40(0x08)
	struct UClass* *939ce45cf3; // 0xd48(0x08)
	struct FStringAssetReference DefaultReflectionCaptureTextureName; // 0xd50(0x10)
	char pad_D60[0x8]; // 0xd60(0x08)
	struct UMaterialInstanceDynamic* *d52bb2e916; // 0xd68(0x08)
	struct FColor *3a3f396815; // 0xd70(0x04)
	char pad_D74[0x4]; // 0xd74(0x04)
	struct FString VertexColorMaterialName; // 0xd78(0x10)
...
struct UGameViewportClient : U*267b167105 {
	...
	struct UGameInstance* GameInstance; // 0x4e8(0x08)
	char pad_4F0[0x180]; // 0x4f0(0x180)
	struct UConsole* *0577cd079b; // 0x670(0x08)
...
struct UConsole : UObject {
	char pad_28[0x10]; // 0x28(0x10)
	struct ULocalPlayer* *8cb17d72a2; // 0x38(0x08)
	struct UTexture2D* *d7075ad4d7; // 0x40(0x08)
	struct UTexture2D* *c697d5ef94; // 0x48(0x08)
...
struct UNetDriver : UObject {
	...
	char pad_71[0x7]; // 0x71(0x07)
	struct UNetConnection* *b95efedb68; // 0x78(0x08)
	struct TArray<struct UNetConnection*> *5caadb491a; // 0x80(0x10)
	char pad_90[0x28]; // 0x90(0x28)
	struct UWorld* World; // 0xb8(0x08)
	struct UPackage* *7ce0584c32; // 0xc0(0x08)
	char pad_C8[0x20]; // 0xc8(0x20)
	struct UClass* *6125afc26a; // 0xe8(0x08)
	struct UProperty* *08fb2db1ef; // 0xf0(0x08)
	struct UProperty* *169c3cf1e7; // 0xf8(0x08)
...
struct UDemoNetDriver : UNetDriver {
	...
	struct TMap<struct FString, struct F*bd2d09f136> *bb20b5ac02; // 0x5b8(0x50)
...
struct UNetConnection : UPlayer {
	...
	struct UClass* *c9a07c0e0e; // 0x60(0x08)
	struct UPackageMap* PackageMap; // 0x68(0x08)
	struct TArray<struct UChannel*> *969e2f926f; // 0x70(0x10)
	struct TArray<struct AActor*> *450acb6ca0; // 0x80(0x10)
	struct AActor* ViewTarget; // 0x90(0x08)
	struct AActor* *c907380c05; // 0x98(0x08)
	int32 *95374739ae; // 0xa0(0x04)
...
struct UForceFeedbackEffect : UObject {
	struct TArray<struct F*8172d5eac2> ChannelDetails; // 0x28(0x10)
...
struct ULocalPlayer : UPlayer {
	...
	struct UClass* *ff1a8deac9; // 0x70(0x08)
...
struct APlayerCameraManager : AActor {
	struct APlayerController* *e9fdc891fb; // 0x3e8(0x08)
	struct USceneComponent* TransformComponent; // 0x3f0(0x08)
	char pad_3F8[0x8]; // 0x3f8(0x08)
	struct F*ccdcf600a2 *0c01e7dd74; // 0x400(0x5e0)
	float FreeCamDistance; // 0x9e0(0x04)
	char pad_9E4[0xc]; // 0x9e4(0x0c)
	struct F*6432761ee7 *c63c0ee2d5; // 0x9f0(0x5d0)
	char pad_FC0[0x4]; // 0xfc0(0x04)
	float DefaultOrthoWidth; // 0xfc4(0x04)
	char pad_FC8[0x28]; // 0xfc8(0x28)
	struct F*ccdcf600a2 ViewTarget; // 0xff0(0x5e0)
	char pad_15D0[0x20]; // 0x15d0(0x20)
	struct F*6432761ee7 *2eaebbc30c; // 0x15f0(0x5d0)
	float ViewPitchMax; // 0x1bc0(0x04)
	float ViewYawMin; // 0x1bc4(0x04)
	float ViewRollMin; // 0x1bc8(0x04)
	float DefaultFOV; // 0x1bcc(0x04)
	char pad_1BD0[0x10]; // 0x1bd0(0x10)
	struct TArray<struct U*d265edd002*> *e5a975db74; // 0x1be0(0x10)
	struct FVector ViewTargetOffset; // 0x1bf0(0x0c)
	float ViewRollMax; // 0x1bfc(0x04)
	char pad_1C00[0x18]; // 0x1c00(0x18)
	struct FVector FreeCamOffset; // 0x1c18(0x0c)
	char pad_1C24[0x4]; // 0x1c24(0x04)
	struct TArray<struct AEmitterCameraLensEffectBase*> *23527db694; // 0x1c28(0x10)
	struct U*50a4472fea* *a616bea493; // 0x1c38(0x08)
	struct U*faef588082* *949f36d826[0x08]; // 0x1c40(0x40)
	struct TArray<struct FPostProcessSettings> *129b64c87e; // 0x1c80(0x10)
	char pad_1C90[0x10]; // 0x1c90(0x10)
	struct TArray<struct U*faef588082*> *6e10f27828; // 0x1ca0(0x10)
	struct TArray<struct U*faef588082*> *08f08cc15c; // 0x1cb0(0x10)
	struct ACameraActor* *71a037b5ab; // 0x1cc0(0x08)
	...
	float DefaultAspectRatio; // 0x1ccc(0x04)
	float ViewPitchMin; // 0x1cd0(0x04)
	float ViewYawMax; // 0x1cd4(0x04)
	char pad_1CD8[0x8]; // 0x1cd8(0x08)
	struct TArray<struct UClass*> DefaultModifiers; // 0x1ce0(0x10)
...
struct UPlayerInput : UObject {
	...
	struct TArray<struct F*61c810cf0e> DebugExecBindings; // 0x120(0x10)
...
struct ANavigationData : AActor {
	...
	struct F*dbc2be8864 *dbc2be8864; // 0x3f0(0x50)
	...
	struct TArray<struct F*a098f5a73b> *efbca435e7; // 0x528(0x10)
...
struct ARecastNavMesh : ANavigationData {
	...
	int32 *f0177cc714; // 0x5d4(0x04)
	int32 *42bcf443d9; // 0x5d8(0x04)
	int32 *a68c5c4820; // 0x5dc(0x04)
...
struct U*ff4b8fbd53 : UObject {
	struct TArray<struct F*7f68d80531> *9763e0c01a; // 0x28(0x10)
};
...
struct UMaterialInterface : UObject {
	...
	struct F*31693f5ae2 LightmassSettings; // 0x40(0x14)
	char pad_54[0x4]; // 0x54(0x04)
	struct TArray<struct F*8f67b6e0e6> *f16f190461; // 0x58(0x10)
...
struct UMaterialInstance : UMaterialInterface {
	...
	struct TArray<struct F*a7bbc83ffe> FontParameterValues; // 0x88(0x10)
	struct TArray<struct F*4ce84ba02f> ScalarParameterValues; // 0x98(0x10)
	struct TArray<struct F*8a4a1d286a> TextureParameterValues; // 0xa8(0x10)
	struct TArray<struct F*c2d53d1c03> VectorParameterValues; // 0xb8(0x10)
...
struct UBlueprintGeneratedClass : UClass {
	...
	struct TArray<struct U*3df69eb1ab*> *d50407421b; // 0x2b8(0x10)
	struct TArray<struct UActorComponent*> *2618d515c0; // 0x2c8(0x10)
	struct TArray<struct U*12776be9f9*> *7a479ec104; // 0x2d8(0x10)
	...
	struct UStructProperty* *e92387d3dd; // 0x2f8(0x08)
	struct UFunction* *33c45f144f; // 0x300(0x08)
	struct TArray<struct F*f871fdbfe8> FastCallPairs; // 0x308(0x10)
	bool *b1de85ca98; // 0x318(0x01)
	char pad_319[0x7]; // 0x319(0x07)
	struct TMap<struct FName, struct F*76eff26226> *8d069c690c; // 0x320(0x50)
...
struct U*1a2c4a78a0 : UObject {
	struct TArray<struct F*32e4d16215> Areas; // 0x28(0x10)
	struct F*85f602d0b9 IncludeFlags; // 0x38(0x04)
	struct F*85f602d0b9 ExcludeFlags; // 0x3c(0x04)
...
struct UEdGraphNode : UObject {
	...
	int32 *61c5fd1f45; // 0x48(0x04)
	int32 *957dc8ede2; // 0x4c(0x04)
	int32 *1bc9527dfd; // 0x50(0x04)
	int32 *99c349eabe; // 0x54(0x04)
	...
	int32 *fbe5696df8; // 0x74(0x04)
	struct FString *7beb49606d; // 0x78(0x10)
...
struct UEdGraphPin_Deprecated : UObject {
	...
	struct F*4342bfc443 PinType; // 0x50(0x80)
	struct FString DefaultValue; // 0xd0(0x10)
	struct FString *e7ac6b2bb0; // 0xe0(0x10)
	struct UObject* *78be025fbb; // 0xf0(0x08)
	struct FText *9f02b52b4e; // 0xf8(0x18)
	struct TArray<struct UEdGraphPin_Deprecated*> *571292af4d; // 0x110(0x10)
	struct TArray<struct UEdGraphPin_Deprecated*> *42fc9067df; // 0x120(0x10)
	struct UEdGraphPin_Deprecated* *de5ae33e93; // 0x130(0x08)
	struct UEdGraphPin_Deprecated* *3af63fd44c; // 0x138(0x08)
};
...
struct ULevel : UObject {
	char pad_28[0x8]; // 0x28(0x08)
	struct TArray<struct U*cfe9bd80c3*> *0545d7fd4e; // 0x30(0x10)
	struct TArray<struct FGuid> *2dafba22fe; // 0x40(0x10)
	struct ALevelScriptActor* LevelScriptActor; // 0x50(0x08)
	float *31c716180a; // 0x58(0x04)
	char pad_5C[0x4]; // 0x5c(0x04)
	struct UWorld* *654b8d1763; // 0x60(0x08)
	struct ANavigationObjectBase* *a2165f48c4; // 0x68(0x08)
	char pad_70[0x40]; // 0x70(0x40)
	struct U*33266603e2* ActorCluster; // 0xb0(0x08)
	char pad_B8[0x38]; // 0xb8(0x38)
	struct ANavigationObjectBase* *81b2bad029; // 0xf0(0x08)
	char pad_F8[0x78]; // 0xf8(0x78)
	struct FGuid *3d8a333984; // 0x170(0x10)
	char pad_180[0x8]; // 0x180(0x08)
	struct UMapBuildDataRegistry* *7c9be48b22; // 0x188(0x08)
	...
	float *c1eaeb8397; // 0x1b0(0x04)
	char pad_1B4[0x4]; // 0x1b4(0x04)
	struct TArray<struct U*b5dde59565*> *575b76f3d9; // 0x1b8(0x10)
	char pad_1C8[0x10]; // 0x1c8(0x10)
	int32 *e9b2c9a902; // 0x1d8(0x04)
	int32 *ef7f2cdc37; // 0x1dc(0x04)
	struct UModel* Model; // 0x1e0(0x08)
	char pad_1E8[0x8]; // 0x1e8(0x08)
	bool *11f6bfbd58; // 0x1f0(0x01)
	char pad_1F1[0x3]; // 0x1f1(0x03)
	struct FIntVector *edcaca8239; // 0x1f4(0x0c)
	char pad_200[0x8]; // 0x200(0x08)
	struct TArray<struct FVector> *71279b0e2d; // 0x208(0x10)
...
struct UAutoBenchSettings : UObject {
	char pad_28[0x8]; // 0x28(0x08)
	struct TArray<struct F*3fd7aec64b> Settings; // 0x30(0x10)
};
...
struct UStaticMesh : UObject {
	...
	struct TArray<struct F*534d06babb> StaticMaterials; // 0x58(0x10)
	float *23cf50e234; // 0x68(0x04)
	int32 LightMapResolution; // 0x6c(0x04)
	int32 *be31f80f30; // 0x70(0x04)
	float *722c540fe9; // 0x74(0x04)
	struct UBodySetup* BodySetup; // 0x78(0x08)
	int32 *f2ad808c42; // 0x80(0x04)
	...
	struct TArray<struct U*2ee8b8c92f*> Sockets; // 0xc0(0x10)
	char pad_D0[0x10]; // 0xd0(0x10)
	struct FVector *10c1bdc006; // 0xe0(0x0c)
	struct FVector *609721a3eb; // 0xec(0x0c)
	struct FBoxSphereBounds *b31255077e; // 0xf8(0x1c)
	bool *2c12e476e1; // 0x114(0x01)
	char pad_115[0x3]; // 0x115(0x03)
	int32 *618491fca8; // 0x118(0x04)
	char pad_11C[0x4]; // 0x11c(0x04)
	struct TArray<struct UAssetUserData*> AssetUserData; // 0x120(0x10)
	struct UNavCollision* NavCollision; // 0x130(0x08)
	struct F*795e425430 *b27fae7125; // 0x138(0x28)
	struct TArray<struct UMaterialInstanceConstant*> *1891538393; // 0x160(0x10)
...
struct ABoxGIVolume : AActor {
	struct U*d152ab6626* VolumeComponent; // 0x3e8(0x08)
};
...
struct AAudioVolume : AVolume {
	...
	struct F*3e305a18ce AmbientZoneSettings; // 0x440(0x24)
...
struct ACullDistanceVolume : AVolume {
	struct TArray<struct F*1eaa6792c3> CullDistances; // 0x420(0x10)
...
struct APainCausingVolume : APhysicsVolume {
	...
	char pad_44D[0x3]; // 0x44d(0x03)
	struct AController* *38f615a2ac; // 0x450(0x08)
...
struct UCameraShake : UObject {
	...
	char pad_29[0x3]; // 0x29(0x03)
	float *58a60c3cf3; // 0x2c(0x04)
	float *206d2da50d; // 0x30(0x04)
	float *9d30b8d5d3; // 0x34(0x04)
	struct F*d2c9ed4b21 *52c4287450; // 0x38(0x24)
	struct F*426dfcc594 *4eb97f3a4f; // 0x5c(0x24)
	struct F*f15493e17b *fc4c873000; // 0x80(0x0c)
	float AnimPlayRate; // 0x8c(0x04)
	float *3d02c9cb75; // 0x90(0x04)
	float *6cb2d05aec; // 0x94(0x04)
	float *49b90e2efd; // 0x98(0x04)
	float *edc22e7546; // 0x9c(0x04)
	...
	struct U*faef588082* AnimInst; // 0x150(0x08)
...
struct U*4aa7f8d102 : UActorComponent {
	...
	struct TArray<struct F*0319448750> *0319448750; // 0x260(0x10)
...
struct UCurveFloat : UCurveBase {
	struct FRichCurve *e7fc2b8ab7; // 0x30(0x70)
...
struct ADistanceFieldCapture : AActor {
	struct U*5eded02585* CaptureComponent; // 0x3e8(0x08)
};
...
struct AFoliageBlockingVolumeActor : AActor {
	struct U*f7a1ed2b6f* FoliageBlockingVolumeComponent; // 0x3e8(0x08)
};
...
struct AGameNetworkManager : AInfo {
	int32 *15c1977abc; // 0x3e8(0x04)
	float *09cbaefa8a; // 0x3ec(0x04)
...
struct AWindDirectionalSource : AInfo {
	struct U*baafa9a332* Component; // 0x3e8(0x08)
};
...
struct AWorldSettings : AInfo {
	...
	struct F*3e305a18ce DefaultAmbientZoneSettings; // 0x4c0(0x24)
	char pad_4E4[0x4]; // 0x4e4(0x04)
	struct USoundMix* *c3960e9a1c; // 0x4e8(0x08)
	float WorldToMeters; // 0x4f0(0x04)
	float MonoCullingDistance; // 0x4f4(0x04)
	struct U*91203b4189* BookMarks[0x0a]; // 0x4f8(0x50)
	float TimeDilation; // 0x548(0x04)
	float *4a0b860420; // 0x54c(0x04)
	...
	struct TArray<struct F*f9b760e032> *e3cbfb681b; // 0x588(0x10)
	struct FMulticastDelegate *4d725b192a; // 0x598(0x10)
	struct FMulticastDelegate *9f4a3923b5; // 0x5a8(0x10)
	struct TArray<struct UAssetUserData*> AssetUserData; // 0x5b8(0x10)
	struct APlayerState* *d0c7c65fe4; // 0x5c8(0x08)
...
struct AInstancedDeferredDecalActor : AActor {
	...
	struct U*d6fbc0688d* RootDecalComponent; // 0x3f8(0x08)
	struct TArray<struct U*d6fbc0688d*> decals; // 0x400(0x10)
...
struct AInstancedSplineDecalActor : AActor {
	struct U*ef97bd0f41* InstancedSplineDecalComponent; // 0x3e8(0x08)
};

// Class Engine.LevelBlockLandscapeGizmoActor
// Size: 0x3f0 (Inherited: 0x3e8)
struct ALevelBlockLandscapeGizmoActor : AActor {
	struct U*cf9e21c072* LandscapeGizmoComponent; // 0x3e8(0x08)
};

// Class Engine.LevelBlocksDataActor
// Size: 0x3f0 (Inherited: 0x3e8)
struct ALevelBlocksDataActor : AActor {
	struct U*6821ee5d79* LevelBlocksDataComponent; // 0x3e8(0x08)
};
...
struct ALevelBlockSpawnPointActor : AActor {
	struct U*5346184155* SpawnPointComponent; // 0x3e8(0x08)
};
...
struct ALightmassPortal : AActor {
	struct U*b6b8d1a87d* PortalComponent; // 0x3e8(0x08)
};
...
struct AMatineeActor : AActor {
	...
	struct FName *69e3ea0ec7; // 0x3f0(0x08)
	...
	struct TArray<struct F*d2ef71db5b> GroupActorInfos; // 0x410(0x10)
	char *b30b3d641a : 1; // 0x420(0x01)
	char pad_420_1 : 7; // 0x420(0x01)
	char pad_421[0x7]; // 0x421(0x07)
	struct TArray<struct U*c8e2f74187*> *ac64d10fc9; // 0x428(0x10)
	struct TArray<struct F*a706765c04> CameraCuts; // 0x438(0x10)
...
struct AMinimapLabelActor : AActor {
	struct U*662cfb94cd* MinimapLabelComponent; // 0x3e8(0x08)
};

// Class Engine.MinimapObjectActor
// Size: 0x3f0 (Inherited: 0x3e8)
struct AMinimapObjectActor : AActor {
	struct U*443f059e60* MinimapObjectComponent; // 0x3e8(0x08)
};
...
struct ANavigationTestingActor : AActor {
	...
	struct U*dde4b794bb* InvokerComponent; // 0x400(0x08)
	char bActAsNavigationInvoker : 1; // 0x408(0x01)
	char pad_408_1 : 7; // 0x408(0x01)
	char pad_409[0x7]; // 0x409(0x07)
	struct F*4093962ce1 *27d5813359; // 0x410(0x20)
	struct FVector *9e90339915; // 0x430(0x0c)
	char pad_43C[0x4]; // 0x43c(0x04)
	struct ANavigationData* *eac456cf29; // 0x440(0x08)
	...
	char pad_459[0x3]; // 0x459(0x03)
	struct FVector2D *341985f1da; // 0x45c(0x08)
	...
	struct UClass* *b5456fcb59; // 0x480(0x08)
	int32 *4bc890dcec; // 0x488(0x04)
	float *47275a0019; // 0x48c(0x04)
...
struct UParticleSystem : UObject {
	...
	struct FBox *112b153859; // 0xf4(0x1c)
	struct TArray<struct F*046b07cf81> *ca8d98fe72; // 0x110(0x10)
	struct TArray<struct F*ed51ac9799> *b39d579fc1; // 0x120(0x10)
...
struct USkeletalMesh : UObject {
	...
	struct FBoxSphereBounds *c204d6493a; // 0x50(0x1c)
	struct FBoxSphereBounds *b31255077e; // 0x6c(0x1c)
	struct FVector PositiveBoundsExtension; // 0x88(0x0c)
	struct FVector NegativeBoundsExtension; // 0x94(0x0c)
	struct TArray<struct F*e47777f630> Materials; // 0xa0(0x10)
	struct TArray<struct F*fb8e6c99a0> *a10abc343e; // 0xb0(0x10)
	...
	struct TArray<struct U*98a08b4821*> NodeMappingData; // 0xf8(0x10)
	...
	struct TArray<struct U*ac42304f2a*> MeshClothingAssets; // 0x298(0x10)
...
struct UAnimationAsset : UObject {
	...
	struct TArray<struct U*7db4928023*> MetaData; // 0x58(0x10)
...
struct ASphereReflectionCapture : AReflectionCapture {
	struct U*d44a97c4a0* *0d106c4035; // 0x3f0(0x08)
};
...
struct APlanarReflection : ASceneCapture {
	struct U*f4dc70db73* PlanarReflectionComponent; // 0x3f0(0x08)
...
struct ASceneCapture2D : ASceneCapture {
	...
	struct U*4d37f15df7* *42bf489806; // 0x3f8(0x08)
...
struct ULevelBlocksData : UObject {
	struct TArray<struct U*6273c6b474*> *22b5f5a112; // 0x28(0x10)
};
...
struct U*6821ee5d79 : UActorComponent {
	...
	struct TArray<struct AActor*> *e5538ac4f3; // 0x220(0x10)
...
struct U*5a32adf371 : UMovementComponent {
	...
	struct TArray<struct F*3875950e73> ControlPoints; // 0x2a0(0x10)
...
struct USkeleton : UObject {
	char pad_28[0x8]; // 0x28(0x08)
	struct TArray<struct F*fe6a9a6fdd> *342e95a478; // 0x30(0x10)
	struct TArray<struct FTransform> RefLocalPoses; // 0x40(0x10)
	char pad_50[0x110]; // 0x50(0x110)
	struct FGuid *fc962fd86a; // 0x160(0x10)
	struct TArray<struct F*eab2f13d1e> *fa52a95a66; // 0x170(0x10)
	struct TArray<struct F*dfe9cf8a88> *3504ed20fb; // 0x180(0x10)
	struct TArray<struct USkeletalMeshSocket*> Sockets; // 0x190(0x10)
	char pad_1A0[0x50]; // 0x1a0(0x50)
	struct F*41665359e6 *b5edcbbf92; // 0x1f0(0x50)
	char pad_240[0x18]; // 0x240(0x18)
	struct TArray<struct UBlendProfile*> *f28211b573; // 0x258(0x10)
	struct TArray<struct F*fe8cadf04c> *80c7f6ed2d; // 0x268(0x10)
...
struct UAnimSequenceBase : UAnimationAsset {
	...
	float *63b5605c53; // 0x8c(0x04)
	struct F*6ea1b55ea3 *109bb426e4; // 0x90(0x10)
...
struct UAnimMontage : U*e429980132 {
	struct FAlphaBlend *f0cd8bf840; // 0xa0(0x38)
	float BlendInTime; // 0xd8(0x04)
	char pad_DC[0x4]; // 0xdc(0x04)
	struct FAlphaBlend *2c0e4747fd; // 0xe0(0x38)
	float BlendOutTime; // 0x118(0x04)
	float *2104e13cd5; // 0x11c(0x04)
	struct FName SyncGroup; // 0x120(0x08)
	int32 *172117ab82; // 0x128(0x04)
	char pad_12C[0x4]; // 0x12c(0x04)
	struct F*1e7b9a312d *a31acbe57a; // 0x130(0x20)
	struct TArray<struct F*950c263671> *f7f06b062f; // 0x150(0x10)
	struct TArray<struct F*14ee813809> *40d7260160; // 0x160(0x10)
	...
	struct TArray<struct F*6e4e2ec99e> *4a32e2fd2f; // 0x188(0x10)
	struct TArray<int32> *ebb891a609; // 0x198(0x10)
...
struct U*dde4b794bb : UActorComponent {
	float *f4b7022996; // 0x1f0(0x04)
	float *b676c5c497; // 0x1f4(0x04)
...
struct U*943f0bf3f9 : UActorComponent {
	...
	char pad_215[0x3]; // 0x215(0x03)
	struct UObject* *3d6ce67ea4; // 0x218(0x08)
...
struct UNavLinkCustomComponent : U*943f0bf3f9 {
	...
	uint32 *d875907568; // 0x228(0x04)
	char pad_22C[0x4]; // 0x22c(0x04)
	struct UClass* *53a448b497; // 0x230(0x08)
	struct UClass* *1b09787d75; // 0x238(0x08)
	struct FVector *751a36f211; // 0x240(0x0c)
	struct FVector *32f146a6e8; // 0x24c(0x0c)
	...
	struct FVector *ca14d78e1e; // 0x260(0x0c)
	struct FVector *8ea9b52fd4; // 0x26c(0x0c)
	struct UClass* *10a2c1c80f; // 0x278(0x08)
	float *a5e2186e74; // 0x280(0x04)
	float *3df6c58979; // 0x284(0x04)
...
struct UNavModifierComponent : U*943f0bf3f9 {
	...
	struct FVector *c22b29a3f8; // 0x228(0x0c)
...
struct UPawnNoiseEmitterComponent : UActorComponent {
	...
	char pad_1F1[0x3]; // 0x1f1(0x03)
	struct FVector *39c89baaec; // 0x1f4(0x0c)
	float NoiseLifetime; // 0x200(0x04)
	float *82e51227e6; // 0x204(0x04)
	float *298432ca82; // 0x208(0x04)
	float *1dbf65ed2b; // 0x20c(0x04)
	float *d7354fdf53; // 0x210(0x04)
...
struct UPhysicsHandleComponent : UActorComponent {
	struct UPrimitiveComponent* *52184f172a; // 0x1f0(0x08)
...
struct ULevelBlockType : UDataAsset {
	...
	struct TArray<struct F*517447b731> Variants; // 0x38(0x10)
	struct TArray<struct F*8bfa60c108> *fd288f2662; // 0x48(0x10)
};
...
struct UTexture : UObject {
	char pad_28[0x8]; // 0x28(0x08)
	struct FGuid *183c967999; // 0x30(0x10)
	...
	struct FPerPlatformFloat *a4fd11200d; // 0x58(0x04)
...
struct UTexture2D : UTexture {
	int32 *da937aa08b; // 0x170(0x04)
	int32 *5f73d3fef5; // 0x174(0x04)
	int32 *2429cadece; // 0x178(0x04)
	struct FIntPoint *619c8d7688; // 0x17c(0x08)
	char pad_184[0x4]; // 0x184(0x04)
	double *426fe36d0f; // 0x188(0x08)
...
struct UTimelineComponent : UActorComponent {
	struct FTimeline *db39d74abd; // 0x1f0(0xe0)
...
struct UAnimComposite : U*e429980132 {
	struct FAnimTrack *7be9827d31; // 0xa0(0x10)
};
...
struct UAnimSequence : UAnimSequenceBase {
	...
	struct TArray<struct F*42613e53dd> *fb8e69baed; // 0xa8(0x10)
	...
	struct UAnimSequence* *0886e2d122; // 0x158(0x08)
	int32 *ea732044b1; // 0x160(0x04)
	int32 *96a4653477; // 0x164(0x04)
	...
	struct TArray<struct F*900dd2f72b> AuthoredSyncMarkers; // 0x178(0x10)
...
struct UBlendSpaceBase : UAnimationAsset {
	...
	struct TArray<struct F*3960a065b0> *b3294e5e3f; // 0x88(0x10)
	struct FInterpolationParameter *d53c75848e[0x03]; // 0x98(0x18)
	float *db93e45de3; // 0xb0(0x04)
	enum class ENotifyTriggerMode *79616e8146; // 0xb4(0x01)
	char pad_B5[0x3]; // 0xb5(0x03)
	int32 *9b786ef582; // 0xb8(0x04)
	char pad_BC[0x4]; // 0xbc(0x04)
	struct TArray<struct FBlendSample> SampleData; // 0xc0(0x10)
	struct TArray<struct F*db5e6e7b5e> *46e974698b; // 0xd0(0x10)
	struct FBlendParameter *46504f53b2[0x03]; // 0xe0(0x60)
};
...
struct UPoseAsset : UAnimationAsset {
	struct F*48a73d20ed *d32caa814e; // 0x78(0x90)
	bool *3c7d7edde5; // 0x108(0x01)
	char pad_109[0x3]; // 0x109(0x03)
	int32 *e83602c12e; // 0x10c(0x04)
...
struct UAnimClassData : UObject {
	char pad_28[0x8]; // 0x28(0x08)
	struct TArray<struct F*3e8db83ef8> *87f8836c42; // 0x30(0x10)
	struct USkeleton* TargetSkeleton; // 0x40(0x08)
	struct TArray<struct FAnimNotifyEvent> *2f35a73a78; // 0x48(0x10)
	int32 *1130675760; // 0x58(0x04)
	char pad_5C[0x4]; // 0x5c(0x04)
	struct TArray<int32> *59b46154cb; // 0x60(0x10)
	struct UStructProperty* *2b665f423d; // 0x70(0x08)
	struct TArray<struct UStructProperty*> *c33ca243bb; // 0x78(0x10)
	struct TArray<struct FName> *5f9fa98dff; // 0x88(0x10)
};
...
struct UAnimCompress_RemoveLinearKeys : UAnimCompress {
	float *bde3a89ea6; // 0x48(0x04)
	float *e155976c67; // 0x4c(0x04)
	float *a995ad9cf7; // 0x50(0x04)
	float *372e1dce1b; // 0x54(0x04)
	float *a06965e073; // 0x58(0x04)
	float *f24ae08784; // 0x5c(0x04)
	float *af249d8003; // 0x60(0x04)
...
struct UAnimCompress_PerTrackCompression : UAnimCompress_RemoveLinearKeys {
	float *2344c2cade; // 0x68(0x04)
	float *bc0abedcb4; // 0x6c(0x04)
	float *7b982819d9; // 0x70(0x04)
	float *99de0a02d7; // 0x74(0x04)
	struct TArray<enum class AnimationCompressionFormat> *0b14225f39; // 0x78(0x10)
	struct TArray<enum class AnimationCompressionFormat> *fc6104d08f; // 0x88(0x10)
	struct TArray<enum class AnimationCompressionFormat> *4365d0fa02; // 0x98(0x10)
	char bResampleAnimation : 1; // 0xa8(0x01)
	char pad_A8_1 : 7; // 0xa8(0x01)
	char pad_A9[0x3]; // 0xa9(0x03)
	float *e54b97909c; // 0xac(0x04)
	int32 *2bb3e65189; // 0xb0(0x04)
	char *e505893db6 : 1; // 0xb4(0x01)
	char *aff7b5faa3 : 1; // 0xb4(0x01)
	char pad_B4_2 : 6; // 0xb4(0x01)
	char pad_B5[0x3]; // 0xb5(0x03)
	int32 *16fd1cd60f; // 0xb8(0x04)
	float *7888aab103; // 0xbc(0x04)
	float *f5e2fb7ce6; // 0xc0(0x04)
	char *14f5f2db55 : 1; // 0xc4(0x01)
	char pad_C4_1 : 7; // 0xc4(0x01)
	char pad_C5[0x3]; // 0xc5(0x03)
	float *53a7fb9546; // 0xc8(0x04)
	float *0158f6fdbb; // 0xcc(0x04)
	float *1ebaffcd05; // 0xd0(0x04)
	float *cbf199c18a; // 0xd4(0x04)
	float *d34780542f; // 0xd8(0x04)
...
struct U*fd11263f10 : UAnimInstance {
	struct UAnimationAsset* *837629d9f7; // 0x398(0x08)
	DelegateProperty *5f1a83de4b; // 0x3a0(0x10)
...
struct UAnimSet : UObject {
	...
	struct TArray<struct FName> *fb0706db87; // 0x30(0x10)
	struct TArray<struct F*edbd0ddf47> *3504ed20fb; // 0x40(0x10)
	struct TArray<bool> *d719029061; // 0x50(0x10)
	struct TArray<bool> *482e919fc5; // 0x60(0x10)
	struct TArray<struct FName> *14a740f598; // 0x70(0x10)
	struct TArray<struct FName> *bea0a3ad1a; // 0x80(0x10)
	struct FName *5e1a66f963; // 0x90(0x08)
	struct FName *0cc2e13e34; // 0x98(0x08)
...
struct UAssetManager : UObject {
	...
	struct TArray<struct UObject*> *1ac34e1a5e; // 0x288(0x10)
...
struct UAssetMappingTable : UObject {
	struct TArray<struct F*b6eb9ac2dd> *5ce9d0e83e; // 0x28(0x10)
};
...
struct UAutomationTestSettings : UObject {
	...
	struct TArray<struct F*858afdee7d> EditorPerformanceTestMaps; // 0x58(0x10)
	struct TArray<struct FStringAssetReference> AssetsToOpen; // 0x68(0x10)
	struct F*c9fef354c4 BuildPromotionTest; // 0x78(0x1f0)
	struct F*bb96164374 MaterialEditorPromotionTest; // 0x268(0x30)
	struct F*28015cd648 ParticleEditorPromotionTest; // 0x298(0x10)
	struct F*04983e2c04 BlueprintEditorPromotionTest; // 0x2a8(0x30)
	struct TArray<struct FString> TestLevelFolders; // 0x2d8(0x10)
	struct TArray<struct F*155f881747> ExternalTools; // 0x2e8(0x10)
	struct TArray<struct F*de76861de8> ImportExportTestDefinitions; // 0x2f8(0x10)
	struct TArray<struct F*fb9a986504> LaunchOnSettings; // 0x308(0x10)
...
struct UBlendProfile : UObject {
	char pad_28[0x8]; // 0x28(0x08)
	struct USkeleton* *585b925421; // 0x30(0x08)
	struct TArray<struct F*b195a56239> *d9fcccff9f; // 0x38(0x10)
};

// Class Engine.BlueprintCore
// Size: 0x50 (Inherited: 0x28)
struct UBlueprintCore : UObject {
	struct UClass* *86b7b4ad7a; // 0x28(0x08)
	struct UClass* GeneratedClass; // 0x30(0x08)
	bool *3a0932d248; // 0x38(0x01)
	bool *44068eab41; // 0x39(0x01)
	char pad_3A[0x2]; // 0x3a(0x02)
	struct FGuid *15519d2316; // 0x3c(0x10)
...
struct UBlueprint : UBlueprintCore {
	...
	struct UObject* *6b119a64cf; // 0x60(0x08)
	...
	struct TArray<struct UActorComponent*> *2618d515c0; // 0x78(0x10)
	struct TArray<struct U*12776be9f9*> *7a479ec104; // 0x88(0x10)
...
struct UCollisionProfile : U*6c389a598a {
	struct TArray<struct F*ae13dbf557> Profiles; // 0x38(0x10)
	struct TArray<struct F*58d8e1f999> DefaultChannelResponses; // 0x48(0x10)
...
struct UWorld : UObject {
	...
	struct AParticleEventManager* *ae98578de5; // 0x160(0x08)
	char pad_168[0x8]; // 0x168(0x08)
	struct UNavigationSystem* NavigationSystem; // 0x170(0x08)
	struct UDirectionalLightComponent* *aa493645a4; // 0x178(0x08)
	char pad_180[0x8]; // 0x180(0x08)
	struct U*21d3a5fd2a* *d895e2af95; // 0x188(0x08)
	char pad_190[0xd8]; // 0x190(0xd8)
	struct TArray<struct F*b7f45c1414> *f2f8cbc728; // 0x268(0x10)
	char pad_278[0x8]; // 0x278(0x08)
	struct TArray<struct UObject*> *fb27a17937; // 0x280(0x10)
	char pad_290[0x20]; // 0x290(0x20)
	struct TArray<struct ULevel*> Levels; // 0x2b0(0x10)
	char pad_2C0[0x8]; // 0x2c0(0x08)
	struct APhysicsVolume* *ed42e77274; // 0x2c8(0x08)
	struct TArray<struct ULevelStreaming*> *48581da8ac; // 0x2d0(0x10)
	char pad_2E0[0x50]; // 0x2e0(0x50)
	struct ULevel* CurrentLevel; // 0x330(0x08)
	char pad_338[0x10]; // 0x338(0x10)
	struct U*21d3a5fd2a* *9a7a6cad41; // 0x348(0x08)
	char pad_350[0x18]; // 0x350(0x18)
	struct UCanvas* *bf9f8cd5ba; // 0x368(0x08)
	char pad_370[0x18]; // 0x370(0x18)
	struct UNetDriver* NetDriver; // 0x388(0x08)
	char pad_390[0x10]; // 0x390(0x10)
	struct UPhysicsCollisionHandler* PhysicsCollisionHandler; // 0x3a0(0x08)
	char pad_3A8[0x3e8]; // 0x3a8(0x3e8)
	struct UAvoidanceManager* AvoidanceManager; // 0x790(0x08)
	struct UWorldComposition* WorldComposition; // 0x798(0x08)
	char pad_7A0[0x8]; // 0x7a0(0x08)
	struct UCanvas* *bb4bbecad0; // 0x7a8(0x08)
	struct UDemoNetDriver* DemoNetDriver; // 0x7b0(0x08)
	char pad_7B8[0x10]; // 0x7b8(0x10)
	struct FString *067ae7b07f; // 0x7c8(0x10)
	struct ULevel* *8a4fdc2050; // 0x7d8(0x08)
	struct ULevel* *6e11098a18; // 0x7e0(0x08)
	char pad_7E8[0x58]; // 0x7e8(0x58)
	struct TArray<struct UObject*> *d73cc1af77; // 0x840(0x10)
	char pad_850[0x8]; // 0x850(0x08)
	struct AGameNetworkManager* *9e4c6a0201; // 0x858(0x08)
	char pad_860[0x8]; // 0x860(0x08)
	struct UAISystemBase* AISystem; // 0x868(0x08)
	char pad_870[0x8]; // 0x870(0x08)
	struct U*21d3a5fd2a* *2a8306bb38; // 0x878(0x08)
	char pad_880[0xd8]; // 0x880(0xd8)
	struct TArray<struct U*8479b69472*> *ba0807b92b; // 0x958(0x10)
	char pad_968[0x78]; // 0x968(0x78)
	struct AGameModeBase* *c9df55177b; // 0x9e0(0x08)
...
struct UNavigationSystem : UBlueprintFunctionLibrary {
	struct ANavigationData* *c2b4fbbc53; // 0x28(0x08)
	struct ANavigationData* *c28689a01b; // 0x30(0x08)
	...
	struct TArray<struct F*dbc2be8864> SupportedAgents; // 0x48(0x10)
	float DirtyAreasUpdateFreq; // 0x58(0x04)
	char pad_5C[0x4]; // 0x5c(0x04)
	struct TArray<struct ANavigationData*> *4bbfcdbf6c; // 0x60(0x10)
	struct TArray<struct FBox> *1082afc001; // 0x70(0x10)
	struct TMap<int32, struct ANavigationData*> *a10890d766; // 0x80(0x50)
	struct TArray<struct ANavigationData*> *7c453b5668; // 0xd0(0x10)
	char pad_E0[0x60]; // 0xe0(0x60)
	struct FMulticastDelegate *4a9806052b; // 0x140(0x10)
...
struct U*6a85fd07be : UObject {
	...
	struct FColor *0b59d3eec5; // 0x30(0x04)
...
struct UAnimBlueprintGeneratedClass : UBlueprintGeneratedClass {
	...
	struct TArray<struct F*3e8db83ef8> *87f8836c42; // 0x3c0(0x10)
	struct USkeleton* TargetSkeleton; // 0x3d0(0x08)
	struct TArray<struct FAnimNotifyEvent> *2f35a73a78; // 0x3d8(0x10)
	int32 *1130675760; // 0x3e8(0x04)
	char pad_3EC[0x4]; // 0x3ec(0x04)
	struct TArray<int32> *59b46154cb; // 0x3f0(0x10)
	char pad_400[0x18]; // 0x400(0x18)
	struct TArray<struct FName> *5f9fa98dff; // 0x418(0x10)
};

// Class Engine.BodySetup
// Size: 0x3a0 (Inherited: 0x28)
struct UBodySetup : UObject {
	struct F*3ef2376653 *51f17763f8; // 0x28(0x48)
	...
	struct F*a92203063d *a92203063d; // 0x2c0(0x10)
...
struct U*a0cd48d0cf : UBodySetup {
	struct F*dec19e3efd *46f51a97fd; // 0x3a0(0x30)
};

// Class Engine.PhysicsAsset
// Size: 0x108 (Inherited: 0x28)
struct UPhysicsAsset : UObject {
	struct TArray<int32> *b1ea445c1e; // 0x28(0x10)
	struct TArray<struct USkeletalBodySetup*> *c0ec18c7c6; // 0x38(0x10)
	struct TArray<struct UPhysicsConstraintTemplate*> *22dd670309; // 0x48(0x10)
...
struct USkeletalBodySetup : UBodySetup {
	struct TArray<struct F*61257e2b8b> *4c18852ae2; // 0x3a0(0x10)
};

// Class Engine.*5abd69ba76
// Size: 0x38 (Inherited: 0x28)
struct U*5abd69ba76 : UObject {
	struct TArray<struct FInputBlendPose> *dc95e655cb; // 0x28(0x10)
};
...
struct U*91203b4189 : UObject {
	...
	struct TArray<struct FString> *cff50e7ab4; // 0x40(0x10)
};

// Class Engine.*e8a1b06437
// Size: 0x38 (Inherited: 0x28)
struct U*e8a1b06437 : UObject {
	float *2ec126503c; // 0x28(0x04)
...
struct UButtonStyleAsset : UObject {
	struct F*7bb05e3554 *7bb05e3554; // 0x28(0x2a8)
};

// Class Engine.CameraAnim
// Size: 0x5e0 (Inherited: 0x28)
struct UCameraAnim : UObject {
	struct U*681140b349* *dd76bcbceb; // 0x28(0x08)
...
struct U*faef588082 : UObject {
	struct UCameraAnim* *aec1714a72; // 0x28(0x08)
	struct U*c8e2f74187* *c8e2f74187; // 0x30(0x08)
	char pad_38[0x18]; // 0x38(0x18)
	float PlayRate; // 0x50(0x04)
	char pad_54[0x14]; // 0x54(0x14)
	struct U*2cd7fc2368* *795848d2d6; // 0x68(0x08)
	struct U*89f82d34bc* *204d384c97; // 0x70(0x08)
...
struct U*50a4472fea : U*d265edd002 {
	struct TArray<struct UCameraShake*> *7118af1b73; // 0x48(0x10)
	float *4449fe70ef; // 0x58(0x04)
	char pad_5C[0x4]; // 0x5c(0x04)
};
...
struct UCanvas : UObject {
	...
	float *f722314eb1; // 0x30(0x04)
	float *785444cbd9; // 0x34(0x04)
...
struct U*22d4ce3b3f : UObject {
	struct F*d23c67e4c5 *d23c67e4c5; // 0x28(0x5e0)
};
...
struct U*594e4d7ca9 : UCurveBase {
	struct FRichCurve *afdd2d733a[0x04]; // 0x30(0x1c0)
...
struct U*59a0aeaef9 : UCurveBase {
	struct FRichCurve *afdd2d733a[0x03]; // 0x30(0x150)
...
struct UPrimaryAssetLabel : U*b7b5fc361e {
	struct F*4a161b0907 Rules; // 0x30(0x10)
	char *552e6c5d45 : 1; // 0x40(0x01)
	char pad_40_1 : 7; // 0x40(0x01)
	char pad_41[0x7]; // 0x41(0x07)
	struct TArray<struct UObject*> *02442bbda5; // 0x48(0x10)
	struct TArray<struct UClass*> *7a0c34b08b; // 0x58(0x10)
};

// Class Engine.*1c2e584736
// Size: 0x38 (Inherited: 0x30)
struct U*1c2e584736 : UDataAsset {
	float *d721b555b8; // 0x30(0x04)
	char pad_34[0x4]; // 0x34(0x04)
};
...
struct U*56b816d897 : UObject {
	int32 *b767cc8582; // 0x28(0x04)
	struct F*d343e03b2f *12735bde0e; // 0x2c(0x24)
	int32 RandomSeed; // 0x50(0x04)
	char pad_54[0x4]; // 0x54(0x04)
	struct TArray<struct FVector> *0a337adbfc; // 0x58(0x10)
	int32 *ad8f1a0260; // 0x68(0x04)
	char pad_6C[0x4]; // 0x6c(0x04)
	struct TArray<struct UMaterialInterface*> Materials; // 0x70(0x10)
	struct TArray<struct F*d72e9b9c3a> ChunkParameters; // 0x80(0x10)
	char pad_90[0x28]; // 0x90(0x28)
};
...
struct UAssetManagerSettings : U*6c389a598a {
	struct TArray<struct F*a4f4171d60> PrimaryAssetTypesToScan; // 0x38(0x10)
	struct TArray<struct FDirectoryPath> DirectoriesToExclude; // 0x48(0x10)
	struct TArray<struct F*7be435a022> PrimaryAssetRules; // 0x58(0x10)
	bool bOnlyCookProductionAssets; // 0x68(0x01)
	char pad_69[0x7]; // 0x69(0x07)
	struct TArray<struct F*143431c4d5> PrimaryAssetIdRedirects; // 0x70(0x10)
	struct TArray<struct F*143431c4d5> PrimaryAssetTypeRedirects; // 0x80(0x10)
	struct TArray<struct F*143431c4d5> AssetPathRedirects; // 0x90(0x10)
};
...
struct UAudioSettings : U*6c389a598a {
	...
	struct TArray<struct F*e73312bd8f> QualityLevels; // 0x80(0x10)
...
struct UPhysicsSettings : U*6c389a598a {
	...
	char pad_AC[0x4]; // 0xac(0x04)
	struct TArray<struct F*a009b7b901> PhysicalSurfaces; // 0xb0(0x10)
	struct F*2e21c888cd DefaultBroadphaseSettings; // 0xc0(0x28)
};
...
struct UUserInterfaceSettings : U*6c389a598a {
	...
	char pad_39[0x7]; // 0x39(0x07)
	struct TMap<enum class EMouseCursor, struct F*98b4e18bfc> HardwareCursors; // 0x40(0x50)
	...
	struct TArray<struct UObject*> *27c486982e; // 0x1e8(0x10)
	struct UClass* *5059247f42; // 0x1f8(0x08)
	struct UDPICustomScalingRule* *65b77e7bb4; // 0x200(0x08)
};
...
struct UDialogueVoice : UObject {
	...
	struct FGuid *0aa39126da; // 0x2c(0x10)
	char pad_3C[0x4]; // 0x3c(0x04)
};
...
struct UDialogueWave : UObject {
	...
	char pad_28_2 : 6; // 0x28(0x01)
	char pad_29[0x7]; // 0x29(0x07)
	struct FString *649b8b652a; // 0x30(0x10)
	struct FString *ef1f30890e; // 0x40(0x10)
	struct TArray<struct F*bb642d4e78> ContextMappings; // 0x50(0x10)
	struct FGuid *0aa39126da; // 0x60(0x10)
};
...
struct U*d38998bd44 : U*da4584ca0b {
	...
	float *54472afc8d; // 0x48(0x04)
	float *c045c89dc5; // 0x4c(0x04)
	float *18a4249393; // 0x50(0x04)
	float *fdb48bf31a; // 0x54(0x04)
...
struct U*f78a737900 : U*ca563f945f {
	struct FInterpCurveFloat *ef44dc2a55; // 0x38(0x18)
};
...
struct U*ba56434602 : U*ca563f945f {
	struct FInterpCurveVector2D *ef44dc2a55; // 0x38(0x18)
};
...
struct U*6c2d93f9c7 : U*f1b7831aad {
	...
	struct FVector *54472afc8d; // 0x58(0x0c)
	struct FVector *c045c89dc5; // 0x64(0x0c)
	struct FVector *18a4249393; // 0x70(0x0c)
	struct FVector *fdb48bf31a; // 0x7c(0x0c)
	enum class *41d1961a55 *dd12e4e0c3[0x03]; // 0x88(0x03)
...
struct U*1728e96d0a : U*31b44bea3d {
	struct FInterpCurveVector *ef44dc2a55; // 0x38(0x18)
...
struct U*0e448efcf1 : U*31b44bea3d {
	...
	char pad_51[0x3]; // 0x51(0x03)
	enum class *5dc8d87af2 *7a35c3be0b; // 0x54(0x01)
	enum class *8f01089b5d *9302ef7485[0x03]; // 0x55(0x03)
...
struct U*6b4215ee4c : U*31b44bea3d {
	struct FInterpCurveTwoVectors *ef44dc2a55; // 0x38(0x18)
	char *524735a8d7 : 1; // 0x50(0x01)
	char *fdbb9b44fb : 1; // 0x50(0x01)
	char pad_50_2 : 6; // 0x50(0x01)
	char pad_51[0x3]; // 0x51(0x03)
	enum class *5dc8d87af2 *7a35c3be0b[0x02]; // 0x54(0x02)
	enum class *8f01089b5d *9302ef7485[0x03]; // 0x56(0x03)
...
struct U*8b25ac3437 : U*3df69eb1ab {
	struct TArray<struct F*36043f6ded> *8d7399a529; // 0x28(0x10)
};
...
struct U*8d2896a616 : U*17427af9ef {
	struct TArray<struct F*5bedd29744> *5dea5901c4; // 0x28(0x10)
};

// Class Engine.*c7becf549b
// Size: 0x38 (Inherited: 0x28)
struct U*c7becf549b : U*17427af9ef {
	struct TArray<struct F*4831d7e4da> *2e9a0cfe4a; // 0x28(0x10)
};

// Class Engine.*01f668a7e4
// Size: 0x38 (Inherited: 0x28)
struct U*01f668a7e4 : U*17427af9ef {
	struct TArray<struct F*700afa9b36> *95afb42cbe; // 0x28(0x10)
};
...
struct U*3ad27dc38c : U*17427af9ef {
	struct TArray<struct F*7f074fb041> *b520a3f302; // 0x28(0x10)
};

// Class Engine.*6fd5603f5a
// Size: 0x38 (Inherited: 0x28)
struct U*6fd5603f5a : U*17427af9ef {
	struct TArray<struct F*cbf0d20804> *533fdd6627; // 0x28(0x10)
};
...
struct U*dfcfa50433 : UObject {
	struct UClass* *b31dd5ac71; // 0x28(0x08)
	struct UObject* *c0bf9f84df; // 0x30(0x08)
	struct TArray<struct FString> *cabf896538; // 0x38(0x10)
	struct TArray<struct FString> *ddeb4a762a; // 0x48(0x10)
	int32 *6d9a054f7d; // 0x58(0x04)
	int32 *e2700ff0d2; // 0x5c(0x04)
...
struct U*5a08634c15 : U*6273c6b474 {
	...
	struct TArray<struct F*ee3b57f9f0> Instances; // 0x38(0x10)
	struct U*da65e6fb26* Manager; // 0x48(0x08)
};

// Class Engine.*357f4504bc
// Size: 0xd8 (Inherited: 0x28)
struct U*357f4504bc : UObject {
	struct F*a6c8b92ca0 Data; // 0x28(0xb0)
};
...
struct UFont : UObject {
	...
	char pad_31[0x7]; // 0x31(0x07)
	struct TArray<struct F*ac2c6700bf> Characters; // 0x38(0x10)
	struct TArray<struct UTexture2D*> Textures; // 0x48(0x10)
	int32 *84f210d62a; // 0x58(0x04)
	float *8c4045198c; // 0x5c(0x04)
	float Ascent; // 0x60(0x04)
	float Descent; // 0x64(0x04)
	float Leading; // 0x68(0x04)
	int32 Kerning; // 0x6c(0x04)
	struct F*a6c8b92ca0 ImportOptions; // 0x70(0xb0)
	int32 *2f21283804; // 0x120(0x04)
	char pad_124[0x4]; // 0x124(0x04)
	struct TArray<int32> *46a8add4a7; // 0x128(0x10)
	float *f426e9e8d1; // 0x138(0x04)
	int32 *d0d500c8b1; // 0x13c(0x04)
	struct FName *2cd51cefa4; // 0x140(0x08)
	struct F*e8eaad59bc *e8eaad59bc; // 0x148(0x28)
...
struct UHapticFeedbackEffect_Buffer : U*2b7e68107f {
	struct TArray<bool> *586af8ecb7; // 0x28(0x10)
...
struct UInheritableComponentHandler : UObject {
	struct TArray<struct F*0f3b4987f4> Records; // 0x28(0x10)
	struct TArray<struct UActorComponent*> *15c57b9e05; // 0x38(0x10)
};
...
struct UInterpCurveEdSetup : UObject {
	struct TArray<struct F*a2fb1c065f> Tabs; // 0x28(0x10)
	int32 *0b0c22883b; // 0x38(0x04)
	char pad_3C[0x4]; // 0x3c(0x04)
};
...
struct UInterpData : UObject {
	...
	float *b397e4b0e4; // 0x2c(0x04)
	struct TArray<struct U*681140b349*> *9bd03cdd69; // 0x30(0x10)
	struct UInterpCurveEdSetup* *2ac5360815; // 0x40(0x08)
	float *96eccc7908; // 0x48(0x04)
	float *87f8bd06df; // 0x4c(0x04)
	char *5159bd3dbd : 1; // 0x50(0x01)
	char pad_50_1 : 7; // 0x50(0x01)
	char pad_51[0x7]; // 0x51(0x07)
	struct U*6ca78ee4e6* *82efbd9cb1; // 0x58(0x08)
	struct TArray<struct FName> *5708534d22; // 0x60(0x10)
};
...
struct U*681140b349 : UObject {
	char pad_28[0x8]; // 0x28(0x08)
	struct TArray<struct U*a7f7b58370*> *fcfa58b810; // 0x30(0x10)
	struct FName GroupName; // 0x40(0x08)
	struct FColor *11a566580d; // 0x48(0x04)
	char *d3a59df4e9 : 1; // 0x4c(0x01)
...
struct U*7aa2a6c4f4 : U*681140b349 {
	struct UCameraAnim* *faef588082; // 0x50(0x08)
	float *4f3216bf28; // 0x58(0x04)
	char pad_5C[0x4]; // 0x5c(0x04)
};
...
struct U*c8e2f74187 : UObject {
	struct U*681140b349* Group; // 0x28(0x08)
	struct AActor* GroupActor; // 0x30(0x08)
	struct TArray<struct U*227b184286*> *7f3c2be61a; // 0x38(0x10)
};
...
struct U*a7f7b58370 : UObject {
	char pad_28[0x10]; // 0x28(0x10)
	struct TArray<struct U*a7f7b58370*> *9b2517c266; // 0x38(0x10)
	struct UClass* *454ca58d42; // 0x48(0x08)
...
struct U*e03df41984 : U*a7f7b58370 {
	struct TArray<struct F*2bf753a285> *fc7a932dd1; // 0x70(0x10)
...
struct U*c7312ca09c : U*a7f7b58370 {
	struct TArray<struct F*17beb675f2> *e7a87a8b95; // 0x70(0x10)
...
struct U*9874235e22 : U*a7f7b58370 {
	struct TArray<struct F*757b12dab9> *ddbe42e5ea; // 0x70(0x10)
...
struct U*24e61502be : U*a7f7b58370 {
	struct FInterpCurveFloat *36b2a97a83; // 0x70(0x18)
	float *8b04c7f7ba; // 0x88(0x04)
...
struct U*a3466a0be5 : U*24e61502be {
	...
	struct TArray<struct F*24dc9b4692> *2184490cf9; // 0x98(0x10)
...
struct U*d664e40a0e : U*24e61502be {
	...
	char pad_91[0x3]; // 0x91(0x03)
	struct FLinearColor *59ad6910df; // 0x94(0x10)
	char pad_A4[0x4]; // 0xa4(0x04)
};
...
struct U*916e5457cf : U*24e61502be {
	struct UAnimBlueprintGeneratedClass* *eefd8d5476; // 0x90(0x08)
	struct UClass* *3ce9c3bdbf; // 0x98(0x08)
...
struct U*52d681b7a6 : U*24e61502be {
	struct TArray<struct UMaterialInterface*> *82ef231abe; // 0x90(0x10)
	struct FName ParamName; // 0xa0(0x08)
};
...
struct U*2cd7fc2368 : U*a7f7b58370 {
	struct FInterpCurveVector *6627e0b8d9; // 0x70(0x18)
	struct FInterpCurveVector *914effeb9a; // 0x88(0x18)
	struct F*fc54882100 *7505fe591a; // 0xa0(0x10)
	struct FName *769f61282a; // 0xb0(0x08)
	float *6be34d1e18; // 0xb8(0x04)
	float *fdd74d36c2; // 0xbc(0x04)
...
struct U*c09c477691 : U*24e61502be {
	...
	char pad_91[0x7]; // 0x91(0x07)
	struct F*fc54882100 *7505fe591a; // 0x98(0x10)
};
...
struct U*ec2df5f07c : U*a7f7b58370 {
	struct FInterpCurveLinearColor *1b9472ac03; // 0x70(0x18)
	float *8b04c7f7ba; // 0x88(0x04)
	char pad_8C[0x4]; // 0x8c(0x04)
};
...
struct U*80688e5dd7 : U*a7f7b58370 {
	struct TArray<struct F*c2c6b9f064> *b85e7c8065; // 0x70(0x10)
};

// Class Engine.*9fb722400c
// Size: 0x88 (Inherited: 0x70)
struct U*9fb722400c : U*a7f7b58370 {
	struct TArray<struct F*24709f3a21> *6271cfef8a; // 0x70(0x10)
...
struct U*ca9fa09ea0 : U*a7f7b58370 {
	struct FInterpCurveVector *4323fbf91a; // 0x70(0x18)
	float *8b04c7f7ba; // 0x88(0x04)
	char pad_8C[0x4]; // 0x8c(0x04)
};
...
struct U*a0570eebe8 : U*ca9fa09ea0 {
	struct TArray<struct F*f81faddf4c> Sounds; // 0x90(0x10)
...
struct U*b0205b4149 : U*a7f7b58370 {
	struct TArray<struct F*841bb4fa70> *933dc2a899; // 0x70(0x10)
	char *0aa83bc524 : 1; // 0x80(0x01)
	char *1d2a54934d : 1; // 0x80(0x01)
	char *cb463a3795 : 1; // 0x80(0x01)
...
struct U*7f392fdd20 : U*227b184286 {
	struct AActor* *231e1147a3; // 0x28(0x08)
};
...
struct U*bcd2daa25a : U*227b184286 {
	...
	struct TArray<float> *83a0d9bc5f; // 0x38(0x10)
	struct TArray<struct F*e6f0dca848> *5db4ad6079; // 0x48(0x10)
	struct U*52d681b7a6* *5af290fd3e; // 0x58(0x08)
};

// Class Engine.*fc66923bfb
// Size: 0x30 (Inherited: 0x28)
struct U*fc66923bfb : U*227b184286 {
	float *f70a77a018; // 0x28(0x04)
	char pad_2C[0x4]; // 0x2c(0x04)
};
...
struct U*6178ba62df : U*227b184286 {
	struct UProperty* *1fb45f020a; // 0x28(0x08)
	struct UObject* *70cb89614e; // 0x30(0x08)
};
...
struct U*651c810587 : U*6178ba62df {
	char pad_38[0x8]; // 0x38(0x08)
	struct FColor *6a5f1b7c6d; // 0x40(0x04)
	char pad_44[0x4]; // 0x44(0x04)
};
...
struct U*b58579d582 : U*6178ba62df {
	char pad_38[0x8]; // 0x38(0x08)
	struct FLinearColor *6a5f1b7c6d; // 0x40(0x10)
};
...
struct U*9b19a12dcb : U*6178ba62df {
	char pad_38[0x8]; // 0x38(0x08)
	struct FVector *3c5a50dccd; // 0x40(0x0c)
	char pad_4C[0x4]; // 0x4c(0x04)
};
...
struct U*f249f3e482 : U*227b184286 {
	float *1038881cbc; // 0x28(0x04)
	char pad_2C[0x4]; // 0x2c(0x04)
	struct UAudioComponent* *879fc1c3e8; // 0x30(0x08)
};
...
struct U*50b2830016 : U*227b184286 {
	struct TArray<struct UMaterialInstanceDynamic*> MaterialInstances; // 0x28(0x10)
	struct TArray<struct FVector> *5ba9316c10; // 0x38(0x10)
	struct TArray<struct F*e6f0dca848> *5db4ad6079; // 0x48(0x10)
	struct U*6183549942* *5af290fd3e; // 0x58(0x08)
};
...
struct U*936b522248 : UObject {
	uint16 *7d7257480c; // 0x28(0x02)
	char pad_2A[0x2]; // 0x2a(0x02)
	uint32 *6cc7ffe634; // 0x2c(0x04)
	uint64 *56dd7bc2a3; // 0x30(0x08)
	int8 *ece6c70c43; // 0x38(0x01)
	char pad_39[0x1]; // 0x39(0x01)
	int16 *c978301b09; // 0x3a(0x02)
	char pad_3C[0x4]; // 0x3c(0x04)
	int64 *d35fd6661c; // 0x40(0x08)
	bool *d07c338b17; // 0x48(0x01)
	char pad_49[0x3]; // 0x49(0x03)
	int32 *563c1c339e; // 0x4c(0x04)
};

// Class Engine.*7383374044
// Size: 0x48 (Inherited: 0x28)
struct U*7383374044 : U*6273c6b474 {
	struct TArray<struct U*ab2d28c427*> *5baea4f465; // 0x28(0x10)
	struct TArray<struct F*9909879c11> Instances; // 0x38(0x10)
};
...
struct U*ab2d28c427 : UObject {
	...
	struct FIntRect *53a7476241; // 0x5c(0x10)
	char pad_6C[0x4]; // 0x6c(0x04)
	struct F*9909879c11 *6cb7c55e16; // 0x70(0x110)
	struct UMaterialInterface* LandscapeMaterial; // 0x180(0x08)
	struct UMaterialInterface* LandscapeHoleMaterial; // 0x188(0x08)
	uint32 *5312624a19; // 0x190(0x04)
	int32 *4118dea9ef; // 0x194(0x04)
	struct TArray<struct F*43cbdd6c74> *142b6ba148; // 0x198(0x10)
	struct TArray<struct F*dc21fcdb72> *b935a81767; // 0x1a8(0x10)
...
struct ULayer : UObject {
	...
	char pad_30_1 : 7; // 0x30(0x01)
	char pad_31[0x7]; // 0x31(0x07)
	struct TArray<struct F*efd6eb22fe> ActorStats; // 0x38(0x10)
};
...
struct U*0520fb9439 : U*6273c6b474 {
	struct TArray<struct F*b991655971> Variants; // 0x28(0x10)
	struct TArray<struct FTransform> Instances; // 0x38(0x10)
	struct TArray<struct F*6ea9fa8839> *2909632458; // 0x48(0x10)
};

// Class Engine.*c3be53f1c6
// Size: 0x38 (Inherited: 0x28)
struct U*c3be53f1c6 : U*6273c6b474 {
	struct TArray<struct F*a42277f8f7> Instances; // 0x28(0x10)
};

// Class Engine.*71292f11d1
// Size: 0x48 (Inherited: 0x28)
struct U*71292f11d1 : U*6273c6b474 {
	struct TArray<struct F*26f0091992> *6e68ba955d; // 0x28(0x10)
	struct TArray<struct F*70531ce4c1> Instances; // 0x38(0x10)
};
...
struct U*46ea2bd74a : UObject {
	...
	struct UTexture2D* *240ccfed83; // 0x58(0x08)
	struct UTextureRenderTarget2D* *53564cb82d; // 0x60(0x08)
	struct TArray<struct F*4f1611d65e> *af15504d30; // 0x68(0x10)
	struct TArray<struct F*a84c0f7964> *113470e23f; // 0x78(0x10)
	struct TArray<struct UObject*> *5d5693ca20; // 0x88(0x10)
};

// Class Engine.*4173dc7674
// Size: 0x50 (Inherited: 0x28)
struct U*4173dc7674 : U*6273c6b474 {
	struct TArray<struct F*4f1611d65e> *58c9f37678; // 0x28(0x10)
	struct TArray<struct F*a84c0f7964> *a4e8456f5a; // 0x38(0x10)
	struct U*46ea2bd74a* Manager; // 0x48(0x08)
};
...
struct U*0448a351dd : U*6273c6b474 {
	struct TArray<struct F*09b56f2140> Variants; // 0x28(0x10)
	struct TArray<struct FTransform> Instances; // 0x38(0x10)
	struct TArray<struct F*6ea9fa8839> *2909632458; // 0x48(0x10)
};
...
struct U*22e9965cd6 : U*6273c6b474 {
	struct TArray<struct F*6ea9fa8839> *2909632458; // 0x28(0x10)
};

// Class Engine.*ef44f1c5dc
// Size: 0x58 (Inherited: 0x28)
struct U*ef44f1c5dc : U*6273c6b474 {
	struct TArray<struct F*ee5b2c43a7> Variants; // 0x28(0x10)
	struct TArray<struct F*0b58def2be> Instances; // 0x38(0x10)
	struct TArray<struct F*6ea9fa8839> *2909632458; // 0x48(0x10)
};
...
struct ULevelStreaming : UObject {
	...
	struct FName *6c4f36be4a; // 0x60(0x08)
	struct TArray<struct FName> *e574f05678; // 0x68(0x10)
	...
	struct ULevel* *06f8d17835; // 0xb8(0x08)
	struct ULevel* *7bdf81c32b; // 0xc0(0x08)
	char pad_C8[0x8]; // 0xc8(0x08)
	struct TArray<struct ALevelStreamingVolume*> *9c901ec567; // 0xd0(0x10)
	float *1c00cc6545; // 0xe0(0x04)
	char pad_E4[0x4]; // 0xe4(0x04)
...
struct U*e5b02c8593 : UObject {
	struct UModel* *71155081dd; // 0x28(0x08)
...
struct U*655bf1d960 : UObject {
	struct F*25888ccc71 LightmassSettings; // 0x28(0x18)
};
...
struct U*6bff317227 : U*4827c03b64 {
	struct FString *532cd07e6d; // 0x28(0x10)
	struct FString *2c0c1841c6; // 0x38(0x10)
	struct FString *39ef66de8c; // 0x48(0x10)
	struct FString *96d3ae03aa; // 0x58(0x10)
	struct FString *a283490049; // 0x68(0x10)
	struct FString *5c94bc6a1e; // 0x78(0x10)
	struct FString *08b760c69e; // 0x88(0x10)
	struct FString *ed2aecd547; // 0x98(0x10)
};
...
struct UMaterialExpressionAdd : UMaterialExpression {
	...
	float *5ce5bfecea; // 0xd0(0x04)
	float *2aeeadef96; // 0xd4(0x04)
};
...
struct UMaterialExpressionBumpOffset : UMaterialExpression {
	...
	float *d1f5a54789; // 0x108(0x04)
	float *616c6356f8; // 0x10c(0x04)
	uint32 *b76d4888c5; // 0x110(0x04)
...
struct U*08b1275de0 : UMaterialExpression {
	...
	char pad_109[0x3]; // 0x109(0x03)
	float *621b1b545c; // 0x10c(0x04)
	float *e42f414d99; // 0x110(0x04)
	char pad_114[0x4]; // 0x114(0x04)
};
...
struct U*32cb46dd72 : UMaterialExpression {
	...
	struct FGuid *c2fef6bf89; // 0x70(0x10)
};
...
struct U*0f0cf1fc01 : UMaterialExpression {
	...
	struct FLinearColor *299208e4aa; // 0x78(0x10)
};
...
struct U*c7a25a5360 : UMaterialExpression {
	...
	struct TArray<struct F*9087bb1d5f> Inputs; // 0x88(0x10)
};
...
struct U*c9eebc3804 : UMaterialExpression {
	...
	float *4c487b31bf; // 0x98(0x04)
	float *d02702455f; // 0x9c(0x04)
};
...
struct U*c5d4334b6f : UMaterialExpression {
	...
	float *057f450838; // 0xd0(0x04)
	float *ce6784a4da; // 0xd4(0x04)
};
...
struct U*9e63c76ae6 : UMaterialExpression {
	struct FExpressionInput *0409138c7b; // 0x60(0x38)
};
...
struct U*d82b2bed64 : UMaterialExpression {
	...
	struct FLinearColor *c1a83cd515; // 0xd0(0x10)
};
...
struct U*9927b5b33e : UMaterialExpression {
	...
	struct FVector4 *ada9866e27; // 0xd0(0x10)
	char *35e4ac82b7 : 1; // 0xe0(0x01)
	char pad_E0_1 : 7; // 0xe0(0x01)
	char pad_E1[0x3]; // 0xe1(0x03)
	int32 *63132e9468; // 0xe4(0x04)
...
struct UMaterialExpressionGetMaterialAttributes : UMaterialExpression {
	struct FMaterialAttributesInput MaterialAttributes; // 0x60(0x40)
	struct TArray<struct FGuid> *bb6a7f2fef; // 0xa0(0x10)
};
...
struct U*d0253e30aa : UMaterialExpression {
	struct FExpressionInput Default; // 0x60(0x38)
	struct FExpressionInput *d9073e9d9d; // 0x98(0x38)
	struct FExpressionInput *cb030b6d2b; // 0xd0(0x38)
};
...
struct UMaterialExpressionIf : UMaterialExpression {
	...
	float *0bff2e6f61; // 0x178(0x04)
	float *2aeeadef96; // 0x17c(0x04)
...
struct UMaterialExpressionLinearInterpolate : UMaterialExpression {
	...
	float *5ce5bfecea; // 0x108(0x04)
	float *2aeeadef96; // 0x10c(0x04)
	float *920aee3a13; // 0x110(0x04)
	char pad_114[0x4]; // 0x114(0x04)
};
...
struct U*1ac16c60a1 : UMaterialExpression {
	...
	struct FExpressionInput *833e639604[0x08]; // 0x3e0(0x1c0)
...
struct UMaterialExpressionMaterialFunctionCall : UMaterialExpression {
	...
	struct TArray<struct F*552e2e57dc> *137ec7f48f; // 0x68(0x10)
	struct TArray<struct F*c000b301a5> *c994aac007; // 0x78(0x10)
};
...
struct U*7d49050006 : UMaterialExpression {
	struct FExpressionInput RealTime; // 0x60(0x38)
	struct FExpressionInput *445ce7da05; // 0x98(0x38)
};
...
struct UMaterialExpressionNoise : UMaterialExpression {
	struct FExpressionInput Position; // 0x60(0x38)
	struct FExpressionInput *49ddfa00ea; // 0x98(0x38)
	...
	float *9c2484c997; // 0xe4(0x04)
	float *c53150ee8f; // 0xe8(0x04)
	float *ecb05d0d1a; // 0xec(0x04)
...
struct UMaterialExpressionNormalize : UMaterialExpression {
	struct FExpressionInput *6e01c4a43f; // 0x60(0x38)
};
...
struct UMaterialExpressionPanner : UMaterialExpression {
	...
	float *6d08c6c18b; // 0x108(0x04)
	float *8432ac5a48; // 0x10c(0x04)
	uint32 *b76d4888c5; // 0x110(0x04)
...
struct U*e49382e192 : UMaterialExpression {
	struct U*147426ac7d* Layer; // 0x60(0x08)
};
...
struct U*4160022b92 : UMaterialExpression {
	...
	struct FExpressionInput *15c881ac7c; // 0x98(0x38)
};
...
struct UMaterialExpressionReflectionVectorWS : UMaterialExpression {
	struct FExpressionInput *e6d3ec0b29; // 0x60(0x38)
...
struct U*cf035cfbac : UMaterialExpression {
	struct FExpressionInput *8e5b97443e; // 0x60(0x38)
	struct FExpressionInput RotationAngle; // 0x98(0x38)
	struct FExpressionInput *d21dd4488a; // 0xd0(0x38)
...
struct U*48685c384e : UMaterialExpression {
	struct FExpressionInput Coordinate; // 0x60(0x38)
	struct FExpressionInput Time; // 0x98(0x38)
	float *36664f1743; // 0xd0(0x04)
	float *b2edd7d1c8; // 0xd4(0x04)
	float Speed; // 0xd8(0x04)
	uint32 *b76d4888c5; // 0xdc(0x04)
};
...
struct U*3fad86e651 : UMaterialExpression {
	...
	struct FVector2D *7d6d4a1448; // 0xd8(0x08)
};
...
struct UMaterialExpressionSetMaterialAttributes : UMaterialExpression {
	...
	struct TArray<struct FGuid> *b4ab63c25a; // 0x70(0x10)
};
...
struct U*8bc845825f : UMaterialExpression {
	struct FExpressionInput *6ef45d8685; // 0x60(0x38)
	struct FExpressionInput *6583019691; // 0x98(0x38)
	struct FExpressionInput *cbaafd0491; // 0xd0(0x38)
	struct FExpressionInput *d3a46fb70e; // 0x108(0x38)
...
struct U*703f8d3355 : U*9cae02a0c8 {
	...
	struct TArray<struct F*387a32966b> Inputs; // 0x98(0x10)
	uint32 *b76d4888c5; // 0xa8(0x04)
...
struct U*f045301ce0 : U*9cae02a0c8 {
	struct FExpressionInput UV; // 0x60(0x38)
	struct TArray<struct F*943f7ed9d9> Inputs; // 0x98(0x10)
	uint32 *b76d4888c5; // 0xa8(0x04)
...
struct U*c0e67efa23 : U*9cae02a0c8 {
	struct FExpressionInput UV; // 0x60(0x38)
	struct FExpressionInput *52589072bc; // 0x98(0x38)
	struct TArray<struct F*391c978835> Inputs; // 0xd0(0x10)
	uint32 *b76d4888c5; // 0xe0(0x04)
...
struct UMaterialExpressionTextureSample : U*0bef821dd3 {
	...
	struct FExpressionInput *2196c6e485; // 0xe0(0x38)
	struct FExpressionInput *f98ba3e373; // 0x118(0x38)
	struct FExpressionInput *a9a6bd32ce; // 0x150(0x38)
	...
	uint32 *b76d4888c5; // 0x1c4(0x04)
	int32 *ed068c9f9f; // 0x1c8(0x04)
...
struct U*7739ebc78c : UMaterialExpressionTextureSample {
	...
	struct FGuid *8f84b5e332; // 0x1f0(0x10)
...
struct UMaterialExpressionTextureCoordinate : UMaterialExpression {
	int32 *1005d82c0f; // 0x60(0x04)
	float *d840cb5194; // 0x64(0x04)
	float *3b760a3aa1; // 0x68(0x04)
...
struct UMaterialFunction : UObject {
	struct FGuid *1089ccbf97; // 0x28(0x10)
	struct FString Description; // 0x38(0x10)
	char bExposeToLibrary : 1; // 0x48(0x01)
	char pad_48_1 : 7; // 0x48(0x01)
	char pad_49[0x7]; // 0x49(0x07)
	struct TArray<struct UMaterialExpression*> *295206fc68; // 0x50(0x10)
...
struct UMaterial : UMaterialInterface {
	...
	struct FVector2MaterialInput *833e639604[0x08]; // 0x520(0x240)
	...
	int32 *7734c8c5f4; // 0x864(0x04)
	enum class ETranslucencyLightingMode *6b49322879; // 0x868(0x01)
	char pad_869[0x3]; // 0x869(0x03)
	float *28d4855ab2; // 0x86c(0x04)
	char *db00906fe4 : 1; // 0x870(0x01)
	char pad_870_1 : 7; // 0x870(0x01)
	char pad_871[0x3]; // 0x871(0x03)
	float *74fcff9564; // 0x874(0x04)
	float *ed4a6e49a9; // 0x878(0x04)
	float *e9e88e9452; // 0x87c(0x04)
	float *f6393e1b05; // 0x880(0x04)
	float *c0ab7c6346; // 0x884(0x04)
	struct FLinearColor *e4d763ac22; // 0x888(0x10)
	...
	struct F*992675a4e8 MaterialClipVolumeTypes; // 0x8b0(0x04)
	...
	int32 *f3f7bbb04f; // 0x8c0(0x04)
	int32 *ec1f50bbb3; // 0x8c4(0x04)
	int32 *4a7b8886c6; // 0x8c8(0x04)
	int32 *4f7e8ac40c; // 0x8cc(0x04)
	struct TArray<struct UMaterialExpression*> Expressions; // 0x8d0(0x10)
	struct TArray<struct F*09bdd24193> *3238fd7911; // 0x8e0(0x10)
	struct TArray<struct F*39db2b6e80> *91304ff35c; // 0x8f0(0x10)
	...
	struct FGuid *1089ccbf97; // 0x918(0x10)
	char pad_928[0x148]; // 0x928(0x148)
	struct TArray<struct UTexture*> *bfbcea3bea; // 0xa70(0x10)
};
...
struct UMaterialParameterCollection : UObject {
	struct FGuid *1089ccbf97; // 0x28(0x10)
	struct TArray<struct F*5abf103b90> *fd0afffee3; // 0x38(0x10)
	struct TArray<struct F*ead729b2e2> *f5b6331d28; // 0x48(0x10)
...
struct UMorphTarget : UObject {
	struct USkeletalMesh* *f81fd892d5; // 0x28(0x08)
...
struct UNavAreaMeta_SwitchByAgent : UNavAreaMeta {
	struct UClass* *a61c817cc3; // 0x40(0x08)
	struct UClass* *4475125439; // 0x48(0x08)
	struct UClass* *62e2dc121a; // 0x50(0x08)
	struct UClass* *b16364599f; // 0x58(0x08)
	struct UClass* *b5c86f9869; // 0x60(0x08)
	struct UClass* *76fbfe8b0d; // 0x68(0x08)
	struct UClass* *5409baac79; // 0x70(0x08)
	struct UClass* *c76dc43396; // 0x78(0x08)
	struct UClass* *9462384225; // 0x80(0x08)
	struct UClass* *7563a265d9; // 0x88(0x08)
	struct UClass* *a91694306c; // 0x90(0x08)
	struct UClass* *b1df057c01; // 0x98(0x08)
	struct UClass* *e8ad46a0f0; // 0xa0(0x08)
	struct UClass* *702b75850a; // 0xa8(0x08)
	struct UClass* *7e86128b57; // 0xb0(0x08)
	struct UClass* *cf355c90c4; // 0xb8(0x08)
};
...
struct UNavCollision : UObject {
	...
	struct TArray<struct F*db04e44ac0> *ef5d447fba; // 0x78(0x10)
	struct TArray<struct F*5b1244bed2> *85416495f0; // 0x88(0x10)
...
struct U*cfe9bd80c3 : UObject {
	struct FName *d12dfd573a; // 0x28(0x08)
};
...
struct U*98a08b4821 : UObject {
	struct TMap<struct FName, struct F*b7b64ce1c8> NodeMapping; // 0x28(0x50)
	struct UBlueprint* *2f52ec8cb4; // 0x78(0x20)
};

// Class Engine.ObjectLibrary
// Size: 0x160 (Inherited: 0x28)
struct UObjectLibrary : UObject {
	struct UClass* *f29bcf9ff1; // 0x28(0x08)
	bool bHasBlueprintClasses; // 0x30(0x01)
	char pad_31[0x7]; // 0x31(0x07)
	struct TArray<struct UObject*> Objects; // 0x38(0x10)
	struct TArray<struct UObject*> *f37ac68b15; // 0x48(0x10)
...
struct U*7c448e30ae : UObject {
	struct TArray<struct UObject*> *58b3be54d9; // 0x28(0x10)
};
...
struct UParticleEmitter : UObject {
	struct FName *5935fd0127; // 0x28(0x08)
	int32 *5408ba3fd6; // 0x30(0x04)
	enum class *a2a9703ae6 *6060e416b7; // 0x34(0x01)
	char pad_35[0x3]; // 0x35(0x03)
	struct TArray<struct UParticleLODLevel*> *faa9975f2c; // 0x38(0x10)
	char *4097e6e36e : 1; // 0x48(0x01)
	char pad_48_1 : 7; // 0x48(0x01)
	char pad_49[0x3]; // 0x49(0x03)
	int32 *9faf86d275; // 0x4c(0x04)
	int32 *b5cd25b667; // 0x50(0x04)
	float MediumDetailSpawnRateScale; // 0x54(0x04)
	float *7739037275; // 0x58(0x04)
	...
	char pad_65[0x3]; // 0x65(0x03)
	float *910e90bf29; // 0x68(0x04)
	char pad_6C[0x4]; // 0x6c(0x04)
	struct U*147426ac7d* *147426ac7d; // 0x70(0x08)
...
struct UParticleLODLevel : UObject {
	...
	char pad_2D[0x3]; // 0x2d(0x03)
	struct UParticleModuleRequired* *b977c16f5c; // 0x30(0x08)
	struct TArray<struct UParticleModule*> Modules; // 0x38(0x10)
	struct UParticleModuleTypeDataBase* *75899ccbd2; // 0x48(0x08)
	struct UParticleModuleSpawn* *01156e8659; // 0x50(0x08)
	struct UParticleModuleEventGenerator* *bdb5d04534; // 0x58(0x08)
	struct TArray<struct U*001fe7ab63*> *981d8e68c5; // 0x60(0x10)
	struct TArray<struct UParticleModule*> *d8bc2b5830; // 0x70(0x10)
	struct TArray<struct UParticleModule*> *6ba65a61e9; // 0x80(0x10)
	struct TArray<struct UParticleModuleOrbit*> *61603e5c21; // 0x90(0x10)
	struct TArray<struct UParticleModuleEventReceiverBase*> *7414be95aa; // 0xa0(0x10)
	char *4097e6e36e : 1; // 0xb0(0x01)
	char pad_B0_1 : 7; // 0xb0(0x01)
	char pad_B1[0x3]; // 0xb1(0x03)
	int32 *9faf86d275; // 0xb4(0x04)
};
...
struct UParticleModuleAccelerationDrag : U*bbc41222bb {
	struct U*ca563f945f* DragCoefficient; // 0x38(0x08)
	struct F*1273267ee1 *9350ee5218; // 0x40(0x38)
};

// Class Engine.ParticleModuleAccelerationDragScaleOverLife
// Size: 0x78 (Inherited: 0x38)
struct UParticleModuleAccelerationDragScaleOverLife : U*bbc41222bb {
	struct U*ca563f945f* DragScale; // 0x38(0x08)
	struct F*1273267ee1 *3da1626500; // 0x40(0x38)
};

// Class Engine.ParticleModuleAccelerationOverLifetime
// Size: 0x88 (Inherited: 0x38)
struct UParticleModuleAccelerationOverLifetime : U*bbc41222bb {
	struct FRawDistributionVector *6e168b0104; // 0x38(0x50)
};
...
struct UParticleModuleAttractorLine : U*63c6edc2d2 {
	struct FVector *c22c14e652; // 0x30(0x0c)
	struct FVector *e57c40697f; // 0x3c(0x0c)
	struct F*1273267ee1 Range; // 0x48(0x38)
...
struct UParticleModuleAttractorParticle : U*63c6edc2d2 {
	...
	struct F*1273267ee1 Range; // 0x38(0x38)
	char *3284031223 : 1; // 0x70(0x01)
	char pad_70_1 : 7; // 0x70(0x01)
	char pad_71[0x7]; // 0x71(0x07)
	struct F*1273267ee1 Strength; // 0x78(0x38)
...
struct UParticleModuleAttractorPoint : U*63c6edc2d2 {
	...
	struct F*1273267ee1 Range; // 0x80(0x38)
	struct F*1273267ee1 Strength; // 0xb8(0x38)
...
struct UParticleModuleAttractorPointGravity : U*63c6edc2d2 {
	...
	struct U*ca563f945f* Strength; // 0x40(0x08)
	struct F*1273267ee1 *0ee663bf63; // 0x48(0x38)
};
...
struct U*5fe9b931c7 : UParticleModuleBeamBase {
	...
	struct F*592bece9b0 *0536b76b13; // 0x34(0x04)
	struct FRawDistributionVector Position; // 0x38(0x50)
	struct F*592bece9b0 *8df5369cee; // 0x88(0x04)
	char pad_8C[0x4]; // 0x8c(0x04)
	struct FRawDistributionVector Tangent; // 0x90(0x50)
	char *6a3986ba75 : 1; // 0xe0(0x01)
	char pad_E0_1 : 7; // 0xe0(0x01)
	char pad_E1[0x3]; // 0xe1(0x03)
	struct F*592bece9b0 *4010fb9fa9; // 0xe4(0x04)
	struct F*1273267ee1 Strength; // 0xe8(0x38)
};
...
struct U*8b38096320 : UParticleModuleBeamBase {
	...
	char pad_9D[0x3]; // 0x9d(0x03)
	struct FRawDistributionVector *d5a4938289; // 0xa0(0x50)
	char *e7a0592334 : 1; // 0xf0(0x01)
	char pad_F0_1 : 7; // 0xf0(0x01)
	char pad_F1[0x7]; // 0xf1(0x07)
	struct F*1273267ee1 *1308a65ed3; // 0xf8(0x38)
...
struct U*29b4e2e572 : UParticleModuleBeamBase {
	...
	char pad_95[0x3]; // 0x95(0x03)
	struct FRawDistributionVector *17a520bdc7; // 0x98(0x50)
	char *b09b3b11ff : 1; // 0xe8(0x01)
	char pad_E8_1 : 7; // 0xe8(0x01)
	char pad_E9[0x7]; // 0xe9(0x07)
	struct F*1273267ee1 *26fa4a6e7c; // 0xf0(0x38)
	char *6f55b57d53 : 1; // 0x128(0x01)
	char pad_128_1 : 7; // 0x128(0x01)
	char pad_129[0x3]; // 0x129(0x03)
	float *4a3f35b959; // 0x12c(0x04)
	char pad_130[0x8]; // 0x130(0x08)
};
...
struct U*01fa96a93e : UParticleModuleCameraBase {
	struct F*1273267ee1 *1a7b57a0c9; // 0x30(0x38)
...
struct UParticleModuleCollision : U*0b1a1619c5 {
	struct FRawDistributionVector *c4086c6841; // 0x30(0x50)
	struct FRawDistributionVector *47d3bedea0; // 0x80(0x50)
	struct F*1273267ee1 *7fc869eaab; // 0xd0(0x38)
	enum class *0aea19a5c2 *ad69b14877; // 0x108(0x01)
	char pad_109[0x7]; // 0x109(0x07)
	struct TArray<enum class EObjectTypeQuery> *3ca7dc95fd; // 0x110(0x10)
	char pad_120[0x8]; // 0x120(0x08)
	char *8aa224a117 : 1; // 0x128(0x01)
	char *9fd4ebbd0a : 1; // 0x128(0x01)
	char pad_128_2 : 6; // 0x128(0x01)
	char pad_129[0x7]; // 0x129(0x07)
	struct F*1273267ee1 ParticleMass; // 0x130(0x38)
	float *95dc229051; // 0x168(0x04)
	char *788404c810 : 1; // 0x16c(0x01)
	char *f39d25f58a : 1; // 0x16c(0x01)
	char pad_16C_2 : 6; // 0x16c(0x01)
	char pad_16D[0x3]; // 0x16d(0x03)
	float *fd084e1b28; // 0x170(0x04)
	char pad_174[0x4]; // 0x174(0x04)
	struct F*1273267ee1 *48dfe54a4a; // 0x178(0x38)
	...
	float *ed77d9cd44; // 0x1b4(0x04)
};

// Class Engine.ParticleModuleCollisionGPU
// Size: 0xb8 (Inherited: 0x30)
struct UParticleModuleCollisionGPU : U*0b1a1619c5 {
	struct F*1273267ee1 *971d780c13; // 0x30(0x38)
	struct F*1273267ee1 ResilienceScaleOverLife; // 0x68(0x38)
	float Friction; // 0xa0(0x04)
	float *159bd7544e; // 0xa4(0x04)
	float *304b88e59b; // 0xa8(0x04)
	float RadiusScale; // 0xac(0x04)
	float *d3e020f589; // 0xb0(0x04)
...
struct U*19674bc6dc : U*a81a2b88ac {
	struct FRawDistributionVector *11a75a6a78; // 0x30(0x50)
	struct F*1273267ee1 *228f5c757d; // 0x80(0x38)
...
struct U*a550017ac2 : U*19674bc6dc {
	struct F*f391bfd93e *ac8c892e8e; // 0xc0(0x20)
};

// Class Engine.*56d1f902b5
// Size: 0xc0 (Inherited: 0x30)
struct U*56d1f902b5 : U*a81a2b88ac {
	struct FRawDistributionVector *e2bd1fceb7; // 0x30(0x50)
	struct F*1273267ee1 *19a0b5b08f; // 0x80(0x38)
	char bClampAlpha : 1; // 0xb8(0x01)
	char pad_B8_1 : 7; // 0xb8(0x01)
	char pad_B9[0x7]; // 0xb9(0x07)
};
...
struct U*8ac4a2d6c2 : U*a81a2b88ac {
	struct FRawDistributionVector *e1f58196a2; // 0x30(0x50)
	struct F*1273267ee1 *29674aaf03; // 0x80(0x38)
...
struct UParticleModuleEventGenerator : U*c23c46cef6 {
	struct TArray<struct F*0b5582c288> Events; // 0x30(0x10)
};
...
struct U*68d957a05d : UParticleModuleKillBase {
	struct FRawDistributionVector *587a35facf; // 0x30(0x50)
	struct FRawDistributionVector *63e147e59d; // 0x80(0x50)
...
struct U*c4926fff1a : UParticleModuleKillBase {
	struct F*1273267ee1 Height; // 0x30(0x38)
...
struct U*1ff74864aa : U*7aa1ad1432 {
	struct F*1273267ee1 LifeTime; // 0x30(0x38)
};

// Class Engine.*76ef8bbbe0
// Size: 0x88 (Inherited: 0x68)
struct U*76ef8bbbe0 : U*1ff74864aa {
	struct F*f391bfd93e *ac8c892e8e; // 0x68(0x20)
};
...
struct U*b7f4c89576 : UParticleModuleLightBase {
	...
	float *a7dc5a1dd2; // 0x34(0x04)
	struct FRawDistributionVector *e1f58196a2; // 0x38(0x50)
	struct F*1273267ee1 *2f05bdbc8a; // 0x88(0x38)
	struct F*1273267ee1 RadiusScale; // 0xc0(0x38)
	struct F*1273267ee1 *6fd108e3c6; // 0xf8(0x38)
	...
	struct U*eafb25fbf7* IESTexture; // 0x140(0x08)
};
...
struct U*acdc6ae6c6 : U*01a79b3453 {
	...
	float *9a94befc69; // 0x80(0x04)
	float *c88430dd63; // 0x84(0x04)
};
...
struct U*0c8c790543 : U*01a79b3453 {
	...
	char pad_31[0x3]; // 0x31(0x03)
	struct FVector *26dc079b46; // 0x34(0x0c)
	struct TArray<struct F*4c1e1de929> *cc89e445a7; // 0x40(0x10)
	...
	char pad_55[0x3]; // 0x55(0x03)
	float *ae200ffadf; // 0x58(0x04)
	char pad_5C[0x4]; // 0x5c(0x04)
	struct FName *0569618a84; // 0x60(0x08)
	int32 *fe0df1506e; // 0x68(0x04)
	char pad_6C[0x4]; // 0x6c(0x04)
};
...
struct UParticleModuleLocationDirect : U*01a79b3453 {
	...
	struct FRawDistributionVector *34f1a04888; // 0x80(0x50)
...
struct U*82c43ef2f7 : U*01a79b3453 {
	...
	char pad_3D[0x3]; // 0x3d(0x03)
	float *4c70186065; // 0x40(0x04)
	char *3f23caf56c : 1; // 0x44(0x01)
	char pad_44_1 : 7; // 0x44(0x01)
	char pad_45[0x3]; // 0x45(0x03)
	float *86da1abd9c; // 0x48(0x04)
	char pad_4C[0x4]; // 0x4c(0x04)
};
...
struct UParticleModuleLocationPrimitiveBase : U*01a79b3453 {
	...
	char pad_31[0x7]; // 0x31(0x07)
	struct F*1273267ee1 *d824a46a33; // 0x38(0x38)
...
struct U*ed0abc2183 : UParticleModuleLocationPrimitiveBase {
	...
	struct F*1273267ee1 *94fe32a6fd; // 0x100(0x38)
...
struct U*af58f46e2a : U*01a79b3453 {
	...
	struct F*1273267ee1 Height; // 0x80(0x38)
	struct F*1273267ee1 Angle; // 0xb8(0x38)
	struct F*1273267ee1 Thickness; // 0xf0(0x38)
};
...
struct U*bb558e1250 : U*01a79b3453 {
	...
	char pad_40_3 : 5; // 0x40(0x01)
	char pad_41[0x3]; // 0x41(0x03)
	float *ae200ffadf; // 0x44(0x04)
	struct FName *0569618a84; // 0x48(0x08)
	struct TArray<struct FName> *b955eaa1e9; // 0x50(0x10)
	char *6c3f763d2e : 1; // 0x60(0x01)
	char pad_60_1 : 7; // 0x60(0x01)
	char pad_61[0x3]; // 0x61(0x03)
	struct FVector *d701169d9e; // 0x64(0x0c)
	float NormalCheckToleranceDegrees; // 0x70(0x04)
	float *abf16ae3b2; // 0x74(0x04)
	struct TArray<int32> *b4d97bde99; // 0x78(0x10)
	char *c012618813 : 1; // 0x88(0x01)
	char *55df86bab6 : 1; // 0x88(0x01)
	char pad_88_2 : 6; // 0x88(0x01)
	char pad_89[0x3]; // 0x89(0x03)
	uint32 *01aa21081b; // 0x8c(0x04)
};

// Class Engine.*f4e761e260
// Size: 0x38 (Inherited: 0x30)
struct U*f4e761e260 : U*01a79b3453 {
	struct FVector2D *8d2abf545a; // 0x30(0x08)
};

// Class Engine.ParticleModuleSourceMovement
// Size: 0x80 (Inherited: 0x30)
struct UParticleModuleSourceMovement : U*01a79b3453 {
	struct FRawDistributionVector *3664a99067; // 0x30(0x50)
};
...
struct UParticleModuleMeshMaterial : U*47fe4af8b4 {
	struct TArray<struct UMaterialInterface*> *ff566008a8; // 0x30(0x10)
};
...
struct U*ea0e6748be : UParticleModuleParameterBase {
	struct TArray<struct F*85b45f808a> *ab48571549; // 0x30(0x10)
	int32 *ec8ad0b12a; // 0x40(0x04)
...
struct U*b825b1f4a4 : U*ea0e6748be {
	struct F*f391bfd93e *ac8c892e8e; // 0x48(0x20)
};

// Class Engine.SubUVAnimation
// Size: 0x60 (Inherited: 0x28)
struct USubUVAnimation : UObject {
	struct UTexture2D* *45f4c63ece; // 0x28(0x08)
	int32 *d0eee5e023; // 0x30(0x04)
	int32 *b866d106f2; // 0x34(0x04)
	enum class *cf1018a8a2 *d301e32d90; // 0x38(0x01)
	enum class *319e761216 *073c1f87d7; // 0x39(0x01)
	char pad_3A[0x2]; // 0x3a(0x02)
	float *c5eda4e98d; // 0x3c(0x04)
...
struct UParticleModuleRequired : UParticleModule {
	...
	struct UMaterialInterface* *a00bc0b772; // 0x38(0x08)
	struct FVector4 *1cb29af141; // 0x40(0x10)
	struct FVector *eabde9c6b9; // 0x50(0x0c)
	struct FRotator *584f715dc4; // 0x5c(0x0c)
	...
	float *21138c4628; // 0x6c(0x04)
	float *7c2783f083; // 0x70(0x04)
	float *1a69d40ddc; // 0x74(0x04)
	...
	char pad_79[0x3]; // 0x79(0x03)
	float *15646e305a; // 0x7c(0x04)
	float *c32a80ebd1; // 0x80(0x04)
	int32 *0b511b58d9; // 0x84(0x04)
	struct F*1273267ee1 SpawnRate; // 0x88(0x38)
	struct TArray<struct F*b7ed34810a> *1b08c04e03; // 0xc0(0x10)
	float *446d2eb434; // 0xd0(0x04)
	float *220d19e872; // 0xd4(0x04)
	...
	char pad_DD[0x3]; // 0xdd(0x03)
	int32 *d0eee5e023; // 0xe0(0x04)
	int32 *b866d106f2; // 0xe4(0x04)
	char *a9d4b49566 : 1; // 0xe8(0x01)
	char pad_E8_1 : 7; // 0xe8(0x01)
	char pad_E9[0x3]; // 0xe9(0x03)
	float *48e20f5c47; // 0xec(0x04)
	int32 *b94807db4c; // 0xf0(0x04)
...
struct UParticleModuleMeshRotation : U*7c305e19c2 {
	struct FRawDistributionVector *9a94b46ec6; // 0x30(0x50)
...
struct U*f4249954a4 : U*7c305e19c2 {
	struct F*1273267ee1 *9a94b46ec6; // 0x30(0x38)
};
...
struct UParticleModuleRotationOverLifetime : U*7c305e19c2 {
	struct F*1273267ee1 *063d44179f; // 0x30(0x38)
...
struct UParticleModuleMeshRotationRate : U*3d17b30f35 {
	struct FRawDistributionVector *d3235c99d2; // 0x30(0x50)
};

// Class Engine.ParticleModuleMeshRotationRate_Seeded
// Size: 0xa0 (Inherited: 0x80)
struct UParticleModuleMeshRotationRate_Seeded : UParticleModuleMeshRotationRate {
	struct F*f391bfd93e *ac8c892e8e; // 0x80(0x20)
};
...
struct UParticleModuleMeshRotationRateOverLife : U*3d17b30f35 {
	struct FRawDistributionVector *c5f45b99f2; // 0x30(0x50)
...
struct U*145cff9c40 : U*3d17b30f35 {
	struct F*1273267ee1 *d3235c99d2; // 0x30(0x38)
};
...
struct UParticleModuleRotationRateMultiplyLife : U*3d17b30f35 {
	struct F*1273267ee1 LifeMultiplier; // 0x30(0x38)
};
...
struct U*4257527455 : U*9369723a5d {
	struct FRawDistributionVector *7e4cac98f6; // 0x30(0x50)
};
...
struct UParticleModuleSizeScaleBySpeed : U*9369723a5d {
	struct FVector2D *62e07041dd; // 0x30(0x08)
	struct FVector2D *66e93de536; // 0x38(0x08)
};
...
struct UParticleModuleSpawn : U*001fe7ab63 {
	struct F*1273267ee1 Rate; // 0x38(0x38)
	struct F*1273267ee1 *63b5605c53; // 0x70(0x38)
	enum class *7d8e2c3b6b *ea129b6abc; // 0xa8(0x01)
	char pad_A9[0x7]; // 0xa9(0x07)
	struct TArray<struct F*b7ed34810a> *1b08c04e03; // 0xb0(0x10)
	struct F*1273267ee1 *97054e2765; // 0xc0(0x38)
...
struct U*174103af1f : U*001fe7ab63 {
	float *462931969d; // 0x38(0x04)
	char pad_3C[0x4]; // 0x3c(0x04)
	struct F*1273267ee1 SpawnPerUnit; // 0x40(0x38)
	char *9496595439 : 1; // 0x78(0x01)
	char pad_78_1 : 7; // 0x78(0x01)
	char pad_79[0x3]; // 0x79(0x03)
	float *28dcd6093f; // 0x7c(0x04)
	float *d08704b5ee; // 0x80(0x04)
...
struct UParticleModuleSubUV : U*9ce9e3de0d {
	...
	struct F*1273267ee1 SubImageIndex; // 0x38(0x38)
...
struct UParticleModuleSubUVMovie : UParticleModuleSubUV {
	...
	char pad_78_1 : 7; // 0x78(0x01)
	char pad_79[0x7]; // 0x79(0x07)
	struct F*1273267ee1 FrameRate; // 0x80(0x38)
	int32 *35ce5490ed; // 0xb8(0x04)
	char pad_BC[0x4]; // 0xbc(0x04)
};
...
struct U*98614401c8 : UParticleModuleTrailBase {
	...
	char pad_31[0x7]; // 0x31(0x07)
	struct FName SourceName; // 0x38(0x08)
	struct F*1273267ee1 *1308a65ed3; // 0x40(0x38)
	char *c97350649a : 1; // 0x78(0x01)
	char pad_78_1 : 7; // 0x78(0x01)
	char pad_79[0x3]; // 0x79(0x03)
	int32 SourceOffsetCount; // 0x7c(0x04)
	struct TArray<struct FVector> *2816c5490c; // 0x80(0x10)
...
struct U*d1973ea140 : UParticleModuleTypeDataBase {
	...
	char pad_30_3 : 5; // 0x30(0x01)
	char pad_31[0x3]; // 0x31(0x03)
	float *48f2c3e1a7; // 0x34(0x04)
	float *7d24f9806d; // 0x38(0x04)
	float *cf9812a780; // 0x3c(0x04)
	float *8a7e9cff3e; // 0x40(0x04)
	char pad_44[0x4]; // 0x44(0x04)
};
...
struct UParticleModuleTypeDataBeam2 : UParticleModuleTypeDataBase {
	...
	char pad_31[0x3]; // 0x31(0x03)
	int32 *6cb00a7d2f; // 0x34(0x04)
	float *3f1f217a29; // 0x38(0x04)
	...
	char pad_4C_1 : 7; // 0x4c(0x01)
	char pad_4D[0x3]; // 0x4d(0x03)
	int32 *eaa01aee37; // 0x50(0x04)
	char pad_54[0x4]; // 0x54(0x04)
	struct FName *c37d272b41; // 0x58(0x08)
	struct F*1273267ee1 Distance; // 0x60(0x38)
	enum class *faaf57805f *ceb34d6204; // 0x98(0x01)
	char pad_99[0x7]; // 0x99(0x07)
	struct F*1273267ee1 TaperFactor; // 0xa0(0x38)
	struct F*1273267ee1 *270cc589ff; // 0xd8(0x38)
...
struct UParticleModuleTypeDataGpu : UParticleModuleTypeDataBase {
	struct F*c408766740 *8bcb1fe2a6; // 0x30(0x2c0)
	struct F*8c10d2fd5d *e7bb05ec9a; // 0x2f0(0x160)
	float *b9deab831f; // 0x450(0x04)
...
struct UParticleModuleTypeDataMesh : UParticleModuleTypeDataBase {
	...
	float Yaw; // 0x4c(0x04)
	struct FRawDistributionVector *d8e81b3bf9; // 0x50(0x50)
...
struct UParticleModuleTypeDataRibbon : UParticleModuleTypeDataBase {
	...
	char pad_4D[0x3]; // 0x4d(0x03)
	float *48f2c3e1a7; // 0x50(0x04)
	float *7d24f9806d; // 0x54(0x04)
	char *8f303e3c71 : 1; // 0x58(0x01)
	char pad_58_1 : 7; // 0x58(0x01)
	char pad_59[0x3]; // 0x59(0x03)
	float *05f6d1af0f; // 0x5c(0x04)
};
...
struct U*eb857906a6 : UParticleModuleVectorFieldBase {
	...
	char pad_30_1 : 7; // 0x30(0x01)
	char pad_31[0x3]; // 0x31(0x03)
	float *bb9cdfd91e; // 0x34(0x04)
	float *ac7c0dace2; // 0x38(0x04)
	char pad_3C[0x4]; // 0x3c(0x04)
};
...
struct U*81bf6faf42 : UParticleModuleVectorFieldBase {
	struct FVector *d1010f4b65; // 0x30(0x0c)
	struct FVector *0f2f980e2e; // 0x3c(0x0c)
};
...
struct UParticleModuleVectorFieldScale : UParticleModuleVectorFieldBase {
	struct U*ca563f945f* VectorFieldScale; // 0x30(0x08)
	struct F*1273267ee1 *c9b2a4dade; // 0x38(0x38)
};

// Class Engine.ParticleModuleVectorFieldScaleOverLife
// Size: 0x70 (Inherited: 0x30)
struct UParticleModuleVectorFieldScaleOverLife : UParticleModuleVectorFieldBase {
	struct U*ca563f945f* VectorFieldScaleOverLife; // 0x30(0x08)
	struct F*1273267ee1 *0352d96e36; // 0x38(0x38)
};
...
struct U*cc985aa6b7 : U*bcab0ec14c {
	struct FRawDistributionVector *3502d378e4; // 0x38(0x50)
	struct F*1273267ee1 *27249e463e; // 0x88(0x38)
};
...
struct U*32537843d3 : U*bcab0ec14c {
	struct F*1273267ee1 Angle; // 0x38(0x38)
	struct F*1273267ee1 Velocity; // 0x70(0x38)
...
struct UParticleModuleVelocityOverLifetime : U*bcab0ec14c {
	struct FRawDistributionVector *6971876fdc; // 0x38(0x50)
...
struct UPhysicalMaterial : UObject {
	...
	char pad_44[0x4]; // 0x44(0x04)
	struct UPhysicalMaterialPropertyBase* *9a2960aa78; // 0x48(0x08)
	enum class EPhysicalSurface SurfaceType; // 0x50(0x01)
	char pad_51[0x3]; // 0x51(0x03)
	float *2ddbfe9350; // 0x54(0x04)
	struct TArray<struct F*298cd37308> *e11ee3dc6e; // 0x58(0x10)
	char pad_68[0x18]; // 0x68(0x18)
};
...
struct U*1d03cdd2a6 : UObject {
	struct TArray<struct F*9ad3af2c58> *3e2db2fdc7; // 0x28(0x10)
};

// Class Engine.*4b3f815593
// Size: 0x50 (Inherited: 0x38)
struct U*4b3f815593 : U*1d03cdd2a6 {
	struct TArray<struct FString> *d69c2f8a49; // 0x38(0x10)
...
struct U*bfce6dc138 : U*1d03cdd2a6 {
	...
	char pad_38_1 : 7; // 0x38(0x01)
	char pad_39[0x7]; // 0x39(0x07)
	struct TArray<DelegateProperty> *662fedc922; // 0x40(0x10)
	struct TArray<DelegateProperty> *2548fe3018; // 0x50(0x10)
};

// Class Engine.*98e8421be7
// Size: 0x68 (Inherited: 0x38)
struct U*98e8421be7 : U*1d03cdd2a6 {
	struct TArray<struct F*f579f33d1f> *03e1e81933; // 0x38(0x10)
	struct FString LastError; // 0x48(0x10)
	struct FString *e369af5425; // 0x58(0x10)
};
...
struct U*f05799c221 : UObject {
	struct FString *055d8cf00e; // 0x28(0x10)
	int32 ResponseCode; // 0x38(0x04)
	int32 Tag; // 0x3c(0x04)
	struct FString *8bd034f933; // 0x40(0x10)
	struct TArray<bool> *08b12c2db2; // 0x50(0x10)
...
// Size: 0x48 (Inherited: 0x28)
struct URig : UObject {
	struct TArray<struct F*1e26811f8e> TransformBases; // 0x28(0x10)
...
struct USimpleConstructionScript : UObject {
	struct TArray<struct USCS_Node*> *548c6e05d9; // 0x28(0x10)
	struct TArray<struct USCS_Node*> *d1c99eccaa; // 0x38(0x10)
	struct USCS_Node* *4dc2bd65af; // 0x48(0x08)
...
struct USCS_Node : UObject {
	...
	struct UActorComponent* *930a480bfe; // 0x30(0x08)
	struct F*76eff26226 *8d069c690c; // 0x38(0x50)
	struct FName VariableName; // 0x88(0x08)
	struct FName *4a9c579dda; // 0x90(0x08)
	struct FName *5618ea73e9; // 0x98(0x08)
	struct FName *92a5014cc6; // 0xa0(0x08)
	bool *528405a512; // 0xa8(0x01)
	char pad_A9[0x7]; // 0xa9(0x07)
	struct TArray<struct USCS_Node*> ChildNodes; // 0xb0(0x10)
	struct USCS_Node* *262c515cd2; // 0xc0(0x08)
	struct TArray<struct F*58d045b1a4> *1a8a67551c; // 0xc8(0x10)
...
struct UDestructibleMesh : USkeletalMesh {
	...
	struct TArray<struct F*53a1c74b57> *e3a2f927cd; // 0x370(0x10)
...
struct USkeletalMeshReductionSettings : UObject {
	struct TArray<struct F*528a6b8e2c> Settings; // 0x28(0x10)
	char pad_38[0x8]; // 0x38(0x08)
};
...
struct USoundConcurrency : UObject {
	struct F*3bb246ee28 Concurrency; // 0x28(0x10)
};
...
struct USoundSubmix : UObject {
	struct TArray<struct USoundSubmix*> *c35c85e5eb; // 0x28(0x10)
	struct USoundSubmix* *c05da71772; // 0x38(0x08)
	struct TArray<struct U*059f6ca67c*> *49706d36a3; // 0x40(0x10)
};

// Class Engine.SoundBase
// Size: 0xa0 (Inherited: 0x28)
struct USoundBase : UObject {
	struct USoundClass* *e6f1a8a451; // 0x28(0x08)
	...
	struct F*3bb246ee28 ConcurrencyOverrides; // 0x40(0x10)
	...
	struct TArray<struct F*dbabf904cf> SoundSubmixSends; // 0x78(0x10)
	float DefaultMasterReverbSendAmount; // 0x88(0x04)
	char pad_8C[0x4]; // 0x8c(0x04)
	struct U*065aab1e6f* SourceEffectChain; // 0x90(0x08)
...
struct USoundCue : USoundBase {
	...
	char pad_A0_1 : 7; // 0xa0(0x01)
	char pad_A1[0x7]; // 0xa1(0x07)
	struct USoundNode* *1641c07c6e; // 0xa8(0x08)
	float *10aca907ae; // 0xb0(0x04)
	float *a785000e4c; // 0xb4(0x04)
	struct FSoundAttenuationSettings *07b17728de; // 0xb8(0x130)
...
struct USoundWave : USoundBase {
	...
	struct FString *649b8b652a; // 0xb8(0x10)
	float *6eb03a2cf3; // 0xc8(0x04)
	float Volume; // 0xcc(0x04)
	float Pitch; // 0xd0(0x04)
	int32 *c500f930b2; // 0xd4(0x04)
	int32 SampleRate; // 0xd8(0x04)
	int32 *49a4041a10; // 0xdc(0x04)
	struct TArray<struct F*b8c123cb20> Subtitles; // 0xe0(0x10)
	struct TArray<struct F*36f94a7d1e> *5111180de2; // 0xf0(0x10)
	struct UCurveTable* Curves; // 0x100(0x08)
	struct UCurveTable* *1143e25d59; // 0x108(0x08)
...
struct USoundClass : UObject {
	struct F*eed253c1ce Properties; // 0x28(0x2c)
	char pad_54[0x4]; // 0x54(0x04)
	struct TArray<struct USoundClass*> ChildClasses; // 0x58(0x10)
	struct TArray<struct FPassiveSoundMixModifier> *4bef31be96; // 0x68(0x10)
...
struct U*065aab1e6f : UObject {
	struct TArray<struct F*3340ad61dc> Chain; // 0x28(0x10)
...
struct USoundMix : UObject {
	...
	char pad_28_1 : 7; // 0x28(0x01)
	char pad_29[0x3]; // 0x29(0x03)
	float *d1336a92b8; // 0x2c(0x04)
	struct FAudioEQEffect *102c092581; // 0x30(0x38)
	struct TArray<struct F*35d2d122d8> *203e2e1cb2; // 0x68(0x10)
	float InitialDelay; // 0x78(0x04)
	float *881bc74a58; // 0x7c(0x04)
	float Duration; // 0x80(0x04)
	float *4c89be388c; // 0x84(0x04)
};
...
struct U*3462e1eb37 : USoundNode {
	...
	struct FSoundAttenuationSettings *07b17728de; // 0x40(0x130)
...
struct USoundNodeBranch : USoundNode {
	struct FName *c4fa14e342; // 0x38(0x08)
};

// Class Engine.*56e1b0cde6
// Size: 0x48 (Inherited: 0x38)
struct U*56e1b0cde6 : USoundNode {
	struct TArray<float> *67d9e2eae5; // 0x38(0x10)
};

// Class Engine.*349c709a81
// Size: 0x40 (Inherited: 0x38)
struct U*349c709a81 : USoundNode {
	float *1698f8b247; // 0x38(0x04)
	float *c2e0831513; // 0x3c(0x04)
};
...
struct U*a2d0a8eee8 : USoundNode {
	struct TArray<struct FDistanceDatum> *676a30a8bc; // 0x38(0x10)
};
...
struct U*82d0041e72 : USoundNode {
	float *a117920c02; // 0x38(0x04)
	float LoopEnd; // 0x3c(0x04)
	float *021f0ce137; // 0x40(0x04)
	int32 *32c144a2cd; // 0x44(0x04)
	char *3a61154a17 : 1; // 0x48(0x01)
	char bLoop : 1; // 0x48(0x01)
	char pad_48_2 : 6; // 0x48(0x01)
	char pad_49[0x7]; // 0x49(0x07)
	struct U*f78a737900* VolumeInterpCurve; // 0x50(0x08)
	struct U*f78a737900* PitchInterpCurve; // 0x58(0x08)
	struct FRuntimeFloatCurve VolumeCurve; // 0x60(0x78)
	struct FRuntimeFloatCurve *d0d6715649; // 0xd8(0x78)
	float *b87c0aa12a; // 0x150(0x04)
	float *2f34e4d6b6; // 0x154(0x04)
	float *796669b85f; // 0x158(0x04)
	float *1e8a841d6c; // 0x15c(0x04)
};

// Class Engine.*a4530877f1
// Size: 0x48 (Inherited: 0x38)
struct U*a4530877f1 : USoundNode {
	struct TArray<int32> *351e49fe63; // 0x38(0x10)
};

// Class Engine.*ee49de76e2
// Size: 0x40 (Inherited: 0x38)
struct U*ee49de76e2 : USoundNode {
	int32 *32c144a2cd; // 0x38(0x04)
...
struct U*bce43fcbac : USoundNode {
	float *b87c0aa12a; // 0x38(0x04)
	float *2f34e4d6b6; // 0x3c(0x04)
	float *796669b85f; // 0x40(0x04)
	float *1e8a841d6c; // 0x44(0x04)
};

// Class Engine.*775b0140ca
// Size: 0x78 (Inherited: 0x38)
struct U*775b0140ca : USoundNode {
	struct F*fd1ea2a2f5 *ddb9f992df; // 0x38(0x20)
	struct F*fd1ea2a2f5 *7157d40d02; // 0x58(0x20)
};
...
struct U*bdc41e4554 : USoundNode {
	...
	char pad_38_2 : 6; // 0x38(0x01)
	char pad_39[0x3]; // 0x39(0x03)
	float *47fcdc9e9a; // 0x3c(0x04)
	float *1283ce8322; // 0x40(0x04)
	float *007bf4f82a; // 0x44(0x04)
	float *f8de572d16; // 0x48(0x04)
	float *bb1cba22f3; // 0x4c(0x04)
	float *49112df372; // 0x50(0x04)
	float *ab436c0ecd; // 0x54(0x04)
	float *9f3424b476; // 0x58(0x04)
	char pad_5C[0x4]; // 0x5c(0x04)
};
...
struct U*77e81e4764 : USoundNode {
	...
	int32 *198112192a; // 0x48(0x04)
	char *b7d75afd39 : 1; // 0x4c(0x01)
	char pad_4C_1 : 7; // 0x4c(0x01)
	char pad_4D[0x3]; // 0x4d(0x03)
	struct TArray<bool> *fed5ce1c46; // 0x50(0x10)
	int32 *26d7e21603; // 0x60(0x04)
	char pad_64[0x4]; // 0x64(0x04)
};
...
struct U*cc48730208 : USoundNode {
	struct USoundClass* *e2444a5810; // 0x38(0x08)
};

// Class Engine.SoundNodeSwitch
// Size: 0x40 (Inherited: 0x38)
struct USoundNodeSwitch : USoundNode {
	struct FName *820006ffbf; // 0x38(0x08)
};

// Class Engine.*70c840d0a4
// Size: 0x40 (Inherited: 0x38)
struct U*70c840d0a4 : USoundNode {
	struct FName *3bbb9de585; // 0x38(0x08)
};
...
struct U*5788ee1977 : UObject {
	...
	struct FText *79845853b4; // 0x58(0x18)
};
...
struct U*12776be9f9 : UObject {
	...
	char pad_31[0x7]; // 0x31(0x07)
	struct TArray<struct F*b185fedfd6> *a74e29c11f; // 0x38(0x10)
	struct TArray<struct F*2d3b7be361> *77b561e3a2; // 0x48(0x10)
	struct TArray<struct F*a5c715f021> *a0463095cc; // 0x58(0x10)
	struct TArray<struct F*f5c8deeab7> *a151eb40b2; // 0x68(0x10)
	struct TArray<struct F*58d045b1a4> *1a8a67551c; // 0x78(0x10)
	struct FGuid *6017117d39; // 0x88(0x10)
};

// Class Engine.TouchInterface
// Size: 0x58 (Inherited: 0x28)
struct UTouchInterface : UObject {
	struct TArray<struct F*3b464b2be8> Controls; // 0x28(0x10)
	float *3d55383df8; // 0x38(0x04)
	float *764eb59cf0; // 0x3c(0x04)
	float *cc28420b57; // 0x40(0x04)
	float *e72facdf2c; // 0x44(0x04)
	float *c867a26557; // 0x48(0x04)
...
struct UUserDefinedEnum : UEnum {
	struct TMap<struct FName, struct FText> *53186095f1; // 0x70(0x50)
};
...
struct U*c9d8b1d195 : UVectorField {
	...
	char pad_51[0x3]; // 0x51(0x03)
	int32 *a57a49d12f; // 0x54(0x04)
	int32 *7a3ccfa0d9; // 0x58(0x04)
	int32 *a30919fabf; // 0x5c(0x04)
	int32 *33c46b8565; // 0x60(0x04)
	int32 *32bd0be2e7; // 0x64(0x04)
	int32 FrameCount; // 0x68(0x04)
	float FramesPerSecond; // 0x6c(0x04)
	char bLoop : 1; // 0x70(0x01)
	char pad_70_1 : 7; // 0x70(0x01)
	char pad_71[0x7]; // 0x71(0x07)
	struct U*f0a1a553f8* NoiseField; // 0x78(0x08)
	float NoiseScale; // 0x80(0x04)
	float *11e10cdb0c; // 0x84(0x04)
};
...
struct UWorldComposition : UObject {
	char pad_28[0x38]; // 0x28(0x38)
	struct TArray<struct ULevelStreaming*> *8345316efb; // 0x60(0x10)
