...
struct ABuff_Invulnerablility_C : ATslBuff {
	...
	void UserConstructionScript(); // Function Buff_Invulnerablility.Buff_Invulnerablility_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x32e590
};
