...
struct ABP_TslBaseLobbySceneTravel_FadeInOut_C : ATslLobbySceneTravel_FadeInOut {
	...
	void UserConstructionScript(); // Function BP_TslBaseLobbySceneTravel_FadeInOut.BP_TslBaseLobbySceneTravel_FadeInOut_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x32e590
};
