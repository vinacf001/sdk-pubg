...
struct UConsoleSettings : UObject {
	...
	struct TArray<struct F*edd2c28b19> ManualAutoCompleteList; // 0x30(0x10)
...
struct UGameMapsSettings : UObject {
	...
	enum class *bdd6c0976d ThreePlayerSplitscreenLayout; // 0x5a(0x01)
	...
	struct TArray<struct F*8518dffd3a> GameModeMapPrefixes; // 0xb0(0x10)
	struct TArray<struct F*8518dffd3a> GameModeClassAliases; // 0xc0(0x10)
};
