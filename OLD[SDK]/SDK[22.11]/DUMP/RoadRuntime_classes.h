...
struct ACrossActor : AStaticMeshActor {
	...
	bool *f6d728170a(); // Function RoadRuntime.CrossActor.*f6d728170a // Final|Native|Public|HasDefaults // @ game+0x6804858
	bool *f9635a76e9(struct FVector Param1, struct FVector Param3); // Function RoadRuntime.CrossActor.*f9635a76e9 // Final|Native|Public|HasDefaults // @ game+0x6804af4
	struct FRotator *694e9228d7(struct FVector Param3, bool Param5); // Function RoadRuntime.CrossActor.*694e9228d7 // Final|Native|Public|HasDefaults // @ game+0x68045bc
	bool *47d697e84b(struct UStaticMesh* Param0); // Function RoadRuntime.CrossActor.*47d697e84b // Final|Native|Public|HasDefaults // @ game+0x6804d90
	void *0197816a5c(); // Function RoadRuntime.CrossActor.*0197816a5c // Final|Native|Public // @ game+0x6804564
};
