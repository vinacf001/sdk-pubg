...
struct ABP_WeaponDisplay_C : ATslWeaponDisplay {
	struct F*a3d8ff36c0 UberGraphFrame; // 0x630(0x08)
	...
	void UserConstructionScript(); // Function BP_WeaponDisplay.BP_WeaponDisplay_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x32e590
	void AddStaticMeshAsyncEvent(); // Function BP_WeaponDisplay.BP_WeaponDisplay_C.AddStaticMeshAsyncEvent // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x32e590
	struct FTransform ExecuteUbergraph_BP_WeaponDisplay(bool K2Node_Event_indexMatch); // Function BP_WeaponDisplay.BP_WeaponDisplay_C.ExecuteUbergraph_BP_WeaponDisplay // HasDefaults // @ game+0x32e590
};
