...
struct F*5cde951495 {
	float OrthoWidth; // 0x00(0x04)
	float OrthoFarClipPlane; // 0x04(0x04)
	struct FVector2D OffCenterProjectionOffset; // 0x08(0x08)
	float PostProcessBlendWeight; // 0x10(0x04)
	char pad_14[0xc]; // 0x14(0x0c)
	struct FPostProcessSettings PostProcessSettings; // 0x20(0x570)
	struct FRotator Rotation; // 0x590(0x0c)
	float AspectRatio; // 0x59c(0x04)
	struct FVector Location; // 0x5a0(0x0c)
	enum class ECameraProjectionMode ProjectionMode; // 0x5ac(0x01)
	char pad_5AD[0x3]; // 0x5ad(0x03)
	char bConstrainAspectRatio : 1; // 0x5b0(0x01)
	char bUseFieldOfViewForLOD : 1; // 0x5b0(0x01)
	char pad_5B0_2 : 6; // 0x5b0(0x01)
	char pad_5B1[0x3]; // 0x5b1(0x03)
	float OrthoNearClipPlane; // 0x5b4(0x04)
	float FOV; // 0x5b8(0x04)
...
struct F*8aa6907eaa {
	...
	char pad_8[0x8]; // 0x08(0x08)
	struct F*5cde951495 POV; // 0x10(0x5c0)
...
struct F*4156116286 {
	...
	struct F*5cde951495 *08b2f76dfb; // 0x10(0x5c0)
};
...
struct FWorldContext {
	char pad_0[0x8]; // 0x00(0x08)
	struct TArray<struct F*748cdb5bcc> *f91257b2df; // 0x08(0x10)
	char pad_18[0x28]; // 0x18(0x28)
	struct FURL *b5cfa248f4; // 0x40(0x70)
	struct TArray<struct U*f633e75a6f*> *4b8fad4d6c; // 0xb0(0x10)
	struct UGameInstance* *1d311e10e5; // 0xc0(0x08)
	char pad_C8[0x30]; // 0xc8(0x30)
	struct TArray<struct ULevel*> *bc7eaca6b4; // 0xf8(0x10)
	char pad_108[0xc8]; // 0x108(0xc8)
	struct FURL *67a79206d3; // 0x1d0(0x70)
	char pad_240[0x8]; // 0x240(0x08)
	struct TArray<struct F*055697d8f7> *6b4a4246de; // 0x248(0x10)
	char pad_258[0x18]; // 0x258(0x18)
	struct TArray<struct F*270e8b5d12> PackagesToFullyLoad; // 0x270(0x10)
	struct UGameViewportClient* GameViewport; // 0x280(0x08)
	struct U*ecaf7d9876* *ecaf7d9876; // 0x288(0x08)
