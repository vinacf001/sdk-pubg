...
struct ALandscapeProxy : AActor {
	...
	float *8e60c8a685(int32 NumSubdivisions, bool bLowerHeights); // Function Landscape.LandscapeProxy.*8e60c8a685 // Final|Native|Public|BlueprintCallable // @ game+0x5dda018
	void *85b6178615(); // Function Landscape.LandscapeProxy.*85b6178615 // Native|Public|BlueprintCallable // @ game+0x571fea0
};
