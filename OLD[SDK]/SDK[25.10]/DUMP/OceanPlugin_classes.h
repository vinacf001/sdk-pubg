...
struct AOceanManager : AActor {
	...
	struct TArray<struct F*a8ec53011e> WaveClusters; // 0x410(0x10)
	struct TArray<struct F*6f9a383ca9> WaveSetOffsetsOverride; // 0x420(0x10)
	...
	struct FLinearColor *647bcbc832(); // Function OceanPlugin.OceanManager.*647bcbc832 // Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const // @ game+0x6c909b0
	struct UTexture2D* *72cdf8bb4c(); // Function OceanPlugin.OceanManager.*72cdf8bb4c // Final|Native|Public|BlueprintCallable // @ game+0x6c90dd4
	struct FVector *7decd84e27(); // Function OceanPlugin.OceanManager.*7decd84e27 // Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable // @ game+0x8893fc
};
...
struct U*2f7dca983b : USceneComponent {
	...
	float TriangleArea(); // Function OceanPlugin.*2f7dca983b.TriangleArea // Final|Native|Public|HasDefaults|BlueprintCallable // @ game+0x6c917fc
	void *0ec6749750(); // Function OceanPlugin.*2f7dca983b.*0ec6749750 // Final|Native|Public|BlueprintCallable // @ game+0x6c90acc
	struct F*ba107aed0a *ad7093360a(); // Function OceanPlugin.*2f7dca983b.*ad7093360a // Final|Native|Public|BlueprintCallable // @ game+0x6c90328
	float *d770a52895(); // Function OceanPlugin.*2f7dca983b.*d770a52895 // Final|Native|Public|BlueprintCallable // @ game+0x6c914a4
	struct TArray<struct F*ba107aed0a> *f3517596ee(); // Function OceanPlugin.*2f7dca983b.*f3517596ee // Final|Native|Public|HasDefaults|BlueprintCallable // @ game+0x6c915a0
	struct FColor *6b958f4d33(); // Function OceanPlugin.*2f7dca983b.*6b958f4d33 // Final|Native|Public|HasDefaults|BlueprintCallable // @ game+0x6c90610
	float *8209657dec(); // Function OceanPlugin.*2f7dca983b.*8209657dec // Final|Native|Public|HasDefaults|BlueprintCallable // @ game+0x6c90ae0
	struct FVector *f46ea16e80(); // Function OceanPlugin.*2f7dca983b.*f46ea16e80 // Final|Native|Public|HasDefaults|BlueprintCallable // @ game+0x6c90418
};
...
struct ABuoyantDestructible : AActor {
	struct U*ed33f09e51* BuoyantDestructibleComponent; // 0x3f8(0x08)
};
...
struct ACustomVehicleController : APlayerController {
	struct APawn* *500819249d; // 0x7c0(0x08)
	char pad_7C8[0x8]; // 0x7c8(0x08)

	bool *ae12026cb6(); // Function OceanPlugin.CustomVehicleController.*ae12026cb6 // Native|Public|BlueprintCallable|BlueprintPure // @ game+0x6c90aa4
	struct APawn* *6a38329ad8(); // Function OceanPlugin.CustomVehicleController.*6a38329ad8 // Native|Public|BlueprintCallable // @ game+0x6c90704
	void EnableBuoyancy(); // Function OceanPlugin.CustomVehicleController.EnableBuoyancy // Exec|Native|Public // @ game+0x6c906ec
	void DrawBuoyancyPoints(); // Function OceanPlugin.CustomVehicleController.DrawBuoyancyPoints // Exec|Native|Public // @ game+0x6c905f8
	void *31abef4fa9(); // Function OceanPlugin.CustomVehicleController.*31abef4fa9 // Native|Public|BlueprintCallable // @ game+0x6c90798
};
...
struct AFlockFish : APawn {
	...
	int32 OnEndOverlap(); // Function OceanPlugin.FlockFish.OnEndOverlap // Final|Native|Protected // @ game+0x6c910b4
	struct FHitResult OnBeginOverlap(); // Function OceanPlugin.FlockFish.OnBeginOverlap // Final|Native|Protected|HasOutParms // @ game+0x6c90e64
};
...
struct UOceanMeshComponent : UPrimitiveComponent {
	...
	float *f3d3b89316(); // Function OceanPlugin.OceanMeshComponent.*f3d3b89316 // Final|Native|Public|BlueprintCallable // @ game+0x6c913c8
	struct FVector *f4bc875ded(); // Function OceanPlugin.OceanMeshComponent.*f4bc875ded // Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable // @ game+0x6c91230
};

// Class OceanPlugin.TimeManager
// Size: 0x4c0 (Inherited: 0x3f8)
struct ATimeManager : AActor {
	struct F*de25589e23 CurrentLocalTime; // 0x3f8(0x1c)
	...
	float *452b60b89f(); // Function OceanPlugin.TimeManager.*452b60b89f // Final|Native|Public|BlueprintCallable // @ game+0x6c90990
	struct FRotator *54a524981e(); // Function OceanPlugin.TimeManager.*54a524981e // Final|Native|Public|HasDefaults|BlueprintCallable // @ game+0x6c905c4
	float *c0a4435af6(); // Function OceanPlugin.TimeManager.*c0a4435af6 // Final|Native|Public|BlueprintCallable|BlueprintPure // @ game+0x6c90884
	float *2aa4474fb2(); // Function OceanPlugin.TimeManager.*2aa4474fb2 // Final|Native|Public|BlueprintCallable // @ game+0x6c90c04
	float *c893e98211(); // Function OceanPlugin.TimeManager.*c893e98211 // Final|Native|Public|BlueprintCallable|BlueprintPure // @ game+0x6c90bdc
	struct F*de25589e23 *65c0af23b6(); // Function OceanPlugin.TimeManager.*65c0af23b6 // Final|Native|Public|BlueprintCallable // @ game+0x6c90c9c
	int32 *924cca3e51(); // Function OceanPlugin.TimeManager.*924cca3e51 // Final|Native|Public|BlueprintCallable // @ game+0x6a142c0
	int32 *4f48b68109(); // Function OceanPlugin.TimeManager.*4f48b68109 // Final|Native|Public|BlueprintCallable // @ game+0x6c908bc
	bool IsLeapYear(); // Function OceanPlugin.TimeManager.IsLeapYear // Final|Native|Public|BlueprintCallable // @ game+0x6c90d48
	struct FRotator *651b16b16d(); // Function OceanPlugin.TimeManager.*651b16b16d // Final|Native|Public|HasDefaults|BlueprintCallable // @ game+0x6c90520
	float *3263eb45e0(); // Function OceanPlugin.TimeManager.*3263eb45e0 // Final|Native|Public|BlueprintCallable // @ game+0x6c91330
	float *2fef94a4d0(); // Function OceanPlugin.TimeManager.*2fef94a4d0 // Final|Native|Public|BlueprintCallable // @ game+0x6c90554
	int32 GetDayOfYear(); // Function OceanPlugin.TimeManager.GetDayOfYear // Final|Native|Public|BlueprintCallable // @ game+0x6c907b0
};
