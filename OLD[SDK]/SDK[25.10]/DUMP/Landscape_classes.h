...
struct ALandscapeMeshProxyActor : AActor {
	struct U*7f12d8f510* LandscapeMeshProxyComponent; // 0x3f8(0x08)
};
...
struct ALandscapeProxy : AActor {
	struct FGuid *6cb6909a1b; // 0x3f8(0x10)
	struct ULandscapeSplinesComponent* SplineComponent; // 0x408(0x08)
	int32 *ae877a5ca7; // 0x410(0x04)
	int32 *7cd27fee79; // 0x414(0x04)
	int32 *f53aeea43c; // 0x418(0x04)
	struct FIntPoint *f753b943ed; // 0x41c(0x08)
	...
	float *4fb34d5583; // 0x458(0x04)
	float *c154edc768; // 0x45c(0x04)
	struct TArray<struct ULandscapeComponent*> LandscapeComponents; // 0x460(0x10)
	struct TArray<struct ULandscapeHeightfieldCollisionComponent*> *985691eccd; // 0x470(0x10)
	struct TArray<struct UHierarchicalInstancedStaticMeshComponent*> *7d9b02b42d; // 0x480(0x10)
	char pad_490[0x60]; // 0x490(0x60)
	char *b994e949a0 : 1; // 0x4f0(0x01)
	char bCastStaticShadow : 1; // 0x4f0(0x01)
	char bCastShadowAsTwoSided : 1; // 0x4f0(0x01)
	char bCastFarShadow : 1; // 0x4f0(0x01)
	char *573ac800ea : 1; // 0x4f0(0x01)
	char bRenderCustomDepth : 1; // 0x4f0(0x01)
	char bGenerateOverlapEvents : 1; // 0x4f0(0x01)
	char *afbddb3b02 : 1; // 0x4f0(0x01)
	char *963d959668 : 1; // 0x4f1(0x01)
	char *0326a86e14 : 1; // 0x4f1(0x01)
	...
	struct F*25888ccc71 LightmassSettings; // 0x500(0x18)
	int32 CollisionMipLevel; // 0x518(0x04)
	int32 *8bb396e6d2; // 0x51c(0x04)
	float *0874902f89; // 0x520(0x04)
	...
	struct ULandscapeLayerInfoObject* *6125e7c73e(); // Function Landscape.LandscapeProxy.*6125e7c73e // Final|Native|Public|BlueprintCallable // @ game+0x62b55c4
	float *9c918124eb(); // Function Landscape.LandscapeProxy.*9c918124eb // Native|Public|BlueprintCallable // @ game+0x5c16844
};
