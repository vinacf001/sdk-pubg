...
struct AFBPBuff_v2_AddReloading_C : ATslFBRBuff {
	...
	void UserConstructionScript(); // Function FBPBuff_v2_AddReloading.FBPBuff_v2_AddReloading_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x2ad9d8
};
