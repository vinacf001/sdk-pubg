...
struct U*14a032dbde : UObject {
	...
	int32 *22408b49f5(); // Function MovieScene.*14a032dbde.*22408b49f5 // Final|Native|Public|BlueprintCallable // @ game+0xc806d4
	void PlayReverse(); // Function MovieScene.*14a032dbde.PlayReverse // Final|Native|Public|BlueprintCallable // @ game+0x62d35dc
	float SetPlaybackPosition(); // Function MovieScene.*14a032dbde.SetPlaybackPosition // Final|Native|Public|BlueprintCallable // @ game+0x62d3690
	float SetPlayRate(); // Function MovieScene.*14a032dbde.SetPlayRate // Final|Native|Public|BlueprintCallable // @ game+0x62d35f8
	bool IsPlaying(); // Function MovieScene.*14a032dbde.IsPlaying // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x62d3590
	void Stop(); // Function MovieScene.*14a032dbde.Stop // Final|Native|Public|BlueprintCallable // @ game+0x62d3818
	void Pause(); // Function MovieScene.*14a032dbde.Pause // Final|Native|Public|BlueprintCallable // @ game+0x62d35ac
	void *ad87fa339d(); // Function MovieScene.*14a032dbde.*ad87fa339d // Final|Native|Public|BlueprintCallable // @ game+0x62d3804
	float GetPlayRate(); // Function MovieScene.*14a032dbde.GetPlayRate // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x62d3530
	float *fcebe680c3(); // Function MovieScene.*14a032dbde.*fcebe680c3 // Final|Native|Public|BlueprintCallable // @ game+0x62d3728
	float *b2077c676e(); // Function MovieScene.*14a032dbde.*b2077c676e // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x62d3578
	float *9548ae7454(); // Function MovieScene.*14a032dbde.*9548ae7454 // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x62d350c
	struct TArray<struct UObject*> *764b6d0441(); // Function MovieScene.*14a032dbde.*764b6d0441 // Final|Native|Public|BlueprintCallable // @ game+0x62d33e8
	float *db1643e9dc(); // Function MovieScene.*14a032dbde.*db1643e9dc // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x62d3548
	void Play(); // Function MovieScene.*14a032dbde.Play // Final|Native|Public|BlueprintCallable // @ game+0x62d35c0
	float *3dc22f4f13(); // Function MovieScene.*14a032dbde.*3dc22f4f13 // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x62d3560
	void *f976cf8725(); // Function MovieScene.*14a032dbde.*f976cf8725 // Final|Native|Public|BlueprintCallable // @ game+0x62d33bc
};
