...
// ScriptStruct PowerIKRuntime.*58266ddf42
// Size: 0x28 (Inherited: 0x00)
struct F*58266ddf42 {
	char pad_0[0x28]; // 0x00(0x28)
};

// ScriptStruct PowerIKRuntime.*828af26ed5
// Size: 0x68 (Inherited: 0x00)
struct F*828af26ed5 {
	char pad_0[0x68]; // 0x00(0x68)
};

// ScriptStruct PowerIKRuntime.*274076baf6
...
struct FPowerIKEffector {
	...
	enum class *fc15552160 PositionSpace; // 0x14(0x01)
	char pad_15[0x3]; // 0x15(0x03)
	struct FRotator Rotation; // 0x18(0x0c)
	enum class *fc15552160 RotationSpace; // 0x24(0x01)
...
struct FPowerIKPoleVector {
	enum class *635f9e2429 Mode; // 0x00(0x01)
...
// ScriptStruct PowerIKRuntime.*1112a9f05b
// Size: 0x10 (Inherited: 0x00)
struct F*1112a9f05b {
