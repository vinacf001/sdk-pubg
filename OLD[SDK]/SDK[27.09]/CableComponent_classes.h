...
struct ACableActor : AActor {
	struct UCableComponent* CableComponent; // 0x408(0x08)
};
...
struct UCableComponent : UMeshComponent {
	...
	void *9b4f891d4b(); // Function CableComponent.CableComponent.*9b4f891d4b // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x6ad36ac
	void *b64a31c5dd(); // Function CableComponent.CableComponent.*b64a31c5dd // Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const // @ game+0x6ad36fc
	void *5f07df3aeb(); // Function CableComponent.CableComponent.*5f07df3aeb // Final|Native|Public|BlueprintCallable // @ game+0x6ad37c4
	void *c59a3fc0a3(); // Function CableComponent.CableComponent.*c59a3fc0a3 // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x6ad36c4
};
