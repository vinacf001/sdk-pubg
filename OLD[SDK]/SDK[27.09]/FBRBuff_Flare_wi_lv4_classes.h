...
struct AFBRBuff_Flare_wi_lv4_C : ATslFBRItemBuff {
	...
	void UserConstructionScript(); // Function FBRBuff_Flare_wi_lv4.FBRBuff_Flare_wi_lv4_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x22ddc4
};
