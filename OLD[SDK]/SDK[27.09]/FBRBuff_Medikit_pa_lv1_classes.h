...
struct AFBRBuff_Medikit_pa_lv1_C : ATslFBRItemBuff {
	...
	void UserConstructionScript(); // Function FBRBuff_Medikit_pa_lv1.FBRBuff_Medikit_pa_lv1_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x22ddc4
};
