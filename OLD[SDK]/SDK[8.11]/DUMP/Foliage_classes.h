...
struct U*700a8d0f9b : UBlueprintFunctionLibrary {
	...
	struct FBox *4d3282e214(); // Function Foliage.*700a8d0f9b.*4d3282e214 // Final|Native|Static|Public|HasDefaults|BlueprintCallable // @ game+0x5dcd5dc
	struct UObject* *36a58b13ed(struct UStaticMesh* StaticMesh, float Radius); // Function Foliage.*700a8d0f9b.*36a58b13ed // Final|Native|Static|Public|HasDefaults|BlueprintCallable // @ game+0x5dcd720
};
...
struct AInteractiveFoliageActor : AStaticMeshActor {
	...
	bool CapsuleTouched(); // Function Foliage.InteractiveFoliageActor.CapsuleTouched // Final|Native|Protected|HasOutParms // @ game+0x5dcd38c
};
...
struct UProceduralFoliageSpawner : UObject {
	...
	void Simulate(); // Function Foliage.ProceduralFoliageSpawner.Simulate // Final|Native|Public|BlueprintCallable // @ game+0x5dcd89c
};
