...
struct ABP_LobbyCharacterPivot_C : ALobbyCharacterPivot {
	...
	void UserConstructionScript(); // Function BP_LobbyCharacterPivot.BP_LobbyCharacterPivot_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x293938
};
