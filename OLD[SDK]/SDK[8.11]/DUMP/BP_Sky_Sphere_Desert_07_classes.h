...
struct ABP_Sky_Sphere_Desert_07_C : AActor {
	...
	struct FLinearColor UpdateSunDirection(bool CallFunc__aca7a45594_ReturnValue, float CallFunc_Abs_ReturnValue, float CallFunc__63e65eadc5_ReturnValue, struct FVector CallFunc__4e30d5fb44_ReturnValue, struct FLinearColor CallFunc__253e5e677f_ReturnValue); // Function BP_Sky_Sphere_Desert_07.BP_Sky_Sphere_Desert_07_C.UpdateSunDirection // Public|BlueprintCallable|BlueprintEvent // @ game+0x293938
	struct FVector UserConstructionScript(float CallFunc_Lerp_ReturnValue, struct FRotator CallFunc_K2_GetActorRotation_ReturnValue, struct FLinearColor CallFunc__1b3f8b152b_ReturnValue3, struct FLinearColor CallFunc__c28e1ae0f8_ReturnValue, struct FRotator CallFunc_K2_GetActorRotation_ReturnValue2); // Function BP_Sky_Sphere_Desert_07.BP_Sky_Sphere_Desert_07_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x293938
};
