...
struct ABP_TslSLBGroggyResistanceBuff_C : ATslResistanceBuff {
	...
	void UserConstructionScript(); // Function BP_TslSLBGroggyResistanceBuff.BP_TslSLBGroggyResistanceBuff_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x293938
};
