...
struct UKeyGuideWidgetBP_C : U*1780b3fcec {
	...
	void Construct(); // Function KeyGuideWidgetBP.KeyGuideWidgetBP_C.Construct // BlueprintCosmetic|Event|Public|BlueprintEvent // @ game+0x293938
	void EscapeEvent(); // Function KeyGuideWidgetBP.KeyGuideWidgetBP_C.EscapeEvent // BlueprintCallable|BlueprintEvent // @ game+0x293938
	void BndEvt__TslCommonButton_0_K2Node_ComponentBoundEvent_20_OnButtonClickedEvent__DelegateSignature(); // Function KeyGuideWidgetBP.KeyGuideWidgetBP_C.BndEvt__TslCommonButton_0_K2Node_ComponentBoundEvent_20_OnButtonClickedEvent__DelegateSignature // BlueprintEvent // @ game+0x293938
	void BndEvt__TslCommonButton_0_K2Node_ComponentBoundEvent_37_OnButtonHoverEvent__DelegateSignature(); // Function KeyGuideWidgetBP.KeyGuideWidgetBP_C.BndEvt__TslCommonButton_0_K2Node_ComponentBoundEvent_37_OnButtonHoverEvent__DelegateSignature // BlueprintEvent // @ game+0x293938
	bool ExecuteUbergraph_KeyGuideWidgetBP(struct APlayerController* CallFunc_GetOwningPlayer_ReturnValue); // Function KeyGuideWidgetBP.KeyGuideWidgetBP_C.ExecuteUbergraph_KeyGuideWidgetBP //  // @ game+0x293938
};
