...
struct F*5cde951495 {
	struct FVector Location; // 0x00(0x0c)
	struct FVector2D OffCenterProjectionOffset; // 0x0c(0x08)
	struct FRotator Rotation; // 0x14(0x0c)
	float OrthoNearClipPlane; // 0x20(0x04)
	float OrthoFarClipPlane; // 0x24(0x04)
	...
	float OrthoWidth; // 0x5a8(0x04)
	float AspectRatio; // 0x5ac(0x04)
};
...
struct FWorldContext {
	char pad_0[0xf8]; // 0x00(0xf8)
	struct TArray<struct U*f633e75a6f*> *4b8fad4d6c; // 0xf8(0x10)
	struct UGameViewportClient* GameViewport; // 0x108(0x08)
	char pad_110[0x8]; // 0x110(0x08)
	struct FURL *b5cfa248f4; // 0x118(0x70)
	struct TArray<struct F*270e8b5d12> PackagesToFullyLoad; // 0x188(0x10)
	char pad_198[0x8]; // 0x198(0x08)
	struct TArray<struct ULevel*> *bc7eaca6b4; // 0x1a0(0x10)
	struct U*ecaf7d9876* *ecaf7d9876; // 0x1b0(0x08)
	char pad_1B8[0x8]; // 0x1b8(0x08)
	struct TArray<struct F*748cdb5bcc> *f91257b2df; // 0x1c0(0x10)
	char pad_1D0[0x10]; // 0x1d0(0x10)
	struct UGameInstance* *1d311e10e5; // 0x1e0(0x08)
	char pad_1E8[0x30]; // 0x1e8(0x30)
	struct FURL *67a79206d3; // 0x218(0x70)
	struct TArray<struct F*055697d8f7> *6b4a4246de; // 0x288(0x10)
