...
struct F*6d0e0b2cc1 {
	...
	float FOV; // 0x5a0(0x04)
	struct FVector2D OffCenterProjectionOffset; // 0x5a4(0x08)
	float PostProcessBlendWeight; // 0x5ac(0x04)
	float AspectRatio; // 0x5b0(0x04)
	enum class ECameraProjectionMode ProjectionMode; // 0x5b4(0x01)
	char pad_5B5[0x3]; // 0x5b5(0x03)
	float OrthoFarClipPlane; // 0x5b8(0x04)
...
struct FWorldContext {
	...
	struct TArray<struct F*f189697845> *22f89144d6; // 0xd8(0x10)
	struct U*8ea0475d8b* *8ea0475d8b; // 0xe8(0x08)
	char pad_F0[0x18]; // 0xf0(0x18)
	struct TArray<struct U*7c448e30ae*> *55d92776e4; // 0x108(0x10)
	struct UGameViewportClient* GameViewport; // 0x118(0x08)
	struct TArray<struct ULevel*> *fdfac597be; // 0x120(0x10)
	char pad_130[0x38]; // 0x130(0x38)
	struct FURL *e2dd2c7e65; // 0x168(0x70)
	struct TArray<struct F*9dcd338c5a> PackagesToFullyLoad; // 0x1d8(0x10)
	struct FURL *83f990b9f5; // 0x1e8(0x70)
	char pad_258[0x10]; // 0x258(0x10)
	struct UGameInstance* *55c38de05e; // 0x268(0x08)
	struct TArray<struct F*248f357491> *959985156a; // 0x270(0x10)
