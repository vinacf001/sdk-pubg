...
struct ABP_MasteryPose_Default_C : ABP_MasteryPose_C {
	...
	void UserConstructionScript(); // Function BP_MasteryPose_Default.BP_MasteryPose_Default_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x1b829c
};
