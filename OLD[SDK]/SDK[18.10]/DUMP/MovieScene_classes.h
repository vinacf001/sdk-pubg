...
struct U*14a032dbde : UObject {
	...
	int32 *22408b49f5(); // Function MovieScene.*14a032dbde.*22408b49f5 // Final|Native|Public|BlueprintCallable // @ game+0xca4478
	void PlayReverse(); // Function MovieScene.*14a032dbde.PlayReverse // Final|Native|Public|BlueprintCallable // @ game+0x5cf7e9c
	float SetPlaybackPosition(); // Function MovieScene.*14a032dbde.SetPlaybackPosition // Final|Native|Public|BlueprintCallable // @ game+0x5cf7f50
	float SetPlayRate(); // Function MovieScene.*14a032dbde.SetPlayRate // Final|Native|Public|BlueprintCallable // @ game+0x5cf7eb8
	bool IsPlaying(); // Function MovieScene.*14a032dbde.IsPlaying // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x5cf7e50
	void Stop(); // Function MovieScene.*14a032dbde.Stop // Final|Native|Public|BlueprintCallable // @ game+0x5cf80d8
	void Pause(); // Function MovieScene.*14a032dbde.Pause // Final|Native|Public|BlueprintCallable // @ game+0x5cf7e6c
	void *ad87fa339d(); // Function MovieScene.*14a032dbde.*ad87fa339d // Final|Native|Public|BlueprintCallable // @ game+0x5cf80c4
	float GetPlayRate(); // Function MovieScene.*14a032dbde.GetPlayRate // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x5cf7df0
	float *fcebe680c3(); // Function MovieScene.*14a032dbde.*fcebe680c3 // Final|Native|Public|BlueprintCallable // @ game+0x5cf7fe8
	float *b2077c676e(); // Function MovieScene.*14a032dbde.*b2077c676e // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x5cf7e38
	float *9548ae7454(); // Function MovieScene.*14a032dbde.*9548ae7454 // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x5cf7dcc
	struct TArray<struct UObject*> *764b6d0441(); // Function MovieScene.*14a032dbde.*764b6d0441 // Final|Native|Public|BlueprintCallable // @ game+0x5cf7ca8
	float *db1643e9dc(); // Function MovieScene.*14a032dbde.*db1643e9dc // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x5cf7e08
	void Play(); // Function MovieScene.*14a032dbde.Play // Final|Native|Public|BlueprintCallable // @ game+0x5cf7e80
	float *3dc22f4f13(); // Function MovieScene.*14a032dbde.*3dc22f4f13 // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x5cf7e20
	void *f976cf8725(); // Function MovieScene.*14a032dbde.*f976cf8725 // Final|Native|Public|BlueprintCallable // @ game+0x5cf7c7c
};
