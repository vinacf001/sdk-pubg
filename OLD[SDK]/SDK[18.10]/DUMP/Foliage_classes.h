...
struct U*cc61dd21b2 : UBlueprintFunctionLibrary {
	...
	int32 *75ab3f0366(); // Function Foliage.*cc61dd21b2.*75ab3f0366 // Final|Native|Static|Public|HasDefaults|BlueprintCallable // @ game+0x5cbffdc
	int32 *2b51d65701(); // Function Foliage.*cc61dd21b2.*2b51d65701 // Final|Native|Static|Public|HasDefaults|BlueprintCallable // @ game+0x5cc0120
};
...
struct AInteractiveFoliageActor : AStaticMeshActor {
	...
	struct FVector *fe59ef3398; // 0x408(0x0c)
	struct FVector *dbcabce038; // 0x414(0x0c)
	struct FVector *f543c89244; // 0x420(0x0c)
	struct FVector *939f237751; // 0x42c(0x0c)
	...
	struct FHitResult CapsuleTouched(); // Function Foliage.InteractiveFoliageActor.CapsuleTouched // Final|Native|Protected|HasOutParms // @ game+0x5cbfd8c
};
...
struct UProceduralFoliageSpawner : UObject {
	...
	int32 Simulate(); // Function Foliage.ProceduralFoliageSpawner.Simulate // Final|Native|Public|BlueprintCallable // @ game+0x5cc029c
};
