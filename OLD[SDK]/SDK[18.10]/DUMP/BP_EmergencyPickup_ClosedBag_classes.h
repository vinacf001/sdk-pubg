...
struct ABP_EmergencyPickup_ClosedBag_C : ATslEmPickupBag {
	...
	void UserConstructionScript(); // Function BP_EmergencyPickup_ClosedBag.BP_EmergencyPickup_ClosedBag_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x1b829c
};
