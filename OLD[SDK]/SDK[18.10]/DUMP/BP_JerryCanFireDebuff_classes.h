...
struct ABP_JerryCanFireDebuff_C : ATslMolotovFireDebuff {
	...
	void UserConstructionScript(); // Function BP_JerryCanFireDebuff.BP_JerryCanFireDebuff_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x1b829c
};
