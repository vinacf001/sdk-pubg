...
struct UBP_ReportPlayerWidget_C : U*0b12cc9da8 {
	...
	enum class *ca55b910bf ButtonEvent__DelegateSignature(); // Function BP_ReportPlayerWidget.BP_ReportPlayerWidget_C.ButtonEvent__DelegateSignature // Public|Delegate|BlueprintCallable|BlueprintEvent // @ game+0x1b829c
};
