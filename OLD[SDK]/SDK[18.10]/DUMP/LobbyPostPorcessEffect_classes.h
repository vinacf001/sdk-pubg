...
struct ALobbyPostPorcessEffect_C : ATslPostProcessEffect {
	...
	void UserConstructionScript(); // Function LobbyPostPorcessEffect.LobbyPostPorcessEffect_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x1b829c
};
