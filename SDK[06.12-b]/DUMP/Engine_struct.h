...
struct F*067063007d {
	float PostProcessBlendWeight; // 0x00(0x04)
	struct FVector Location; // 0x04(0x0c)
	float OrthoNearClipPlane; // 0x10(0x04)
	float OrthoWidth; // 0x14(0x04)
	enum class ECameraProjectionMode ProjectionMode; // 0x18(0x01)
	char pad_19[0x3]; // 0x19(0x03)
	struct FVector2D OffCenterProjectionOffset; // 0x1c(0x08)
	struct FRotator Rotation; // 0x24(0x0c)
	float OrthoFarClipPlane; // 0x30(0x04)
	float AspectRatio; // 0x34(0x04)
	float FOV; // 0x38(0x04)
	char pad_3C[0x4]; // 0x3c(0x04)
...
struct FWorldContext {
	struct UGameViewportClient* GameViewport; // 0x00(0x08)
	char pad_8[0x28]; // 0x08(0x28)
	struct TArray<struct F*50fa517ac7> *6e845a0cbb; // 0x30(0x10)
	char pad_40[0x28]; // 0x40(0x28)
	struct TArray<struct F*52c76088ce> PackagesToFullyLoad; // 0x68(0x10)
	char pad_78[0xe0]; // 0x78(0xe0)
	struct TArray<struct U*b0f24f93f7*> *c0f8e6db4a; // 0x158(0x10)
	char pad_168[0x8]; // 0x168(0x08)
	struct UGameInstance* *d9161cd8f3; // 0x170(0x08)
	struct FURL *dfec1c00f1; // 0x178(0x70)
	struct FURL *cbdb4b9722; // 0x1e8(0x70)
	struct TArray<struct F*81839ef2e0> *b22fe64d39; // 0x258(0x10)
	char pad_268[0x20]; // 0x268(0x20)
	struct TArray<struct ULevel*> *d78af1966d; // 0x288(0x10)
	struct U*3189c6f422* *3189c6f422; // 0x298(0x08)
