...
struct UConsoleSettings : UObject {
	...
	struct TArray<struct F*61eef2a2bb> ManualAutoCompleteList; // 0x38(0x10)
...
struct UGameMapsSettings : UObject {
	...
	enum class *91b9b8ac44 ThreePlayerSplitscreenLayout; // 0x62(0x01)
	...
	struct TArray<struct F*bb20d2c770> GameModeMapPrefixes; // 0xb8(0x10)
	struct TArray<struct F*bb20d2c770> GameModeClassAliases; // 0xc8(0x10)
};
...
// Class EngineSettings.*ed1299f7bb
// Size: 0x30 (Inherited: 0x30)
struct U*ed1299f7bb : UObject {
};
