...
// Enum AnimGraphRuntime.*01519c78ca
enum class *01519c78ca : uint8 {
	*9f75aa1e65,
	*5629adc9d1,
	*ead96233b6,
	*01519c78ca_MAX,
...
struct FAnimNode_CurveSource : FAnimNode_Base {
	...
	TScriptInterface<struct U*36e98723ce> CurveSource; // 0x58(0x10)
};
...
struct FAnimNode_LayeredBoneBlend : FAnimNode_Base {
	...
	enum class *e010c2fbb2 CurveBlendOption; // 0x90(0x01)
...
// ScriptStruct AnimGraphRuntime.*6e8fd0e9bb
// Size: 0x88 (Inherited: 0x10)
struct F*6e8fd0e9bb : F*e6b4c2a011 {
	float ScaleFactor; // 0x10(0x04)
	bool *775722e106; // 0x14(0x01)
	char pad_15[0x3]; // 0x15(0x03)
	struct FRichCurve CustomCurve; // 0x18(0x70)
};

// ScriptStruct AnimGraphRuntime.*e6b4c2a011
// Size: 0x10 (Inherited: 0x00)
struct F*e6b4c2a011 {
...
struct FAnimNode_RefPose : FAnimNode_Base {
	enum class *01519c78ca RefPoseType; // 0x30(0x01)
	char pad_31[0x7]; // 0x31(0x07)
};
...
// ScriptStruct AnimGraphRuntime.*f0cca4b2c2
// Size: 0x750 (Inherited: 0x520)
struct F*f0cca4b2c2 : F*c3868df940 {
...
struct FAnimNode_CopyBone : FAnimNode_SkeletalControlBase {
	...
	enum class *627034402d ControlSpace; // 0x12b(0x01)
	char pad_12C[0x4]; // 0x12c(0x04)
};
...
// ScriptStruct AnimGraphRuntime.*051d43c2e3
// Size: 0x30 (Inherited: 0x00)
struct F*051d43c2e3 {
	char pad_0[0x30]; // 0x00(0x30)
};

// ScriptStruct AnimGraphRuntime.*4a62b37a3d
...
struct FAnimNode_ModifyBone : FAnimNode_SkeletalControlBase {
	...
	enum class *627034402d TranslationSpace; // 0x137(0x01)
	enum class *627034402d RotationSpace; // 0x138(0x01)
	enum class *627034402d ScaleSpace; // 0x139(0x01)
...
struct FAnimNode_ObserveBone : FAnimNode_SkeletalControlBase {
	...
	enum class *627034402d DisplaySpace; // 0x110(0x01)
...
struct FAnimNode_TwoBoneIK : FAnimNode_SkeletalControlBase {
	...
	enum class *627034402d EffectorLocationSpace; // 0x144(0x01)
	enum class *627034402d JointTargetLocationSpace; // 0x145(0x01)
	char pad_146[0x2]; // 0x146(0x02)
