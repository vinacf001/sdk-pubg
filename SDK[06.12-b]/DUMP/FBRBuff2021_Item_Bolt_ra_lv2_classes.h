...
struct AFBRBuff2021_Item_Bolt_ra_lv2_C : ATslFBRItemBuff {
	...
	void UserConstructionScript(); // Function FBRBuff2021_Item_Bolt_ra_lv2.FBRBuff2021_Item_Bolt_ra_lv2_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x22c9a0
};
