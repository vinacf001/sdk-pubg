...
struct U*077b952708 : UObject {
	...
	float *db13708ed5(); // Function MovieScene.*077b952708.*db13708ed5 // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x5fc7f00
	void Stop(); // Function MovieScene.*077b952708.Stop // Final|Native|Public|BlueprintCallable // @ game+0x5fc81a0
	void PlayReverse(); // Function MovieScene.*077b952708.PlayReverse // Final|Native|Public|BlueprintCallable // @ game+0x5fc7f64
	void Pause(); // Function MovieScene.*077b952708.Pause // Final|Native|Public|BlueprintCallable // @ game+0x5fc7f34
	void Play(); // Function MovieScene.*077b952708.Play // Final|Native|Public|BlueprintCallable // @ game+0x5fc7f48
	float *33ff4dc197(); // Function MovieScene.*077b952708.*33ff4dc197 // Final|Native|Public|BlueprintCallable // @ game+0x5fc80b0
	float *e619608247(); // Function MovieScene.*077b952708.*e619608247 // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x5fc7e94
	float SetPlayRate(); // Function MovieScene.*077b952708.SetPlayRate // Final|Native|Public|BlueprintCallable // @ game+0x5fc7f80
	void *369f181ebb(); // Function MovieScene.*077b952708.*369f181ebb // Final|Native|Public|BlueprintCallable // @ game+0x5fc7d44
	struct TArray<struct UObject*> *b45e0dc9b9(); // Function MovieScene.*077b952708.*b45e0dc9b9 // Final|Native|Public|BlueprintCallable // @ game+0x5fc7d70
	float GetPlayRate(); // Function MovieScene.*077b952708.GetPlayRate // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x5fc7eb8
	void *b0a7ef1c52(); // Function MovieScene.*077b952708.*b0a7ef1c52 // Final|Native|Public|BlueprintCallable // @ game+0x5fc818c
	float *299565d7ba(); // Function MovieScene.*077b952708.*299565d7ba // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x5fc7ed0
	bool IsPlaying(); // Function MovieScene.*077b952708.IsPlaying // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x5fc7f18
	float SetPlaybackPosition(); // Function MovieScene.*077b952708.SetPlaybackPosition // Final|Native|Public|BlueprintCallable // @ game+0x5fc8018
	int32 *af322aa928(); // Function MovieScene.*077b952708.*af322aa928 // Final|Native|Public|BlueprintCallable // @ game+0xcca4f4
	float *65ef202f2e(); // Function MovieScene.*077b952708.*65ef202f2e // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x5fc7ee8
};
