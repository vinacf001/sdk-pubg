...
// Size: 0xd90 (Inherited: 0xd70)
struct U*883e67a4f9 : UHierarchicalInstancedStaticMeshComponent {
	struct FMulticastDelegate OnInstanceTakePointDamage; // 0xd68(0x10)
	struct FMulticastDelegate OnInstanceTakeRadialDamage; // 0xd78(0x10)
};
...
struct U*bae01c6b5e : UBlueprintFunctionLibrary {
	...
	int32 *189d4ea2b6(); // Function Foliage.*bae01c6b5e.*189d4ea2b6 // Final|Native|Static|Public|HasDefaults|BlueprintCallable // @ game+0x5f8fc98
	int32 *adf5b3b7b3(); // Function Foliage.*bae01c6b5e.*adf5b3b7b3 // Final|Native|Static|Public|HasDefaults|BlueprintCallable // @ game+0x5f8fddc
};
...
struct AInteractiveFoliageActor : AStaticMeshActor {
	...
	struct FHitResult CapsuleTouched(); // Function Foliage.InteractiveFoliageActor.CapsuleTouched // Final|Native|Protected|HasOutParms // @ game+0x5f8fa48
};
...
struct UProceduralFoliageSpawner : UObject {
	...
	int32 Simulate(); // Function Foliage.ProceduralFoliageSpawner.Simulate // Final|Native|Public|BlueprintCallable // @ game+0x5f8ff58
};
