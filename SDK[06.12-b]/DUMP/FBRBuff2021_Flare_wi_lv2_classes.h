...
struct AFBRBuff2021_Flare_wi_lv2_C : ATslFBRItemBuff {
	...
	void UserConstructionScript(); // Function FBRBuff2021_Flare_wi_lv2.FBRBuff2021_Flare_wi_lv2_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x22c9a0
};
