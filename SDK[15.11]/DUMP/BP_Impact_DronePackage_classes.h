...
struct ABP_Impact_DronePackage_C : ATslImpactEffect {
	...
	void UserConstructionScript(); // Function BP_Impact_DronePackage.BP_Impact_DronePackage_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x21d2c4
};
