...
struct AFBRBuff_Item_12Guage_Pa_Lv1_C : ATslFBRItemBuff {
	...
	void UserConstructionScript(); // Function FBRBuff_Item_12Guage_Pa_Lv1.FBRBuff_Item_12Guage_Pa_Lv1_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x21d2c4
};
