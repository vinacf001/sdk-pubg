...
// Size: 0xd70 (Inherited: 0xd50)
struct U*68caa303be : UHierarchicalInstancedStaticMeshComponent {
	struct FMulticastDelegate OnInstanceTakePointDamage; // 0xd48(0x10)
	struct FMulticastDelegate OnInstanceTakeRadialDamage; // 0xd58(0x10)
};
...
struct U*700a8d0f9b : UBlueprintFunctionLibrary {
	...
	void *4d3282e214(); // Function Foliage.*700a8d0f9b.*4d3282e214 // Final|Native|Static|Public|HasDefaults|BlueprintCallable // @ game+0x5fb414c
	void *36a58b13ed(); // Function Foliage.*700a8d0f9b.*36a58b13ed // Final|Native|Static|Public|HasDefaults|BlueprintCallable // @ game+0x5fb4290
};
...
struct AInteractiveFoliageActor : AStaticMeshActor {
	...
	struct FVector *7968e5e03a; // 0x410(0x0c)
	struct FVector *6201ccff37; // 0x41c(0x0c)
	struct FVector *3efd165ca5; // 0x428(0x0c)
	struct FVector *18dd295f2c; // 0x434(0x0c)
	...
	void CapsuleTouched(); // Function Foliage.InteractiveFoliageActor.CapsuleTouched // Final|Native|Protected|HasOutParms // @ game+0x5fb3efc
};
...
struct UProceduralFoliageSpawner : UObject {
	...
	void Simulate(); // Function Foliage.ProceduralFoliageSpawner.Simulate // Final|Native|Public|BlueprintCallable // @ game+0x5fb440c
};
