...
struct UNiagaraComponent : UPrimitiveComponent {
	struct UNiagaraEffect* Asset; // 0x998(0x08)
	char pad_9A8[0x8]; // 0x9a8(0x08)
	struct TArray<struct F*2f6acd5670> *e4a2c28d06; // 0x9b0(0x10)
	struct TArray<struct F*916f6dba5b> *2c184b855c; // 0x9c0(0x10)
	struct TArray<struct U*cd0aefaa57*> *ea0084a67f; // 0x9d0(0x10)
	bool *70896d945b; // 0x9e0(0x01)
	char pad_9E1[0xf]; // 0x9e1(0x0f)

	void *c295b4c44d(); // Function Niagara.NiagaraComponent.*c295b4c44d // Final|Native|Public|HasDefaults|BlueprintCallable // @ game+0x6261b64
	void *82a41ea059(); // Function Niagara.NiagaraComponent.*82a41ea059 // Final|Native|Public|HasDefaults|BlueprintCallable // @ game+0x6261a04
	void *4887bfdca5(); // Function Niagara.NiagaraComponent.*4887bfdca5 // Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable // @ game+0x6261cbc
	void *c27fd77e4a(); // Function Niagara.NiagaraComponent.*c27fd77e4a // Final|Native|Public|BlueprintCallable // @ game+0x6261514
	void *1ba7b99f0e(); // Function Niagara.NiagaraComponent.*1ba7b99f0e // Final|Native|Public|BlueprintCallable // @ game+0x6261554
	void *bb159d3df5(); // Function Niagara.NiagaraComponent.*bb159d3df5 // Final|Native|Public|BlueprintCallable // @ game+0x6261df0
	void *3a2c3cec9a(); // Function Niagara.NiagaraComponent.*3a2c3cec9a // Final|Native|Public|BlueprintCallable // @ game+0x62614d4
	void *0bf5489262(); // Function Niagara.NiagaraComponent.*0bf5489262 // Final|Native|Public|BlueprintCallable // @ game+0x62618e4
	void *5e10cdf5fb(); // Function Niagara.NiagaraComponent.*5e10cdf5fb // Final|Native|Public|BlueprintCallable // @ game+0x6261790
	void *0ee27878ae(); // Function Niagara.NiagaraComponent.*0ee27878ae // Final|Native|Public|BlueprintCallable // @ game+0x6261674
};
...
struct U*b3665cbb22 : UBlueprintFunctionLibrary {
	...
	void SpawnEffectAttached(); // Function Niagara.*b3665cbb22.SpawnEffectAttached // Final|Native|Static|Public|HasDefaults|BlueprintCallable // @ game+0x6262048
	void *f921c9dbbb(); // Function Niagara.*b3665cbb22.*f921c9dbbb // Final|Native|Static|Public|HasDefaults|BlueprintCallable // @ game+0x6261e80
};
