// Enum PowerIKRuntime.*3175b42e22
enum class *3175b42e22 : uint8 {
	*4921975547,
	*27f28fd199,
	*deee6750be,
	*4471d574ac,
...
// Enum PowerIKRuntime.*31b85f15bd
enum class *31b85f15bd : uint8 {
	*e386b49d1b,
	*29e26aeffd,
	*15872e2b68,
	*4c4cc2f01b,
...
// ScriptStruct PowerIKRuntime.*57568c2303
// Size: 0xa8 (Inherited: 0x00)
struct F*57568c2303 {
	char pad_0[0xa8]; // 0x00(0xa8)
};

// ScriptStruct PowerIKRuntime.*0f054e5f31
// Size: 0x28 (Inherited: 0x00)
struct F*0f054e5f31 {
	char pad_0[0x28]; // 0x00(0x28)
};

// ScriptStruct PowerIKRuntime.*99e5cfbc5e
// Size: 0x68 (Inherited: 0x00)
struct F*99e5cfbc5e {
	char pad_0[0x68]; // 0x00(0x68)
};

// ScriptStruct PowerIKRuntime.*ad813d5860
...
struct FPowerIKEffector {
	...
	enum class *3175b42e22 PositionSpace; // 0x14(0x01)
	char pad_15[0x3]; // 0x15(0x03)
	struct FRotator Rotation; // 0x18(0x0c)
	enum class *3175b42e22 RotationSpace; // 0x24(0x01)
...
struct FPowerIKPoleVector {
	enum class *31b85f15bd Mode; // 0x00(0x01)
...
// ScriptStruct PowerIKRuntime.*f338802636
// Size: 0x10 (Inherited: 0x00)
struct F*f338802636 {
