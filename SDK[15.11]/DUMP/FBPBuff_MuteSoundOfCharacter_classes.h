...
struct AFBPBuff_MuteSoundOfCharacter_C : ATslFBRSoundBuff {
	...
	void UserConstructionScript(); // Function FBPBuff_MuteSoundOfCharacter.FBPBuff_MuteSoundOfCharacter_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x21d2c4
};
