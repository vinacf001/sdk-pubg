...
// Size: 0xb00 (Inherited: 0x9a0)
struct ULandscapeComponent : UPrimitiveComponent {
	int32 SectionBaseX; // 0x998(0x04)
	int32 SectionBaseY; // 0x99c(0x04)
	int32 *54a300c73c; // 0x9a0(0x04)
	int32 *0ac6c17a96; // 0x9a4(0x04)
	int32 *05ea8d542a; // 0x9a8(0x04)
	struct UMaterialInterface* OverrideMaterial; // 0x9b0(0x08)
	struct UMaterialInterface* OverrideHoleMaterial; // 0x9b8(0x08)
	struct TArray<struct UMaterialInstanceConstant*> MaterialInstances; // 0x9c0(0x10)
	struct TArray<struct F*4fee740a0d> *1f3b7254ae; // 0x9d0(0x10)
	struct TArray<struct UTexture2D*> *4c9232b568; // 0x9e0(0x10)
	struct UTexture2D* XYOffsetmapTexture; // 0x9f0(0x08)
	struct FIntPoint *338e1bb7a0; // 0x9f8(0x08)
	struct FVector4 *5ff691d859; // 0xa00(0x10)
	float *0da2b6f976; // 0xa10(0x04)
	struct UTexture2D* HeightmapTexture; // 0xa18(0x08)
	struct UTexture2D* NormalmapTexture; // 0xa20(0x08)
	struct FBox *8d62646241; // 0xa28(0x1c)
	struct ULandscapeHeightfieldCollisionComponent* CollisionComponent; // 0xa44(0x1c)
	struct FGuid *f0a9768bcf; // 0xa60(0x10)
	struct TArray<struct FGuid> IrrelevantLights; // 0xa70(0x10)
	int32 CollisionMipLevel; // 0xa80(0x04)
	int32 *dcd63fdeac; // 0xa84(0x04)
	float *6dc77033e2; // 0xa88(0x04)
	float *ba25840801; // 0xa8c(0x04)
	float StaticLightingResolution; // 0xa90(0x04)
	int32 ForcedLOD; // 0xa94(0x04)
	int32 LODBias; // 0xa98(0x04)
	struct FGuid *0ce71e6b22; // 0xa9c(0x10)
	struct FGuid *3b8f06b235; // 0xaac(0x10)
	char pad_ABC[0x4]; // 0xabc(0x04)
	struct UTexture2D* GIBakedBaseColorTexture; // 0xac0(0x08)
	bool *6f4162ec76; // 0xac8(0x01)
	bool *43a67787b6; // 0xac9(0x01)
	char pad_ACA[0x6]; // 0xaca(0x06)
	struct UMaterialInterface* *1be858469e; // 0xad0(0x08)
	struct UTexture2D* *348709cf49; // 0xad8(0x08)
	char pad_AE0[0x20]; // 0xae0(0x20)
};
...
struct ULandscapeHeightfieldCollisionComponent : UPrimitiveComponent {
	struct TArray<struct ULandscapeLayerInfoObject*> *4651115958; // 0x998(0x10)
	int32 *69a0ad9f89; // 0x9a8(0x04)
	int32 *7b9896e8d4; // 0x9ac(0x04)
	int32 *79567fcf21; // 0x9b0(0x04)
	float *5f88168dea; // 0x9b4(0x04)
	int32 *f2521a8ad4; // 0x9b8(0x04)
	int32 *596a69ae94; // 0x9bc(0x04)
	struct TArray<bool> *ff29e1ddbf; // 0x9c0(0x10)
	struct FGuid *1cb000e4af; // 0x9d0(0x10)
	struct FBox *8d62646241; // 0x9e0(0x1c)
	struct ULandscapeComponent* RenderComponent; // 0x9fc(0x1c)
	char pad_A20[0x78]; // 0xa20(0x78)
	struct TArray<struct UPhysicalMaterial*> *8fae1bb6aa; // 0xa98(0x10)
...
struct ULandscapeMeshCollisionComponent : ULandscapeHeightfieldCollisionComponent {
	struct FGuid *3fe167b539; // 0xb00(0x10)
...
struct ALandscapeMeshProxyActor : AActor {
	struct U*b5c217f432* LandscapeMeshProxyComponent; // 0x3f8(0x08)
};

// Class Landscape.*b5c217f432
// Size: 0xb70 (Inherited: 0xb40)
struct U*b5c217f432 : UStaticMeshComponent {
	struct FGuid *a377647193; // 0xb40(0x10)
	struct TArray<struct FIntPoint> *faa5075fd7; // 0xb50(0x10)
	int8 *11b2d6bbfc; // 0xb60(0x01)
	char pad_B61[0xf]; // 0xb61(0x0f)
};

// Class Landscape.LandscapeProxy
// Size: 0x840 (Inherited: 0x3f8)
struct ALandscapeProxy : AActor {
	struct FGuid *a377647193; // 0x3f8(0x10)
	struct ULandscapeSplinesComponent* SplineComponent; // 0x408(0x08)
	int32 *54a300c73c; // 0x410(0x04)
	int32 *0ac6c17a96; // 0x414(0x04)
	int32 *05ea8d542a; // 0x418(0x04)
	struct FIntPoint *7c8732156f; // 0x41c(0x08)
	...
	float *6dc77033e2; // 0x458(0x04)
	float *ba25840801; // 0x45c(0x04)
	struct TArray<struct ULandscapeComponent*> LandscapeComponents; // 0x460(0x10)
	struct TArray<struct ULandscapeHeightfieldCollisionComponent*> *3c9dc87539; // 0x470(0x10)
	struct TArray<struct UHierarchicalInstancedStaticMeshComponent*> *684d466ca0; // 0x480(0x10)
	char pad_490[0x60]; // 0x490(0x60)
	char *c54d3d7caa : 1; // 0x4f0(0x01)
	char bCastStaticShadow : 1; // 0x4f0(0x01)
	char bCastShadowAsTwoSided : 1; // 0x4f0(0x01)
	char bCastFarShadow : 1; // 0x4f0(0x01)
	char *8674a790fb : 1; // 0x4f0(0x01)
	char bRenderCustomDepth : 1; // 0x4f0(0x01)
	char bGenerateOverlapEvents : 1; // 0x4f0(0x01)
	char *78d4b525b3 : 1; // 0x4f0(0x01)
	char *2e30b51a7f : 1; // 0x4f1(0x01)
	char *badd1b31e9 : 1; // 0x4f1(0x01)
	...
	struct F*886b75ca22 LightmassSettings; // 0x500(0x18)
	int32 CollisionMipLevel; // 0x518(0x04)
	int32 *dcd63fdeac; // 0x51c(0x04)
	float *ff57d72168; // 0x520(0x04)
	char pad_524[0xc]; // 0x524(0x0c)
	struct FBodyInstance BodyInstance; // 0x530(0x230)
	enum class ENavDataGatheringMode *c609dcac1c; // 0x760(0x01)
	char pad_761[0xdf]; // 0x761(0xdf)

	void *8e60c8a685(); // Function Landscape.LandscapeProxy.*8e60c8a685 // Final|Native|Public|BlueprintCallable // @ game+0x5fceb7c
	void *85b6178615(); // Function Landscape.LandscapeProxy.*85b6178615 // Native|Public|BlueprintCallable // @ game+0x590dde4
};
...
struct ULandscapeSplinesComponent : UPrimitiveComponent {
	struct TArray<struct ULandscapeSplineControlPoint*> ControlPoints; // 0x998(0x10)
	struct TArray<struct ULandscapeSplineSegment*> Segments; // 0x9a8(0x10)
	struct TArray<struct UMeshComponent*> *8c6b6d1d8f; // 0x9b8(0x10)
};
