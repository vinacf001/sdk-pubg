...
struct ABP_TslBaseLobbySceneTravel_Teleport_C : ATslLobbySceneTravel_Teleport {
	...
	void UserConstructionScript(); // Function BP_TslBaseLobbySceneTravel_Teleport.BP_TslBaseLobbySceneTravel_Teleport_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x21d2c4
};
