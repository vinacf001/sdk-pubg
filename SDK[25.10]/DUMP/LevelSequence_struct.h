...
struct F*5f70314217 {
	struct UObject* *2d89fab18a; // 0x00(0x1c)
	char pad_1C[0x4]; // 0x1c(0x04)
	struct FString ComponentName; // 0x20(0x10)
	struct UObject* *e9c0a56ae1; // 0x30(0x08)
};

// ScriptStruct LevelSequence.*18b04c0f43
// Size: 0x50 (Inherited: 0x00)
struct F*18b04c0f43 {
	struct TMap<struct FGuid, struct F*b20fa12cb6> *ab2c4d6ddf; // 0x00(0x50)
};

// ScriptStruct LevelSequence.*b20fa12cb6
// Size: 0x10 (Inherited: 0x00)
struct F*b20fa12cb6 {
	struct TArray<struct F*4144c94bfd> References; // 0x00(0x10)
};
...
struct F*cf8a9c6e3b {
	...
	struct F*7c29304c5c Settings; // 0x48(0x08)
};
