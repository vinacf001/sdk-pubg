...
struct F*6d0e0b2cc1 {
	...
	enum class ECameraProjectionMode ProjectionMode; // 0x04(0x01)
	char pad_5[0x3]; // 0x05(0x03)
	char bConstrainAspectRatio : 1; // 0x08(0x01)
	char bUseFieldOfViewForLOD : 1; // 0x08(0x01)
	char pad_8_2 : 6; // 0x08(0x01)
	char pad_9[0x3]; // 0x09(0x03)
	float OrthoFarClipPlane; // 0x0c(0x04)
	struct FRotator Rotation; // 0x10(0x0c)
	float OrthoNearClipPlane; // 0x1c(0x04)
	float FOV; // 0x20(0x04)
	char pad_24[0xc]; // 0x24(0x0c)
	struct FPostProcessSettings PostProcessSettings; // 0x30(0x570)
	float AspectRatio; // 0x5a0(0x04)
	struct FVector Location; // 0x5a4(0x0c)
	struct FVector2D OffCenterProjectionOffset; // 0x5b0(0x08)
	float OrthoWidth; // 0x5b8(0x04)
...
struct FWorldContext {
	struct TArray<struct U*7c448e30ae*> *55d92776e4; // 0x00(0x10)
	char pad_10[0x30]; // 0x10(0x30)
	struct TArray<struct F*9dcd338c5a> PackagesToFullyLoad; // 0x40(0x10)
	struct U*8ea0475d8b* *8ea0475d8b; // 0x50(0x08)
	struct FURL *83f990b9f5; // 0x58(0x70)
	struct TArray<struct F*f189697845> *22f89144d6; // 0xc8(0x10)
	char pad_D8[0xd0]; // 0xd8(0xd0)
	struct UGameInstance* *55c38de05e; // 0x1a8(0x08)
	char pad_1B0[0x10]; // 0x1b0(0x10)
	struct TArray<struct F*248f357491> *959985156a; // 0x1c0(0x10)
	char pad_1D0[0x18]; // 0x1d0(0x18)
	struct TArray<struct ULevel*> *fdfac597be; // 0x1e8(0x10)
	struct FURL *e2dd2c7e65; // 0x1f8(0x70)
	char pad_268[0x8]; // 0x268(0x08)
	struct UGameViewportClient* GameViewport; // 0x270(0x08)
