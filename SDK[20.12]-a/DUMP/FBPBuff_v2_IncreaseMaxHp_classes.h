...
struct AFBPBuff_v2_IncreaseMaxHp_C : ATslIncreaseMaxHpBuff {
	...
	void UserConstructionScript(); // Function FBPBuff_v2_IncreaseMaxHp.FBPBuff_v2_IncreaseMaxHp_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x3b43ac
};
