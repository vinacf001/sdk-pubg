...
struct UNiagaraComponent : UPrimitiveComponent {
	...
	struct TArray<struct F*0ee7a24bff> *8e095988a9; // 0x9c0(0x10)
	struct TArray<struct F*901dfe5449> *8b1d39fad9; // 0x9d0(0x10)
	struct TArray<struct U*561e25d4e6*> *31c143a97a; // 0x9e0(0x10)
	bool *859a7db0e0; // 0x9f0(0x01)
	char pad_9F1[0xf]; // 0x9f1(0x0f)

	void *206caa6c6a(); // Function Niagara.NiagaraComponent.*206caa6c6a // Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable // @ game+0x6701494
	void *904c9f6561(); // Function Niagara.NiagaraComponent.*904c9f6561 // Final|Native|Public|BlueprintCallable // @ game+0x6700d2c
	void *1a9370ca29(); // Function Niagara.NiagaraComponent.*1a9370ca29 // Final|Native|Public|HasDefaults|BlueprintCallable // @ game+0x670133c
	void *3958968000(); // Function Niagara.NiagaraComponent.*3958968000 // Final|Native|Public|BlueprintCallable // @ game+0x6700cac
	void *94ee81e316(); // Function Niagara.NiagaraComponent.*94ee81e316 // Final|Native|Public|BlueprintCallable // @ game+0x67015c8
	void *6583fd4268(); // Function Niagara.NiagaraComponent.*6583fd4268 // Final|Native|Public|BlueprintCallable // @ game+0x6700f68
	void *561f9f0fe5(); // Function Niagara.NiagaraComponent.*561f9f0fe5 // Final|Native|Public|BlueprintCallable // @ game+0x6700e4c
	void *d9236539a6(); // Function Niagara.NiagaraComponent.*d9236539a6 // Final|Native|Public|BlueprintCallable // @ game+0x6700cec
	void *5b77053795(); // Function Niagara.NiagaraComponent.*5b77053795 // Final|Native|Public|BlueprintCallable // @ game+0x67010bc
	void *7226b31442(); // Function Niagara.NiagaraComponent.*7226b31442 // Final|Native|Public|HasDefaults|BlueprintCallable // @ game+0x67011dc
};
...
struct U*548c9377d3 : UBlueprintFunctionLibrary {
	...
	void SpawnEffectAttached(); // Function Niagara.*548c9377d3.SpawnEffectAttached // Final|Native|Static|Public|HasDefaults|BlueprintCallable // @ game+0x6701820
	void *ec2ab531f3(); // Function Niagara.*548c9377d3.*ec2ab531f3 // Final|Native|Static|Public|HasDefaults|BlueprintCallable // @ game+0x6701658
};
