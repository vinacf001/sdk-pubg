...
struct ABP_Sky_Sphere_Desert_07_C : AActor {
	...
	struct U*22e8771771* Horizon color curve; // 0x470(0x08)
	struct U*22e8771771* Zenith color curve; // 0x478(0x08)
	struct U*22e8771771* Cloud color curve; // 0x480(0x08)

	void UpdateSunDirection(); // Function BP_Sky_Sphere_Desert_07.BP_Sky_Sphere_Desert_07_C.UpdateSunDirection // Public|BlueprintCallable|BlueprintEvent // @ game+0x3b43ac
	void UserConstructionScript(); // Function BP_Sky_Sphere_Desert_07.BP_Sky_Sphere_Desert_07_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x3b43ac
};
