...
struct F*067063007d {
	...
	float AspectRatio; // 0x04(0x04)
	struct FRotator Rotation; // 0x08(0x0c)
	float OrthoNearClipPlane; // 0x14(0x04)
	char bConstrainAspectRatio : 1; // 0x18(0x01)
	char bUseFieldOfViewForLOD : 1; // 0x18(0x01)
	char pad_18_2 : 6; // 0x18(0x01)
	char pad_19[0x3]; // 0x19(0x03)
	float OrthoFarClipPlane; // 0x1c(0x04)
	struct FVector Location; // 0x20(0x0c)
	enum class ECameraProjectionMode ProjectionMode; // 0x2c(0x01)
	char pad_2D[0x3]; // 0x2d(0x03)
	float PostProcessBlendWeight; // 0x30(0x04)
	struct FVector2D OffCenterProjectionOffset; // 0x34(0x08)
	float FOV; // 0x3c(0x04)
...
struct F*67dd5045be {
	...
	char pad_8[0x8]; // 0x08(0x08)
	struct F*067063007d POV; // 0x10(0x5b0)
...
struct F*506119bf4d {
	...
	struct F*067063007d *4fc1364ad4; // 0x10(0x5b0)
};
...
struct FWorldContext {
	char pad_0[0x10]; // 0x00(0x10)
	struct FURL *cbdb4b9722; // 0x10(0x70)
	struct TArray<struct F*81839ef2e0> *b22fe64d39; // 0x80(0x10)
	char pad_90[0xd8]; // 0x90(0xd8)
	struct UGameViewportClient* GameViewport; // 0x168(0x08)
	struct U*3189c6f422* *3189c6f422; // 0x170(0x08)
	struct FURL *dfec1c00f1; // 0x178(0x70)
	char pad_1E8[0x10]; // 0x1e8(0x10)
	struct TArray<struct F*52c76088ce> PackagesToFullyLoad; // 0x1f8(0x10)
	struct TArray<struct F*50fa517ac7> *6e845a0cbb; // 0x208(0x10)
	struct TArray<struct U*b0f24f93f7*> *c0f8e6db4a; // 0x218(0x10)
	char pad_228[0x58]; // 0x228(0x58)
	struct UGameInstance* *d9161cd8f3; // 0x280(0x08)
	struct TArray<struct ULevel*> *d78af1966d; // 0x288(0x10)
