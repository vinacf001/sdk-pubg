...
struct U*077b952708 : UObject {
	...
	void *db13708ed5(); // Function MovieScene.*077b952708.*db13708ed5 // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x647b2c0
	void Stop(); // Function MovieScene.*077b952708.Stop // Final|Native|Public|BlueprintCallable // @ game+0x647b560
	void PlayReverse(); // Function MovieScene.*077b952708.PlayReverse // Final|Native|Public|BlueprintCallable // @ game+0x647b324
	void Pause(); // Function MovieScene.*077b952708.Pause // Final|Native|Public|BlueprintCallable // @ game+0x647b2f4
	void Play(); // Function MovieScene.*077b952708.Play // Final|Native|Public|BlueprintCallable // @ game+0x647b308
	void *33ff4dc197(); // Function MovieScene.*077b952708.*33ff4dc197 // Final|Native|Public|BlueprintCallable // @ game+0x647b470
	void *e619608247(); // Function MovieScene.*077b952708.*e619608247 // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x647b254
	void SetPlayRate(); // Function MovieScene.*077b952708.SetPlayRate // Final|Native|Public|BlueprintCallable // @ game+0x647b340
	void *369f181ebb(); // Function MovieScene.*077b952708.*369f181ebb // Final|Native|Public|BlueprintCallable // @ game+0x647b104
	void *b45e0dc9b9(); // Function MovieScene.*077b952708.*b45e0dc9b9 // Final|Native|Public|BlueprintCallable // @ game+0x647b130
	void GetPlayRate(); // Function MovieScene.*077b952708.GetPlayRate // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x647b278
	void *b0a7ef1c52(); // Function MovieScene.*077b952708.*b0a7ef1c52 // Final|Native|Public|BlueprintCallable // @ game+0x647b54c
	void *299565d7ba(); // Function MovieScene.*077b952708.*299565d7ba // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x647b290
	void IsPlaying(); // Function MovieScene.*077b952708.IsPlaying // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x647b2d8
	void SetPlaybackPosition(); // Function MovieScene.*077b952708.SetPlaybackPosition // Final|Native|Public|BlueprintCallable // @ game+0x647b3d8
	void *af322aa928(); // Function MovieScene.*077b952708.*af322aa928 // Final|Native|Public|BlueprintCallable // @ game+0xe83f8c
	void *65ef202f2e(); // Function MovieScene.*077b952708.*65ef202f2e // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x647b2a8
};
