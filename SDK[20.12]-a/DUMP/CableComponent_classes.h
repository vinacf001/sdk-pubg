...
struct UCableComponent : UMeshComponent {
	...
	void *964e40b0d6(); // Function CableComponent.CableComponent.*964e40b0d6 // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x6ef1a40
	void *18d715e2a2(); // Function CableComponent.CableComponent.*18d715e2a2 // Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const // @ game+0x6ef1a78
	void *56bed28938(); // Function CableComponent.CableComponent.*56bed28938 // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x6ef1a28
	void *b78de2535f(); // Function CableComponent.CableComponent.*b78de2535f // Final|Native|Public|BlueprintCallable // @ game+0x6ef1b40
};
