...
struct AP_Vehicle_Explosion_BP_C : ATslParticle {
	...
	void SwitchBasedOnSurface(); // Function P_Vehicle_Explosion_BP.P_Vehicle_Explosion_BP_C.SwitchBasedOnSurface // Public|HasDefaults|BlueprintCallable|BlueprintEvent // @ game+0x3b43ac
	void UserConstructionScript(); // Function P_Vehicle_Explosion_BP.P_Vehicle_Explosion_BP_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x3b43ac
};
