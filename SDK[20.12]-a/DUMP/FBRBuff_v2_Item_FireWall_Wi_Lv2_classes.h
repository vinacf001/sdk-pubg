...
struct AFBRBuff_v2_Item_FireWall_Wi_Lv2_C : ATslFBRItemBuff {
	...
	void UserConstructionScript(); // Function FBRBuff_v2_Item_FireWall_Wi_Lv2.FBRBuff_v2_Item_FireWall_Wi_Lv2_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x3b43ac
};
