...
struct UHoudiniAssetComponent : UPrimitiveComponent {
	...
	void *2c228a11cd(); // Function HoudiniEngineRuntime.HoudiniAssetComponent.*2c228a11cd // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x6fc510c
};
