...
struct ABP_QOL_Marker_C : AActor {
	...
	void UserConstructionScript(); // Function BP_QOL_Marker.BP_QOL_Marker_C.UserConstructionScript // Event|Public|HasDefaults|BlueprintCallable|BlueprintEvent // @ game+0x3b43ac
};
