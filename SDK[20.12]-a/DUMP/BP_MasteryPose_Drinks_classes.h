...
struct ABP_MasteryPose_Drinks_C : ABP_MasteryPose_C {
	...
	void UserConstructionScript(); // Function BP_MasteryPose_Drinks.BP_MasteryPose_Drinks_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x3b43ac
};
